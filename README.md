...
<!-- INDEX:clawhub:START -->
最后同步：2026-08-17T08:52:50.809Z

已镜像完整内容：**72672** 个 skill，明细见 `index/clawhub.json` 与 `skills/clawhub/`。
<!-- INDEX:clawhub:END -->

### skills.sh

<!-- INDEX:skills-sh:START -->
最后同步：2026-07-27T15:33:27.578Z

已镜像完整内容：**3096** 个 skill，明细见 `index/skills-sh.json` 与 `skills/skills-sh/`。
<!-- INDEX:skills-sh:END -->
