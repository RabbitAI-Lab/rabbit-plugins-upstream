...
平台提示词：真实感、生活感和情绪价值优先，少叫卖感；适合 Vlog 种草、开箱测评、沉浸式体验、氛围感短片。画质和光影写细一点。
