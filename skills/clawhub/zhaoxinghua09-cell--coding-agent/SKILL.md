...
version: 1.0.0
license: MIT
description: 将编码工作委托给 Codex、Claude Code 或 OpenCode 作为后台工作进程执行，用于回答「大重构能不能丢给后台跑」「PR 能不能自动审」这类问题
tags:
- 诺声
- AI技能
- SynomosAI
...
category: 开发工具
updated: 2026-08-28
fingerprint: FP-MX-BCBEEB32BE16
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-BCBEEB32BE16
