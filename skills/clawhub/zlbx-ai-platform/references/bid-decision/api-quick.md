...
> `POST https://mcp-server.zhiliaobiaoxun.com/api_v2/` + 工具名（例：`https://mcp-server.zhiliaobiaoxun.com/api_v2/search_bids`），Header 带 `X-API-Key` + `X-Client: ai-platform/1.0.1`。
