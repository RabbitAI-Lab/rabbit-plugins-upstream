# Contributing to `Convert Github Repository`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Convert Github Repository.git
cd Convert Github Repository
...
git add .
git commit -m "feat(convert-github-repository): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(convert-github-repository): add <brief description>
