...
def set_pool_mode(pool_ge_8yi):
    ...
    同时更新模块级 PRIZE_PAYOUT, 使既有 `from ... import PRIZE_PAYOUT`
    的调用方保持一致性(不破坏向后兼容)。
    """
    global _POOL_GE_8YI, PRIZE_PAYOUT
    _POOL_GE_8YI = bool(pool_ge_8yi)
    PRIZE_PAYOUT = PRIZE_PAYOUT_BOOSTED if _POOL_GE_8YI else PRIZE_PAYOUT_BASE
    return PRIZE_PAYOUT
...
PRIZE_PAYOUT = PRIZE_PAYOUT_BASE
PRIZE_NAME = {
    (5, 2): '一等奖', (5, 1): '二等奖',
    (5, 0): '三等奖', (4, 2): '三等奖',
    (4, 1): '四等奖',
