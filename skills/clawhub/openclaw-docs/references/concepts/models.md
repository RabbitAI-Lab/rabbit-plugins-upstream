...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationModel conceptsModels CLIGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
...
- [“Model is not allowed” (and why replies stop)](#%E2%80%9Cmodel-is-not-allowed%E2%80%9D-and-why-replies-stop)
- [Switching models in chat (/model)](#switching-models-in-chat-%2Fmodel)
...
is merged by default unless `models.mode` is set to `replace`.Model Provider QuickstartModel Providers⌘I