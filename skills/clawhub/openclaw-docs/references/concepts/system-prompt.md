...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationFundamentalsSystem PromptGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpFundamentals
...
`openclaw status` itself when possible (asking the user only when it lacks access).Agent LoopContext⌘I