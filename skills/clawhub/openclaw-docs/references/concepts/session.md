...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationSessions and memorySession ManagementGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpFundamentals
...
- [Mapping transports → session keys](#mapping-transports-%E2%86%92-session-keys)
- [Lifecycle](#lifecycle)
- [Send policy (optional)](#send-policy-optional)
