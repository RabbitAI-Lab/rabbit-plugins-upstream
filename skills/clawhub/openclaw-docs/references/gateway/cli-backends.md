...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationProtocols and APIsCLI BackendsGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Using it as a fallback](#using-it-as-a-fallback)
- [Configuration overview](#configuration-overview)
- [Example configuration](#example-configuration)
- [How it works](#how-it-works)
- [Sessions](#sessions)
- [Images (pass-through)](#images-pass-through)
- [Inputs / outputs](#inputs-%2F-outputs)
- [Defaults (built-in)](#defaults-built-in)
...
Tools Invoke APILocal Models⌘I