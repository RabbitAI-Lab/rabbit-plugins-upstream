...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationProtocols and APIsGateway ProtocolGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Framing](#framing)
- [Roles + scopes](#roles-%2B-scopes)
- [Roles](#roles)
- [Scopes (operator)](#scopes-operator)
- [Caps/commands/permissions (node)](#caps%2Fcommands%2Fpermissions-node)
- [Presence](#presence)
- [Node helper methods](#node-helper-methods)
- [Exec approvals](#exec-approvals)
- [Versioning](#versioning)
- [Auth](#auth)
- [Device identity + pairing](#device-identity-%2B-pairing)
- [TLS + pinning](#tls-%2B-pinning)
- [Scope](#scope)
...
TypeBox schemas in `src/gateway/protocol/schema.ts`.Sandbox vs Tool Policy vs ElevatedBridge Protocol⌘I