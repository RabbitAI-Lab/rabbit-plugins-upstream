...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationSecurity and sandboxingSandboxingGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Images + setup](#images-%2B-setup)
- [setupCommand (one-time container setup)](#setupcommand-one-time-container-setup)
- [Tool policy + escape hatches](#tool-policy-%2B-escape-hatches)
...
SecuritySandbox vs Tool Policy vs Elevated⌘I