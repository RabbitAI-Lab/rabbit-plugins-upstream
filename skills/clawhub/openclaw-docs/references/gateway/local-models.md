...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationProtocols and APIsLocal ModelsGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Recommended: LM Studio + MiniMax M2.1 (Responses API, full-size)](#recommended-lm-studio-%2B-minimax-m2-1-responses-api-full-size)
...
- [Regional hosting / data routing](#regional-hosting-%2F-data-routing)
