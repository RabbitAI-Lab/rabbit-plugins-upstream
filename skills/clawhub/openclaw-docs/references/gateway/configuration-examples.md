...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationConfiguration and operationsConfiguration ExamplesGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Recommended starter](#recommended-starter)
- [Expanded example (major options)](#expanded-example-major-options)
- [Common patterns](#common-patterns)
- [Multi-platform setup](#multi-platform-setup)
- [Secure DM mode (shared inbox / multi-user DMs)](#secure-dm-mode-shared-inbox-%2F-multi-user-dms)
- [OAuth with API key failover](#oauth-with-api-key-failover)
- [Anthropic subscription + API key, MiniMax fallback](#anthropic-subscription-%2B-api-key-minimax-fallback)
- [Work bot (restricted access)](#work-bot-restricted-access)
...
Configuration ReferenceAuthentication⌘I