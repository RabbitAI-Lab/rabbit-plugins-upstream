...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationConfiguration and operationsBackground Exec and Process ToolGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
On this page
- [Background Exec + Process Tool](#background-exec-%2B-process-tool)
- [exec tool](#exec-tool)
...
Gateway LockMultiple Gateways⌘I