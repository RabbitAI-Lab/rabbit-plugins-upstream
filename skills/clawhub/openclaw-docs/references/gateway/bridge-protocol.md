...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationProtocols and APIsBridge ProtocolGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Transport](#transport)
- [Handshake + pairing](#handshake-%2B-pairing)
- [Frames](#frames)
...
is expected; add a bridge protocol version field before any breaking changes.Gateway ProtocolOpenAI Chat Completions⌘I