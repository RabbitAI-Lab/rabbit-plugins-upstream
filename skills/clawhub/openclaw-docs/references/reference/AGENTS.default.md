...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationTemplatesDefault AGENTS.mdGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpCLI commands
...
On this page
- [AGENTS.md — OpenClaw Personal Assistant (default)](#agents-md-%E2%80%94-openclaw-personal-assistant-default)
...
- [Tools & skills](#tools-%26-skills)
- [Backup tip (recommended)](#backup-tip-recommended)
- [What OpenClaw Does](#what-openclaw-does)
- [Core Skills (enable in Settings → Skills)](#core-skills-enable-in-settings-%E2%86%92-skills)
...
Device Model DatabaseAGENTS.md Template⌘I