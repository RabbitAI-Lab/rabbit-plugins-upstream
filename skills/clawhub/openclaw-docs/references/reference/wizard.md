...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationTechnical referenceOnboarding Wizard ReferenceGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpCLI commands
...
On this page
- [Onboarding Wizard Reference](#onboarding-wizard-reference)
- [Flow details (local mode)](#flow-details-local-mode)
- [Non-interactive mode](#non-interactive-mode)
- [Add agent (non-interactive)](#add-agent-non-interactive)
- [Gateway wizard RPC](#gateway-wizard-rpc)
