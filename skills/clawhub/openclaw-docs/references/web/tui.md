...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationWeb interfacesTUIGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
- [Mental model: agents + sessions](#mental-model-agents-%2B-sessions)
- [Sending + delivery](#sending-%2B-delivery)
- [Pickers + overlays](#pickers-%2B-overlays)
- [Keyboard shortcuts](#keyboard-shortcuts)
- [Slash commands](#slash-commands)
- [Local shell commands](#local-shell-commands)
- [Tool output](#tool-output)
- [History + streaming](#history-%2B-streaming)
