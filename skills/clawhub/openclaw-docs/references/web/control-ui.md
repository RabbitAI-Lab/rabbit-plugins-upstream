...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationWeb interfacesControl UIGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpGateway
...
On this page
- [Control UI (browser)](#control-ui-browser)
- [Quick open (local)](#quick-open-local)
- [Device pairing (first connection)](#device-pairing-first-connection)
...
- [Bind to tailnet + token](#bind-to-tailnet-%2B-token)
- [Insecure HTTP](#insecure-http)
- [Building the UI](#building-the-ui)
- [Debugging/testing: dev server + remote Gateway](#debugging%2Ftesting-dev-server-%2B-remote-gateway)
...
Remote access setup details: [Remote access](/gateway/remote).WebDashboard⌘I