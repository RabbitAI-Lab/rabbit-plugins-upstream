...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationConfigurationGroup MessagesGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
Chat Channels
Messaging platforms
...
- [What’s implemented (2025-12-03)](#what%E2%80%99s-implemented-2025-12-03)
- [Config example (WhatsApp)](#config-example-whatsapp)
- [Activation command (owner-only)](#activation-command-owner-only)
- [How to use](#how-to-use)
- [Testing / verification](#testing-%2F-verification)
