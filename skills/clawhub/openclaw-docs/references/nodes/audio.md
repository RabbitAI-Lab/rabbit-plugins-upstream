...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationMedia and devicesAudio and Voice NotesGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
Tools
Built-in tools
...
On this page
- [Audio / Voice Notes — 2026-01-17](#audio-%2F-voice-notes-%E2%80%94-2026-01-17)
- [What works](#what-works)
- [Auto-detection (default)](#auto-detection-default)
- [Config examples](#config-examples)
- [Provider + CLI fallback (OpenAI + Whisper CLI)](#provider-%2B-cli-fallback-openai-%2B-whisper-cli)
...
- [Mention Detection in Groups](#mention-detection-in-groups)
- [Gotchas](#gotchas)
...
Image and Media SupportCamera Capture⌘I