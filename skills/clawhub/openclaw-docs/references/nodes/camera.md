...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationMedia and devicesCamera CaptureGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
Tools
Built-in tools
...
- [CLI helper (temp files + MEDIA)](#cli-helper-temp-files-%2B-media)
...
- [Safety + practical limits](#safety-%2B-practical-limits)
...
Audio and Voice NotesTalk Mode⌘I