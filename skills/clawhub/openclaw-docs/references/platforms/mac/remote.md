...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationmacOS companion appRemote ControlGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpPlatforms overview
...
On this page
- [Remote OpenClaw (macOS ⇄ remote host)](#remote-openclaw-macos-%E2%87%84-remote-host)
- [Modes](#modes)
...
There is no global “default sound” toggle in the app anymore; callers choose a sound (or none) per request.macOS PermissionsmacOS Signing⌘I