...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationPlatforms overviewmacOS AppGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpPlatforms overview
...
On this page
- [OpenClaw macOS Companion (menu bar + gateway broker)](#openclaw-macos-companion-menu-bar-%2B-gateway-broker)
...
- [openclaw://agent](#openclaw%2F%2Fagent)
- [Onboarding flow (typical)](#onboarding-flow-typical)
- [Build & dev workflow (native)](#build-%26-dev-workflow-native)
