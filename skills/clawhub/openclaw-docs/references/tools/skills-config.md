...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationSkillsSkills ConfigGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
Tools
Built-in tools
...
- [Fields](#fields)
- [Notes](#notes)
- [Sandboxed skills + env vars](#sandboxed-skills-%2B-env-vars)
...
Global `env` and `skills.entries.<skill>.env/apiKey` apply to **host** runs only.SkillsClawHub⌘I