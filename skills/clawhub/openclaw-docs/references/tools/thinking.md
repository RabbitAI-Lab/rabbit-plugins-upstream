...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationBuilt-in toolsThinking LevelsGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
Tools
Built-in tools
...
On this page
- [Thinking Levels (/think directives)](#thinking-levels-%2Fthink-directives)
- [What it does](#what-it-does)
- [Resolution order](#resolution-order)
- [Setting a session default](#setting-a-session-default)
- [Application by agent](#application-by-agent)
- [Verbose directives (/verbose or /v)](#verbose-directives-%2Fverbose-or-%2Fv)
- [Reasoning visibility (/reasoning)](#reasoning-visibility-%2Freasoning)
- [Related](#related)
