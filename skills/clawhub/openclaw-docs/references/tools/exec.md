...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationBuilt-in toolsExec ToolGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpOverview
Tools
Built-in tools
...
- [Session overrides (/exec)](#session-overrides-%2Fexec)
- [Authorization model](#authorization-model)
- [Exec approvals (companion app / node host)](#exec-approvals-companion-app-%2F-node-host)
- [Allowlist + safe bins](#allowlist-%2B-safe-bins)
- [Examples](#examples)
