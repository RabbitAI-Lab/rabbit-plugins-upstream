...
[Skip to main content](#content-area)OpenClaw home pageEnglishSearch...⌘KSearch...NavigationFirst stepsOnboarding OverviewGet startedInstallChannelsAgentsToolsModelsPlatformsGateway & OpsReferenceHelpHome
OpenClaw
Overview
Showcase
Core concepts
...
- [Choose your onboarding path](#choose-your-onboarding-path)
...
For detailed steps, follow the CLI onboarding docs above.Getting StartedOnboarding: CLI⌘I