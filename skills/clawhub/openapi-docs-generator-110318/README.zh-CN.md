...
- github-issues：[feat(api-keys): publish effective scope-plan contract for constrained Agent Keys](https://github.com/ChronoAIProject/NyxID/issues/1207)
- github-issues：[Consolidate dual error handler modules into one shared middleware](https://github.com/TevaLabs/Xelma-Backend/issues/373)
...
- github-issues：[Emit Socket.IO events when bets are accepted (stub or on-chain)](https://github.com/TevaLabs/Xelma-Backend/issues/376)
