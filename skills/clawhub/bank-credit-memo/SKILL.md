...
| 动态类型 | 内容摘要 | 发布时间 | 影响范围 |
|---------|---------|---------|---------|
| 监管发布 | NFRA 2026年第2号令：《银行保险机构许可证管理办法》6月1日施行 | 2026-06 | 信用备忘录需更新许可证信息展示 |
| 监管动态 | Basel III资本管理办法持续实施，三重风险计量规则逐步落地 | 2026-H1 | 信用备忘录需更新资本占用计算（Basel III风险权重） |
| 监管动态 | 2026年Q1银行监管处罚分析：消费者权益保护处罚占比提升 | 2026-Q1 | 信用备忘录需增加消费者权益保护评估 |
| 政策更新 | 交易账簿资本要求风险敏感性提高，12家上市银行资本占用变化 | 2025-11 | 授信方案需考虑资本占用变化 |
