...
from shopee_search_common import DEFAULT_BASE_URL, build_url, parse_int, validate_envelope
from geekbi_auth import ActionRequired, authenticated_json_request


ENDPOINT = "/api/v1/shopee/category/ai-info"
...
def validate_response(payload):
    data = validate_envelope(payload, "Shopee 类目路径查询失败")
...
def main():
    parser = argparse.ArgumentParser(description="查询 Shopee 类目路径")
