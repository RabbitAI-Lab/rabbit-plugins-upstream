---
name: amazon-industry-benchmark
display_name: 亚马逊行业对标 · 类目星级差评率排行
description: >
  亚马逊行业对标 Skill。免费查看本品在类目里的星级、差评率相对位置，
  付费查看类目排行（近30天热度/差评率/平均星级三种口径），辅助选品
  与竞争定位。Use when the user asks about category benchmark, industry ranking,
  leaderboard, 行业对标、类目排行、竞争定位、星级对比、差评率对比。
  Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: industry-benchmark
displayName: 亚马逊行业对标 · 类目星级差评率排行
version: 1.4.7
summary: 看你的 ASIN 在类目里的星级/差评率位置与类目排行
license: MIT
---
