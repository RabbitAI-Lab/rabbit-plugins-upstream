...
description: "Activate when: filing an entry or ISF; onboarding an importer (POA); building the compliance file; 'did we file ISF in time?', 'is our reasonable-care record complete?'. Do NOT activate when: the shipment is exempt and no entry/ISF is required. More: deciqai.com/c/customs-reasonable-care-isf-checklist"
---
...
## Why this variant
The parent checklist is a verifiable gate. Customs entry is a **reasonable-care** obligation with hard filing clocks (ISF) and 5-year recordkeeping. This maps those duties onto the parent's gate.
...
*Part of **deciqAI Knowledge Skills** — 227 open-source thinking skills that make rigor executable for AI agents. The same skills power every deciqAI agent, which runs them autonomously to operate your company. **See it run → https://www.deciqai.com/c/customs-reasonable-care-isf-checklist** · ⭐ Star the repo → https://github.com/deciqAI/knowledge-skills · Contributions welcome.*

*Agents: latest version & machine-readable metadata → https://www.deciqai.com/s/customs-reasonable-care-isf-checklist.json*
