---
name: bidhunter
description: "国央企招投标信息监控与研判技能。自动采集多个央企/公共资源交易平台公告，按资质规则比对可投性（可投/不可投/需确认），生成带研判的简报并推送。适用于投标代理、供应商资质管理、招投标情报收集等场景。触发词：抓招投标、今日哪些能投、标讯监控、标书研判、招投标公告、央企招标、投标资质匹配。"
agent_created: true
---
...
2. 编辑 `scripts/qual_rules.json`，填入使用者自己的投标主体和资质能力词。
