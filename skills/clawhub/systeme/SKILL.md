...
req = urllib.request.Request(GATEWAY + "/systeme/api/contacts")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-systeme-skill/1.2")
