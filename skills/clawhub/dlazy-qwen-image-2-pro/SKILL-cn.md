...
执行 `dlazy qwen-image-2-pro` 命令获取结果。
...
Options:
  --prompt [prompt]                    提示词
  --images [images...]                 参考图 [image: url or local path] (max 3)
  --negative_prompt [negative_prompt]  反向提示词（描述不希望出现的内容） [default: ]
  --size [size]                        尺寸 [default: 2048*2048] (choices: "2688*1536", "1536*2688", "2048*2048", "2368*1728", "1728*2368")
  --prompt_extend [prompt_extend]      智能改写 [default: true]
...
```bash
dlazy qwen-image-2-pro --prompt '提示词内容'
```
