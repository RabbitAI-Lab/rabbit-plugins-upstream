...
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy banana2 -h 查看帮助信息。"}}
---
...
Options:
  ...
  --imageSize [imageSize]              图片尺寸 [default: 512] (choices: "512", "1K", "2K", "4K")
...
# 复杂调用：
dlazy banana2 --prompt '提示词内容' --image 'https://files.dlazy.com/image.png'
```
