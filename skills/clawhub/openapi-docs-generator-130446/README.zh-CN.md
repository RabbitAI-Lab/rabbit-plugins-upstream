...
- github-issues：[Add Swagger/OpenAPI documentation](https://github.com/laugh-tales/starpass-backend/issues/37)
- github-issues：[feat(backend): Add Swagger / OpenAPI documentation to the NestJS API](https://github.com/Afro-Pay/AfroPay-Stellar/issues/27)
...
- github-issues：[Publish an OpenAPI specification and serve interactive docs](https://github.com/StellarGateLabs/StellarGate/issues/20)
