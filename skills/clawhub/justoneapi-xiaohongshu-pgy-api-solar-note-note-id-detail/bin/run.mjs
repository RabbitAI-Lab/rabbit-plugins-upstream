...
const manifest = {
  ...
  "skillName": "justoneapi_xiaohongshu_pgy_api_solar_note_note_id_detail",
  "slug": "justoneapi-xiaohongshu-pgy-api-solar-note-note-id-detail",
  ...
  "endpointPath": "api/solar/note/noteId/detail",
  "skillType": "interface"
};
