  ...
  - name: fliggy_poi_search
    ...
    parameters:
      ...
      - name: keyword
        ...
        required: false
  - name: fliggy_marriott_hotel_search
    ...
    parameters:
      ...
      - name: extra
        ...
        required: false
  - name: fliggy_marriott_hotel_detail
    ...
    parameters:
      - name: hotel_id
        ...
        required: true
  - name: fliggy_marriott_package_search
...
- 机票搜索可筛选舱位和直飞，如`seat_class="经济舱", direct_only=true`
