...
ENDPOINT = "/api/v1/shopee/category/ai-list"
...
def validate_response(payload):
    data = validate_envelope(payload, "Shopee 类目列表查询失败")
...
def main():
    parser = argparse.ArgumentParser(description="查询 Shopee 子类目")
