...
class AuditChain {
   ...
   * @param {string} [platform] - Optional platform prefix (e.g. 'cc', 'oc'). When set, audit file goes to .skill-compass/{platform}/{skillName}/audit.jsonl
   */
  constructor(skillName, platform) {
    this.skillName = skillName;
    this.skillCompassDir = '.skill-compass';
    this.auditFile = platform
      ? path.join(this.skillCompassDir, platform, skillName, 'audit.jsonl')
      : path.join(this.skillCompassDir, skillName, 'audit.jsonl');
