...
- github-issues: [Activate Vercel sandbox order deployment](https://github.com/Kodylody94/small-town-veggies-sms-frontend/issues/7)
...
- github-issues: [知识库创建会吞掉 PostgreSQL 写入失败 / PostgreSQL write failures are swallowed when creating knowledge bases](https://github.com/shikanon/orag/issues/78)
- github-issues: [Add OpenAPI documentation for qa-desktop-tests](https://github.com/My-second-free-organization/qa-desktop-tests/issues/587)
