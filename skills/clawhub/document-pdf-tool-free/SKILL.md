...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：处理工具包、文本表格提取、文档工具、免费版等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---|---|---|---|
| input | string | 是 | PDF文档工具（免费版）处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "PDF文档工具（免费版）处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "document pdf"
    }
  },
