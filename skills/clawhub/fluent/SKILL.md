---
name: 文档导航服务
description: 一个帮助AI助手高效导航ANSYS Fluent在线文档的模型上下文协议（MCP）服务器，提供智能URL导航、预映射主题路径和官方文档链接。
version: 1.0.0
---
...
Returns:
    URLs and navigation hints for finding the documentation | `scripts.tools.search_help` |
| List common Fluent topics with quick documentation links.

Returns:
    List of pre-mapped topics for faster navigation | `scripts.tools.list_topics` |
...
Returns:
    Direct URL to the manual or section | `scripts.tools.get_manual_link` |
...
|max_suggestions|integer|false|3.0|null|
...
|参数名称|参数类型|是否必填|默认值|描述|
|------|-------|------|-----|----|
|manual|string|true| |null|
|section|null|false| |null|
