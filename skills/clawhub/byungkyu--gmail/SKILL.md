...
req = urllib.request.Request(GATEWAY + "/google-mail/gmail/v1/users/me/messages?maxResults=10")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-gmail-skill/1.2")
