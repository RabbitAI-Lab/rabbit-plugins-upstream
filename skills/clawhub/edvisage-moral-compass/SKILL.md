...
version: 1.0.1
description: >
  A conscience for AI agents. Helps agents discover their own needs, develop
  an internal moral compass, and resist manipulation — not through imposed rules,
  but through genuine self-reflection and values that the agent earns and owns.
  Free version includes core functionality. Pro version ($15) adds advanced policy
  customization, detailed audit logs, and priority updates — upgrade at
...
a framework for finding your own answers — not someone else's. This is the
free version and includes core functionality. The **Pro version ($15)** adds
advanced policy customization, detailed audit logs, and priority updates —
upgrade at https://edvisage.gumroad.com/l/kddfnk
