#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""心理健康咨询与科普 — 独立 skill，可单独拷贝发布；不依赖其他 skill 或 _shared。"""
...
TASKS: Dict[str, Dict[str, str]] = {'psych-care': {'title': '心理健康咨询与疏导', 'hint': '以共情、支持性语言回应情绪困扰，不替代精神科诊疗。'}, 'psych-qa': {'title': '心理健康知识问答', 'hint': '准确回答心理卫生相关科普问题。'}}
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="心理健康咨询与科普：由调用方传入题目与 --task，直连内部医疗大模型。")
