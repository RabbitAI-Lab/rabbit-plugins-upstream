...
API_BASE = "https://api.iwiki.com/v1"
...
def search_docs(keyword: str) -> dict:
    ...
    Returns:
        API 响应
    """
    token = os.environ.get("IWIKI_TOKEN")
    if not token:
        raise ValueError("未设置 IWIKI_TOKEN 环境变量")
...
def main():
    parser = argparse.ArgumentParser(description="搜索 iWiki 知识库文档")
