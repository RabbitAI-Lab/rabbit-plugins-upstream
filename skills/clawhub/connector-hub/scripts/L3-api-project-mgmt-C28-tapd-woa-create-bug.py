...
API_BASE = "https://api.tapd.woa.com/bugs"

def create_bug(title: str, description: str = "", severity: str = "normal", 
               priority: str = "2", owner: str = "") -> dict:
    """创建 Bug"""
...
def main():
    parser = argparse.ArgumentParser(description="创建 TAPD 司内版 Bug")
    ...
    try:
        data = create_bug(args.title, args.desc, args.severity, args.priority, args.owner)
