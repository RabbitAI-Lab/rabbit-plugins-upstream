...
3. 调用即刻数据开放接口 `/v1/calendar/tao/detail` 查询数据。
...
API_PATH = "/v1/calendar/tao/detail"
APPKEY_ENV_NAMES = ("JIKE_CALENDAR_TAO_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
TITLE = "道历查询 - 即刻数据"
FAIL_TITLE = "道历查询失败"
FIELDS = [('foto_string', '道历日期'), ('to_full_string', '完整说明'), ('festivals', '节日'), ('is_day_san_hui', '三会日'), ('is_day_san_yuan', '三元日'), ('is_day_ba_jie', '八节日'), ('is_day_wu_la', '五腊日'), ('is_day_ba_hui', '八会日'), ('is_day_wu', '戊日'), ('is_day_ming_wu', '明戊'), ('is_day_an_wu', '暗戊'), ('is_day_tian_she', '天赦日')]
