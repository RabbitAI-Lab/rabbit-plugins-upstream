---
name: socq-tiktok-shop
description: Research public TikTok Shop products, shops, creators, categories, and sales signals with SocQ. Use when an agent needs TikTok Shop-specific discovery, collection, endpoint selection, credit estimates, asynchronous task execution, pagination, or raw exports through the SocQ CLI, MCP, or REST API.
metadata:
  openclaw:
...
- Platform page: <https://socq.ai/apis/tiktok-shop>
- API documentation: <https://docs.socq.ai/api-manual/tiktok-shop>
...
Use this Skill to select and run SocQ endpoints for public TikTok Shop research. SocQ requests are asynchronous and credit-metered.

## Use When

- The user asks to discover, collect, compare, or analyze public TikTok Shop data.
- The workflow needs TikTok Shop-specific endpoint selection, input validation, pagination, or raw exports.
...
1. Prefer an already configured SocQ MCP server at `https://api.socq.ai/mcp?platforms=tiktok-shop`; use the typed tool listed in [platform.md](references/platform.md), or compact `socq_execute` when needed.
