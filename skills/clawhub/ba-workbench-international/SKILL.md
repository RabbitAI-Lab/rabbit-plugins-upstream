---
name: ba-workbench-international
description: "Business Analysis Super Workbench — International Edition. The world's premier full-stack business analysis intelligent workbench."
...
# Business Analysis Super Workbench V1.2.0 International Edition

> **"Give this Skill to a primary school student, and they'll become a top-tier business analyst."**
>
> Deeply integrating the global BA knowledge system + MBB top consulting methodologies + leading enterprise practices from Amazon / Google / Netflix and other global innovators (regional examples — Chinese, European, APAC enterprises — are included as applicable, not as the sole focus).
> Covering 14 stages, 100+ frameworks, 50+ deliverables, 8 BA roles.
> Framework index (selected): PESTLE / Porter's Five Forces / SWOT / TOWS / VRIO / TAM-SAM-SOM / BCG / GE-McKinsey / Ansoff / DCF / NPV / IRR / Break-Even / BMC / Lean Canvas / RACI / Power-Interest / Fishbone / 5 Whys / FMEA / Decision Tree / AHP / BPMN / VSM / SIPOC / ADKAR / Kotter — see each stage's methodology sections for the full catalog.
> From strategic insight to boardroom presentations, from financial modeling to process reengineering — full chain coverage.
...
> 💡 **Every analysis is a cornerstone of decision-making.**
> Verify your data, ensure your logic is consistent, and format neatly — decision-makers notice every detail.
> No matter how good the analysis, it's better to clock out early and spend time with the people who matter.
> — yinjianheng (殷健恒)
...
| I Want To... | Jump To |
|--------------|---------|
| Analyze macro environment / industry trends | [Stage 1: Strategy & Industry Analysis](#stage-1-strategy-industry-analysis) |
| Do market segmentation / customer personas / market sizing | [Stage 2: Market & Customer Insight](#stage-2-market-customer-insight) |
| Do competitive analysis / competitive positioning | [Stage 3: Competitive Intelligence & Positioning](#stage-3-competitive-intelligence-positioning) |
| Do financial modeling / valuation / ROI analysis | [Stage 4: Financial Analysis & Modeling](#stage-4-financial-analysis-modeling) |
| Design / validate business models | [Stage 5: Business Model Design & Validation](#stage-5-business-model-design-validation) |
| Do stakeholder analysis / management | [Stage 6: Stakeholder Management](#stage-6-stakeholder-management) |
| Elicit requirements / do user research | [Stage 7: Requirements Elicitation & Discovery](#stage-7-requirements-elicitation-discovery) |
| Write requirements documents / BRD / FRD | [Stage 8: Requirements Analysis & Specification](#stage-8-requirements-analysis-specification) |
| Evaluate solutions / vendor selection | [Stage 9: Solution Evaluation](#stage-9-solution-evaluation) |
| Build a business case / investment decision | [Stage 10: Business Case & Investment Decision](#stage-10-business-case-investment-decision) |
| Analyze business processes / do BPR | [Stage 11: Business Process Analysis & Reengineering](#stage-11-business-process-analysis-reengineering) |
| Do data analysis / BI / business performance analysis | [Stage 12: Data Analysis & Business Intelligence](#stage-12-data-analysis-business-intelligence) |
| Do risk analysis / decision modeling | [Stage 13: Risk Analysis & Decision Science](#stage-13-risk-analysis-decision-science) |
| Manage implementation / change management | [Stage 14: Implementation & Change Management](#stage-14-implementation-change-management) |
| Establish BA workflow / weekly rhythm | [BA Workflow System](#ba-workflow-system) |
| Understand BA competency model / career path | [Competency Model & Career Development](#competency-model-career-development) |
| Write business documents / reports | [Document Factory](#document-factory) |
| Draw business diagrams | [Chart Factory](#chart-factory) |
| Create business presentation PPTs | [PPT Factory](#ppt-factory) |
| Explore global BA certifications | [Global BA Certification Landscape](#global-ba-certification-landscape) |
| Compare global BA methodologies | [International BA Methodology Comparison](#international-ba-methodology-comparison) |
| Understand global BA salary benchmarks | [Global BA Salary Benchmarks](#global-ba-salary-benchmarks-by-region) |

---

## The Essence of Business Analysis: Deep Cognition

### BA vs. Related Roles: Fundamental Differences
...
| **Alibaba** | Data-driven business BA | Data+AI Platform (formerly "Data Middle Platform"; label updated 2026-07) + OneData + Full-domain analysis | Everything speaks with data |
...
> Impact Mapping → Answers "why" and "what"
> User Story Mapping → Answers "what first" and "how"
> Combined use: Impact Mapping sets direction → Story Mapping prioritizes
...
> Event Storming → Discover domain events and business rules
> DDD Bounded Contexts → Partition microservices based on event boundaries
...
→ See full content in [`references/requirements-management-lifecycle.md`](references/requirements-management-lifecycle.md)
...
#### 13.4 AI Governance & Compliance BA Checklist (GDPR / EU AI Act)

> As generative AI / Agents enter the analysis production chain, BAs must embed data-compliance and AI-governance constraints at the requirements & design stage. The following is the international compliance baseline (as of 2026-07, subject to current regulations).

**Regulatory Baseline (International)**
- **GDPR (EU 2016/679, in force 2018)**: lawful basis & consent, data minimization, sensitive-data safeguards, cross-border transfer (SCC / adequacy), right to explanation for automated decisions (Art. 22).
- **EU AI Act (Regulation 2024/1689)**: risk-based tiering — **Unacceptable / High / Limited / Minimal**; high-risk AI (e.g., hiring, credit scoring, critical infrastructure) requires risk management, data governance, human oversight, conformity assessment, and registration in the EU database. Phased obligations from 2025–2027.
- **US**: sectoral + state laws (e.g., Colorado AI Act, EU-US Data Privacy Framework for transfers); no single federal AI statute yet.
- **Other regions**: UK pro-innovation approach; Canada AIDA; China PIPL/AI measures (see domestic edition).

**BA Compliance Checklist (mandatory at requirements stage)**
| # | Check | Risk | Land in NFR |
|---|-------|------|-------------|
| 1 | Is personal/sensitive data minimized & lawful? | Over-collection, cross-border breach | NFR-Privacy: consent, minimization, SCC |
| 2 | AI system risk tier (EU AI Act)? | Blocked launch if High-risk gaps | NFR-Compliance: tier, conformity, registration |
| 3 | Automated decisions explainable & contestable? | Art. 22 / user-rights disputes | NFR-Explainability: decision log, appeal path |
| 4 | Training/analytics data licensed & governed? | Infringement, leakage | NFR-Security: encryption, access control, audit |
| 5 | AI output identifiable / traceable? | Regulatory penalty, misinformation | NFR-Compliance: labeling, watermark, human review |

**Non-Functional Requirements (NFR) Template (BA deliverable)**
```
NFR-ID | Category(Perf/Security/Privacy/Compliance/Scalability/Usability) | Description | Acceptance | Priority
NFR-01 | Privacy     | PII masked before storage              | 100% sampled masked | Must
NFR-02 | Security     | Full audit log ≥180 days               | Traceable           | Must
NFR-03 | Compliance   | AI output carries explicit label       | 100% compliant      | Must
NFR-04 | Performance  | Dashboard first-load ≤3s (1M rows)     | Load-test pass      | Should
```
...
| Create business presentation PPT | `ppt-generator` | `ppt-master` |
...
> **Getting Started: Tell me directly what business analysis you need, and the BA Skill automatically matches the stage, methodology, framework, and toolchain.**
> Whether you're a business analysis beginner or a seasoned analyst seeking top-tier frameworks, this Skill is your super BA brain library.
...
|---------|------|---------|
| V1.2.0-intl | 2026-07-07 | Routine iteration upgrade: added AI frontier paradigms, refreshed time-sensitive data, corrected broken references. Added AI Governance & Compliance BA Checklist (GDPR/EU AI Act risk-tiering + NFR template); NEST "Web3"→"Agents/Generative AI"; Alibaba "Data Middle Platform"→"Data+AI Platform"; toolkit mapping synced to real skill names; front-matter cleaned for international consistency |
...
5. **Usage Compliance**: Users should ensure that their use of this Skill complies with the laws and regulations of their country/region, industry standards, and internal corporate policies. Use of this Skill for any illegal purpose or purpose contrary to public order and good morals is prohibited.
...
> Data source: Compiled from official exam handbooks and public pricing pages of IIBA / PMI / BCS / IREB; fees and question formats are **observed values as of 2026-07**; actual figures are subject to each certifying body's official announcements (fees vary by membership, region, and exchange rate).
...
> Data source: Compiled from IIBA global salary surveys, Robert Half / Harvey Nash salary guides, and public data from Glassdoor / Levels.fyi / Payscale / regional statistics bureaus; data collection point: **as of 2026-07**, market observations rather than official salary scales; actual figures subject to employer offers and live market conditions (affected by inflation, exchange rates, and industry fluctuations).
