...
> 适合美食／生活／旅行／温暖治愈系文章。暖色调营造食欲感和亲切感，适合有温度的内容。
> 主色 `#EA580C` 只在锚点出现（全文 ≤5 处），大面积白底＋灰阶，彩色只做点缀。
...
| 变量 | 色值 | 用途 |
|------|------|------|
| 主色 | `#EA580C` | 章节编号、CTA 背景、加粗锚点（≤5 处） |
| 主色浅 | `#FB923C` | 英文标签、子标题竖条、装饰点 |
| 浅底色 | `#FFF7ED` | 引言卡、引用块、数据卡背景 |
| 浅边框 | `#FED7AA` | 表格边框、徽章边框 |
| 高亮色 | `#FEF3C7` | 黄底高亮起始色 |
...
<section style="width:36px;height:4px;background:#EA580C;border-radius:2px;margin-bottom:16px;"></section>
...
```html
<section style="margin:0 0 28px;padding:20px 24px;background:#FFF7ED;border-radius:8px;">
...
<p style="margin:0;line-height:1.6;font-size:13px;color:#EA580C;text-align:right;"><span leaf="">—— {{作者名}}</span></p>
</section>
```
...
<section style="flex-shrink:0;margin-right:10px;width:20px;height:20px;background:#EA580C;border-radius:4px;display:flex;align-items:center;justify-content:center;"><p style="margin:0;line-height:1;font-size:11px;color:#ffffff;font-weight:bold;"><span leaf="">1</span></p></section>
<p style="margin:0;line-height:1.6;font-size:15px;color:#44403C;"><span leaf="">核心看点一描述</span></p>
</section>
<section style="margin:0 0 12px;display:flex;align-items:flex-start;">
<section style="flex-shrink:0;margin-right:10px;width:20px;height:20px;background:#EA580C;border-radius:4px;display:flex;align-items:center;justify-content:center;"><p style="margin:0;line-height:1;font-size:11px;color:#ffffff;font-weight:bold;"><span leaf="">2</span></p></section>
...
<section style="flex-shrink:0;margin-right:10px;width:20px;height:20px;background:#EA580C;border-radius:4px;display:flex;align-items:center;justify-content:center;"><p style="margin:0;line-height:1;font-size:11px;color:#ffffff;font-weight:bold;"><span leaf="">3</span></p></section>
...
<p style="margin:0 12px 0 0;line-height:1;font-size:40px;font-weight:bold;color:#EA580C;"><span leaf="">01</span></p>
<section>
<p style="margin:0 0 4px;line-height:1.3;font-size:20px;font-weight:bold;color:#1C1917;"><span leaf="">章节中文标题</span></p>
<p style="margin:0;line-height:1.4;font-size:12px;color:#FB923C;letter-spacing:1px;"><span leaf="">ENGLISH LABEL</span></p>
</section>
</section>
```
...
```html
<section style="margin:28px 0 12px;padding-left:12px;border-left:3px solid #FB923C;">
...
```html
<section style="margin:24px 0;padding:16px 20px;background:#FFF7ED;border-left:3px solid #EA580C;border-radius:0 6px 6px 0;">
...
```html
<section style="margin:24px 0;padding:24px;background:#FFF7ED;border-radius:8px;text-align:center;">
<p style="margin:0 0 6px;line-height:1;font-size:36px;font-weight:bold;color:#EA580C;"><span leaf="">98%</span></p>
...
```html
<section style="margin:24px 0;border:1px solid #FED7AA;border-radius:8px;overflow:hidden;">
<section style="display:flex;background:#EA580C;">
...
<section style="display:flex;border-top:1px solid #FED7AA;">
...
<section style="width:6px;height:6px;background:#FB923C;border-radius:50%;margin:0 5px;"></section>
<section style="width:36px;height:2px;background:#FB923C;border-radius:1px;"></section>
<section style="width:6px;height:6px;background:#FB923C;border-radius:50%;margin:0 5px;"></section>
</section>
```
...
```html
<section style="margin:40px 0 0;padding:28px 24px;background:#EA580C;border-radius:8px;text-align:center;">
...
<p style="margin:0;line-height:1.5;font-size:14px;font-weight:bold;color:#EA580C;"><span leaf="">{{作者名}}</span></p>
</section>
</section>
```
...
<p style="margin:0;line-height:1.5;font-size:13px;color:#EA580C;font-weight:bold;"><span leaf="">产品名</span></p>
</section>
```
...
| 文章类型 | 核心组件组合 |
|---------|------------|
| 美食／探店 | 封面＋引言＋目录＋章节标题＋正文＋数据卡＋图片（通用库）＋签名 |
| 生活／旅行 | 封面＋引言＋目录＋章节标题＋正文＋引用块＋产品徽章＋签名 |
| 节庆／促销 | 封面＋引言＋章节标题＋正文＋高亮标记＋CTA＋签名 |
| 温暖治愈／情感 | 封面＋引言＋章节标题＋正文＋荧光笔＋分割线＋签名 |
