...
def list_components(
    ...
    return call_api("1777419067406339", "list_components", arguments)
...
def get_component(
    ...
    return call_api("1777419067406339", "get_component", arguments)
...
def get_component_example(
    ...
    return call_api("1777419067406339", "get_component_example", arguments)
...
def search_components(
    ...
    return call_api("1777419067406339", "search_components", arguments)
...
def get_component_props(
    ...
    return call_api("1777419067406339", "get_component_props", arguments)
...
def get_installation_guide(
    ...
    return call_api("1777419067406339", "get_installation_guide", arguments)
...
def get_components_by_category(
    ...
    return call_api("1777419067406339", "get_components_by_category", arguments)
...
def get_celo_composer_cli_info(
    ...
    return call_api("1777419067406339", "get_celo_composer_cli_info", arguments)
