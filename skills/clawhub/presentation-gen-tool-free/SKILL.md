...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：从主题或文档自动、PPT、演示文稿、支持多种模板、布局与图表插入、演示文稿生成、免费版等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---|---|---|---|
| input | string | 是 | 演示文稿生成（免费版）处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "演示文稿生成（免费版）处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "presentation gen"
    }
  },
