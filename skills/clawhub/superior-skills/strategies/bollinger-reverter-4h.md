...
- Designed to coexist with `donchian-strong-regime.md` — they fire on mutually exclusive regimes (ADX < 25 here, regime-strong gate there)
- Supersedes the prior 1h variant of `mean-reversion.md`
