# Wechat Distillation Writing / wechat-copywrite-alchemy
...
- **Multi-platform material access**: Supports automatic article collection from WeChat Official Accounts; also accepts pasted text or file paths for flexible material sourcing.
...
- **Multi-platform material collection**: Supports automatic article retrieval from WeChat Official Accounts; also accepts manual paste or file paths
...
| Cross-platform material integration | Brand | "Collect XX's articles from WeChat OA for a complete persona" | Cross-platform merging, more comprehensive persona |
