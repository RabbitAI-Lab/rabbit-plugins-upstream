...
slug: self-check
version: 2.1.0
description: "系统自检工具。全面检查环境配置、文件完整性、Gateway、备份状态、日志报错、磁盘用量等，汇报问题并给出修复建议（不主动修复）。兼容 workspace/workspace-xxx 两种命名。"
metadata: {"clawdbot":{"emoji":"🔍","requires":{"bins":["node","npm"],"os":["linux","darwin"]},"configPaths":[".openclaw/"]}}
---
