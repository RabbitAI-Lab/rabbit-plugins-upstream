...
Fig.
1 represents the tradesman as you would see him while you were bending over him from above;
figs.
...
![A diagram of three triangles, points downwards. They all have the same width, but the second has a smaller height than the first, and the third has a smaller height again.](../_figures/I___Of_the_Nature_of_Flatland/全文/fig_001.svg)

> 图注：A diagram of three triangles, points downwards. They all have the same width, but the second has a smaller height than the first, and the third has a smaller height again.

<details><summary>上下文</summary>
