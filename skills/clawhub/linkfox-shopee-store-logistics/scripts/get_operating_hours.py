...
def main() -> None:
    ...
    print(json.dumps(run_logistics_api("get_operating_hours", params, "get_operating_hours.py"), indent=2, ensure_ascii=False))
