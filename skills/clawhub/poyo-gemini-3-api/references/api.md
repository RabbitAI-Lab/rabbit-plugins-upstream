# PoYo Gemini 3 Series API Reference

## Endpoints

- OpenAI-compatible chat: `POST https://api.poyo.ai/v1/chat/completions`
- Gemini Native Format: `POST https://api.poyo.ai/v1beta/models/{model}:generateContent`
- Gemini Native streaming: `POST https://api.poyo.ai/v1beta/models/{model}:streamGenerateContent`
...
- `gemini-3-flash-preview`: Gemini 3 Flash Preview chat model on PoYo
- `gemini-3-pro-preview`: Gemini 3 Pro Preview chat model on PoYo
- `gemini-3.1-pro-preview`: Gemini 3.1 Pro Preview chat model on PoYo
