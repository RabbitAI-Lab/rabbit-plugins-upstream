...
def load_config():
    """Load config.json, falling back to safe defaults for fresh installs."""
    ...
    return {
        ...
        "vault_root": "",
        "image_search_paths": [],
        "settings": {"default_theme": "newspaper", "auto_open_browser": True},
    }
...
VAULT_ROOT = Path(CONFIG.get("vault_root") or ".")
DEFAULT_THEME = CONFIG.get("settings", {}).get("default_theme", "newspaper")
