...
triggers:
  ...
  - branches
  - planning
  - a plan has 2+ sequentially dependent changes
metadata: {"openclaw": {"homepage": "https://github.com/athola/claude-night-market/tree/master/plugins/sanctum", "emoji": "\u2699\ufe0f", "requires": {"config": ["night-market.sanctum:git-workspace-review", "night-market.sanctum:do-issue"]}}}
