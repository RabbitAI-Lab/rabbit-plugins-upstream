...
name: run-coach
version: 1.1.2
description: Science-based running coach via Telegram. Logs training, syncs Garmin data, sends visual training plans as HD photo albums, and coaches with evidence-driven discipline — never nags, never asks for data it already has.
license: MIT-0
metadata:
  category: lifestyle
