# Endpoint examples - ReplyNodes App Store Public Reads (v1)
...
### GET /v1/appstore/apps/{id} - lookup by track id

```sh
curl -sS \
  -H 'Authorization: Bearer API_KEY' \
  "BASE_URL/v1/appstore/apps/1234567890"
```

### GET /v1/appstore/apps/{id} - lookup by bundle id

```sh
curl -sS \
  -H 'Authorization: Bearer API_KEY' \
  "BASE_URL/v1/appstore/apps/com.example.app"
```
...
### GET /v1/appstore/apps/{id}/similar

```sh
curl -sS \
  -H 'Authorization: Bearer API_KEY' \
  "BASE_URL/v1/appstore/apps/1234567890/similar?country=us"
```
...
[
  {
    ...
    "parameters": {
      ...
      "properties": {
        "id": {
          "type": "string",
          "description": "Numeric track id (up to 19 digits) or reverse-DNS-style bundle id (letters, digits, hyphens, at least one dot).",
