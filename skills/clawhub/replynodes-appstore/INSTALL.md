...
4. Instruct naturally, for example: "Look up com.example.app with the appstore-api skill, list related apps, and report meta.availability and null counters honestly."
