...
Status: **PUBLISHED** to ClawHub as `@replynodes-ai/replynodes-appstore`
version `1.0.4`. Moderation status: **CLEAN**. This records the
verified publication event only; public discovery is not claimed without
registry inspect evidence.

Published to ClawHub as @replynodes-ai/replynodes-appstore version 1.0.4; inspect/moderation evidence is recorded after publication.
