...
### 平台规则与版权红线（抖音2026审核合规·制作级）

> 剪辑是合规的最后一道闸。很多视频不是内容差，是画面/字幕/封面里埋了审核雷，发布即限流。以下规则在导出前必须逐条过。

**AIGC 双标识（2026.1落地，5月全国推）**
- **显式**：若视频含AI生成内容，发布页必须勾选，且视频前5秒出现 ≥36号字"AI生成"，不可遮挡、不可动画缩走
- **隐式**：平台自动写入元数据，**严禁删除/篡改**（剪映"抹除AI痕迹"类操作会触发补标+限流）
- AI换脸 / 声音克隆 → **直接封号**，本地生活口播不要用

**生活服务 AIGC 禁用（团购带货视频）**
- 餐饮/住宿/游玩/洗浴按摩/丽人/维修/家政 的**团购带货视频**，商品内容/场景/服务过程/效果 **不得用AI生成**
- 即：菜品特写、店内环境、服务过程、前后对比效果，必须用实拍，不能AI绘图/数字人替代

**画面 / 字幕 / 口播 的站外引流规避**
- 禁止在画面、花字、字幕、简介里出现：电话/手机/微信号/QQ/"V我"/"看个性签名"/"主页有微"/二维码
- 禁止暗示导流："货到付款""去其他平台搜店""评论区拿链接"等字幕或口播
- 联系方式一律不进画面；引导到店用"左下角定位""主页领券"等平台内动作

**绝对化用语（生活服务特别敏感）**
- 字幕/花字禁用：最、第一、全网最低、天花板、TOP1、100%、绝对、万能、根治、史无前例
- 改法：用可验证的具体描述替代（"开了3年""老客户都回头"）

**黑话 / 谐音 / emoji 规避**
- 平台已能识别变异词、拆分词、图片水印里的数字/字母、emoji替代（"薇❤""√信""微❤️"）
- 联系方式、境外工具名、平台名，不能谐音/缩写/emoji规避，要直说或删

**指向性 / 网暴风险**
- 指着具体门店说问题：必须打码 + 取得同意，否则用"有些店"泛指、不拍门头特写
- 拍客人/学生：必须取得肖像授权，最好不拍正脸

**音乐 / 字体 / 素材 / 水印**
- 音乐版权是重灾区：商用视频必须使用正版授权音乐，个人视频优先使用平台内置音乐库
- 字体版权同样重要：不要随便用网上下载的字体——思源系列、阿里巴巴普惠体等免费商用字体是安全选择
- 素材版权：使用他人拍摄的素材需要授权，使用AI生成的素材需要确认平台政策（见上方AIGC条款）
