---
name: guaikei-douyin-videos-for-competitor-benchmarking
title: guaikei抖音视频竞品对标
description: 当用户想知道抖音上什么火、谁在火、评论怎么看时，使用本技能：搜、扒、翻、追四个动作覆盖搜索、博主作品、评论、热榜。用户做选题、找对标、看口碑时即使没提"抖音"也应使用。不适用于发布视频或下载素材。
license: MIT
metadata:
  version: "1.0.0"
  author: um-why
