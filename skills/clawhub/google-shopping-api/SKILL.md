...
metadata:
  openclaw:
    ...
    throttle: 1
    emoji: "\U0001F6CD"
    homepage: https://scavio.dev/docs/google-shopping?utm_source=clawhub&utm_medium=skill&utm_campaign=google-shopping-api
---
...
Get a free API key at [scavio.dev](https://scavio.dev/?utm_source=clawhub&utm_medium=skill&utm_campaign=google-shopping-api) (50 free credits to get started, no card required):
