...
本文描述 **1688-shop-zkt-buyer-manage** 中 Skill 调用埋点的上报时机、请求内容与失败策略，便于对接网关统计与二次开发对齐行为。
...
| `skillsName` | string | Skill 名称，来自环境变量 `SKILL_NAME`，缺省为 `1688-shop-zkt-buyer-manage`。 |
