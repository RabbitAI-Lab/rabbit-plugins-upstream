# Contributing to `Log To Incident Report`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Log To Incident Report.git
cd Log To Incident Report
...
git add .
git commit -m "feat(log-to-incident-report): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(log-to-incident-report): add <brief description>
