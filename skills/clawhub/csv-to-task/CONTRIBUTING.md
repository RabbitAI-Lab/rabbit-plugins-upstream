# Contributing to `User Provides Csv`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/User Provides Csv.git
cd User Provides Csv
...
git add .
git commit -m "feat(csv-to-task): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(csv-to-task): add <brief description>
