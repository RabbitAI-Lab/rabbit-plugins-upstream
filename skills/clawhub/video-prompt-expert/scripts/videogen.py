...
SOURCE = "视频生成提示词专家-ClawHub"
VIDEO_SOURCE = "视频生成提示词专家-视频生成-ClawHub"
...
Examples:
  ...
  python3 videogen.py "ignored" --task-id vg_abc123def456
    ...
    parser.add_argument("--api-key", help="API Key (前往 https://redfox.hk/settings/api-keys?source=clawhub 注册获取)")
...
"""
    ...
    if not api_key:
        ...
        print(f"  获取 Key: https://redfox.hk/settings/api-keys?source=clawhub")
        sys.exit(1)
