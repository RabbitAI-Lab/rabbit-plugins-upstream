...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="门诊病历内涵质控：主诉和诊断部位不一致（chief-complaint-diagnosis-inconsistent）。",
    )
    ...
    parser.add_argument("--output", default="", help="输出文件路径（默认：../runs/med-emr-qc/chief-complaint-diagnosis-inconsistent.txt）。")
