...
文案按 `references/google-ads/rules/google-ads-creative-optimization.md` **1.2 / 1.3**：先定 B2B/B2C，写满 15 标题 + 4 描述；禁止空话与无活动促销。`campaign-validate` 还拦：组内标题重复、**不同广告组共用同一标题**。
