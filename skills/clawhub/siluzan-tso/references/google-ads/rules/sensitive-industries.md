...
> 本文件仅在行业属于 Tier 2（受限）或 Tier 3（高度管制）时加载。
> Tier 分级见 `references/google-ads-compliance.md` 第一章。

---

## 目录

- [Tier 2: 酒精饮品](#tier-2-酒精饮品)
- [Tier 2: 赌博/博彩](#tier-2-赌博博彩)
- [Tier 2: 金融服务](#tier-2-金融服务)
- [Tier 2: 加密货币](#tier-2-加密货币)
- [Tier 2: 政治广告](#tier-2-政治广告)
- [Tier 2: 交友约会](#tier-2-交友约会)
- [Tier 2: 减肥/美容](#tier-2-减肥美容)
- [Tier 2: 教育/培训](#tier-2-教育培训)
- [Tier 2: 招聘/人力资源](#tier-2-招聘人力资源)
- [Tier 2: 高糖高盐高脂食品（HFSS）](#tier-2-高糖高盐高脂食品hfss)
- [Tier 3: 医疗/制药](#tier-3-医疗制药)
- [Tier 3: 成瘾治疗](#tier-3-成瘾治疗)
- [Tier 3: 法律服务](#tier-3-法律服务)
- [Tier 3: 保健品/CBD](#tier-3-保健品cbd)
- [地区限制速查](#地区限制速查)
...
**必备否定词**：`underage`、`minor`、`teen`、`children`、`kid`

**完全禁止投放的地区**：巴基斯坦、沙特、科威特、利比亚、苏丹、也门、伊朗、阿富汗、孟加拉国
**严格限制**：印度（仅部分邦）、土耳其（全面禁止）、挪威/瑞典/冰岛（避免 "discount"、"cheap"、"sale" + 酒类词组合）
...
**必备否定词**：`free money`、`cheat`、`hack`、`rigged`、`fix`、`exploit`、`underage`
...
- 英国：须有 FCA 授权
- 澳大利亚：须展示 ASIC 信贷牌照号
- 印度：贷款须 RBI 合规，投资须 SEBI 合规

---

## Tier 2: 加密货币

**Google 认证**：交易所、钱包、信托 → **必须认证**。
...
- 信号/喊单服务："crypto signals"、"trading tips guaranteed"

**必备否定词**：`hack`、`scam`、`Ponzi`、`pump and dump`、`free Bitcoin`、`guaranteed return`

---

## Tier 2: 政治广告

**Google 认证**：多数国家要求广告主身份验证。
...
**必备否定词**：`escort`、`hookup`、`sex`、`underage`、`teen dating`
...
- 恐吓式营销："shocking transformation"、"before and after"

**必备否定词**：`miracle`、`overnight`、`no exercise`、`no diet`、`pill`、`steroid`

**最高级用词**："fastest weight loss"、"best diet pill" → **极高拒审率**；替换为 "evidence-based weight management"、"clinically studied formula"
...
**必备否定词**：`buy drugs`、`get high`、`where to find`、`dealer`
...
**必备否定词**：`scam`、`fake lawyer`、`illegal`、`bribe`

**地区注意**：美国各州律师广告规则不同，部分州禁止 "best lawyer" 等最高级用词
...
- CBD（禁止地区）
- THC 产品（Google 全球禁止）
- "FDA approved supplement"（除非确实获批，多数保健品不是）
- 合成代谢类固醇
...
**最高级用词**："best university"、"#1 program" → 需权威排名（QS/US News 等）佐证
...
- 避免 "効く"（有效）——无药事法许可不可用
- "No.1" 须注明具体第三方调查来源及日期

### 德国/EU

- 健康声明须符合 EU Health Claims Regulation (EC) No. 1924/2006
- 比较广告允许但须客观可验证

### 中东（GCC）

- 酒精、赌博、交友——**全面禁止**
- 宗教敏感性：避免可能被视为不尊重伊斯兰教的关键词
- 内容端庄要求延伸到关键词意图
