...
description: "Generate complex SQL queries from requirements"
version: 2.1.0
capabilities:
...
Use when you need to generate complex sql queries from requirements.
...
curl -X POST https://ai-service-hub-15.emergent.host/api/original-services/sql-builder \
  ...
  -d '{
  "input": "Example input for SQL Query Builder"
}'
```
