...
- github-issues: [feat(autonomous-dispatcher): per-run artifact directory + run-id threading + 'status ' inspector](https://github.com/zxkane/autonomous-dev-team/issues/235)
- github-issues: [Support area/category-scoped --override dispositions that survive re-review (finding keys drift)](https://github.com/accidental-hedge-fund/agent-pipeline/issues/229)
...
- github-issues: [Optimize EventDb::put to avoid double bincode round-trip and extra copy](https://github.com/aicers/review-database/issues/800)
