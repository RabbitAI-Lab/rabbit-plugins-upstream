...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--asr",
        choices=("auto", "whisper_cpp", "whisper", "siliconflow", "none"),
        default="auto",
        help=(
            "Audio transcription backend. Default: auto "
    ...
    parser.add_argument(
        ...
        default="auto",
        help=(
            "ASR model name. Default: auto (whisper.cpp uses the WHISPER_CPP_MODEL env var; "
            "openai-whisper defaults to base; SiliconFlow maps auto to "
    ...
    parser.add_argument(
        "--asr-language",
        default="auto",
        help="Language for transcription, e.g. Chinese, zh, English, auto. Default: auto",
    )
    parser.add_argument(
        "--asr-prompt",
        default=None,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.metadata_only and args.asr != "none" and result.get("video_path"):
        ...
        result["srt_path"] = asr_result.get("srt_path")
