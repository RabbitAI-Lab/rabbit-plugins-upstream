...
- github-issues：[Feature Request: Make `--verbose` more practical with log levels](https://github.com/CluvexStudio/Aether/issues/39)
...
- hacker-news-search：[Clojure 1.13 adds support for checked keys](https://news.ycombinator.com/item?id=48806658)
