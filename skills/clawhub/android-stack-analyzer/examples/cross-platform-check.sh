...
# Android Stack Analyzer - 跨平台快速检查脚本 (Linux/macOS)
# 用于快速获取当前页面和页面栈信息

echo "==================================="
echo "  Android Stack Analyzer - 快速检查 (Linux/macOS)"
echo "==================================="
echo ""
...
# 获取最近任务
echo "🕐 最近任务："
adb shell "dumpsys activity recents" 2>/dev/null | grep -E "ActivityRecord|TaskRecord|Recent" | head -10 || echo "❌ 无法获取最近任务"
echo ""
