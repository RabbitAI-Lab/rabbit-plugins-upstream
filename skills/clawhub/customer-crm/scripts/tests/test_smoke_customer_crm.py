#!/usr/bin/env python3
"""Smoke test for customer-crm Skill
...
# 路径: d:\JueJin\skills\customer-crm\scripts\tests\test_smoke_*.py
# parents[0]=tests/ [1]=scripts/ [2]=customer-crm/ [3]=skills/ [4]=project_root
PROJECT_ROOT = Path(__file__).resolve().parents[4]
SKILL_PATH = PROJECT_ROOT / "skills" / "customer-crm" / "SKILL.md"
...
if __name__ == "__main__":
    ...
    test_error_handling()
    print("All smoke tests passed for customer-crm")
