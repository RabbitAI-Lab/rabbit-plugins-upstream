...
echo "   mcporter call sailing-sports-mcp tteagt --args '{\"query\": \"你的问题\", \"project\": \"CAR\"}'   # 赛车"
echo ""
echo "示例："
...
echo "   mcporter call sailing-sports-mcp tteagt --args '{\"query\": \"F1下一场比赛是什么时候\", \"project\": \"CAR\"}'  # 赛车"
echo ""
echo "💡 后续安全提示："
