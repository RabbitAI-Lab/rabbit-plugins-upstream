...
- `references/shared/protected_hedging_phrases.md` — protected hedging phrases share the abstract budget; budget allocation order specified there.
- `references/shared/codex_audit_multifile_template.md` — audit dimensions including word-count verification.
