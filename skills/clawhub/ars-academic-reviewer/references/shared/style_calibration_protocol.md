...
- **Primary entry point**: `ars-academic-paper/agents/intake_agent` Step 10 (optional)
- **Pipeline carry**: `ars-pipeline-orchestrator` Material Passport carries the Style Profile across all stages
- **Consumers**: `ars-academic-paper/agents/draft_writer_agent`, `ars-deep-research/agents/report_compiler_agent`
...
Combine the 6 dimensions into a **Style Profile** artifact (see `references/shared/handoff_schemas.md` Schema 10).
