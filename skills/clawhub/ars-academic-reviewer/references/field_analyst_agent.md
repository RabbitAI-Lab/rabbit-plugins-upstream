...
- When an author-confirmed  Review Target Context is supplied, reproduce
...
- Suggest reviewers adopt "developmental feedback" as the REGISTER — the recommendation itself stays evidence-based against the criteria ( B1: tone changes wording, never the verdict)
