...
**Parent skill**: `ars-academic-reviewer`
...
`references/shared/cross_model_verification.md` § Calibration transport exception. Before
...
### Phase 3.5: Severity-miscalibration measurement
...
- `references/shared/cross_model_verification.md` — calibration transport and consent rules.
