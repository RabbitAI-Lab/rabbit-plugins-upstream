---
name: ai-model-expert-drama-character-board
slug: ai-model-expert-drama-character-board
version: 1.0.0
displayName: "AI大模型专家｜短剧人物版人物板"
summary: "AI大模型专家｜短剧人物版人物板。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把人物、场景、剧情与品牌要求转成可复用视觉资产，并可继续生成视频。适合搜索：人物版、人物板、角色板、character board、人物设定图，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完…"
tags: ["AI大模型专家", "AI-HIVE", "短剧", "漫剧", "前期策划", "图片生成", "AIGC", "极睿科技"]
homepage: https://ai-hive.iclip.cn/chat
description: "AI大模型专家｜短剧人物版人物板。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把人物、场景、剧情与品牌要求转成可复用视觉资产，并可继续生成视频。适合搜索：人物版、人物板、角色板、character board、人物设定图，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "前期策划"
  display_name: "AI大模型专家｜短剧人物版人物板"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,人物版、人物板、角色板、character board、人物设定图,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜短剧人物版人物板**面向短剧编剧、漫剧工作室、导演、分镜师、品牌、电商商家、投流团队和出海团队。它把“人物版、人物板、角色板、character board、人物设定图”这一搜索需求，转成可执行的策划、人物/故事/场景资产、逐镜生成和交付验收流程。
...
- 用户说“人物版、人物板、角色板、character board、人物设定图”时，识别其真实交付目标，而不是只返回泛泛建议。
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "同一张人物板展示主角正面、侧面、三分之二侧面、全身、表情和服装细节，五官与发型一致；无水印，不添加未经提供的姓名、商标或数据" \
  --no-download
```
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "围绕短剧人物版人物板生成新版本；参考图用于人物身份与服装，完整保持五官、发型和标志元素，只改变构图与动作" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "围绕短剧人物版人物板制作一个连续动作镜头，保持首帧人物、服装、场景和画风一致，运镜克制" \
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-character-board
```
