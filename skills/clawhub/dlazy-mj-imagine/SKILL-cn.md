...
version: 1.3.4
description: "Midjourney 风格出图入口，支持画幅、Bot 类型与输出位（grid/U1-U4）。适合艺术化、风格强烈的创意图生成。"
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy mj-imagine -h 查看帮助信息。"}}
---
...
Midjourney 风格出图入口，支持画幅、Bot 类型与输出位（grid/U1-U4）。适合艺术化、风格强烈的创意图生成。
...
Options:
  --prompt [prompt]                    提示词
  --aspect_ratio [aspect_ratio]        画幅比例 [default: auto] (choices: "auto", "1:1", "4:3", "3:4", "16:9", "9:16", "3:2", "2:3", "21:9")
  --botType [botType]                  机器人类型 [default: MID_JOURNEY] (choices: "MID_JOURNEY", "NIJI_JOURNEY")
  --output [output]                    输出方式 [default: grid] (choices: "grid", "U1", "U2", "U3", "U4")
