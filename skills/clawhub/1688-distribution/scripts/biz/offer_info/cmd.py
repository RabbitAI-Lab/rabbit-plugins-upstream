...
from scripts.biz.offer_info.service import get_offer_info, extract_decision_factors


def query(offer_id: str = "", decision: str = ""):
    """查询商品分销参谋数据"""
    try:
        if not offer_id:
