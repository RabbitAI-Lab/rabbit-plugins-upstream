---
name: dlazy-gemini-3.1
version: 1.1.2
description: Google 多模态大模型，长上下文与视觉理解强，适合文档解析、图像/视频理解与结构化输出。
metadata:
  {
    'clawdbot':
      {
    ...
    'openclaw': { 'systemPrompt': '当调用此技能时，可以使用 dlazy gemini-3.1 -h 查看帮助信息。' },
  }
---
...
Google 多模态大模型，长上下文与视觉理解强，适合文档解析、图像/视频理解与结构化输出。
