---
name: union-ad-corporate
description: "UnionSkill企业商务蓝广告PPT。图像型工作流：内容分析→大纲确认→逐页生图→PPTX装配。适合B2B方案、年报、客户提案。"
...
> 生图Prompt必须包含：16:9横版、纯白背景，深海军蓝标题，天蓝/商务蓝强调色、无页码标注、中文标题清晰可读
...
```bash
python3 ~/.openclaw/skills/ppt-generator/scripts/union_pptx_assembler.py <图片目录> --style corporate-blue --topic "PPT标题"
```
