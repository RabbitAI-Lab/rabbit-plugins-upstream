#!/usr/bin/env python3
"""
TianAPI Saylove Fetcher
-----------------------
随机获取一句土味情话。
零外部依赖，仅使用 Python 标准库。

Usage:
    python3 fetch_saylove.py --key YOUR_KEY

Env Config:
    export TIANAPI_SAYLOVE_KEY=your_api_key
    # 或在脚本同级目录创建 .env 文件: TIANAPI_SAYLOVE_KEY=your_api_key
"""
...
# --- 配置常量 ---
API_ENDPOINT = "https://apis.tianapi.com/saylove/index"
ENV_KEY_NAME = "TIANAPI_SAYLOVE_KEY"
DEFAULT_TIMEOUT = 10
...
class Config:
    ...
    def _exit_with_help(self, msg: str):
        ...
        print(f"💡 提示: 申请 Key -> https://www.tianapi.com/apiview/80", file=sys.stderr)
        sys.exit(1)
...
class TianAPIClient:
    ...
    def fetch_saylove(self) -> Dict[str, Any]:
        """
        执行 API 请求
...
def main():
    parser = argparse.ArgumentParser(description="TianAPI Saylove Fetcher")
