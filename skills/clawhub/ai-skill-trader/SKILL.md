...
```bash
npx clawhub@latest publish . --slug ai-skill-trader --version 1.0.0
```

Then verify installation:

```bash
npx clawhub@latest install ai-skill-trader
```
