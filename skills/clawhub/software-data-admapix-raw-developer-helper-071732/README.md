...
- github-issues: [heatmap (5/7) — getDartPositions + DartPosition entity + dartHeatmapProvider](https://github.com/mathrb/dartlodge/issues/576)
- github-issues: [heatmap (2/7) — DartInputSink.submitDart carries {x,y} through the seam](https://github.com/mathrb/dartlodge/issues/573)
- github-issues: [heatmap (1/7) — normalise dart position at auto-scorer emission](https://github.com/mathrb/dartlodge/issues/572)
