...
Options:
  --prompt [prompt]                    提示词
  --generation_mode [generation_mode]  生成模式 [default: frames] (choices: "frames")
  --firstFrame [firstFrame]            首帧图 [image: url or local path]
  --lastFrame [lastFrame]              尾帧图 [image: url or local path]
...
# 复杂调用：
dlazy seedance-1.5-pro --prompt '提示词内容' --image 'https://files.dlazy.com/image.png'
```
