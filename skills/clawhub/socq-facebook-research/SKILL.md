...
- Platform page: <https://socq.ai/apis/facebook>
- API documentation: <https://docs.socq.ai/api-manual/facebook>
...
Use this Skill to select and run SocQ endpoints for public Facebook research. SocQ requests are asynchronous and credit-metered.

## Use When

- The user asks to discover, collect, compare, or analyze public Facebook data.
- The workflow needs Facebook-specific endpoint selection, input validation, pagination, or raw exports.
...
1. Prefer an already configured SocQ MCP server at `https://api.socq.ai/mcp?platforms=facebook`; use the typed tool listed in [platform.md](references/platform.md), or compact `socq_execute` when needed.
