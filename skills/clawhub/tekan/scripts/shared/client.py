...
RECHARGE_URL = "https://video.tekan.cn/subscription?action=recharge"
...
RESPONSE_CODES = {
    ...
    "5000": "Internal server error, please report at https://video.tekan.cn with task type and taskId (e.g. 'avatar4 task failed, taskId: abc123')",
