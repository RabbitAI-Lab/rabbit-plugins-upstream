#!/usr/bin/env python3
"""Generate audio from text using Tekan Text-to-Voice API.
...
FIXED_COST = to_tekan_credit(0.1)
...
def cmd_run(args, parser):
    ...
    client.guard_credit(FIXED_COST, "text2voice")
...
def main():
    parser = argparse.ArgumentParser(
        description="Tekan Text-to-Voice — generate audio from text.",
