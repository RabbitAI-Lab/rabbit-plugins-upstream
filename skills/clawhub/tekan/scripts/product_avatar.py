#!/usr/bin/env python3
"""Product Avatar image replacement using Tekan PA V3/V4 API.
...
FIXED_COST = to_tekan_credit(0.5)
...
def print_result(result: dict, args) -> None:
    ...
    if args.json:
        ...
        cost = result.get("costCredit", 0) or FIXED_COST
...
def cmd_run(args, parser):
    ...
    client.guard_credit(FIXED_COST, "product_avatar")
...
def main():
    parser = argparse.ArgumentParser(
        description="Tekan Product Avatar — replace product images in digital human scenes.",
