...
# HF Daily Deep Researcher v5.2.1 — 多Agent编排版
...
def run_search(focus_keywords, days=None, mode="light"):
    ...
    v5.2.1 关键改进：搜索阶段从"主次 fallback"改为"并行互补"，
    ...
    # === v5.2.1 核心改动：并行互补搜索，而非主次 fallback ===
...
## 版本历史
- **v5.2.1** (2026-08-04): **搜索策略重要修正**。从"主次 fallback"升级为"并行互补"：
