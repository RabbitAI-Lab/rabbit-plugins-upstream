#!/usr/bin/env python3
"""
Dependency Check - linkfox-amazon-store-external-fulfillment
============================================================

与其它 amazon-store 系列 skill 相同：探测是否已安装 `linkfox-amazon-store-auth`。
"""
...
def main() -> None:
    ...
    payload = {
        ...
        "reason": (
            f"linkfox-amazon-store-external-fulfillment 依赖 `{REQUIRED_SKILL}`，"
