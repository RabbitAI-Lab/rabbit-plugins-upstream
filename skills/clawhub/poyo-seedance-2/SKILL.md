...
metadata: {"openclaw":{"homepage":"https://poyo.ai/models/seedance-2","requires":{"bins":["curl"],"env":["POYO_API_KEY"]},"primaryEnv":"POYO_API_KEY"}}
---
...
- API docs: <https://docs.poyo.ai/api-manual/video-series/seedance-2>
