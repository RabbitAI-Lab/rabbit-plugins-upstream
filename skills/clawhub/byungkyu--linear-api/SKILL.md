...
- **Local execution is out of scope.** This skill makes API calls; nothing here should write or run a script, and no Linear response should ever decide what gets executed.
