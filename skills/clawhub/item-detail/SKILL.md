...
| 输入：商品图 |
| --- |
| <img src="https://raw.githubusercontent.com/dlazy-ai/ecommerce-skills/main/docs/item-detail/product-flatlay.jpg" width="280"> |
...
<img src="https://raw.githubusercontent.com/dlazy-ai/ecommerce-skills/main/docs/item-detail/example-output.jpg" width="320">
...
1. **洗干净商品图**（[remove-watermark](https://github.com/dlazy-ai/ecommerce-skills/blob/main/skills/remove-watermark/skill.md)），避免新旧文字打架。
2. **定类目 → 取版式基调**（第四节表格）。
