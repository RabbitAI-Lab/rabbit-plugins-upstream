...
| 做法 | 说明 |
| --- | --- |
| ✅ 商品图干净 | 带文字的图会让新排版和旧文字打架，先走 [remove-watermark](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/remove-watermark/skill.md) |
...
1. **洗干净商品图**（[remove-watermark](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/remove-watermark/skill.md)），避免新旧文字打架。
2. **定类目 → 取版式基调**（第四节表格）。
...
| 输入：商品图 |
| --- |
| <img src="https://raw.githubusercontent.com/dlazyai/ecommerce-skills/main/docs/item-detail/product-flatlay.jpg" width="280"> |
...
<img src="https://raw.githubusercontent.com/dlazyai/ecommerce-skills/main/docs/item-detail/example-output.jpg" width="320">
