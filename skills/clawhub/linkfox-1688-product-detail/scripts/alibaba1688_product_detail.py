#!/usr/bin/env python3
"""
1688 Product Detail - LinkFox Skill
调用 /alibaba1688/productDetail 接口。

Usage:
  python alibaba1688_product_detail.py '<JSON parameters>'           # 自动：小结果全量；大结果写文件+摘要
  python alibaba1688_product_detail.py '<JSON parameters>' --inline  # 强制全量打印到 stdout
...
API_PATH = "/alibaba1688/productDetail"
SLUG = "linkfox-1688-product-detail"
