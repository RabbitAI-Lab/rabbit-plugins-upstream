---
name: socq-tiktok-ad-library-research
description: Research public Tiktok Ad Library content, accounts, keywords, and performance data with SocQ. Use when an agent needs Tiktok Ad Library-specific discovery, collection, endpoint selection, credit estimates, asynchronous task execution, pagination, or raw exports through the SocQ CLI, MCP, or REST API.
metadata:
  openclaw:
...
# SocQ Tiktok Ad Library Research

## SocQ Links

- Website: <https://socq.ai/>
- Platform page: <https://socq.ai/platforms>
- API documentation: <https://docs.socq.ai/api-manual/tiktok-ad-library>
...
Use this Skill to select and run SocQ endpoints for public Tiktok Ad Library research. SocQ requests are asynchronous and credit-metered.

## Use When

- The user asks to discover, collect, compare, or analyze public Tiktok Ad Library data.
- The workflow needs Tiktok Ad Library-specific endpoint selection, input validation, pagination, or raw exports.
...
1. Prefer an already configured SocQ MCP server at `https://api.socq.ai/mcp?platforms=tiktok-ad-library`; use the typed tool listed in [platform.md](references/platform.md), or compact `socq_execute` when needed.
