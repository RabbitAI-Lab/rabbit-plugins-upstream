#!/usr/bin/env python
"""
1688-item-one-click —— 商品一键操作 CLI 统一入口
...
Commands（更多参数见项目根目录 SKILL.md）:
    ...
    before_check                   执行前检查（判断是否可执行、是否需签署协议）
    execute                        执行操作（修改标题/主图）
