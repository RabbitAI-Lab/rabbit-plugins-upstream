...
- github-issues：[[security] Unescaped interpolation of untrusted values (root_path, title, asset URLs) into Swagger UI / ReDoc HTML enabl](https://github.com/fastapi/fastapi/issues/16253)
