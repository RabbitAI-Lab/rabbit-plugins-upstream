...
- github-issues: [LIB-01: Deliver the remote Libraries contract and server state](https://github.com/ScottArbeit/Grace/issues/1038)
...
- github-issues: [Docs: specify request and response schemas for `GET /agents/count`](https://github.com/Stellar-Ecosystem/lodestar/issues/615)
