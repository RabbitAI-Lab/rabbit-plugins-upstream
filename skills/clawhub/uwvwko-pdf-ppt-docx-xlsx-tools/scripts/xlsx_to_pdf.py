"""XLSX → PDF (通过 LibreOffice)

用法:
    python xlsx_to_pdf.py input.xlsx [output_dir] [--soffice PATH]
...
def main():
    if len(sys.argv) < 2:
        print("用法: python xlsx_to_pdf.py input.xlsx [output_dir] [--soffice PATH]")
        sys.exit(1)
