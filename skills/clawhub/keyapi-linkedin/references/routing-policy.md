...
Use this file to choose the right LinkedIn endpoint family and, when necessary, compose multiple endpoints into one answer. Lowest-level execution rules live in `global-rules.md`.
