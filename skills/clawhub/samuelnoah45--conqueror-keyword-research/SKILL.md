---
name: conqueror-keyword-research
description: "Find keyword opportunities for a site: discover seeds, score volume, difficulty and intent, check SERPs, and save the winners. Use when deciding what to target. Requires a connected Conqueror MCP server."
---
...
Turn seed topics into a prioritized keyword opportunity set using Conqueror MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
End with next actions, including whether to run `conqueror-keyword-clustering`, create a content brief, or save the chosen keywords.

## Guardrails

- Do not invent metrics. If Conqueror does not return a value, write `unknown`.
