...
- hacker-news-ask-hn: [Ask HN: Who build production apps with out seeing code?](https://news.ycombinator.com/item?id=48927027)
...
- github-issues: [[good first issue] Add `polis status --json`](https://github.com/ymxlx/polis-protocol/issues/47)
