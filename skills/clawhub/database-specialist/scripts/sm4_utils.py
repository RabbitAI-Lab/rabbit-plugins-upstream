...
SM4 (GB/T 32907-2016) - 128-bit block, 128-bit key, 32 rounds.
"""
import base64
import struct
...
def sm4_encrypt_hex(key_hex, plain):
    return sm4_encrypt_ecb(bytes.fromhex(key_hex), plain.encode("utf-8")).hex()

def sm4_encrypt_base64(key_b64, plain):
    return base64.b64encode(sm4_encrypt_ecb(base64.b64decode(key_b64), plain.encode("utf-8"))).decode()
