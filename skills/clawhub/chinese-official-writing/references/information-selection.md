...
1. 材料已给且与当前主旨相关的事实进入正文，保持主体、对象、数字、日期、状态和结论强度；事实之间的时间、因果和归属关系以材料明确关系为准。已选入正文的事项，直接陈述该事项已给的业务事实和当前状态。
...
篇幅目标在上述信息范围内完成；可围绕已选事实的明确关系展开，不增加材料外的主体、流程、产物、范围、责任或联系方式。用户点名不得编造的字段按输出模式省略或短列，不在正文中解释为“未提供”，也不以同义概念补回。
