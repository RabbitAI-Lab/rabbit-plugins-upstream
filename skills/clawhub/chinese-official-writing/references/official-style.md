...
- 评价强度与证据强度匹配。使用“提升、强化、推进、赋能、闭环、机制、体系、显著、长效”等抽象词或强评价时，后面应落到具体对象、动作、责任、时限、数据或制度载体；没有证据时改为材料能够支持的直接表述。
...
正式化改写只压实原文已有事实。不要为了让句子更正式而补入原文没有的组织名称、牵头部门、责任分工、整改动作、督办安排、成果总结或后续处理进展。
