---
name: apidot-gpt-5-4-api
description: "Use APIDot for GPT 5.4 API workflows, including OpenAI-compatible chat, professional task execution, spreadsheet and document analysis, tool-oriented planning, code and test handoffs, streaming planning, usage tracking, API key safety guidance, and APIDot docs routing."
homepage: https://apidot.ai/models/gpt-5-4
metadata:
  openclaw:
...
Use APIDot as a GPT 5.4-focused API surface for professional task execution, spreadsheet and document analysis, tool-oriented planning, coding handoffs, streaming-aware chat, and usage-aware routing.

This skill is for routing GPT 5.4 questions to the right APIDot docs, model page, reference notes, and integration guidance. It is documentation-only: it includes no scripts, makes no network requests, and does not store credentials.
...
- Open the GPT 5.4 model page: https://apidot.ai/models/gpt-5-4
- Read GPT 5.4 API docs: https://apidot.ai/docs/gpt-5-4
- Open the account dashboard: https://apidot.ai/dashboard/api-key
- Use general APIDot examples: https://github.com/APIDotAI/apidot-examples

## Search Terms

Use this skill for searches and requests phrased as GPT 5.4, GPT 5 4, gpt-5.4, gpt-5-4, GPT API, OpenAI-compatible chat, spreadsheet analysis, document analysis, tool planning, code handoff, or APIDot GPT API.

## When To Use

Use this skill when the user asks to:

- Build a GPT 5.4 API integration with APIDot.
- Use GPT 5.4 for professional task execution, spreadsheet analysis, document analysis, tool-oriented planning, or coding handoffs.
- Plan OpenAI-compatible chat request handling, response parsing, streaming behavior, or usage tracking.
- Compare GPT 5.4 with other APIDot chat models for routing decisions.
- Find APIDot GPT 5.4 docs, model pages, or examples.
...
APIDot GPT 5.4 integrations usually start by choosing the right chat path and routing policy:
...
2. Use GPT 5.4 for professional work where accuracy, code handoffs, and document reasoning matter.
...
Start from the user's GPT 5.4 task, then open the matching APIDot source:

| User Goal | Start Here |
| --- | --- |
| Browse APIDot GPT 5.4 model page | https://apidot.ai/models/gpt-5-4 |
| Build with GPT 5.4 | https://apidot.ai/docs/gpt-5-4 |
| Read APIDot API docs | https://apidot.ai/docs |
| Learn APIDot quickstart flow | https://apidot.ai/docs/quickstart |
| Review errors and retries | https://apidot.ai/docs/errors |
| Use general APIDot examples | https://github.com/APIDotAI/apidot-examples |

For GPT 5.4 request modes, prefer the live APIDot model page and docs page. Do not copy request fields from another chat model family unless the APIDot docs show the same field.

Use `references/api.md` for a local, non-executable summary of GPT 5.4 model routing, request planning, and integration notes.

## Integration Guidance

- Use `apidot-chat-api` when the user needs broad APIDot chat guidance across several model families.
- Use `apidot-gpt-5-5-api` when the user specifically needs GPT 5.5 coverage.
- Use this skill when the user is specifically building with GPT 5.4 through APIDot.
- Ask whether the application needs spreadsheet analysis, document analysis, tool planning, coding handoffs, or streaming before choosing request shape.
