...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量产品图生成，主体准确，商业信息清晰", "keywords": "产品图生成、产品图、商品图、商业摄影、商品场景图、产品渲染、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "product-image", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "产品图生成"}')
