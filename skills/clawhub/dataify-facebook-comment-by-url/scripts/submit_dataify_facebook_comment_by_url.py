...
def main():
    ...
    parser.add_argument("--get-all-replies", help="get_all_replies value. Default: True.")
    parser.add_argument("--limit-records", help="limit_records value, integer >= 0. Default: 10.")
    parser.add_argument("--comments-sort", help="comments_sort value. Default: All comments.")
