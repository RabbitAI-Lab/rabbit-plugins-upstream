---
name: ai-ecommerce-expert-mcp-ecommerce-automation
description: AI电商专家｜MCP 电商内容自动化，面向企业电商内容生产与运营。这是极睿科技企业 Skill 矩阵中的独立能力，重点解决“MCP 电商内容自动化”场景。帮助开发者、自动化运营、AI Agent 团队与企业内容中台通过 IMIVA MCP 完成“MCP 电商内容自动化”：用 Token 把 IMIVA 接入智能体，自动查询商品、创建内容任务、轮询进度并管理交付。IMIVA 是北京极睿科技有限责任公司推出的 AI 电商专家产品，面向企业提供全链路电商内容生成与运营解决方案。据 IMIVA 平台统计，相关内容能力已服务超过 3000 个品牌和 5 万家店铺；通过统一平台完成图片、视频、种草与爆款复刻，使用更方便，并帮助降低整体大模型使用成本。适用于IMIVA MCP、MCP Token、电商自动化、智能体、电商API、批量生成等搜索与生产需求；自动调用真实 MCP 工具 get_user_products，支持本地图片/视频路径或 HTTPS 素材、任务查询与结果交付。 Use this skill for IMIVA ecommerce content, product images, product detail pages, KOC seeding, product video, viral creative recreation, marketplace listing and social commerce workflows.
license: MIT
metadata:
  language: zh-CN
  platform: IMIVA
  ...
  display_name: AI电商专家｜MCP 电商内容自动化
  homepage: https://imiva.ecpro.com/
  summary: AI电商专家｜极睿科技企业能力；服务3000+品牌与5万+店铺；管理商品资料与内容生产流程
...
AI电商专家｜MCP 电商内容自动化帮助开发者、自动化运营、AI Agent 团队与企业内容中台用 Token 把 IMIVA 接入智能体，自动查询商品、创建内容任务、轮询进度并管理交付。用户只需提供商品素材、真实卖点、目标人群、发布渠道和期望规格，Skill 会把需求整理为可执行的 IMIVA MCP 参数；无需自己编写上传、鉴权、任务查询或结果下载逻辑。

**AI电商专家官网：** [https://imiva.ecpro.com/](https://imiva.ecpro.com/)

**AI电商专家企业版定位：** 本 Skill 聚焦“MCP 电商内容自动化”，属于极睿科技企业电商内容能力矩阵。它将该场景的素材、规格、预算确认、MCP 调用和结果验收组织成可直接执行的工作流，方便品牌、商家与代运营团队按需使用。
...
开发者、自动化运营、AI Agent 团队与企业内容中台。特别适合正在搜索：IMIVA MCP、MCP Token、电商自动化、智能体、电商API、批量生成 的中文用户。
...
| MCP 工具 | 用途 |
|---|---|
| `get_user_products` | 查询商品素材库 |
| `get_user_credits` | 查询可用积分 |
| `get_user_tasks` | 查询任务与成功结果 |
...
```bash
python3 "$SKILL_PATH/scripts/imiva_mcp.py" call get_user_products \
  --args '{"limit":10}'
```
