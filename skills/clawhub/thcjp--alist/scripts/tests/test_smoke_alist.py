...
# 路径: d:\JueJin\skills\alist\scripts\tests\test_smoke_*.py
# parents[0]=tests/ [1]=scripts/ [2]=alist/ [3]=skills/ [4]=project_root
PROJECT_ROOT = Path(__file__).resolve().parents[4]
SKILL_PATH = PROJECT_ROOT / "skills" / "alist" / "SKILL.md"
...
if __name__ == "__main__":
    ...
    test_error_handling()
    print("All smoke tests passed for alist")
