...
**处理**: 解析诊断个人效率问题与瓶颈的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回诊断个人效率问题与瓶颈的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 建立任务捕获与组织系统
建立任务捕获与组织系统

**处理**: 解析建立任务捕获与组织系统的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回建立任务捕获与组织系统的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 设计时间块管理计划
设计时间块管理计划

**处理**: 解析设计时间块管理计划的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回设计时间块管理计划的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 识别干扰源建立专注环境
识别干扰源建立专注环境

**处理**: 解析识别干扰源建立专注环境的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回识别干扰源建立专注环境的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 提供克服拖延的具体方法
提供克服拖延的具体方法

**处理**: 解析提供克服拖延的具体方法的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回提供克服拖延的具体方法的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
| input | string | 是 | 个人效率顾问基础版处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "个人效率顾问基础版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "personal prod"
    }
  },
