...
The range-regime check is the opposite end of the spectrum — useful for gating mean-reversion strategies (see `bollinger-reverter-4h.md`).
...
- `donchian-strong-regime.md` — uses bear overlay (validated)
