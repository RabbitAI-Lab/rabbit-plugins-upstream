...
version: 1.3.6
description: "Image search tool: queries Pixabay image API by keywords and returns image URLs and metadata for references, backgrounds, and design assets."
...
Execute `dlazy search_image` to get the result.
...
Options:
  ...
  --imageType [imageType]              Image Type [default: all] (choices: "all", "photo", "illustration", "vector")
  --orientation [orientation]          Orientation [default: all] (choices: "all", "horizontal", "vertical")
...
```bash
dlazy search_image --prompt 'prompt content'
```
