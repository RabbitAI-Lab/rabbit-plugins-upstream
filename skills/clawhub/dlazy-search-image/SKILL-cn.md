---
name: dlazy-search_image
version: 1.3.6
description: "图片搜索工具：调用 Pixabay 图片 API，根据关键字返回图片 URL 与元数据，适合寻找参考图、背景图和设计素材。"
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy search_image -h 查看帮助信息。"}}
---
...
图片搜索工具：调用 Pixabay 图片 API，根据关键字返回图片 URL 与元数据，适合寻找参考图、背景图和设计素材。
...
执行 `dlazy search_image` 命令获取结果。

```bash
dlazy search_image -h

Options:
  --query [query]                      搜索关键字
  --imageType [imageType]              图片类型 [default: all] (choices: "all", "photo", "illustration", "vector")
  --orientation [orientation]          方向 [default: all] (choices: "all", "horizontal", "vertical")
  --page [page]                        页码 [default: 1]
  --perPage [perPage]                  每页数量 [default: 10]
  --lang [lang]                        语言 [default: zh]
...
```bash
dlazy search_image --prompt '提示词内容'
```
