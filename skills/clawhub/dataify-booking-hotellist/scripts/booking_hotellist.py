#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Create Dataify Booking hotel information collection tasks."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create Dataify Booking hotel information collection tasks.")
