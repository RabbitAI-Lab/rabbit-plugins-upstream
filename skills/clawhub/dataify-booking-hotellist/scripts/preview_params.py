#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Print Dataify Booking hotel information parameter confirmation tables."""
...
def print_preview(args: argparse.Namespace) -> None:
    ...
    print(
        ...
        "Yes | JSON array; include multiple objects to collect multiple Booking URLs. |"
    )
    ...
    print(
        f"| url | {markdown_escape(current_url)} | {markdown_escape(DEFAULT_BOOKING_URL)} | "
        "Yes | Booking URL. |"
    )
