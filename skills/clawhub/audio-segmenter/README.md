...
1. **基础触发**：
    ...
    1、帮我把这个音频切成小段：F:\命理学-音频\猴哥说易\月支月令如何看一个人事业！.mp3

    2、音频切片，这个文件夹 F:\命理学-音频-干声，每段每段15秒，输出到 F:\命理学-音频-干声-切片
...
1. **参数指定**： 
    ...
    1、把这个音频切成30秒一段：F:\命理学-音频\猴哥说易\月支月令如何看一个人事业！.mp3 输出到 F:\命理学-音频-切片

    2、递归切片整个文件夹 F:\命理学-音频 -d 45

    3、音频分割 -i F:\命理学-音频\猴哥说易\月支月令如何看一个人事业！.mp3 -d 90

1. **口语化/场景**：

    1、帮我制作语音数据集，把这些音频都切片
...
1. **强制触发**：
    ...
    /Audio-Segmenter -i "F:\命理学-音频\猴哥说易\月支月令如何看一个人事业！.mp3" -d 60
