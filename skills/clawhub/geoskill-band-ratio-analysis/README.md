# Band Ratio Analysis (geoskill-band-ratio-analysis)

> Batch computation of spectral indices such as NDVI/NDWI/MNDWI/NDBI/EVI/SAVI, outputting per-index GeoTIFF files and value-range statistics
...
python geoskill-band-ratio-analysis.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
