...
- github-issues: [Bind caller-policy authorization to authenticated HTTP caller identity](https://github.com/sgajbi/lotus-ai/issues/107)
...
- github-issues: [Dockerfile and build script that bakes in present detectors](https://github.com/tobneu/SkinBouncer/issues/13)
