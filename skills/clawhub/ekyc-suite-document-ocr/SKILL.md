...
version: 1.0.15
description: |
  eKYC Suite Document OCR is the focused ClawHub identity document OCR Skill, document verification Skill, document verification review Skill, ID card OCR Skill, Chinese ID card OCR Skill, Chinese national ID card OCR Skill, bank card OCR Skill, driver license OCR Skill, and vehicle license OCR Skill under the eKYC Suite brand.
