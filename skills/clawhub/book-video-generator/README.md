...
- 封面图含书名 + 作者，前 5 秒显示封面 + 旁白不中断，第 6 秒切回分镜图
- 全程约 146 秒，文件大小约 9.3MB
- **图像生成**：火山即梦 Seedream 5.0 lite
- **语音合成**：火山引擎 TTS

**在线观看**：[https://chenjun198711.github.io/book-video-generator/](https://chenjun198711.github.io/book-video-generator/)

> 也可直接下载视频文件：[`demo/自由的夜行_三分钟精读.mp4`](demo/自由的夜行_三分钟精读.mp4)
...
├── .gitignore
├── demo/                             # 演示视频
│   └── 自由的夜行_三分钟精读.mp4        # 《自由的夜行》史铁生 完整生成效果
├── references/
