...
```shell
runapi minimax-h3 <operation> --async --input-file request.json > task.json
...
```shell
runapi wait "$task_id" --service minimax-h3 --action <operation> > result.json
```
...
- SDK integration: https://github.com/runapi-ai/minimax-h3-sdk
