...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度种草图片，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、种草图片、小红书种草图、社媒配图、好物推荐图、UGC视觉、笔记封面、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-seeding-image", "rule": "optional", "search": "固定调用 Seedream 5.0 Lite 的种草图片裸接口能力", "title": "Seedream 5.0 Lite 种草图片"}')
