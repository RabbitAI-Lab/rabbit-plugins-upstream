...
req = urllib.request.Request(GATEWAY + "/google-calendar/calendar/v3/users/me/calendarList")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-google-calendar-skill/1.2")
