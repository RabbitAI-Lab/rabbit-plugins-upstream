...
display_name: 亚马逊评论导出 · 一键下载CSV报告
description: >
  亚马逊评论导出 Skill。采集指定 ASIN 的评论并一键导出 CSV 到本地，
  AI 分析报告可导出 Markdown / HTML 存档或二次加工，适合接入自有
  表格与 BI 流程。Use when the user asks about exporting reviews, review CSV,
  download reviews, 评论导出、评论下载、CSV、报告导出、数据落地。
  Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: review-export
displayName: 亚马逊评论导出 · 一键下载CSV报告
version: 1.4.7
summary: 采集评论一键导出 CSV，分析报告导出 Markdown/HTML
license: MIT
---
