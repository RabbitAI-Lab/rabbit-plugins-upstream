...
证据覆盖：6 条信号，覆盖 3 个来源类型。

## 来源证据

- clawhub-popular-skill：[Popular Clawhub skill demand: ontology has 191,964 downloads](https://clawhub.ai/skills/ontology)
- clawhub-popular-skill：[Popular Clawhub skill demand: Multi Search Engine has 156,153 downloads](https://clawhub.ai/skills/multi-search-engine)
...
- hacker-news-ask-hn：[Ripple Calculator: Complete Guide to XRP Profit and Conversion](https://news.ycombinator.com/item?id=48808317)
- github-issues：[Galactic Exodus: #1276 Step 2 dropped SALVAGE object lifecycleを実装・fixture同期する](https://github.com/kkismd/tbx/issues/1294)
