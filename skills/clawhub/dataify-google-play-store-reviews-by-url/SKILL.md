...
description: "Collect Google Play app reviews from a known Play Store app URL. Do not use for app discovery, rankings, or general Google Play search."
---
...
**Input:** a Google Play app URL.

```bash
python3 scripts/build-dataify-request.py --tool-sign google-play-store_reviews_by-url --params-json '[{"url":"https://play.google.com/store/apps/details?id=com.google.android.youtube"}]'
```
