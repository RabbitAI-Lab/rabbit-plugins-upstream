...
支持模型：GV、Hailuo（海螺）、Kling（可灵）、Jimeng（即梦）、Vidu、Hunyuan（混元）、Mingmou（明眸）、OS、Seedance（豆包）、PixVerse
"""
...
示例:
  ...
  python3 vod_aigc_video.py create --model GV --prompt "test" --dry-run
    ...
    create_parser.add_argument('--model', required=True,
                               ...
                               help='模型名称（必填）：GV/Hailuo/Kling/Jimeng/Vidu/Hunyuan/Mingmou/OS/Seedance/PixVerse')
