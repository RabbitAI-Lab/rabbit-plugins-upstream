...
示例:
  ...
  # 指定媒体名称和封面
  python3 vod_pull_upload.py --url "https://example.com/video.mp4" --media-name "我的视频" --cover-url "https://example.com/cover.jpg"
  ...
  # 等待任务完成
  python3 vod_pull_upload.py --url "https://example.com/video.mp4"  # 默认等待完成
