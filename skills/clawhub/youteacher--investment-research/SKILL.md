...
- [API 密钥配置](https://ai-skills.open-idea.net/skill-docs/investment-research/API-KEY.md)
- [操作契约](https://ai-skills.open-idea.net/skill-docs/investment-research/OPERATIONS.md)
