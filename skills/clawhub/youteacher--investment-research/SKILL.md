...
description: Use when 用户需要检索公司公告或 XBRL 事实，并基于平台内真实来源任务生成带引用、无投资指令的风险分析或投资研究报告；需要 INVESTMENT_RESEARCH_API_KEY。
metadata: {"packageVersion":"1.0.0","openclaw":{"emoji":"📊","homepage":"https://ai-skills.open-idea.net","primaryEnv":"INVESTMENT_RESEARCH_API_KEY","requires":{"env":["INVESTMENT_RESEARCH_API_KEY"]}}}
---
...
5. 按 [来源、证据与投资安全规则](references/BEHAVIOR-RULES.md)交付 structured 结果。
...
- [来源、证据与投资安全规则](references/BEHAVIOR-RULES.md)
