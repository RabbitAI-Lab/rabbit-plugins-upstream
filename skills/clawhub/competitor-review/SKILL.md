---
name: amazon-competitor-review
display_name: 亚马逊竞品评论分析 · 对手短板拆解
description: >
  亚马逊竞品评论分析 Skill：批量采集竞品 ASIN 的评论并做多品对比，
  定位对手被反复夸的强项与被反复骂的短板，找出可切入的差异化机会，
  输出竞品对比报告与打法建议。Use when the user asks about competitor analysis,
  rival product reviews, competitive benchmarking, 竞品分析、竞品调研、对手评论、
  竞争对手对比、差异化定位、竞品短板。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: competitor-review
displayName: 亚马逊竞品评论分析 · 对手短板拆解
version: 1.4.7
summary: 竞品评论横向对比，定位对手短板与切入点
license: MIT
---
