# PoYo Kling O3 API Reference

## Endpoint

- Submit task: `POST https://api.poyo.ai/api/generate/submit`
- Status query: `GET https://api.poyo.ai/api/generate/status/{task_id}`
- Source docs: <https://docs.poyo.ai/api-manual/video-series/kling-o3>
- Model page: <https://poyo.ai/models/kling-o3>
...
curl --fail-with-body --request POST \
  ...
  --data '{
    ...
    "input": {
      "prompt": "A refined product launch video of a transparent speaker on a black glass table, soft reflections, slow camera push-in, clean studio lighting",
      "multi_shots": false,
      "duration": 5,
      "sound": true,
      "aspect_ratio": "16:9"
...
curl --fail-with-body --request POST \
  ...
  --data '{
    "model": "kling-o3/standard",
    "input": {
      "prompt": "Create a clean fashion campaign clip. Preserve the outfit and set references while the subject turns toward the camera",
