# Contributing to `Meeting Transcript To Summary`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Meeting Transcript To Summary.git
cd Meeting Transcript To Summary
...
git add .
git commit -m "feat(meeting-transcript-to-summary): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(meeting-transcript-to-summary): add <brief description>
