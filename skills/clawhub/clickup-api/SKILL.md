...
req = urllib.request.Request(GATEWAY + "/clickup/api/v2/team")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-clickup-skill/1.2")
