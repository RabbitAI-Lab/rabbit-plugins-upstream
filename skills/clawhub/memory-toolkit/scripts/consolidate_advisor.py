...
def llm_summarize_cluster(cluster: dict) -> str | None:
    ...
    ⚠️ Privacy note: Memory text is sent to the local Ollama instance (OLLAMA_URL).
    Ensure OLLAMA_URL points to localhost for privacy. No data leaves the machine.
    """
