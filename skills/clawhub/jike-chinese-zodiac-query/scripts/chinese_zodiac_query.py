...
3. 调用即刻数据开放接口 `/v1/chinese_zodiac` 查询数据。
...
API_PATH = "/v1/chinese_zodiac"
APPKEY_ENV_NAMES = ("JIKE_CHINESE_ZODIAC_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
FIELDS = [('name', '生肖'), ('five_elements_anls', '五行'), ('natal_buddha', '本命佛'), ('year', '年份'), ('auspicious_clr', '吉祥颜色'), ('lucky_num', '幸运数字'), ('lucky_flower', '幸运花'), ('advantage', '优点'), ('shortcoming', '缺点'), ('causeq', '事业'), ('love', '爱情'), ('fortune', '运势'), ('healthy', '健康'), ('suitable', '宜配'), ('avoid', '忌配')]
OPTIONAL_PARAMS = [('name', '生肖名称，例如 牛')]
REQUIRED_PARAMS = []
DATE_PARAMS = []
TITLE = "生肖查询 - 即刻数据"
FAIL_TITLE = "生肖查询失败"
