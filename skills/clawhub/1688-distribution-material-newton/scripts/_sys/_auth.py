...
from scripts._sys._const import SKILL_VERSION, OPENCLAW_CONFIG_PATH
...
def _get_ak_raw_from_config() -> Optional[str]:
    ...
    try:
        ...
        skill = entries.get("1688-distribution-material-newton", {})
...
if __name__ == "__main__":
    ...
    headers = build_signature(
        method="POST",
        uri="/api/distribution_material_edit_image_by_jimeng/1.0.0",
        body='{"offerId":"123456"}',
        content_type="application/json",
        ak_id=ak_id,
        ak_secret=ak_secret,
