...
/**
 * SAFETY: Uses execFileSync (no shell) with hardcoded binary name `yt-dlp`
 * and array args to prevent command injection. Never passes user-controlled
 * strings as the command argument.
 */
