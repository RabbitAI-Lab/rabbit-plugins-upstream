...
req = urllib.request.Request(GATEWAY + "/apollo/v1/labels")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-apollo-skill/1.2")
