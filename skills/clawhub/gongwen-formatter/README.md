...
- **Bold text** is automatically converted to KaiTi_GB2312 bold (楷体加粗); *italic text* is automatically converted to KaiTi (楷体)
...
| Heading 2 | `###` | Kai Ti_GB2312 bold | 3rd |
...
| Bold | `**text**` | Auto-convert to KaiTi_GB2312 bold |
