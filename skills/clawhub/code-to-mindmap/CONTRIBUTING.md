# Contributing to `Code To Mindmap`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Code To Mindmap.git
cd Code To Mindmap
...
git add .
git commit -m "feat(code-to-mindmap): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(code-to-mindmap): add <brief description>
