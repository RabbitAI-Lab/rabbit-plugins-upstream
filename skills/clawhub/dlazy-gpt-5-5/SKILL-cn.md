...
name: dlazy-gpt-5.5
version: 1.1.2
description: OpenAI 通用大模型，平衡推理质量与响应速度，适合对话、写作、规划与多模态分析。
metadata:
  {
    'clawdbot':
      {
    ...
    'openclaw': { 'systemPrompt': '当调用此技能时，可以使用 dlazy gpt-5.5 -h 查看帮助信息。' },
  }
---
...
OpenAI 通用大模型，平衡推理质量与响应速度，适合对话、写作、规划与多模态分析。
