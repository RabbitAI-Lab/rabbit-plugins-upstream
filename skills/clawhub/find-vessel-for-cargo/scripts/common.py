...
USER_AGENT = "ShippingClaw-VesselMatcher/1.0"


def cache_dir() -> Path:
    configured = os.getenv("VESSEL_MATCHER_CACHE_DIR")
    if configured:
        ...
        path = Path(tempfile.gettempdir()) / "shippingclaw-find-vessel-for-cargo"
