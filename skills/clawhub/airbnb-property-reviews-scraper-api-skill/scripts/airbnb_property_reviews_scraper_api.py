...
# API Configuration
TEMPLATE_ID = '113864965712003495'
API_BASE_URL = "https://api.browseract.com/v3/bots"
API_KEY_URL = 'https://www.browseract.com/reception/integrations?co-from=airbnb-property-reviews-scraper'


def run_airbnb_property_reviews_scraper_task(api_key, room_detail_url='https://www.airbnb.com/rooms/1668897264370376980', max_review_count='10'):
    """
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python airbnb_property_reviews_scraper_api.py <room_detail_url> [max_review_count]", flush=True)
        sys.exit(1)
    ...
    room_detail_url = sys.argv[1] if len(sys.argv) > 1 else 'https://www.airbnb.com/rooms/1668897264370376980'
    max_review_count = sys.argv[2] if len(sys.argv) > 2 else '10'

    result = run_airbnb_property_reviews_scraper_task(api_key, room_detail_url, max_review_count)
    if result:
