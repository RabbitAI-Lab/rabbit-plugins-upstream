...
version: 1.1.2
displayName: 博客发布工具
summary: "将Markdown文章。将Markdown文章。支持自动化配置和灵活的参数设置，适支持多种应用场景，提升生产力效果。博客发布工具工具。支持自动化配置和灵活的参数设置，适用于多种工作场景"
...
```yaml
tags: ["ssg", "server-side-rendering"]
categories: ["tech"]
```
...
### Q6: 专属技术名词如何处理？
A: AI、RAG、NLP、Kubernetes、Go、PHP、SQL、SSG、Server-Side Rendering等技术名称直接用英文slug，不需要中文映射.
### Q7: 文件名中可以包含日期吗？
