...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量营销图片，主体准确，商业信息清晰", "keywords": "营销图片、营销视觉、活动KV、推广图片、促销图、Campaign视觉、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "marketing-image", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "营销图片"}')
