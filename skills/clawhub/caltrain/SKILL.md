---
name: 火车时刻查询服务
description: 基于GTFS数据的Caltrain火车时刻查询服务，提供实时火车时刻表、站点查询和时间特定查询功能。
version: 1.0.0
---
...
## scripts.tools.next_trains
工具描述：Return the next few scheduled Caltrain departures.
...
|------|-------|------|-----|----|
|origin|string|true| |null|
|destination|string|true| |null|
|when_iso|null|false| |null|

---

## scripts.tools.list_stations
工具描述：List all available Caltrain stations.
