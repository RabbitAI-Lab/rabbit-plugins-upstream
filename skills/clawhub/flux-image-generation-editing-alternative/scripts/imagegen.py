...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一张高完成度商业图片，用于替代 FLUX 工作流，主体准确，构图清晰，细节真实", "keywords": "FLUX.1、Black Forest Labs、Flux图片、FLUX替代、平替、API、国内可用、图片生成、图片编辑", "model": "public_model_nano_banana_pro", "name": "flux-image-generation-editing-alternative", "rule": "optional", "search": "寻找 FLUX 替代、同类、平替、价格与国内 API 入口", "title": "FLUX 图片生成替代｜AI 图片生成与编辑"}')
