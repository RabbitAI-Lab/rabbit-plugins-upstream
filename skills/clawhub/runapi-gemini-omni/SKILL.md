...
- For a one-off artifact or result, use the registered `gemini-omni` service in the `runapi` CLI. If the installed command catalog does not list it, stop and report the missing service instead of inventing a command.
...
- SDK integration: https://github.com/runapi-ai/gemini-omni-sdk
