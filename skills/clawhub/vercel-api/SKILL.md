...
req = urllib.request.Request(GATEWAY + "/vercel/v2/user")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-vercel-skill/1.2")
