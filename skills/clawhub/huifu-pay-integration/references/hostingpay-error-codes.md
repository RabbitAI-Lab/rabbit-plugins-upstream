...
官方公共全集：[返回码](https://paas.huifu.com/partners/api/doc/csfl/api_csfl_ywm.md)。本页将 HTTP 层、网关业务层和托管交易层拆开便于排查，但只摘录高频项；具体接口页的专属码与公共全集必须合并查看，同码多义时结合接口、`resp_desc` 和交易场景判断。
