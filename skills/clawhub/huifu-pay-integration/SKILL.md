...
1.3.2 目标：在接入副驾驶基础上新增商户进件 API 路由。先判断开发者处境，再推荐产品线、商户进件资料路径、接入方案、本地沙箱演练、参数/返回/代码片段检查、问题修复建议和上线检查。默认只读取当前场景必需的 3-5 份本地 reference。
...
| 企业/个体商户基础信息进件 | `references/merchant-onboarding-enterprise.md`、同目录 `merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md`、`merchant-onboarding-external-resources.md` |
| 无执照个人商户基础信息进件 | `references/merchant-onboarding-individual.md`、同目录 `merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md`、`merchant-onboarding-external-resources.md` |
| 商户进件图片上传 / 文件标识 | `references/merchant-onboarding-image-upload.md`、同目录 `merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md`、`merchant-onboarding-external-resources.md` |
...
| 商户业务开通 / 补开 / 渠道结果 | `references/merchant-onboarding-business-open.md`、同目录 `merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md`、`merchant-onboarding-external-resources.md` |
| 基础进件已有 `huifu_id`、业务已提交，判断是否可交易 | 按主体读取 `merchant-onboarding-enterprise.md` 或 `merchant-onboarding-individual.md`，再读 `merchant-onboarding-business-open.md`、`merchant-onboarding-application-status-query.md`、`merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md` |
| 商户详细信息核对 | `references/merchant-onboarding-detail-query.md`、同目录 `merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md`、`merchant-onboarding-external-resources.md` |
| 商户申请单审核或渠道状态查询 | `references/merchant-onboarding-application-status-query.md`、同目录 `merchant-onboarding-complete-field-catalog.md`、`merchant-onboarding-field-contracts.md`、`merchant-onboarding-external-resources.md` |
...
| --- | --- |
| Skill 包版本 | `1.3.2` |
| Skill 包发布日期 | `2026-07-13` |
| 1.3.2 merchant onboarding refresh | 新增企业/个人进件、图片上传、业务开通、详情与申请状态 API 路由；未确认上传/回调协议只输出确认清单 |
