...
description: Defines testing quality metrics, coverage thresholds, and anti-patterns
version: 1.9.8
triggers:
  - testing
  - quality
  - standards
  - metrics
  - establishing test gates or validating a test suite's coverage targets
