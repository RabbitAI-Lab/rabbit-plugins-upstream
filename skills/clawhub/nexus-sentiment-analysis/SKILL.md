...
description: "Analyze emotional tone and detect opinions"
version: 2.1.0
capabilities:
...
Use when you need to analyze emotional tone and detect opinions.
...
curl -X POST https://ai-service-hub-15.emergent.host/api/original-services/sentiment-analysis \
  ...
  -d '{
  "input": "Example input for Sentiment Analysis API"
}'
```
