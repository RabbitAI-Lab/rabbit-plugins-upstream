...
version: 1.0.0
license: MIT
description: 全能 AI 编程导师，通过苏格拉底式教学法提供交互式编程学习、代码审查、调试指导、算法练习、项目指导与设计模式讲解，用于回答「这段代码为什么错」「怎么从零学 Python」「面试算法怎么练」这类问题
tags:
- 诺声
- AI技能
- SynomosAI
...
category: 编程教学
updated: 2026-08-28
fingerprint: FP-MX-02E57A2365F4
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-02E57A2365F4
