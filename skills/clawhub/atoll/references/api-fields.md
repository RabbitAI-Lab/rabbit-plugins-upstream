...
legacy unsafe values are redacted as `null` in projections. Deleted agent or
actor rows use immutable AH-2095 snapshots. Detail adds ordered `transitions` and
