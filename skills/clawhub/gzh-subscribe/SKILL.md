...
前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册获取 API Key，三种配置方式任选其一：
...
**Q：额度用完了怎么办？**
A：前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册获取 API Token。
