...
(Fill in a 2-3 paragraph Chinese introduction here: features, application scenarios, core algorithm.)
...
```bash
python geoskill-urban-drainage-analysis.py --bbox 116.0 39.0 117.0 40.0 [other parameters]
```
