...
class YouTubeDownloader(BaseDownloader):
    ...
    def fetch_works(self, account_id: str, page_size: int = DEFAULT_PAGE_SIZE, page_num: int = 1,
        ...
        if page_num <= 1:
            ...
            payload = {"channel": account_id, "source": "多平台主页作品提取-ClawHub"}
        elif self._continuation_token:
            payload = {"continuation": self._continuation_token, "source": "多平台主页作品提取-ClawHub"}
        else:
    ...
    def get_download_info(self, work_url: str) -> dict:
        payload = {"url": work_url, "source": "多平台主页作品提取-ClawHub"}
