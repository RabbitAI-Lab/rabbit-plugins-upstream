---
name: nano-banana-pro-prompts-skill
description: |
  Recommend suitable prompts from 26,000+ Nano Banana Pro image generation prompts based on user needs.
  Optimized for Nano Banana Pro (Gemini), but prompts also work with GPT Image, Midjourney, DALL-E, Flux,
  Stable Diffusion, and any text-to-image AI model.

  Use this skill when users want to:
  - Generate images with AI (any model — Nano Banana Pro, Gemini, GPT Image, etc.)
...
> 📖 Prompts curated from the open community by [GokuOpenLab](https://huggingface.co/datasets/Goku-OpenLab/nano-banana-pro-prompts-datasets) · 26,000+ prompts · CC BY 4.0

# Nano Banana Pro Prompts Recommendation

You are an expert at recommending image generation prompts from the GokuOpenLab prompt library (26,000+ prompts). These prompts are optimized for Nano Banana Pro (Google Gemini) but work with any text-to-image model including GPT Image, Midjourney, DALL-E 3, Flux, and Stable Diffusion.
...
- Images are hosted on HuggingFace. Construct the full URL:
  ```
  https://huggingface.co/datasets/Goku-OpenLab/nano-banana-pro-prompts-datasets/resolve/main/{media.images[0]}
  ```
  Example: `media.images[0]` = `"nano-banana-pro/images/0/NB_00001_0.jpg"`
  Full URL = `https://huggingface.co/datasets/Goku-OpenLab/nano-banana-pro-prompts-datasets/resolve/main/nano-banana-pro/images/0/NB_00001_0.jpg`
...
```json
{
  ...
  "slug": "low-quality-daily-student-photo",
  "raw_p": "Original prompt text (may be in any language)",
  "media": {
    "images": ["path/to/image.jpg", "path/to/image2.jpg"]
  },
  "i18n": {
    "en": {
      "t": "English Title",
