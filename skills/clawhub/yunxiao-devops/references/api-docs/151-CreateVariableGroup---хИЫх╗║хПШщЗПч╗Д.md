...
`POST https://{domain}/oapi/v1/appstack/organizations/{organizationId}/apps/{appName}/variableGroup`
...
`curl -X 'POST' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/ec766e63aee3437d9a51f334d6exxxxx/apps/my-web-service/variableGroup' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \ --data ' { "branchName": "master", "displayName": "dev", "fromRevisionSha": "1.0.0", "message": "message", "name": "dev", "vars": [ { "description": "命名空间", "key": "namespace", "value": "default" } ] }'`
