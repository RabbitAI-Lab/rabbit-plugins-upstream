# GetWorkitemType - 获取工作项类型详情

通过 OpenAPI 获取工作项类型详情。
...
`GET https://{domain}/oapi/v1/projex/organizations/{organizationId}/workitemTypes/{id}`
...
`curl -X 'GET' \ 'https://test.rdc.aliyuncs.com/oapi/v1/projex/organizations/{organizationId}/workitemTypes/{id}' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
