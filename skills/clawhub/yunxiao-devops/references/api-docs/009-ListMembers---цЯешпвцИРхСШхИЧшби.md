...
```
GET https://{domain}/oapi/v1/platform/members
```
...
| perPage | integer | query | 否 | 每页数据条数，1<=perPage<=100，默认100。 |  |

## **请求示例**

### **中心版**

`curl -X 'GET' \ 'https://{domain}/oapi/v1/platform/organizations/{organizationId}/members?page={page}&perPage={perPage}' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`

### **Region版**

```
curl -X 'GET' \
  'https://{domain}/oapi/v1/platform/members?page={page}&perPage={perPage}' \
