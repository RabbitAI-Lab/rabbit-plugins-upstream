...
`GET https://{domain}/oapi/v1/flow/organizations/{organizationId}/variableGroups`

### **Region版**

```
GET https://{domain}/oapi/v1/flow/variableGroups
```
...
`curl -X 'GET' \ 'https://{domain}/oapi/v1/flow/organizations/5ebbc0228123212b59xxxxx/variableGroups?perPage=10&page=1&pageSort=ID&pageOrder=DESC' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`

### **Region版**

```
curl -X 'GET' \
  'https://{domain}/oapi/v1/flow/variableGroups?perPage=10&page=1&pageSort=ID&pageOrder=DESC' \
