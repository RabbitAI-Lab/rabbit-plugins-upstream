...
```
POST https://{domain}/oapi/v1/codeup/repositories/{repositoryId}/webhooks
```
...
`curl -X 'POST' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/webhooks' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \ --data ' { "description": "描述内容", "enableSslVerification": false, "mergeRequestsEvents": true, "noteEvents": true, "pushEvents": true, "tagPushEvents": true, "token": "xxx", "url": "http://example/example" }'`

### **Region版**

```
curl -X 'POST' \
  'https://{domain}/oapi/v1/codeup/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/webhooks' \
