# PassReleaseStagePipelineValidate - 通过研发阶段流水线人工卡点
...
`POST https://{domain}/oapi/v1/appstack/organizations/{organizationId}/apps/{appName}/releaseWorkflows/{releaseWorkflowSn}/releaseStages/{releaseStageSn}/executions/{executionNumber}:passPipelineValidate`
...
| executionNumber | string | path | 是 | 流水线运行 ID，对应 ExecuteChangeRequestReleaseStage 返回的 pipelineRunId。 | 123 |
