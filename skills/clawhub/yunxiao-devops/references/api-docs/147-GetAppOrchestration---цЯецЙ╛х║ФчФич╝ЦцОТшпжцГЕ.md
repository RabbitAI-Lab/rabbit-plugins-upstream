...
| sn | string | path | 是 | 应用编排唯一序列号，未指定 tag 和 sha 时将查找最新版本。 | my-web-service@KUBERNETES |
| tagName | string | query | 否 | 编排 tag。 | demotag |
| sha | string | query | 否 | 编排 commit sha。 | d23ccbd926c31e3ca0b153f22c4548b93b1426e |
| organizationId | string | path | 是 | 组织 ID。 | 99d1\*\*\*\*71d4 |

## **请求示例**

`curl -X 'GET' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/anyOrganizationId/apps/my-web-service/orchestrations/my-web-service@KUBERNETES?tagName=demotag&sha=d23ccbd926c31e3ca0b153f22c4548b93b1426e' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
