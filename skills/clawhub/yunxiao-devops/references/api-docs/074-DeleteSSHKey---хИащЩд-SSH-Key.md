...
`DELETE https://{domain}/oapi/v1/codeup/organizations/{organizationId}/keys/{keyId}`

### **Region版**

```
DELETE https://{domain}/oapi/v1/codeup/keys/{keyId}
```
...
| keyId | string | path | 是 | SSH Key 主键 ID。 | 1 |

## **请求示例**

### **中心版**

`curl -X 'DELETE' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/keys/1' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
