...
```
GET https://{domain}/oapi/v1/codeup/repositories/{repositoryId}/branches
```
...
| sort | string | query | 否 | 排序方式：name\_asc - 名称升序；updated\_asc - 更新时间升序；updated\_desc - 更新时间降序。 | name\_asc |
| search | string | query | 否 | 查询条件。 | demo-branch |

## **请求示例**

### **中心版**

`curl -X 'GET' \ 'https://{domain}/oapi/v1/codeup/organizations/60de7a6852743a5162b5f957/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/branches?page=1&perPage=20&sort=name_asc&search=demo-branch' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`

### **Region版**

```
curl -X 'GET' \
  'https://{domain}/oapi/v1/codeup/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/branches?page=1&perPage=20&sort=name_asc&search=demo-branch' \
