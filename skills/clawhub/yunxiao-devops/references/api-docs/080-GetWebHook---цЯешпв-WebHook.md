# GetWebHook - 查询 WebHook

通过 OpenAPI 查询单个 WebHook。
...
`GET https://{domain}/oapi/v1/codeup/organizations/{organizationId}/repositories/{repositoryId}/webhooks/{hookId}`

### **Region版**

```
GET https://{domain}/oapi/v1/codeup/repositories/{repositoryId}/webhooks/{hookId}
```
...
`curl -X 'GET' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/webhooks/1' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
