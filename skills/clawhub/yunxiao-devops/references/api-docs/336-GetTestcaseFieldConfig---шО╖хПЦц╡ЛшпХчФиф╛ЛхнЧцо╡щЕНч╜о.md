# GetTestcaseFieldConfig - 获取测试用例字段配置

通过 OpenAPI 获取测试用例字段配置。
...
`GET https://{domain}/oapi/v1/testhub/organizations/{organizationId}/testRepos/{id}/testcases/fields`
...
`curl -X 'GET' \ 'https://test.rdc.aliyuncs.com/oapi/v1/testhub/organizations/{organizationId}/testRepos/{id}/testcases/fields' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
...
`[ { "cascadingOptions": { "mustSelectLeaf": true, "optionsList": [] }, "defaultValue": "12233", "description": "描述", "format": "list", "id": "field-id-xxx", "name": "名称", "options": [ { "displayValue": "111", "id": "field-id-xxx", "value": "111", "valueEn": "111" } ], "required": true, "showWhenCreate": true, "type": "NativeField" } ]`
