...
```
GET https://{domain}/oapi/v1/codeup/keys
```
...
`curl -X 'GET' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/keys?page=1&perPage=20&orderBy=created_at&sort=desc' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`

### **Region版**

```
curl -X 'GET' \
  'https://{domain}/oapi/v1/codeup/keys?page=1&perPage=20&orderBy=created_at&sort=desc' \
