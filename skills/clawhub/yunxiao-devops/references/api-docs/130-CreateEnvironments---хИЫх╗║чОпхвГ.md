...
| name | string | body | 是 | 环境名称。 | env-name |
...
| resourcePoolName | string | body | 是 | 资源池名称。 | default |
...
`curl -X 'POST' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/organization-id-xxx/apps/my-web-service/envs' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \ --data ' { "deployGroupName": "deploy-group-name", "description": "description", "displayName": "display-name", "labelList": [ { "displayName": "测试标签键", "displayValue": "测试标签值", "extraMap": { }, "name": "demo-label", "namespace": "default", "value": "demo-label-value" } ], "name": "env-name", "profiles": [ { "displayName": "开发变量组", "name": "dev", "type": "GLOBAL" } ], "replicasManagement": "SYSTEM", "resourcePoolName": "default", "resourceType": "KUBERNETES", "rolloutStrategies": [ { "batchMode": "ConfirmFirstBatch", "batchSteps": [ { "type": "WEIGHT", "value": "90" } ], "batches": "2", "deployType": "Batch", "locator": "aaa.bbb.ccc", "targetReplicas": 3, "timeOutMS": 60000 } ] }'`
