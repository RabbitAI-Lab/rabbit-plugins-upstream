...
```
DELETE https://{domain}/oapi/v1/codeup/repositories/{repositoryId}/protectedBranches/{id}
```
...
`curl -X 'DELETE' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/protectedBranches/1' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
