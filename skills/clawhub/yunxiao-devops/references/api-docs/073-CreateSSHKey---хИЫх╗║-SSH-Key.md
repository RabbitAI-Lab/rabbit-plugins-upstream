...
```
POST https://{domain}/oapi/v1/codeup/keys
```
...
| \- | object | body | 否 |  |  |
| expireTime | string | body | 否 | 过期时间。 | 2024-10-05T15:30:45Z |
| key | string | body | 是 | SSH Key 公钥串。 | xxx |
| keyScope | string | body | 是 | 作用范围: ALL - 全部（读/写操作，包括 clone/pull/push），READ - 只读（仅支持 clone/pull）。 | ALL |
| title | string | body | 是 | SSH Key 标题。 | SSH Title |

## **请求示例**

### **中心版**

`curl -X 'POST' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/keys' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \ --data ' { "expireTime": "2024-10-05T15:30:45Z", "key": "xxx", "keyScope": "ALL", "title": "SSH Title" }'`

### **Region版**

```
curl -X 'POST' \
  'https://{domain}/oapi/v1/codeup/keys' \
  -H 'Content-Type: application/json' \
  -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \
  --data '
    {
        "expireTime": "2024-10-05T15:30:45Z",
        "key": "xxx",
        "keyScope": "ALL",
        "title": "SSH Title"
    }'
