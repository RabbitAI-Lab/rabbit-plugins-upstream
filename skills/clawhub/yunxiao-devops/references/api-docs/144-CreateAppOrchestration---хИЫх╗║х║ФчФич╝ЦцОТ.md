...
`POST https://{domain}/oapi/v1/appstack/organizations/{organizationId}/apps/{appName}/orchestrations`
...
| \- | object | body | 否 | 创建编排请求。 |  |
| templateId | string | body | 是 | 编排模板 ID。 | 20663627-81ee-4cfe-9b69-\*\*\*\*4a674 |
| templateType | string | body | 是 | 编排模板类型。 | ORG |

## **请求示例**

`curl -X 'POST' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/anyOrganizationId/apps/my-web-service/orchestrations' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \ --data ' { "templateId": "20663627-81ee-4cfe-9b69-****4a674", "templateType": "PREDEFINED" }'`
