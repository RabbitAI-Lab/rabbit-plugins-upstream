# ListChangeOrdersByOrigin - 根据创建来源查询部署单

通过 OpenAPI 根据创建来源查询部署单。
...
| --- | --- | --- | --- | --- | --- |
| originType | string | query | 是 | 创建来源类型。 | FLOW |
| originId | string | query | 是 | 创建来源标识。 | 如果 originType 为 FLOW，则 originId 格式为 pipelineId+pipelineRunId，如 123+1，注意：+需要经过 urlEncode，即%2B |
| appName | string | query | 否 | 应用名。 | my-web-service |
| envName | string | query | 否 | 环境名。 | dev |
| organizationId | string | path | 是 | 组织 ID。 | ec766e63aee3437d9a51f334d6exe671 |

## **请求示例**

`curl -X 'GET' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/ec766e63aee3437d9a51f334d6exe671/changeOrders:byOrigin?originType=FLOW&originId=123%2B1&appName=my-web-service&envName=dev' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
...
| creatorId | string | 创建人。 | 5e96a034afcc954c89849976 |
...
| modifierId | string | 修改人。 | 5e96a034afcc954c89849976 |
