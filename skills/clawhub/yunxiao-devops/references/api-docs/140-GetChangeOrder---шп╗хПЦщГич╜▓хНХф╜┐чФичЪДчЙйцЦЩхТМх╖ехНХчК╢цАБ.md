...
| changeOrderSn | string | path | 是 | 部署单编号。 | 66c0c9fffeb86b450c199fcd |
| organizationId | string | path | 是 | 组织 ID。 | ec766e63aee3437d9a51f334d6exe671 |

### 请求示例

`curl -X 'GET' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/ec766e63aee3437d9a51f334d6exe671/apps/my-web-service/changeOrders/66c0c9fffeb86b450c199fcd' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
...
| envValues | map | 实际生效的参数KV。 | {"image.backend": "nginx:1.12","envName": "dev","appName": "myapp","namespace": "default","replicas": "2"} |
