...
`GET https://{domain}/oapi/v1/projex/organizations/{organizationId}/projects/{id}/workitemTypes`
...
| category | string | query | 是 | 工作项类型，可选值为 Req，Bug，Task 等。 |  |

## **请求示例**

`curl -X 'GET' \ 'https://{domain}/oapi/v1/projex/organizations/{organizationId}/projects/{id}/workitemTypes?category={category}' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
