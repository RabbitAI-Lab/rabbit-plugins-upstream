...
```
GET https://{domain}/oapi/v1/codeup/repositories/{repositoryId}/branches/{branchName}
```
...
| branchName | string | path | 是 | 分支名称（若有特殊符号，可使用 URL-Encoder 进行编码处理）。 | demo-branch |

## **请求示例**

### **中心版**

`curl -X 'GET' \ 'https://{domain}/oapi/v1/codeup/organizations/60d54f3daccf2bbd6659f3ad/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/branches/demo-branch' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`

### **Region版**

```
curl -X 'GET' \
  'https://{domain}/oapi/v1/codeup/repositories/2813489或者60de7a6852743a5162b5f957%2FDemoRepo/branches/demo-branch' \
