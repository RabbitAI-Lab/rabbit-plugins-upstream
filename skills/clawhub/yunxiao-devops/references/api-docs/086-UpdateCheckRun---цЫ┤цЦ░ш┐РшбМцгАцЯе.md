...
```
POST https://{domain}/oapi/v1/codeup/repositories/{repositoryId}/checkRuns/{checkRunId}
```
...
| name | string | body | 否 | check run 的名称，长度限制在50以内。 | check run name |
