...
`curl -X 'DELETE' \ 'https://test.rdc.aliyuncs.com/oapi/v1/projex/organizations/{organizationId}/projects/{projectId}/milestones/{id}' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484' \ --data ' { "operatorId": "操作者的useId，个人token时该参数无效" }'`
