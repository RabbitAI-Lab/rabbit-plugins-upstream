...
| --- | --- | --- | --- | --- | --- |
| appName | string | path | 是 |  | anyAppName |
| envName | string | path | 是 |  | anyEnvName |
| organizationId | string | path | 是 | 组织 ID。 | 99d1\*\*\*\*71d4 |

## **请求示例**

`curl -X 'DELETE' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/organization-id-xxx/apps/anyAppName/envs/anyEnvName' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
