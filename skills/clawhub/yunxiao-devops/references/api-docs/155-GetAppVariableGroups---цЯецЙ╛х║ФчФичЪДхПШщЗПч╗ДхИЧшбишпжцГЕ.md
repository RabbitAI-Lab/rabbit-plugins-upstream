# GetAppVariableGroups - 查找应用的变量组列表详情

通过OpenAPI查找应用的变量组列表详情。
...
`GET https://{domain}/oapi/v1/appstack/organizations/{organizationId}/apps/{appName}/variableGroups`
...
`curl -X 'GET' \ 'https://test.rdc.aliyuncs.com/oapi/v1/appstack/organizations/organization-id-xxx/apps/my-web-service/variableGroups' \ -H 'Content-Type: application/json' \ -H 'x-yunxiao-token: pt-0fh3****0fbG_35af****0484'`
