 ...
 *   - --get --raw prints the plaintext secret to stdout. There is NO confirmation
 *     gate: supplying --raw prints the secret directly. Treat --raw as
 *     credential-exposing and redirect to a protected file (e.g. > /tmp/k && chmod 600 /tmp/k).
 *
