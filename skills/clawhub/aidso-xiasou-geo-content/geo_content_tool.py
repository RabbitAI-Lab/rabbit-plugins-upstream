...
def main() -> None:
    ...
    generate_parser.add_argument("--ai-platform", required=True, help="目标优化平台，例如 豆包、Deepseek、腾讯元宝、文心一言、通义千问、KIMI、抖音AI、百度AI")
    ...
    if args.command == "generate":
        result = generate_content(args.brand, args.issue, args.ai_platform, args.confirmed, args.poll_interval, args.max_poll_times)
        print_json(result)
