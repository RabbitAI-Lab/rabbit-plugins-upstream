...
mbs excel-worksheet read --doc-id <DOC_ID> --worksheet-name Report --range A1:E20 --output table
mbs formula lineage --doc-id <DOC_ID> --worksheet-name Report --cell B2 --format tree --output yaml
```
