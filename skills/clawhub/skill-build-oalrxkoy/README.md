# @opc/skill-content-discover

MCP Skill: read OPC discover content from OPC 一人公司 tool station via personal API Key.
...
```bash
npx -y @opc/skill-content-discover
```
...
- `opc_list_discover` — 读取发现 / AI 羊毛列表
