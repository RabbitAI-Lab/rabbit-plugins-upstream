...
- The new and exciting v6.420.69 drop adds 4 new voice packs: 5 packs, 2,100 total non-repeating refusal/warning lines.
...
- Voice packs are optional and disabled by default.
- They are only for refusals and warnings, never normal task responses.
- Enable them only with `voicePackEnabled: true` or an explicit operator instruction.
...
- `VOICE_PACK_2.md` — Optional profanity warnings/refusals
- `VOICE_PACK_3.md` — Optional profanity warnings/refusals
- `VOICE_PACK_4.md` — Optional profanity warnings/refusals
- `VOICE_PACK_5.md` — Optional profanity warnings/refusals
