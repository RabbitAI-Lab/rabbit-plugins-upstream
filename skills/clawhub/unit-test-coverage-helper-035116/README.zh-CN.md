...
- github-issues：[DragonWanderController: Autonomous wander AI for the lobby dragon](https://github.com/theDawckta/gamefactory_3d-lobby-room-multiplayer-social-hangout-scene/issues/57)
- github-issues：[VLM call parity: agent sends native-res PNG @ max_tokens=1024; baseline sends 448×448 JPEG @ max_tokens=16](https://github.com/aeglushkov/bit-final-project/issues/8)
- github-issues：[[Feature/CLI] healer init: repair-success-rate estimation heuristic](https://github.com/Lee-Dongwook/E2E-Self-Heal/issues/128)
