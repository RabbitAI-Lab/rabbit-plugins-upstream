...
req = urllib.request.Request(GATEWAY + "/microsoft-excel/v1.0/me/drive")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-microsoft-excel-skill/1.2")
