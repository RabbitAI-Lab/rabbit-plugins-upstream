...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "高转化广告图，单一主张、明确视觉焦点、真实产品证据和行动号召区域，适合信息流投放", "keywords": "高转化广告图、信息流广告、广告KV、CTR、投放素材、促销图、Campaign视觉、A/B测试", "model": "public_model_nano_banana_pro", "name": "high-conversion-ad-image-generation-editing", "product_promise": "生成多个钩子与构图方向用于广告测图，保持商品事实准确并为渠道文字规范预留安全区", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "高转化广告图片生成与编辑", "trend_inspired": true}')
