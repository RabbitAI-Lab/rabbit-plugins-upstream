...
req = urllib.request.Request(GATEWAY + "/apify/v2/users/me")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-apify-skill/1.2")
