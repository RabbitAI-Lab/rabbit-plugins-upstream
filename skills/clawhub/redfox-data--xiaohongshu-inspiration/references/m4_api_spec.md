...
| source   | String | 是   | 数据来源（固定传"小红书冷门账号爆款文章-ClawHub"） |
...
```
GET https://redfox.hk.com/story/api/cozeSkill/getXhsCozeSkillDataLowFans?rankDate=2025-01-15&source=小红书冷门账号爆款文章-ClawHub&category=综合全部
```

### 示例2：查询时尚穿搭分类

```
GET https://redfox.hk.com/story/api/cozeSkill/getXhsCozeSkillDataLowFans?rankDate=2025-01-15&source=小红书冷门账号爆款文章-ClawHub&category=时尚穿搭
```

### 示例3：查询美味佳肴分类

```
GET https://redfox.hk.com/story/api/cozeSkill/getXhsCozeSkillDataLowFans?rankDate=2025-01-15&source=小红书冷门账号爆款文章-ClawHub&category=美味佳肴
```
