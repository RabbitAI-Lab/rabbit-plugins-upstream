...
| 能力档 | 角色 | 候选池（按优先级） | **本轮实际** | 余额 |
|--------|------|-------------------|-------------|------|
| 检索 | T1 / T2 / T3 | deepseek-v4-flash → glm-4-flash → qwen3-coder | （检查） | ✅/⚠️/❌ |
| 分析写作 | T4 / T5 | deepseek-v4-pro → minimax-m3 | （检查） | ✅/⚠️/❌ |
| 批判审计 | T6 / T7 / G14 | claude-opus-5 → minimax-m3 → deepseek-v4-pro | （检查） | ✅/⚠️/❌ |
| 主控 | T0 | deepseek-v4-pro → deepseek-v4-flash | （检查） | ✅/⚠️/❌ |
...
- **归档**：项目结束时由主控 T8 终检自动归档到 （检查 audits/methodology-footprint-{项目名}.md）
