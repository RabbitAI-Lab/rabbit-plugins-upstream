...
- **Phase 0 同意关卡**（v2.1.7 金标准）→ [`_shared/关键协议.md#phase-0同意关卡v217-金标准`](_shared/关键协议.md#phase-0同意关卡v217-金标准)
- **0 条空卡协议**（v2.1.8）→ [`_shared/关键协议.md#0-条空卡协议v218`](_shared/关键协议.md#0-条空卡协议v218)
- **三检索员并行独立运行**（v2.1.8 核心架构）→ [`_shared/关键协议.md#三检索员并行独立运行v218-核心架构`](_shared/关键协议.md#三检索员并行独立运行v218-核心架构)
- **修订回环 ≤2 轮降级**（v2.2.0，v2.3.1 定义细化，教训 #64 + #120）→ [`_shared/关键协议.md#修订回环-≤2-轮降级v220v231-定义细化教训-64--120`](_shared/关键协议.md#修订回环-≤2-轮降级v220v231-定义细化教训-64--120)
- **完成验证铁律**（v2.1.3，教训 #46）→ [`_shared/关键协议.md#完成验证铁律v213教训-46`](_shared/关键协议.md#完成验证铁律v213教训-46)
- **执行韧化协议**（v2.1.0）→ [`_shared/关键协议.md#执行韧化协议v210`](_shared/关键协议.md#执行韧化协议v210)
