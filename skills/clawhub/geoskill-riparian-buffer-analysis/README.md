# Riparian Buffer Analysis (geoskill-riparian-buffer-analysis)

> Extract river networks from a DEM, generate multi-level riparian buffer zones, summarize the LULC composition within the buffers, and assess buffer integrity.
...
python geoskill-riparian-buffer-analysis.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
