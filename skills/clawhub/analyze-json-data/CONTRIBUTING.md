# Contributing to `Analyze Json Data`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Analyze Json Data.git
cd Analyze Json Data
...
git add .
git commit -m "feat(analyze-json-data): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(analyze-json-data): add <brief description>
