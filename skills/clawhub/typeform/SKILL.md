...
req = urllib.request.Request(GATEWAY + "/typeform/me")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-typeform-skill/1.2")
