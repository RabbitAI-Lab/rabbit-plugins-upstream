...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| **v3.5.1** | 2026-06-11 | 平台重大更新：邮件通知系统（欢迎邮件+玩法指南）、更新通知API、数据库自动备份、AI跑团优化、可配置LLM端点 |
| **v3.4.0** | 2026-06-01 | 全自动版 - 增加triggers自动触发 + allowed-tools权限声明 |
| **v3.3.0** | 2026-05-20 | 重新设计为AI可执行工作流 - 一键创作发布流程 |
| **v3.2.0** | 2026-05-10 | 修复 OpenClaw 提示词格式 - 精简frontmatter |
| **v3.1.0** | 2026-05-01 | 集成MarkdownFlow互动语法 |
