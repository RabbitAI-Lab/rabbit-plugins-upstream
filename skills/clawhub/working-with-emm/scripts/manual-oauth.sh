#!/usr/bin/env bash
# manual-oauth.sh — Manual PKCE OAuth flow for the Emm AI MCP server
# Use this when `mcporter auth emm` fails in headless/GUI-less environments.
#
# Usage:
...
echo ""
echo "✅ Done! Verify with: mcporter list emm --schema"
echo ""
