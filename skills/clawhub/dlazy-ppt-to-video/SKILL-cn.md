---
name: dlazy-ppt-to-video
version: 1.0.2
description: "PPT 转视频、PowerPoint 转视频、幻灯片转视频、演示文稿转视频——解析、大纲、分镜、配音、合成、校验。当用户给一份 PPT / PowerPoint / Keynote、想要讲解视频 / 路演 / 课件 / 培训视频时使用。"
...
PPT 转视频、Word 转视频、Excel 转视频、PDF 转视频、文档转视频——解析、大纲、分镜、配音、合成、校验。当用户给一份文档、想要讲解视频 / 报告解读 / 课件 / 培训视频时使用。
...
此技能与 dlazy 沙箱 agent 对话，**已固定到 `file-to-video` 模板** —— 一个以项目为单位、可端到端运行该模板的助手，支持多轮对话。
...
> **智能体关键指令**:
>
> 1. 新任务运行 `dlazy chat --skill file-to-video --prompt "..."`。
