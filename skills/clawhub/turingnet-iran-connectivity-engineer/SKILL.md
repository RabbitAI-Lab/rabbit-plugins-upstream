...
license: MIT
description: Turing-inspired privacy-first IT troubleshooting with actual intake templates, evidence redactor redact_pii.py, low-bandwidth offline mode, 60-second triage script turingnet_triage.sh, timeline template, and integration sandbox-selfheal-guard for self-heal when snapshot wipes. Lawful, evidence-based, no bypass.
---
