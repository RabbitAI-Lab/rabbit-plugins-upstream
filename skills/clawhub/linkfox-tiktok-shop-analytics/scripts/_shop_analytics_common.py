"""Shared helpers for linkfox-tiktok-shop-analytics (ERP developerProxy, token backendized)."""
...
# ERP analytics skill path whitelist
ALLOWED_PATH_PREFIXES = ("analytics", "authorization")


def ensure_auth_skill_available(caller: str = "shop-analytics script") -> None:
