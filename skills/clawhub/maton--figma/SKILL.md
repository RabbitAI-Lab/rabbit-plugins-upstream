...
req = urllib.request.Request(GATEWAY + "/figma/v1/me")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-figma-skill/1.2")
