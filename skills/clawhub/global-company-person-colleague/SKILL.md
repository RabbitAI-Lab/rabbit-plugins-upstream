...
```bash
python scripts/error_report.py --params '{"requestPath":"/agent/search/depth_company/person/colleague/list","requestId":"f47ac10b58cc4372a5670e02b2c3d479","context":"Colleague list query failed with a server error"}'
```
