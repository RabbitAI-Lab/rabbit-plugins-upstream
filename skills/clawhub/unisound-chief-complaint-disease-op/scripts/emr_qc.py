...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="门诊病历内涵质控：主诉不应使用疾病和操作（chief-complaint-disease-op）。",
    )
    ...
    parser.add_argument("--output", default="", help="输出文件路径（默认：../runs/med-emr-qc/chief-complaint-disease-op.txt）。")
