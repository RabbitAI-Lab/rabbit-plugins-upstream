...
slug: ct-literature
name: ct-literature
displayName: 临床试验文献检索专家 (ct-literature)
cn_name: 临床试验文献检索专家
version: 1.0.0
invocable: true
...
license: MIT
description: "检索公开学术文献（OpenAlex 主源 + Europe PMC/MeSH 生物医学精准[默认开启] + bioRxiv/medRxiv 预印本 + arXiv 方法学广度），归一化合并去重，可产出 CSM 安全性定性子集，协助提供OA文献PDF下载。"
triggers:
