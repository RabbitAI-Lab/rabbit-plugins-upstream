#!/usr/bin/env bash
# agnes-image-2.1.sh - Generate/edit images via Agnes Image 2.1 Flash API
# Usage:
#   ./agnes-image-2.1.sh text "prompt" SIZE [OUTPUT_FILE]
#   ./agnes-image-2.1.sh img2img "prompt" SIZE IMAGE_URL [OUTPUT_FILE]
#   ./agnes-image-2.1.sh multi "prompt" SIZE IMAGE_URL1 IMAGE_URL2 [...] [OUTPUT_FILE]
#
# Environment: ANGES_API_KEY (required, shared with 2.0)
