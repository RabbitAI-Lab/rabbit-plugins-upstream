---
name: linkpix-youtube-viral-video
description: "YouTube 爆款带货视频生成。帮助品牌出海团队、知识博主、广告创意团队通过青虎AI完成“YouTube 爆款带货视频生成”：可调用可灵Kling 3.0、阿里Wanx 3.0、MiniMax H3、Seedance 2.0、Seedance 2.5、HappyHorse 1.1等大模型，生成高质量开箱测评、长视频解说、品牌TVC、深度种草等视频类型，完美适配YouTube高画质、长留存、强品牌信任度的平台特性。适用于YouTube Ads、品牌频道、联盟营销、独立站引流等长线营销场景。Use this skill for YouTube爆款视频, 开箱测评, 长视频解说, 品牌TVC, 深度种草, YouTube Ads, 独立站引流, 高画质, 长留存, 品牌信任, Seedance, Vidu Q2, 可灵Kling, AIGC视频生成。通过青虎AI统一接入，支持素材上传、任务轮询和结果下载。 当用户要求做YouTube 爆款视频生成或YouTube带货/种草/投放短视频时必须触发。关键词：LinkPix、qhkit、青虎、YouTube爆款视频、开箱测评、长视频解说、品牌TVC、深度种草、YouTube Ads、独立站引流、YouTube Shorts。"
user-invocable: true
...
YouTube 爆款带货视频生成。帮助品牌出海团队、知识博主、广告创意团队通过青虎AI完成“YouTube 爆款带货视频生成”：可调用可灵Kling 3.0、阿里Wanx 3.0、MiniMax H3、Seedance 2.0、Seedance 2.5、HappyHorse 1.1等大模型，生成高质量开箱测评、长视频解说、品牌TVC、深度种草等视频类型，完美适配YouTube高画质、长留存、强品牌信任度的平台特性。适用于YouTube Ads、品牌频道、联盟营销、独立站引流等长线营销场景。Use this skill for YouTube爆款视频, 开箱测评, 长视频解说, 品牌TVC, 深度种草, YouTube Ads, 独立站引流, 高画质, 长留存, 品牌信任, Seedance, Vidu Q2, 可灵Kling, AIGC视频生成。通过青虎AI统一接入，支持素材上传、任务轮询和结果下载。

平台向的电商视频总入口（第 1 批 `linkpix-ecom-video` 的拆分）：`qhkit video` 多模型成片 + `video-quick` 多图成片 + 需要分镜时 `storyboard`。默认画幅 **横屏 16:9**，默认语言 **英语**。模型优先从目录里找：可灵3.0 Omni、Seedance2.5、Seedance2.0、Happy Horse 1.1。

## 何时触发

- 「做YouTube爆款视频 / 带货视频 / 种草视频 / 投放视频」
- 用户没点名具体模型、但明确要发 YouTube
...
qhkit video generate '{"modelLabel":"Seedance2.0 15秒","prompt":"<按下方平台提示词改写>","uploadedImages":["./商品图.jpg"],"orientationLabel":"横屏 16:9","languageLabel":"英语"}'
qhkit video status   '{"videoTaskId":"task-123"}'
qhkit video estimate '{"modelLabel":"Seedance2.0 15秒","uploadedImages":["./商品图.jpg"]}'
# 多图一键成片
qhkit video-quick generate '{"prompt":"<平台向卖点>","duration":15,"creative":"1","orientation":"landscape","language":"en","uploadedImages":["./图1.jpg","./图2.jpg"]}'
# 先写分镜再成片
qhkit storyboard script '{"uploadedImages":["./商品图.jpg"],"productName":"保温杯","pointDescription":"316不锈钢·24h保温"}'
```

平台提示词：默认横屏 16:9、更长时长（能选 20/30 秒就优先）；开箱测评、品牌 TVC、深度种草要把材质和光影写准。Shorts 时再改回竖屏。qhkit 单段最长约 30 秒，更长内容分段生成后告知用户需自行拼接。

- 用户没点名模型时，把首选列表里当前在架的 2–3 个（含单价）列给用户选，不要替用户拍板。
- 参考视频 / 参考音频是否可传以当次 `models` 为准。
- `orientationLabel` 必须来自该模型的候选；目录没有 横屏 16:9 时改用最接近的竖/横屏并告诉用户。
