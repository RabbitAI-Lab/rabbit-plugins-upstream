---
name: class-diagram
description: Generates a Mermaid class diagram showing types, inheritance, and composition
version: 1.9.8
triggers:
  - visualizing class hierarchies or documenting a module public API
