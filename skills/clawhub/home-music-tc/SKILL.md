...
home-music off
home-music stop
home-music stop --fade   # Gradual fade-out over ~3 seconds
```
- Pauses Spotify
- Disconnects all speakers
- With `--fade`: gradually reduces volume before stopping
...
PLAYLIST_FOCUS="spotify:playlist:37i9dQZF1DWZeKC4gAKpQo"
```
