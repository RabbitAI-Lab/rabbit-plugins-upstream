"""CLI argument parsing tests for thematic-map-automation."""
import subprocess
import sys
import os
...
class TestCLIBasics:
    ...
    def test_bad_symbol_exit_2(self):
        r = run_cli(["--bbox", "116", "39", "117", "40", "--synthetic", "--symbol", "bad"])
        assert r.returncode == 2

    def test_input_file_not_found_exit_2(self):
        assert run_cli(["--input", "nope.geojson"]).returncode == 2
