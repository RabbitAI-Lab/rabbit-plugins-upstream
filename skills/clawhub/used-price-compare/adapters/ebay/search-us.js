...
{
  "name": "ebay/search-us",
  "description": "Search eBay US (nationwide) listings (new, used, refurbished items)",
  "domain": "www.ebay.com",
  "args": {
  ...
  "readOnly": true,
  "example": "bb-browser site ebay/search-us 'iPhone 15 Pro' --condition used --sort price"
}
*/
async function(args) {
  if (!args.query) return { error: 'Missing argument: query' };

  const SITE_HOST = 'www.ebay.com';
  const SITE_CURRENCY = '$';
  const SITE_REGION = 'US (nationwide)';
  const SITE_SOURCE = 'ebay.com';
