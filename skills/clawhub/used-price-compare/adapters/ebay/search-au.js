...
{
  "name": "ebay/search-au",
  "description": "Search eBay AU (nationwide) listings (new, used, refurbished items)",
  ...
  "readOnly": true,
  "example": "bb-browser site ebay/search-au 'iPhone 15 Pro' --condition used --sort price"
}
*/
async function(args) {
  if (!args.query) return { error: 'Missing argument: query' };

  const SITE_HOST = 'www.ebay.com.au';
  const SITE_CURRENCY = 'A$';
  const SITE_REGION = 'AU (nationwide)';
  const SITE_SOURCE = 'ebay.com.au';
