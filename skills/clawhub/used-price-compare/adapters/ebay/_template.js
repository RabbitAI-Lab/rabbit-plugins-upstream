/* @meta
{
  "name": "ebay/search-{{COUNTRY}}",
  "description": "Search eBay {{REGION}} listings (new, used, refurbished items)",
  "domain": "{{DOMAIN}}",
  "args": {
  ...
  "readOnly": true,
  "example": "bb-browser site ebay/search-{{COUNTRY}} 'iPhone 15 Pro' --condition used --sort price"
}
*/
async function(args) {
  if (!args.query) return { error: 'Missing argument: query' };

  const SITE_HOST = '{{DOMAIN}}';
  const SITE_CURRENCY = '{{CURRENCY}}';
  const SITE_REGION = '{{REGION}}';
