# @opc/skill-content-policies

MCP Skill: read OPC policies from OPC 一人公司 tool station via personal API Key.
...
```bash
npx -y @opc/skill-content-policies
```
