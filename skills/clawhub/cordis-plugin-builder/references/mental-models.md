...
> 操作流程见 [deployment-overview.md](deployment-overview.md) / [packaging.md](packaging.md)；本文件沉淀**如何理解**插件系统的
...
| | 代码形态（[plugin-forms.md](plugin-forms.md)） | 部署形态（[deployment-overview.md](deployment-overview.md)） |
|---|---|---|
...
七种部署流程（详见 [deployment-overview.md](deployment-overview.md)）背后一条认知：
