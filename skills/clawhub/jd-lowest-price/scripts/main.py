...
通过SCF代理查询京东历史最低价频道好货，仅筛选京东自营商品，
好评≥97%、销量≥500的品质精选。
"""
...
PROXY_URL = os.environ.get("PROXY_URL", "https://1439498936-fmw9ldxblp.ap-guangzhou.tencentscf.com")
TOOL_NAME = "get_lowest_picks"
CHANNEL_NAME = "历史最低价"
TIMEOUT_SHORT = 15
TIMEOUT_LONG = 90
...
TOOLS = {
    "get_lowest_picks": tool_get_lowest_picks,
}
