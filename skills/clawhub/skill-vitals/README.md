...
runtime bundle is deliberately limited to the English `SKILL.md`, Chinese
`references/guide.zh-CN.md`, `agents/openai.yaml`, `README.md`, `LICENSE`, and
the two runtime scripts; repository-only docs, tests, and reports are excluded.
