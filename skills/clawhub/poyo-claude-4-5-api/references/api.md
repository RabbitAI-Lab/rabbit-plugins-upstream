# PoYo Claude 4.5 Series Messages API Reference
...
- `claude-opus-4-5-20251101`: Claude Opus 4.5 on PoYo
- `claude-sonnet-4-5-20250929`: Claude Sonnet 4.5 on PoYo
- `claude-haiku-4-5-20251001`: Claude Haiku 4.5 on PoYo
