...
# API Configuration
TEMPLATE_ID = '113863332617788839'
API_BASE_URL = "https://api.browseract.com/v3/bots"
API_KEY_URL = 'https://www.browseract.com/reception/integrations?co-from=amazon-product-details-scraper'


def run_amazon_product_details_scraper_task(api_key, marketplace_url='https://www.amazon.com', asin='B085DTZQNZ'):
    """
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python amazon_product_details_scraper_api.py <marketplace_url> [asin]", flush=True)
        sys.exit(1)
    ...
    result = run_amazon_product_details_scraper_task(api_key, marketplace_url, asin)
    if result:
