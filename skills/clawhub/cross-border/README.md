...
客户端未选中时，在问题前加“使用 $cross-border-review-analysis”。
...
作为安装目录名。当前包的 name 是 cross-border-review-analysis，WorkBuddy 用户级目录为
~/.workbuddy/skills/cross-border-review-analysis/。版本压缩包的外层目录名不是固定 Skill 名。
更新已有同名安装时保留本地配置。
