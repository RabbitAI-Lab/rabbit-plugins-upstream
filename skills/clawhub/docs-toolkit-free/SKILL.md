...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：决策树导航的文档、专家系统、支持站点地图、全文索引与版本追、文档导航工具包、免费版等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
...
| 参数名 | 类型 | 必填 | 说明 |
|---|---|---|---|
| input | string | 是 | 文档导航工具包（免费版）处理的输入数据或指令 |
