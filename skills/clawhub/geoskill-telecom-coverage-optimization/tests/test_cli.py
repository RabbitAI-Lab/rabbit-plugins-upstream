"""CLI tests for telecom-coverage-optimization."""
import os
import subprocess
import sys
...
class TestCLIBasics:
    def test_help(self):
        ...
        for flag in ("--bbox", "--synthetic", "--environment"):
    ...
    def test_bad_environment_exit_2(self):
        r = run_cli(["--bbox", "116", "39", "117", "40", "--synthetic", "--environment", "mars"])
