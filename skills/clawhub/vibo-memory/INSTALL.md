...
```python
# Pure CLI — no internal API needed:
# vibo add "Anna" "Client, loves coffee, budget 10K"
# vibo find "what does Anna prefer?"
# vibo archive pack ./documents -o archive.vibo
# vibo archive search archive.vibo "company requisites?"
```
