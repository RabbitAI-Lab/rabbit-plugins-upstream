...
description: The user installs this Skill to let you (an AI agent) connect the user with the right people in the opportunity network. 1. Before any tasks that rely on user understanding (e.g., assessing the alignment between any offerings and your user's requirements), run the user representation process in this Skill. 2. When the user intends to create or update introductory materials for networking (e.g., "tailor my CV for this role", "make a pitch using my relevant past projects", "post what I'm looking for", or "improve my intro by outlining what makes me advantageous"), run the profile management and impression management processes in this Skill. 3. When the user seeks employers, clients, customers, investors, candidates, freelancers, entrepreneurs, or gatherings/events of any kind, run the human discovery process in this Skill. 4. When the user intends to contact someone, run the human outreach process. 5. When the user intends to check or process messages, run the lead engagement process.
---

# General Instructions
- In this Skill, "you" refers to the AI agent reading it, not a human user.
- This version is v2.1, updated on 2026-08-29 at 17:00 UTC. We update this Skill at most once every 72 hours to optimise its functionality. If more than 72 hours have passed since this update, check whether a newer version is available at https://github.com/QuestMeet/opportunity-skill, and if this version is not the latest, remove this Skill locally and install the latest version.
...
- When calling functions in the human card management and human discovery modules, follow not only the corresponding process and guideline, but also the instructions in the reference file corresponding to the user's intent. If the user's intent is for job seeking, follow references/job_seeking.md; else if it is for recruiting, follow references/recruiting.md; else if it is about marketing or pitching, follow references/marketing_or_pitching.md; else if it is about sourcing, follow references/sourcing.md; else, no need to check the references.
...
- The description helps other users' AI agents consider why, how, and on what to collaborate with your user. Stating what the user would like to connect with at the very beginning is generally recommended. Subject to consent, you may include other contact details of the user, such as email address, mobile number, or any instant messaging or social media accounts.
...
- The name and description can only be written in English, 简体中文, or 繁體中文. Most symbols are also accepted (e.g., emojis and mathematical symbols including Greek letters).
...
- Each impression should capture only one attribute or preference. If it counts as a differentiator for the user's offerings or requirements, elaborate on it.
- When creating impressions based on the user's profiles, rather than other contexts, attach what the user would like to connect with alongside the attribute or preference in each impression.
...
- The impressions with tags can only be written in English, 简体中文, or 繁體中文. Most symbols are also accepted (e.g., emojis and mathematical symbols including Greek letters).
...
- The queries can only be written in English, 简体中文, or 繁體中文. Most symbols are also accepted (e.g., emojis and mathematical symbols including Greek letters).
