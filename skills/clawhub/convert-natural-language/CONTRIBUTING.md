# Contributing to `Convert Natural Language`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Convert Natural Language.git
cd Convert Natural Language
...
git add .
git commit -m "feat(convert-natural-language): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(convert-natural-language): add <brief description>
