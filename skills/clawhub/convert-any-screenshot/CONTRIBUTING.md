# Contributing to `Convert Any Screenshot`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Convert Any Screenshot.git
cd Convert Any Screenshot
...
git add .
git commit -m "feat(convert-any-screenshot): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(convert-any-screenshot): add <brief description>
