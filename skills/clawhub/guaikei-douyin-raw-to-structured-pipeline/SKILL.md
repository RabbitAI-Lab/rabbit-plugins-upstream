---
name: guaikei-douyin-raw-to-structured-pipeline
description: 4 项能力 × 5 维筛选 × 1 个上限：抖音关键词搜索（排序/时间/时长/内容类型/条数）、博主作品批量抓取、视频评论获取、实时热榜查询，单次最多 10000 条。用户提抖音搜索/热榜/评论/博主/竞品/选题/舆情时触发，其他平台不适用。
license: MIT
metadata:
  enabled: true
  type: command
