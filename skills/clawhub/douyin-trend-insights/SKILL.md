---
name: "douyin-trend-insights"
description: "当用户需要做抖音趋势洞察、抖音趋势分析、热点观察、内容方向判断、趋势线索归纳或营销灵感整理时使用。面向内容运营、品牌调研和创作者。"
source_client: "socialdatax-skills"
source_platform: "clawhub"
source_skill: "douyin-trend-insights"
...
- 可选：`--source-client socialdatax-skills --source-platform clawhub --source-skill douyin-trend-insights`：这是当前 Agent Skill 的来源标记；按本 Skill 示例执行时保持这些值不变。
