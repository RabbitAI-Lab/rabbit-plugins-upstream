---
name: dlazy-product-video
version: 1.0.2
description: "product video, product demo video, product ad video, product showcase — turn a product's photos or link into a polished demo / ad video. Use when the user wants a product demo, showcase, or ad video."
...
This skill talks to the dlazy sandbox agent, **pinned to the `product-to-ecommerce-video` template** — a project-scoped assistant that runs the template end-to-end across multiple turns.
...
dlazy chat --skill product-to-ecommerce-video --prompt "..."
...
1. For a new task, run `dlazy chat --skill product-to-ecommerce-video --prompt "..."`.
