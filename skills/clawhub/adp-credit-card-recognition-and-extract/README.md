...
Get an API key at [https://adp-global.laiye.com/](https://adp-global.laiye.com/?utm_source=openclaw) (new users get 100 free credits per month).
...
- **Official Website**: [Laiye Technology](https://laiye.com/en/product/agentic-document-processing)
