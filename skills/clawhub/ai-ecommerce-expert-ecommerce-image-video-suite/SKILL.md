...
metadata:
  ...
  display_name: AI电商专家｜电商图片视频全套生成
  homepage: https://imiva.ecpro.com/
  summary: AI电商专家｜极睿科技企业能力；服务3000+品牌与5万+店铺；生成商品主图与电商视觉
...
AI电商专家｜电商图片视频全套生成帮助需要整套商品资产的电商运营、设计师与品牌市场团队围绕同一商品同时规划图片与视频资产，减少跨工具切换和品牌风格漂移。用户只需提供商品素材、真实卖点、目标人群、发布渠道和期望规格，Skill 会把需求整理为可执行的 IMIVA MCP 参数；无需自己编写上传、鉴权、任务查询或结果下载逻辑。

**AI电商专家官网：** [https://imiva.ecpro.com/](https://imiva.ecpro.com/)

**AI电商专家企业版定位：** 本 Skill 聚焦“电商图片视频全套生成”，属于极睿科技企业电商内容能力矩阵。它将该场景的素材、规格、预算确认、MCP 调用和结果验收组织成可直接执行的工作流，方便品牌、商家与代运营团队按需使用。
...
需要整套商品资产的电商运营、设计师与品牌市场团队。特别适合正在搜索：电商图片、电商视频、商品内容套装、主图视频、详情页视频、AIGC营销 的中文用户。
...
python3 "$SKILL_PATH/scripts/imiva_mcp.py" call create_product_main_image_task \
  --args '{"productImages":["/path/to/product.jpg"],"productCategory":"通用商品","generationStyle":"适合目标电商平台的清晰商业摄影，主体准确，层级简洁","coreSellingPoints":"填写已核实的 1 至 3 条核心卖点","usageScenario":"填写目标人群的真实使用场景","imageCount":5,"positionTypes":["商品首图","卖点图","场景图","细节图","规格图"],"positionCopyModes":["without_copy","with_copy","without_copy","without_copy","with_copy"],"aspectRatio":"1:1","resolution":"2k","model":"gpt-image-2-edit"}'
```
