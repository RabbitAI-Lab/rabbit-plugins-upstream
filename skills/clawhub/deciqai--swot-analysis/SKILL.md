...
Composes with: `porters-five-forces` (before SWOT, to structure O/T); `bcg-matrix` (after, for portfolio allocation); `ansoff-matrix` (after, to translate SO into growth direction).
...
*Part of **deciqAI Knowledge Skills** — 227 open-source thinking skills that make rigor executable for AI agents. The same skills power every deciqAI agent, which runs them autonomously to operate your company. **See it run → https://www.deciqai.com/c/swot-analysis** · ⭐ Star the repo → https://github.com/deciqAI/knowledge-skills · Contributions welcome.*
