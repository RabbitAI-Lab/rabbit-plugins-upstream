---
name: brainstorming
description: "changelog: Enhanced with ClawHub metadata and expanded process details"
metadata:
  openclaw:
    homepage: description: "You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation.
...
## 2. PURPOSE
changelog: Enhanced with ClawHub metadata and expanded process details
