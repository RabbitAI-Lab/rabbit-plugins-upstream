...
**具体触发词**：A股数据、市场数据、股票分析、板块分析、选股、市场复盘、基本面分析报告、个股分析报告、股票分析报告、写一篇股票分析、基本面研究报告、公司基本面、财务分析、财报分析、ROE分析、杜邦分析、个股舆情、公告解读、研报解读、消息面分析、个股主力资金、个股资金流向、个股资金动向   
...
| 用户需求关键词 | 匹配Skill | 说明 |
|--------------|-----------|------|
| 基本面分析报告、个股分析报告、股票分析报告、写一篇股票分析、基本面研究报告、公司基本面、个股基本面分析 | `xiapi-stock-report` | A股上市公司基本面分析报告生成器，输出财务质地、新闻情绪、行业地位、核心竞争力、ROE分析等八段结构化报告 |
...
| SQL选股、选股、股票筛选、技术筛选、量化筛选、自定义筛选、条件选股 | `xiapi-stock-sql-screener` | SQL条件选股（自定义多条件组合筛选） |
...
3. **优先匹配专业skill**：
   - 若出现"基本面分析报告/个股分析报告/股票分析报告/写一篇股票分析/基本面研究报告/公司基本面"等意图，优先路由到 `xiapi-stock-report`（综合性基本面分析报告，包含财务质地、新闻情绪、ROE分析等八段结构）
   - 若出现"财务分析/财报分析/ROE/杜邦/盈利质量"等意图，优先路由到 `xiapi-financial-roe-analysis`（财务深度分析子模块）
   - 若出现"舆情/公告/研报/消息面/利好利空/新闻催化"等意图，优先路由到 `xiapi-news-catalyst-analysis`（消息面分析子模块）
...
```
用户输入："帮我写一篇宁德时代的股票分析报告"
匹配结果：关键词包含"股票分析报告"、"写一篇" → 调用 `xiapi-stock-report`

用户输入："分析一下贵州茅台的基本面，输出一份完整的基本面研究报告"
匹配结果：关键词包含"基本面"、"基本面研究报告" → 调用 `xiapi-stock-report`
