...
version: 2.1.0
display_name: 数学教案设计
slug: xiaozhi-teach-math-lesson-planner
displayName: 数学教案设计
summary: '数学教师的备课工具：把一节数学课的概念建构路径、例题示范与变式训练排成可上的教案。'
license: MIT
---
