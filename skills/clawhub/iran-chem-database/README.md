...
**A complete, production-ready Linux application that automatically discovers,
mirrors (via HTTrack), and indexes every Iranian chemical supplier's website,
...
- Mitigations: polite-crawling defaults (robots.txt `--robots=2`, rate limits,
  ...
  to verify every supplier/molecule before relying on it.
...
- **SKILL.md SHA-256:** `86c5d7bca09874de72fc7eb71a8ddbb8da7deba6d3ad835136fb46576eddd8c8`
- **src/crawler/httrack_engine.py SHA-256:** `3082fa235a249c7591838370d6f4db10998bf623aa1d63be1605e693c1c78215`
- **src/parser/grade_classifier.py SHA-256:** `e5aef6f22f4aa1c1446f00ff4acfef15ec89a4350e0387078e293d3c4784d420`
