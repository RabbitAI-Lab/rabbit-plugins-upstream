...
| Seed baseline (v2.14) | `data/seed_export/`, `src/utils/seed_db.py`, `tools/seed_load.py` | shipped 408-molecule crawl export + O(1) name/CAS/InChIKey/CID index, "is it new?" diff, zero-network PubChem-cache preload, SQLite starting point for the live DB |
...
- **SKILL.md SHA-256:** `792d9cf4c55ba1ee31e8edf73e5d631280aed1d08614988c5694fd78596ef26f`
...
- **src/utils/seed_db.py SHA-256:** `3d235f0812fc363694603f9a58cfae220213acedbe109606cef13b08a79fef91`
- **tools/seed_load.py SHA-256:** `96da14dc5dcc2bad988211ac85817fe3e3f35edbffc2ea1e9b80d7b1333582a0`
...
- **data/seed_export/coverage_report.json SHA-256:** `274375e0aa662fc12bc3768964102db7693edd8a819bebc846dbc7be9a36ab3e`

Verify locally:

```bash
sha256sum SKILL.md src/crawler/httrack_engine.py src/parser/grade_classifier.py \
  requirements.txt src/utils/seed_db.py tools/seed_load.py \
  data/seed_export/iran_organic_molecules.csv data/seed_export/iran_inorganic_excluded.csv \
  data/seed_export/coverage_report.json
