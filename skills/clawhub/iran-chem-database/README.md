...
| Seed baseline (v2.14–v2.17) | `data/seed_export/`, `src/utils/seed_db.py`, `tools/seed_load.py` | 1,058-row deduped crawl baseline led by the **873-row MARKET-VERIFIED export** (v2.17: +224 molecules from a 29,841-post Telegram sweep; every row backed by a real crawled listing; unified evidence schema; 873 unique InChIKeys/CIDs, 840 with canonical SMILES, 844 confirmed-organic + 29 explicitly flagged inorganic) + O(1) name/CAS/InChIKey/CID index, name-variant tracking, "is it new?" diff, zero-network PubChem-cache preload, SQLite starting point with UNIQUE identity_key |
...
The package ships a real 408-molecule crawl export in `data/seed_export/`.
...
- **SKILL.md SHA-256:** `80a9b28b63901128b4a750619610491d410cfe0336ccbdc173c448b6d25759e9`
- **CHANGELOG.md SHA-256:** `da71e36c63cbdcb78c40c612a4601471522ceada7a5925d14cf2cd6de27e5480`
...
- **src/utils/seed_db.py SHA-256:** `114bace5c2f2e6f83b1d8c68500b35b8678c24692a5f8d06eaad040fc94a65bc`
- **tools/seed_load.py SHA-256:** `9bb843d508db285e84fe848fc459fc24745e7c2175c97d66f09100d852cbd4e3`
- **tools/export_verified.py SHA-256:** `7caa379a83eae90103f527454ca7c0060fa7edcc9db70a6ac583aadf951e3c07`
...
- **data/seed_export/coverage_report.json SHA-256:** `29108535b6c7cf2bb910aba583369220516b705d713cacca3509ade3f5a0d0d4`
