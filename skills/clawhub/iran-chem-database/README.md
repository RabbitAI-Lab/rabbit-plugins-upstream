...
| Seed baseline (v2.14–v2.19) | `data/seed_export/`, `src/utils/seed_db.py`, `tools/seed_load.py` | **1041 CID-unique confirmed-organic PRIMARY** (`iran_organic_molecules_catalogue_verified_2026-08-25.csv`, v2.19) plus retained historical files (873-row market-verified, parallel-AI, expanded, legacy) + inorganic exclusions + O(1) name/CAS/InChIKey/CID index, name-variant tracking, "is it new?" diff, zero-network PubChem-cache preload, SQLite starting point with UNIQUE identity_key |
...
The package ships a 1041-molecule CID-unique confirmed-organic crawl export in `data/seed_export/` (plus historical seed files).
...
- **SKILL.md SHA-256:** `705b3fec65d25d6cc4808fa9cb573209cb0034f48568deeb3aec26bfd3bd0cfe`
...
- **src/utils/seed_db.py SHA-256:** `2cefc3279ca8b6e52b76f35c3767ed82faf186566fdfcfb218a84b5f5d4b21dd`
- **tools/seed_load.py SHA-256:** `abd0eb8b26432baf77aca412eb5958872de8f9dffdd1516609eb3eaaccd18322`
...
- **data/seed_export/coverage_report.json SHA-256:** `070135a19c8ee384f6fd79cd4c6c98c7455a33ba716ca4f25eb1dfbd700d5c60`
