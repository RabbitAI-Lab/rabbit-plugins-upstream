...
# Current baseline (2026-08-24): full parallel-AI run — 1068 organic
# molecules (8-provider parallel normalization, PubChem-verified,
# CID-deduped) over ~79k mirrored posts + the market-verified seed, plus the
# 96 inorganic rows excluded at the organic gate. Highest priority in
# load_seed_rows(); the older baseline files remain for audit/history.
...
def load_seed_rows() -> List[dict]:
    ...
    """
    sources = (
        (CURRENT_BASELINE_CSV, "iran_organic_molecules_parallel_ai_2026-08-24.csv"),
