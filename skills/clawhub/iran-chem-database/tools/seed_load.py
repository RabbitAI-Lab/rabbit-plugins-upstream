#!/usr/bin/env python3
"""Seed-baseline CLI for iran-chem-database (v2.17.0).
...
The baseline lives in data/seed_export/ (873 market-verified rows, crawled
2026-08-24). It is a STARTING POINT for faster discovery and for seeding
...
def main(argv):
    ...
    if cmd == "status":
        ...
        if cur_man:
            print(f"  CURRENT (2026-08-24 parallel-AI, PRIMARY): "
