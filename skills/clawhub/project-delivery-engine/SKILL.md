...
**项目交付神器！适用于任何需要持续推进的项目。**

当你让 AI 连续工作几天、几周甚至几个月时，它很容易忘记做过什么、做到哪里，文件数量和体量也会不断增长，越来越多、越来越乱。项目交付引擎让 AI 长期稳定推进项目：进度不断档、过程不失忆、文件资料不混乱。

- **很轻**：日常生效入口只需约 2,000 Token（词元），其他规则按需读取。
