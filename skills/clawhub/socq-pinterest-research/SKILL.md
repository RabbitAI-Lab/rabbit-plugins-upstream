---
name: socq-pinterest-research
description: Research public Pinterest content, accounts, keywords, and performance data with SocQ. Use when an agent needs Pinterest-specific discovery, collection, endpoint selection, credit estimates, asynchronous task execution, pagination, or raw exports through the SocQ CLI, MCP, or REST API.
metadata:
  openclaw:
...
# SocQ Pinterest Research

## SocQ Links

- Website: <https://socq.ai/>
- Platform page: <https://socq.ai/apis/pinterest>
- API documentation: <https://docs.socq.ai/api-manual/pinterest>
...
Use this Skill to select and run SocQ endpoints for public Pinterest research. SocQ requests are asynchronous and credit-metered.

## Use When

- The user asks to discover, collect, compare, or analyze public Pinterest data.
- The workflow needs Pinterest-specific endpoint selection, input validation, pagination, or raw exports.
...
1. Prefer an already configured SocQ MCP server at `https://api.socq.ai/mcp?platforms=pinterest`; use the typed tool listed in [platform.md](references/platform.md), or compact `socq_execute` when needed.
