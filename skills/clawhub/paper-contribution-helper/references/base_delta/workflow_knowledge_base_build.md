...
- `.delta-contribution-reframer/references/anonymous_casebook.json`
...
8. Confirm `.delta-contribution-reframer/references/anonymous_casebook.json` and `.delta-contribution-reframer/references/per_pdf_report_synthesis.md` are non-empty.
