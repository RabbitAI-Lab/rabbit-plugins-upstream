...
- `.delta-contribution-reframer/references/anonymous_casebook.json`: project-local anonymous reusable cases.
- `.delta-contribution-reframer/references/per_pdf_report_synthesis.md`: project-local reusable synthesis.

## Path Portability

State files must not create runtime dependencies on machine-specific absolute paths. Prefer project-relative resource paths such as `references/anonymous_casebook.json` inside `.delta-contribution-reframer/`.
