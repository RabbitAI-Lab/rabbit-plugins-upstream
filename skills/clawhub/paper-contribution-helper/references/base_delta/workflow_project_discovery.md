...
- reusable anonymous project-local resources after initialization: `.delta-contribution-reframer/references/anonymous_casebook.json`, `.delta-contribution-reframer/references/per_pdf_report_synthesis.md`, and `.delta-contribution-reframer/references/domain_profile_*.md`.
