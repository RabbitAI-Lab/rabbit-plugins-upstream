...
- `anonymous_casebook.json`, `per_pdf_report_synthesis.md`, and `llm_deep_read_synthesis.md` are non-empty for initialized real-corpus packages.
...
- Generated ClawHub packages use MIT-0 via `LICENSE.md` and do not include platform-specific `agents/openai.yaml` metadata.
