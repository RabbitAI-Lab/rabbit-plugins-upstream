...
4. Load `references/anonymous_casebook.json` and `references/per_pdf_report_synthesis.md` only as anonymous analogy resources. Do not use them as evidence about the target paper.
