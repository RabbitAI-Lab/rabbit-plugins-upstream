...
def main() -> None:
    ...
    resources = []
    for rel in ["references/anonymous_casebook.json", "references/per_pdf_report_synthesis.md", "references/llm_deep_read_synthesis.md"]:
        path = skill_dir / rel
        resources.append(
            {
                "path": rel,
    ...
    report = {
        ...
        "evolution_overlay": str(overlay / "evolution" / "evolving_casebook.json"),
    }
