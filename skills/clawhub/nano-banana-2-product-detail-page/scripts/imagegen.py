...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Nano Banana 2 制作高完成度商品详情页，主体准确，构图清晰", "keywords": "Nano Banana 2、NanoBanana2、Nano Banana、香蕉2、Gemini 图片、商品详情页、电商详情页、详情页视觉、卖点图、产品长图、商品介绍图、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "nano-banana-2-product-detail-page", "rule": "optional", "search": "固定调用 Nano Banana 2 的商品详情页裸接口能力", "title": "Nano Banana 2 商品详情页"}')
