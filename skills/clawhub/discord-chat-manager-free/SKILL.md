...
description: "基础 Discord 聊天管理工具,支持消息发送、回复、搜索与读取,适合个人日常使用。"
license: Proprietary
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：Discord、聊天管理工具、支持消息发送、搜索与读取、适合个人日常使用、面向个人用户的、频道聊天管理工具、核心能力、向频道发送消息并、支持回复指定消息、与按关键词搜索历、对消息添加表情反、应与基础编辑删除、查询频道列表与频、道基础信息等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
