...
🔥 官方原生 · SocialEpoch WhatsApp SCRM · 企业级SCRM自动化解决方案
...
# 📡 第三步：自动消息接收服务管理（新增核心能力）
内置双模式客户端管控，兼顾日常稳定与异常修复，全程安全无高危操作：
- 轻量保活：仅拉起接收服务，不重复下载、不强制关闭进程，适合日常消息收发
- 强制重置：优雅停止旧客户端、覆盖升级程序、修复网关配置，适合异常恢复/版本更新
- 状态检测：快速查看本地接收客户端安装运行状态
