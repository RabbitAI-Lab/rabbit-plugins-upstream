...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: BANK_DRAFT,BANK_ACCEPTANCE_BILL,ELECTRONIC_BANK_ACCEPTANCE_BILL,COMMERCIAL_ACCEPTANCE_BILL,ELECTRONIC_COMMERCIAL_ACCEPTANCE,BANK_CHECK,BANK_RECEIPT,DEPOSIT_SLIP,TELEGRAPHIC_TRANSFER_VOUCHER,WITHDRAWAL_VOUCHER,MOBILE_PAYMENT_BILL,FISCAL_AUTH_PAYMENT_VOUCHER,CUSTOMS_PAYMENT_RECEIPT,CUSTOMS_DECLARATION,INTERNATIONAL_BILL,COMMERCIAL_INVOICE,CERTIFICATE_OF_ORIGIN,CARGO_TRANSPORT_INSURANCE,PACKING_LIST,BILL_OF_LADING")
        sys.exit(1)
