...
- **`--force` never bypasses security checks:** it only forces a fresh payment instead of reusing a cached token — budget and allowlist checks always apply
