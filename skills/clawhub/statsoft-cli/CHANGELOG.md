...
- **YAML frontmatter 双语字段保持中文在前、英文在后**（displayName / description 已合规，未变）
- **正文全部翻转为英文在前、中文在后**（标题、段落、表格、列表项），与 v2.6.20「中文在前」相反——按用户 2026-07-19 新规则执行
- **尽量同行 ` / ` 分隔**：标题与短内容由两行（中/英各一行）合并为单行 `英文 / 中文`，减少分行
- 正文长度 108 行（≤200）
