---
name: meta-value-alignment
version: 1.0.0
description: |
  由 model-distillation 从教师技能 value-alignment 蒸馏并增强的超越型元技能，
...
> 由 `model-distillation` 从教师技能 **value-alignment** 蒸馏并增强生成。
> 生成时间：2026-07-23 03:56:08 ｜ 蒸馏机制：跨模型蒸馏（见 meta-evolver 北极星策略）
