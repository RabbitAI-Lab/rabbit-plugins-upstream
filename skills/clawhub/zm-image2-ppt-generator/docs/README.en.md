...
```
Please install zm-image2-ppt-generator-skills for me:
...
The script installs the skill to `~/.claude/skills/zm-image2-ppt-generator-skills/`; Claude Code picks it up after restart.
...
> Use **zm-image2-ppt-generator** to make a 5-slide deck about **[your topic]**, style = `dark-aurora`.
