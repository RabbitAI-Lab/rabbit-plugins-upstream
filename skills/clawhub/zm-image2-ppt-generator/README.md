...
# zm-image2-ppt-generator-skills
...
[![GitHub stars](https://img.shields.io/github/stars/JuneYaooo/zm-image2-ppt-generator-skills?style=flat)](https://github.com/JuneYaooo/zm-image2-ppt-generator-skills/stargazers)
...
```
帮我安装 zm-image2-ppt-generator-skills：
https://raw.githubusercontent.com/JuneYaooo/zm-image2-ppt-generator-skills/main/docs/install.md
```
...
```bash
git clone git@github.com:JuneYaooo/zm-image2-ppt-generator-skills.git
cd zm-image2-ppt-generator-skills
...
- Claude Code: `~/.claude/skills/zm-image2-ppt-generator-skills/`
- Codex: `~/.codex/skills/zm-image2-ppt-generator-skills/`

如果你走 API 直连模式，再填一个 key 就能用：

```bash
# Claude Code:
# ~/.claude/skills/zm-image2-ppt-generator-skills/.env
#
# Codex:
# ~/.codex/skills/zm-image2-ppt-generator-skills/.env
...
> 帮我用 **zm-image2-ppt-generator** 生成一份关于 **[你的主题]** 的 5 页 PPT，风格用 `dark-aurora`。
...
[![Star History Chart](https://api.star-history.com/svg?repos=JuneYaooo/zm-image2-ppt-generator-skills&type=Date)](https://star-history.com/#JuneYaooo/zm-image2-ppt-generator-skills&Date)
