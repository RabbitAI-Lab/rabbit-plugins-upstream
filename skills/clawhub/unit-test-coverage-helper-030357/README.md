...
- github-issues: [sw-loop.sh Monolith Decomposition into Focused Modules](https://github.com/sethdford/shipwright/issues/779)
- github-issues: [Reconcile CRM schema documentation with canonical migrations 015 and 016](https://github.com/saberistic-team/agent-web/issues/277)
- github-issues: [docs: resync 4 stale fr/es quickstart translations + re-baseline i18n-lag (MNE-2290)](https://github.com/mnemom/docs/issues/409)
- github-issues: [[CI Monitor] Daily Report - 2026-07-22](https://github.com/bingxche/sglang-ci-bot/issues/143)
- github-issues: [Misc. bug: Flaky Vulkan unit test results on some Intel Battlemage Linux systems](https://github.com/ggml-org/llama.cpp/issues/25767)
