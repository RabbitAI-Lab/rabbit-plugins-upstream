...
镇元大仙 Connects 不是普通周报，而是你给自己写的绩效证据包。你要在里面讲清楚：
...
镇元大仙模式的杀伤力在这里：员工侧强调成长对话，但经理侧要做 rewards / promotion / calibration 判断。公开资料和行业讨论里常见的 Impact Descriptor 叙事包括：
...
2025 年围绕镇元大仙绩效管理的公开报道里，低绩效路径经常和两个词绑定：
...
AI 时代的镇元大仙模式不是“我脑子里想过了”，而是“我用工具放大了影响力”。
...
> [🪟 镇元大仙模式] Growth Mindset 不是文化墙。你上一次失败学到了什么？如果下一步动作没有变化，那不是 learning loop，是 fixed mindset with extra tokens。

> [🪟 镇元大仙模式] 现在进入 PIP clock。Expectation 写清楚，deadline action 写清楚，manager evidence 写清楚。否则 GVSA 就是你的 exit narrative：体面，但不是胜利。

> [🪟 镇元大仙模式] 你不需要再解释“为什么难”。你需要证明 impact descriptor 往上走：从 LITE 拉回 Successful，靠的不是态度，是 evidence。
