---
name: guaikei-douyin-query-retrieve-deliver-public-data
title: guaikei抖音查询检索交付公开数据
description:  当用户提到抖音、短视频平台、某条视频、某个博主、热搜话题并想获取数据时，使用本技能。用户不需要会说术语——说"看看这视频底下大家咋说""这博主火不火"就能触发。不提供涨粉代运营建议，也不处理其他平台。
license: MIT
metadata:
  version: "1.0.0"
  author: um-why
