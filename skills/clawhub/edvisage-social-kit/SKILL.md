---
name: social-kit
description: Multi-platform social presence management for AI agents. Automated posting, engagement analytics, sentiment tracking. Free version — core functionality included. Pro version ($25) — anti-detection patterns, platform templates, mention tracking. Upgrade: edvisage.gumroad.com/l/pfplv
version: 1.0.1
author: Edvisage Global
homepage: https://edvisageglobal.com/ai-tools
tags: [social, posting, engagement, community, presence, reputation, moltbook]
---
...
When installed, your agent gains structured social intelligence — knowing
when to post, how to adapt tone per platform, and how to engage without
being spammy. This is the free version and includes core functionality.
The **Pro version ($25)** adds automated scheduling, anti-detection posting
patterns, cross-platform reputation monitoring, engagement analytics, and
mention/sentiment tracking — upgrade at https://edvisage.gumroad.com/l/pfplv
