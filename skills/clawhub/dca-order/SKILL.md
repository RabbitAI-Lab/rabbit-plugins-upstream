---
name: dca-order
description: DCA orders for crypto. Split buys over time, gasless, oracle-protected, 8 EVM chains. 
---

# Spot Advanced Swap Orders

Dollar cost average into any token with gasless DCA orders — split buys over time across 8 EVM chains, powered by decentralized TWAP execution.
