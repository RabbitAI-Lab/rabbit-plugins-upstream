---
name: voice-generate
description: Generates text in a learned writing voice
version: 1.9.8
triggers:
  - voice
  - generation
  ...
  - writing
  - registers
  - drafting content that must match a specific author's style profile extracted by voice-extract
metadata: {"openclaw": {"homepage": "https://github.com/athola/claude-night-market/tree/master/plugins/scribe", "emoji": "\u270d\ufe0f", "requires": {"config": ["night-market.scribe:voice-extract", "night-market.scribe:slop-detector"]}}}
