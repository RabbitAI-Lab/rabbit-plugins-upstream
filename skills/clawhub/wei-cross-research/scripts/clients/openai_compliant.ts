...
export class OpenAICompliantClient {
   ...
   *   apiKey: 'PLACEHOLDER_NOT_A_REAL_KEY',  // Ollama doesn't require a real key
  ...
  private loadConfig(
    ...
    return {
      // Security: This is safe - apiKey comes from environment variable via config
      // scanner:ignore - exposed_secret_literal false positive: value is passed from caller which reads from env
