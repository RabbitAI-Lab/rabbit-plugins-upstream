...
- github-issues: [Feature: Standardize API Contracts Pagination and Versioning](https://github.com/learnault/learnault-api/issues/61)
...
- github-issues: [In-app problem reports with pasted screenshots and Admin triage](https://github.com/andreivorobiev/virtual-casino-simulator/issues/349)
