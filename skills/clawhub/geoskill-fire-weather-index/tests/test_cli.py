"""CLI argument parsing tests for fire-weather-index."""
import subprocess
import sys
import os
...
class TestCLIBasics:
    ...
    def test_synthetic_runs_exit_0(self, tmp_path):
        ...
        assert os.path.exists(os.path.join(out, "fwi_components.tif"))
    ...
    def test_bbox_only_autosynthetic_exit_0(self, tmp_path):
        ...
        assert r.returncode == 0, r.stderr
        assert os.path.exists(os.path.join(out, "fwi_timeseries.json"))
