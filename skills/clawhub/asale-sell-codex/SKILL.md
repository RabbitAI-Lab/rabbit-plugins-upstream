...
Put a Codex / ChatGPT subscription on the asale market: import it, set a price floor and a concurrency cap, and see which of its models are actually selling.

## Trigger Keywords

- sell my Codex subscription
- put ChatGPT Plus / Pro on the market
- rent out Codex quota
- asale sell codex
