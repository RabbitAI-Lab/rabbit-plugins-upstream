...
```bash
python3 skills/pptx-master/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p "skills/pptx-master/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `skills/pptx-master/templates/layouts/`; project templates go to `projects/<project>/templates/`
>
...
```bash
ls -la "skills/pptx-master/templates/layouts/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 skills/pptx-master/scripts/svg_quality_checker.py "skills/pptx-master/templates/layouts/<template_id>" --format <canvas_format>
```
...
Update `skills/pptx-master/templates/layouts/layouts_index.json`:
...
**Template Path**: `skills/pptx-master/templates/layouts/<template_id>/`
**Category**: <category>
