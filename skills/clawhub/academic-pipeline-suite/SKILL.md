...
这是一个元技能包，用于一键安装完整的 Academic Pipeline 生态系统。**所有 9 个依赖技能已打包在内**，安装时无需联网下载，100% 离线可用。
...
| # | 技能 | 用途 |
|---|------|------|
| 1 | `academic-pipeline` | 12 阶段全流程编排器 |
| 2 | `academic-search` | 8 大平台文献检索 |
| 3 | `deep-research` | 深度研究分析 |
| 4 | `academic-paper` | 论文撰写/修订 |
| 5 | `academic-paper-reviewer` | 同行评审 |
| 6 | `humanizer` | 英文去 AI 化 |
| 7 | `humanizer-zh` | 中文去 AI 化 |
| 8 | `ima-skills` | IMA 知识库 |
