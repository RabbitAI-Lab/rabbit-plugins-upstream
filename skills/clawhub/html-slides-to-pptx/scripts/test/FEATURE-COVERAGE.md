...
> 3. 样张页(96-107、110-117)同时受 `test/exemplar-checks.js` 设计门禁(0 ERROR/0 WARN)。
...
> 页面角色:fidelity 锚(01-21 精简页/游离页/特性页)= 转换保真;exemplar 样张(96-107、110-117)= 保真+设计纪律双锚。
...
- L1/L3:36 页 + 8 样张(110-117)+ 模板 3(extraPages)= **47**
- L2 playlist:32 页 + 8 样张 = **40**(10 精简 deck + 4 游离 + 6 特性 + 20 样张)
- 退役:06/16/18(重复)+ 04/07/10/13/14/17/19/20(精简)= 11 页
- **2026-08-05 瘦身(golden.js)**:L2 notesSlide 合并为单项锚定(40 文件 → 1 项,差异时明细列文件);L3 仅含 capture 基元页截图(19 页;28 纯原生页由 L1 完全锚定免截图);孤儿 PNG(退役 11 页)已清。比对项 174 → **107**(L1 47 + L2 41 + L3 19),磁盘 6.4MB → 2.7MB,保护范围不减
