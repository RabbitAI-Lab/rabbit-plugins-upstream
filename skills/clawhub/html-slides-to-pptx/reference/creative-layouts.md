# 创意布局手册(creative-layouts · P2 新特性组合技巧)

> 本手册是 `layout-recipes.md` 的进阶补充:聚焦 **P0/P1/P2 新特性如何组合出专业且有创意的版式**。
> `layout-recipes.md` 覆盖基础骨架(三卡片横排/左右分栏/统计数字带/纵向堆叠);
> 本手册覆盖 **渐变/预设几何/上下标/原生图表表格/旋转/虚线/阴影** 等特性的创意组合。
>
> **使用时机**:访谈 Q5 大纲确认时,按页类型从本手册选模式;写每页时对照代码模板复用。
> **配套**:`html-spec.md`(契约)、`layout-recipes.md`(基础配方)、`density-tiers.md`(密度上限)。
...
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:0;top:0;width:1920px;height:440px;
            background:linear-gradient(135deg,#0A2E5C 0%,#2D9CDB 100%);
...
<div data-object="true" data-object-type="textbox"
     style="position:absolute;left:100px;top:140px;width:1400px;height:140px;
            font-size:64px;font-weight:800;color:#FFFFFF;line-height:1.2;">
...
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:100px;top:300px;width:120px;height:6px;
            background:linear-gradient(to right,#F39800,#FF6B6B);border-radius:3px;"></div>
```
...
<div data-object="true" data-object-type="shape" data-shape="chevron"
     style="position:absolute;left:100px;top:400px;width:260px;height:80px;background:#0A2E5C;"></div>
<div data-object="true" data-object-type="shape" data-shape="chevron"
     style="position:absolute;left:340px;top:400px;width:260px;height:80px;background:#2D9CDB;"></div>
<div data-object="true" data-object-type="shape" data-shape="chevron"
     style="position:absolute;left:580px;top:400px;width:260px;height:80px;background:#27AE60;"></div>
...
<div data-object="true" data-object-type="shape" data-shape="flowchartDecision"
     style="position:absolute;left:900px;top:380px;width:180px;height:120px;
            background:#FFF;border:2px solid #F39800;"></div>

<!-- 向下箭头(连接器) -->
<div data-object="true" data-object-type="shape" data-shape="downArrow"
     style="position:absolute;left:970px;top:520px;width:40px;height:60px;background:#F39800;"></div>

<!-- 旋转的分支标签(transform:rotate) -->
<div data-object="true" data-object-type="textbox"
     style="position:absolute;left:820px;top:560px;width:160px;height:40px;
            font-size:18px;font-weight:600;color:#F39800;text-align:center;
...
<div style="position:absolute;left:100px;top:200px;width:1720px;display:flex;gap:24px;">
  <div data-object="true" data-object-type="shape"
       style="flex:1;height:200px;background:linear-gradient(135deg,#0A2E5C,#1A4A7A);
              border-radius:12px;padding:28px;">
    <div style="font-size:14px;letter-spacing:4px;color:rgba(255,255,255,0.6);font-weight:600;">ACCURACY</div>
    <div style="font-size:56px;font-weight:800;color:#FFF;line-height:1;margin-top:12px;">
      94.2<sup style="font-size:24px;">%</sup>
    </div>
    <div style="font-size:16px;color:#6BCB77;margin-top:8px;letter-spacing:1px;">↑ 12% vs Q3</div>
  </div>
  <!-- 更多 KPI 卡(同结构,换渐变色) -->
</div>
...
<div data-object="true" data-chart='{"type":"bar","labels":["Q1","Q2","Q3","Q4"],"series":[{"name":"营收","values":[120,180,240,310]}]}'
     style="position:absolute;left:100px;top:440px;width:840px;height:320px;border:1px solid #E5E7EB;border-radius:12px;padding:20px;"></div>

<!-- 原生表格 -->
<div data-object="true" data-object-type="table" style="position:absolute;left:980px;top:440px;width:840px;">
  <table style="width:100%;border-collapse:collapse;font-size:16px;">
    <tr style="background:#0A2E5C;color:#FFF;">
    ...
    <tr style="border-bottom:1px solid #E5E7EB;">
      ...
      <td style="padding:12px;text-align:center;color:#27AE60;">+29%</td>
    </tr>
  </table>
</div>
```
...
<div data-object="true" data-object-type="textbox"
  ...
  产品发布<br><span style="font-size:14px;color:#999;">首个 AI 工作流</span>
</div>
```
...
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:0;top:0;width:1920px;height:8px;
            background:linear-gradient(to right,#0A2E5C,#2D9CDB,#64D2FF);"></div>
...
<div data-layout="grid" data-layout-cols="3" data-layout-gap="24"
  ...
  <div data-object="true" data-layout-h="300"
    ...
    <div style="font-size:14px;letter-spacing:6px;color:#2D9CDB;font-weight:700;">01</div>
    <div data-shape-ignore style="font-size:24px;font-weight:700;margin-top:16px;color:#0A2E5C;">智能分析</div>
    <div style="font-size:16px;color:#666;margin-top:12px;line-height:1.55;">自动识别数据模式,生成洞察建议</div>
    <div style="margin-top:20px;padding-top:16px;border-top:1px solid #F0F0F0;font-size:14px;color:#2D9CDB;">
...
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:100px;top:400px;width:6px;height:180px;
            background:linear-gradient(to bottom,#F39800,#FF6B6B);border-radius:3px;"></div>

<!-- 引用文字(斜体 + run 级强调 + 超链接) -->
<div data-object="true" data-object-type="textbox"
     style="position:absolute;left:130px;top:400px;width:1500px;height:180px;
            font-size:30px;font-style:italic;color:#333;line-height:1.6;">
  "AI 不是替代人类,而是<i>放大</i>人类的创造力。"
  <br><span style="font-size:18px;font-style:normal;color:#999;letter-spacing:1px;">
    — 参阅 <a href="https://example.com/report" style="color:#2D9CDB;">完整报告</a>
  </span>
</div>
```
...
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:100px;top:300px;width:540px;height:360px;
            background:#FFF;border-top:8px solid #27AE60;border-radius:8px;
            box-shadow:0 4px 16px rgba(0,0,0,0.08);">
</div>
<!-- 左卡内容:五角星评分 + 优势列表 -->
<div data-object="true" data-object-type="shape" data-shape="star5"
     style="position:absolute;left:130px;top:340px;width:32px;height:32px;background:#F39800;"></div>
<div data-object="true" data-object-type="textbox"
     style="position:absolute;left:180px;top:335px;width:200px;height:40px;
            font-size:22px;font-weight:700;color:#27AE60;line-height:40px;">方案 A</div>
<div data-object="true" data-object-type="textbox"
...
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:680px;top:300px;width:540px;height:360px;
            background:#FFF;border-top:8px solid #EB5757;border-radius:8px;
            box-shadow:0 4px 16px rgba(0,0,0,0.08);">
</div>
<!-- 右卡内容:闪电图标 + 劣势列表 -->
<div data-object="true" data-object-type="shape" data-shape="lightningBolt"
     style="position:absolute;left:710px;top:340px;width:28px;height:36px;background:#EB5757;"></div>
<div data-object="true" data-object-type="textbox"
     style="position:absolute;left:760px;top:335px;width:200px;height:40px;
            font-size:22px;font-weight:700;color:#EB5757;line-height:40px;">方案 B</div>
```
...
<!-- 窗口圆点装饰(三个小圆) -->
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:140px;top:330px;width:16px;height:16px;border-radius:50%;background:#FF6B6B;"></div>
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:168px;top:330px;width:16px;height:16px;border-radius:50%;background:#FFD93D;"></div>
<div data-object="true" data-object-type="shape"
     style="position:absolute;left:196px;top:330px;width:16px;height:16px;border-radius:50%;background:#6BCB77;"></div>

<!-- 代码内容(pre 保留空白;code 内联;不同语法元素用 span 变色) -->
<div data-object="true" data-object-type="textbox"
     style="position:absolute;left:140px;top:380px;width:1640px;height:320px;">
  <pre style="font-family:'Courier New',monospace;font-size:20px;color:#A8E6CF;line-height:1.6;white-space:pre;margin:0;"><code><span style="color:#64D2FF;">const</span> ai = <span style="color:#64D2FF;">new</span> Workflow({
  model: <span style="color:#FFD93D;">"gpt-4"</span>,
  tools: [<span style="color:#FFD93D;">"search"</span>, <span style="color:#FFD93D;">"code"</span>, <span style="color:#FFD93D;">"analyze"</span>],
  <span style="color:#9B59B6;font-style:italic;">// 上下标示例:复杂度 O(n<sup>2</sup>)</span>
});</code></pre>
</div>
```
...
| 特性 | 要点 |
|---|---|
| 深色渐变背景 | `linear-gradient(135deg,#1A1A2E,#16213E)`(原生,可编辑) |
