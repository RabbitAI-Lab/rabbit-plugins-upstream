...
<body>
<div class="slide-container" style="position:relative;width:1920px;height:1080px;overflow:hidden;background:#FAFAF7;">
...
```html
<div data-object="true" data-object-type="shape" style="position:absolute;left:100px;top:940px;width:1720px;height:2px;background:#D5D5D0;z-index:1;"></div>
```
...
<div style="position:absolute;left:100px;top:380px;width:1720px;display:flex;gap:20px;">
  <div data-object="true" data-object-type="shape" style="flex:1;height:400px;background:#FFF;border:1px solid #E5E7EB;border-radius:10px;padding:30px;">
  ...
  <div data-object="true" data-object-type="shape" style="flex:1;height:400px;background:#FFF;">…</div>
</div>
```
...
<div data-layout="columns" data-layout-gap="20" style="position:absolute;left:100px;top:340px;width:1720px;height:400px;">
  <div data-object="true" data-layout-w="1fr"   style="background:#FFF;padding:30px;…">卡片 1</div>
  <div data-object="true" data-layout-w="1.2fr" style="background:#0A2E5C;padding:30px;…">卡片 2</div>
  <div data-object="true" data-layout-w="300"   style="background:#FFF;padding:30px;…">固定 300px 侧栏</div>
</div>
...
<div data-layout="stack" data-layout-gap="24" style="position:absolute;left:100px;top:300px;width:1720px;">
  <div data-object="true" data-layout-h="120" style="background:#FFF;…">条目 1</div>
  <div data-object="true" data-layout-h="120" style="background:#FFF;…">条目 2</div>
</div>
...
<div data-layout="grid" data-layout-cols="4" data-layout-gap="20" style="position:absolute;left:100px;top:800px;width:1720px;">
  <div data-object="true" data-layout-h="160" style="background:#FFF;…">格子</div>
</div>
```
...
### 4.3 单行垂直居中徽章(固定高度条内文字居中)
容器设**与高度相同的 line-height**,转换器会识别为单行并用 middle 对齐:

```html
<div data-object="true" data-object-type="shape" style="position:absolute;left:1390px;top:876px;width:400px;height:44px;background:#F39800;z-index:5;"></div>
<div data-object="true" data-object-type="textbox" style="position:absolute;left:1390px;top:876px;width:400px;height:44px;text-align:center;z-index:10;">
  <div style="font-size:20px;font-weight:800;color:#0A2C63;line-height:44px;letter-spacing:2px;">AI = 人类的"智力外挂"</div>
</div>
```

方式 B 下徽章可直接做卡片的流式子元素:`<div style="height:44px;background:#F39800;text-align:center;"><div style="line-height:44px;…">文字</div></div>`

### 4.4 颜色
- 文字用**不透明纯色**(`#FFFFFF`、`#13489D`)
- ⚠️ `rgba(255,255,255,.75)` 这类半透明文字会退化为纯色 → 请预先手算与底色的混合色,直接写混合后的 hex
- ✅ 推荐用 `theme.css` 里的 CSS 变量(`var(--lenovo-red)`),计算样式时自动解析
...
<div data-object="true" data-object-type="shape" data-shape="triangle"
     style="position:absolute;left:100px;top:100px;width:120px;height:100px;background:#0A2E5C;"></div>

<!-- 右箭头(方向指示) -->
<div data-object="true" data-object-type="shape" data-shape="rightArrow"
     style="position:absolute;left:300px;top:100px;width:200px;height:80px;background:#F39800;"></div>

<!-- V 形 chevron(流程步骤) -->
<div data-object="true" data-object-type="shape" data-shape="chevron"
     style="position:absolute;left:600px;top:100px;width:180px;height:80px;background:#2D9CDB;"></div>
```
...
```bash
node ~/.claude/skills/html-slides/scripts/validate.js slides/你的页面.html
```
- **ERROR 必须清零**(否则转换必有缺漏)
- WARN 酌情处理(多数可接受)
