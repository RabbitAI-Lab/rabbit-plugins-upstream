...
> **选片段前先看页面形态:`reference/page-archetypes.md`(30 个原型)与设计纪律 `reference/design-principles.md`。**
> 带 ⚠️ 的片段有使用限制(去 AI 味纪律),超限场景禁用。
> **2026-08-05 起**:图示构件片段是**结构形状**(承载信息),不计装饰预算、不占卡片矩阵限额;图标从 `assets/icons.md` 复制(stroke 显式 hex,禁 currentColor)。
