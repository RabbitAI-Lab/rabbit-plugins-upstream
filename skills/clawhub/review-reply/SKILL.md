---
name: amazon-review-reply
display_name: 亚马逊差评回复助手 · AI生成回复话术
description: >
  亚马逊差评回复助手 Skill。免费列出订阅 ASIN 的待处理差评，AI 逐条
  生成买家沟通话术、平台申诉建议与产品改进方向，并跟踪每条差评的处理
  状态（待处理/已联系/已申诉/改进中/归档）。Use when the user asks about
  replying to negative reviews, review response, 差评回复、差评处理、买家沟通、
  申诉话术、售后回复。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: review-reply
displayName: 亚马逊差评回复助手 · AI生成回复话术
version: 1.4.7
summary: 列出待处理差评，AI 逐条生成回复/申诉/改进建议
license: MIT
---
