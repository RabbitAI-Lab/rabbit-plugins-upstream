...
- Copy only named Skills and preview rule merges. MCP/config are opt-in; never copy `.openclaw`, runtime/UI state, or `.env*` wholesale. Runtime probes and installation are outside this migration skill.
