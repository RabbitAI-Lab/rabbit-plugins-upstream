...
- Skills use `.cline/skills/` and `~/.cline/skills/`. Project instructions use `.cline/rules/`; compatibility locations are inventory candidates, not merge targets.
...
Source: [unified configuration and `CLINE_DATA_DIR`](https://docs.cline.bot/getting-started/config).
