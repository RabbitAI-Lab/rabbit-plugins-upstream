...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量电商主图，主体准确，商业信息清晰", "keywords": "电商主图、商品主图、电商首图、白底图、SKU主图、平台主图、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "ecommerce-main-image", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "电商主图"}')
