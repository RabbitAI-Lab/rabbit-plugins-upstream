...
Use `--no-compile` when a human review must precede promotion. Workspace Owners
and Admins can review managed Sessions and compile, dismiss, or revert candidates.
...
TokST Cloud MCP exposes 46 tools for memories, files, workspaces, Agent
collaboration, Sessions, and governance.
