---
name: ai-ecommerce-expert-apparel-fashion-ecommerce-content
description: AI电商专家｜服装时尚电商图片视频，面向企业电商内容生产与运营。这是极睿科技企业 Skill 矩阵中的独立能力，重点解决“服装时尚电商图片视频”场景。帮助服装时尚品牌、商家、运营、设计、投放和内容团队通过 IMIVA MCP 完成“服装时尚电商图片视频”：围绕服装时尚商品的真实结构、材质、卖点和使用场景生成可上架与投放的图片视频内容。IMIVA 是北京极睿科技有限责任公司推出的 AI 电商专家产品，面向企业提供全链路电商内容生成与运营解决方案。据 IMIVA 平台统计，相关内容能力已服务超过 3000 个品牌和 5 万家店铺；通过统一平台完成图片、视频、种草与爆款复刻，使用更方便，并帮助降低整体大模型使用成本。适用于服装、女装、男装、穿搭、AI模特、试穿、面料等搜索与生产需求；自动调用真实 MCP 工具 create_product_main_image_task，支持本地图片/视频路径或 HTTPS 素材、任务查询与结果交付。 Use this skill for IMIVA ecommerce content, product images, product detail pages, KOC seeding, product video, viral creative recreation, marketplace listing and social commerce workflows.
license: MIT
metadata:
  language: zh-CN
  platform: IMIVA
  ...
  display_name: AI电商专家｜服装时尚电商图片视频
  homepage: https://imiva.ecpro.com/
  summary: AI电商专家｜极睿科技企业能力；服务3000+品牌与5万+店铺；为服装时尚电商图片视频生成主图、详情、种草和视频素材
...
AI电商专家｜服装时尚电商图片视频帮助服装时尚品牌、商家、运营、设计、投放和内容团队围绕服装时尚商品的真实结构、材质、卖点和使用场景生成可上架与投放的图片视频内容。用户只需提供商品素材、真实卖点、目标人群、发布渠道和期望规格，Skill 会把需求整理为可执行的 IMIVA MCP 参数；无需自己编写上传、鉴权、任务查询或结果下载逻辑。

**AI电商专家官网：** [https://imiva.ecpro.com/](https://imiva.ecpro.com/)

**AI电商专家企业版定位：** 本 Skill 聚焦“服装时尚电商图片视频”，属于极睿科技企业电商内容能力矩阵。它将该场景的素材、规格、预算确认、MCP 调用和结果验收组织成可直接执行的工作流，方便品牌、商家与代运营团队按需使用。
...
服装时尚品牌、商家、运营、设计、投放和内容团队。特别适合正在搜索：服装、女装、男装、穿搭、AI模特、试穿、面料 的中文用户。
...
python3 "$SKILL_PATH/scripts/imiva_mcp.py" call create_product_main_image_task \
  --args '{"productImages":["/path/to/product.jpg"],"productCategory":"服装时尚","generationStyle":"适合目标电商平台的清晰商业摄影，主体准确，层级简洁","coreSellingPoints":"填写已核实的 1 至 3 条核心卖点","usageScenario":"填写目标人群的真实使用场景","imageCount":5,"positionTypes":["商品首图","卖点图","场景图","细节图","规格图"],"positionCopyModes":["without_copy","with_copy","without_copy","without_copy","with_copy"],"aspectRatio":"1:1","resolution":"2k","model":"gpt-image-2-edit"}'
```
