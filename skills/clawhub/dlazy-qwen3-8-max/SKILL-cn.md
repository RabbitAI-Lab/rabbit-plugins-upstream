...
version: 1.2.3
description: "通义千问旗舰推理模型（2.4 万亿参数 MoE），擅长复杂推理、代码工程与长上下文分析。支持文本与图片输入。"
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy qwen3.8-max -h 查看帮助信息。"}}
---
...
通义千问旗舰推理模型（2.4 万亿参数 MoE），擅长复杂推理、代码工程与长上下文分析。支持文本与图片输入。
...
```bash
dlazy qwen3.8-max --prompt '提示词内容'
```
