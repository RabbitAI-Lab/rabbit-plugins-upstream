"""Shared helpers for linkfox-tiktok-shop-logistics (ERP developerProxy, token backendized)."""
...
# ERP logistics skill path whitelist
ALLOWED_PATH_PREFIXES = ("logistics", "authorization")


def ensure_auth_skill_available(caller: str = "shop-logistics script") -> None:
