...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度图生图，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、图生图、图片生成图片、以图生图、image to image、I2I、参考图重绘、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-image-to-image", "rule": "image", "search": "固定调用 Seedream 5.0 Lite 的图生图裸接口能力", "title": "Seedream 5.0 Lite 图生图"}')
