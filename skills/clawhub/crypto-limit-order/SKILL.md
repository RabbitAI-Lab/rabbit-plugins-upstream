---
name: crypto-limit-order
description: Crypto limit orders. Gasless, oracle-protected execution across 8 EVM chains. 
---

# Spot Advanced Swap Orders

Place crypto limit orders on any supported DEX — gasless, non-custodial, and oracle-protected across 8 EVM chains.
