---
name: amazon-hot-review-analysis
display_name: Amazon亚马逊爆款评论分析 · VOC 洞察
description: >
  亚马逊爆款评论分析 Skill：采集热销竞品评论，拆解爆款卖点、差评短板与买家真实需求，
  输出选品验证、竞品调研与 Listing 打磨建议，附星级/趋势/关键词图表。
  Use when the user asks about best seller review analysis, product research, niche validation,
  爆款分析、选品、市场调研、竞品评论、热卖产品分析、卖点挖掘、评论对比。
  Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: hot-review
displayName: Amazon亚马逊爆款评论分析 · VOC 洞察
version: 1.4.7
summary: 拆解爆款评论：卖点、差评短板与选品验证
license: MIT
---
