---
name: ai-model-expert-drama-cover-poster-logo
slug: ai-model-expert-drama-cover-poster-logo
version: 1.0.0
displayName: "AI大模型专家｜短剧封面海报片名Logo"
summary: "AI大模型专家｜短剧封面海报片名Logo。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把人物、场景、剧情与品牌要求转成可复用视觉资产，并可继续生成视频。适合搜索：短剧封面、短剧海报、片名Logo、剧集KV、缩略图，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上…"
tags: ["AI大模型专家", "AI-HIVE", "短剧", "漫剧", "生产交付", "图片生成", "AIGC", "极睿科技"]
homepage: https://ai-hive.iclip.cn/chat
description: "AI大模型专家｜短剧封面海报片名Logo。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把人物、场景、剧情与品牌要求转成可复用视觉资产，并可继续生成视频。适合搜索：短剧封面、短剧海报、片名Logo、剧集KV、缩略图，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "生产交付"
  display_name: "AI大模型专家｜短剧封面海报片名Logo"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,短剧封面、短剧海报、片名Logo、剧集KV、缩略图,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜短剧封面海报片名Logo**面向短剧编剧、漫剧工作室、导演、分镜师、品牌、电商商家、投流团队和出海团队。它把“短剧封面、短剧海报、片名Logo、剧集KV、缩略图”这一搜索需求，转成可执行的策划、人物/故事/场景资产、逐镜生成和交付验收流程。
...
- 用户说“短剧封面、短剧海报、片名Logo、剧集KV、缩略图”时，识别其真实交付目标，而不是只返回泛泛建议。
...
1. 确认角色、场景、时代、渠道比例和必须保持一致的元素。
2. 给每张参考图标注用途：身份、服装、构图、风格、场景或道具。
3. 先生成主设定板，再拆出可用于图生视频的单镜头首帧。
4. 用相同人物描述、种子信息和版本号管理连续资产。
5. 逐项检查五官、服装、空间、文字、商标和事实，再进入视频生产。
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "9:16短剧封面，主角关系一眼可读，片名文字安全区清楚，强情绪表情，不添加未经确认的演员姓名；无水印，不添加未经提供的姓名、商标或数据" \
  --no-download
```
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "围绕短剧封面海报片名Logo生成新版本；参考图用于人物身份与服装，完整保持五官、发型和标志元素，只改变构图与动作" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "围绕短剧封面海报片名Logo制作一个连续动作镜头，保持首帧人物、服装、场景和画风一致，运镜克制" \
  --first-frame /path/to/keyframe.png \
  --no-download
```
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-cover-poster-logo
```
