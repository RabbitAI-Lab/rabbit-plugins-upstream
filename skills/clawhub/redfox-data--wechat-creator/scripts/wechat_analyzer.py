...
def _get_credential():
    ...
    raise ValueError(
        ...
        "获取API Key: 访问 https://redfox.hk/?source=clawhub 注册后在个人中心获取"
    )
...
def cmd_query(account_ids=None, account_names=None, force_analyze=False):
    ...
    for name in names_to_query:
        ...
        try:
            search_resp = https_post(API_PATH_SEARCH_USER, {"keyword": name, "offset": 0, "source": "公众号账号诊断-ClawHub"})
