---
name: customer-service-caller
version: 1.0.0
description: |
  Tired of being on hold? Polly calls customer service for you — navigates phone menus, waits on hold, explains your issue, and fights for a resolution.
keywords:
  - agent
  - phone
  - agent phone call
...
Polly Customer Service Caller takes the pain out of dealing with customer support. Tell Polly your problem and what outcome you want — a refund, a cancellation, a billing correction, a service upgrade — and Polly will make the call, navigate the IVR phone tree, wait through the hold music, and speak with a representative on your behalf.
It handles the frustrating parts so you don't have to.

---

## When to Use

- The user needs to contact a company's customer service department
- The user says things like "help me call…", "I want to complain about…", "get me a refund from…", "cancel my subscription with…"
- The user is dealing with a billing error, service issue, product return, or account problem
- The user wants to escalate a complaint or negotiate a better deal
