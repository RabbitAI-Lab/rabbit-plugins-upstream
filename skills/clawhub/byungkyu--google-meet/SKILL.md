...
req = urllib.request.Request(GATEWAY + "/google-meet/v2/conferenceRecords")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-google-meet-skill/1.2")
