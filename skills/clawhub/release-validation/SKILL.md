...
check returns `false` with `gh label create release-validation --color 0E8A16
--description "OpenClaw release-validation campaign"`. Do not use `--force` or
alter an existing label. Apply `release-validation` with `gh issue edit <number>
