# Contributing to `Sync Data Notion`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Sync Data Notion.git
cd Sync Data Notion
...
git add .
git commit -m "feat(sync-data-notion): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(sync-data-notion): add <brief description>
