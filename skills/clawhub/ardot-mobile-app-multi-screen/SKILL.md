---
name: ardot-mobile-app-multi-screen
displayName: ardot-mobile-app-multi-screen
slug: ardot-mobile-app-multi-screen
author: 诺声(Logos)@SynomosAI
copyright: SynomosAI
version: 1.0.0
license: MIT
description: 在 Ardot 画布上一次产出多个移动端 App 屏幕（如首页 / 列表 / 详情 / 编辑 / 第三方打通等），用于回答「怎么一次画一整套 App 页面」「多屏风格怎么统一」这类问题
tags:
- 诺声
- AI技能
- SynomosAI
...
category: 设计工具
updated: 2026-08-28
fingerprint: FP-MX-061D50A7E87A
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-061D50A7E87A
