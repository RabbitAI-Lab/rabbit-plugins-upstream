...
description: 合同续租预警与方案生成技能。基于真实Excel台账（示例产业园AC+服务.xlsx）提前识别到期合同，分析企业画像，生成续租方案。触发场景：(1) 定时任务每日09:00检查合同到期日期，(2) 提前3个月标记"续租预警"，(3) 手动触发续租检查（@企服助手 续租检查）。
---
...
本技能用于自动化合同续租管理，基于示例产业园A真实Excel台账，提前识别到期合同，分析企业画像，生成个性化续租方案，并推送给招商人员和管家进行审批。
...
**数据源**: `/Users/mac/示例产业园AC+服务.xlsx`（真实业务数据）
