...
description: Formats review deliverables with consistent structure for comparable findings
version: 1.9.8
triggers:
  - formatting
  - deliverables
  ...
  - reporting
  - structure
  - finalizing any review or analysis that must be shared or compared
