# Irrigation Scheduling Optimization (geoskill-irrigation-scheduling)

> Based on Penman-Monteith water demand and soil water balance, triggers an irrigation calendar by thresholds. Computes crop water demand with Penman-Monteith, runs a soil water balance and triggers an irrigation calendar.
...
python geoskill-irrigation-scheduling.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
