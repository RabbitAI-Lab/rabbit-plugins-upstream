...
displayName: "🎬 AI Video Generation — Pro Pack on RunComfy"
description: >
  AI video generation on RunComfy. This RunComfy video generation skill
  is a smart router across the RunComfy video-model catalog — HappyHorse
  1.0 (Arena #1, native in-pass audio), Wan-AI Wan 2-7 (open weights,
  audio-driven lip-sync), ByteDance Seedance v2 / 1-5 / 1-0 (multi-modal
  cinematic), Kling 3.0 / 2-6, Google Veo 3-1, MiniMax Hailuo 2-3,
  ByteDance Dreamina 3-0. RunComfy video generation covers text-to-video
  (t2v), image-to-video (i2v), and Veo's video-extend endpoint. The
  RunComfy video generation skill picks the right model for intent
  (Arena #1 quality, multi-shot character identity, in-pass audio,
  ...
  `runcomfy run` invoke. Calls `runcomfy run <vendor>/<model>/text-to-
  video` or `/image-to-video` through the local RunComfy CLI. Triggers
  on "generate video", "make a video", "text to video", "t2v", "image
  to video", "i2v", "animate", "AI video", "make X move", "video from
  prompt", "video from image", or any explicit ask to produce a video
  clip from prompt or still with RunComfy.
emoji: "🎬"
...
[runcomfy.com](https://www.runcomfy.com/?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [Video models](https://www.runcomfy.com/models?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [CLI docs](https://docs.runcomfy.com/cli/introduction?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Kling 3.0 4K** — [`kling/kling-3.0/4k/text-to-video`](https://www.runcomfy.com/models/kling/kling-3.0/4k/text-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Seedance v2 Fast** — [`bytedance/seedance-v2/fast`](https://www.runcomfy.com/models/bytedance/seedance-v2/fast?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Kling 2-6 Pro** — [`kling/kling-2-6/pro/text-to-video`](https://www.runcomfy.com/models/kling/kling-2-6/pro/text-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Seedance 1-5 Pro** — [`bytedance/seedance-1-5/pro/text-to-video`](https://www.runcomfy.com/models/bytedance/seedance-1-5/pro/text-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Veo 3-1** — [`google-deepmind/veo-3-1/image-to-video`](https://www.runcomfy.com/models/google-deepmind/veo-3-1/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Veo 3-1 Fast** — [`google-deepmind/veo-3-1/fast/image-to-video`](https://www.runcomfy.com/models/google-deepmind/veo-3-1/fast/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
> Faster Veo 3-1 variant.
> Pick for: iteration on Veo compositions.
> Avoid for: hero delivery — use full **Veo 3-1**.

**Kling 3.0 4K I2V** — [`kling/kling-3.0/4k/image-to-video`](https://www.runcomfy.com/models/kling/kling-3.0/4k/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Kling 3.0 Pro I2V** — [`kling/kling-3.0/pro/image-to-video`](https://www.runcomfy.com/models/kling/kling-3.0/pro/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
> Default Kling 3.0 quality tier.
> Pick for: high-quality i2v at moderate cost.
> Avoid for: 4K final delivery.

**Kling 3.0 Standard I2V** — [`kling/kling-3.0/standard/image-to-video`](https://www.runcomfy.com/models/kling/kling-3.0/standard/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
> Cheapest 3.0 i2v tier.
> Pick for: concepting / drafts on Kling 3.0.
> Avoid for: final delivery.

**Hailuo 2-3 Pro** — [`minimax/hailuo-2-3/pro/image-to-video`](https://www.runcomfy.com/models/minimax/hailuo-2-3/pro/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Dreamina 3-0 Pro** — [`bytedance/dreamina-3-0/pro/image-to-video`](https://www.runcomfy.com/models/bytedance/dreamina-3-0/pro/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Seedance 1-0 Pro Fast** — [`bytedance/seedance-1-0/pro/fast/image-to-video`](https://www.runcomfy.com/models/bytedance/seedance-1-0/pro/fast/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Veo 3-1 Extend** — [`google-deepmind/veo-3-1/extend-video`](https://www.runcomfy.com/models/google-deepmind/veo-3-1/extend-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Veo 3-1 Fast Extend** — [`google-deepmind/veo-3-1/fast/extend-video`](https://www.runcomfy.com/models/google-deepmind/veo-3-1/fast/extend-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Catalog**: [happyhorse-1-0](https://www.runcomfy.com/models/happyhorse/happyhorse-1-0/text-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Catalog**: [wan-2-7](https://www.runcomfy.com/models/wan-ai/wan-2-7?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`wan-models` collection](https://www.runcomfy.com/models/collections/wan-models?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Catalog**: [seedance-v2 Pro](https://www.runcomfy.com/models/bytedance/seedance-v2/pro?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`seedance` collection](https://www.runcomfy.com/models/collections/seedance?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Catalog**: [happyhorse-1-0 i2v](https://www.runcomfy.com/models/happyhorse/happyhorse-1-0/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Catalog**: [veo-3-1 i2v](https://www.runcomfy.com/models/google-deepmind/veo-3-1/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`veo-3` collection](https://www.runcomfy.com/models/collections/veo-3?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
**Catalog**: [`kling` collection](https://www.runcomfy.com/models/collections/kling?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy)
...
| Endpoint | When |
|---|---|
| [`minimax/hailuo-2-3/pro/image-to-video`](https://www.runcomfy.com/models/minimax/hailuo-2-3/pro/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`/standard/image-to-video`](https://www.runcomfy.com/models/minimax/hailuo-2-3/standard/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) | MiniMax Hailuo — natural motion, strong on real-world subjects |
| [`bytedance/dreamina-3-0/pro/image-to-video`](https://www.runcomfy.com/models/bytedance/dreamina-3-0/pro/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) | Dreamina — illustrative / concept art lean |
| [`bytedance/seedance-1-0/pro/fast/image-to-video`](https://www.runcomfy.com/models/bytedance/seedance-1-0/pro/fast/image-to-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) | Seedance 1-0 — cheaper baseline |
| [`kling/kling-video-o1/standard`](https://www.runcomfy.com/models/kling/kling-video-o1/standard?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) | Kling Video O1 — reasoning-style video model |
| [`kling/kling-2-6/motion-control-pro`](https://www.runcomfy.com/models/kling/kling-2-6/motion-control-pro?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) | Transfer motion from a reference video onto a target character |
...
- [All video models](https://www.runcomfy.com/models?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) — every endpoint with its API schema tab
- [`kling`](https://www.runcomfy.com/models/collections/kling?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`seedance`](https://www.runcomfy.com/models/collections/seedance?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`veo-3`](https://www.runcomfy.com/models/collections/veo-3?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`hailuo`](https://www.runcomfy.com/models/collections/hailuo?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`wan-models`](https://www.runcomfy.com/models/collections/wan-models?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`dreamina`](https://www.runcomfy.com/models/collections/dreamina?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) brand collections
- [`/models/feature/lip-sync`](https://www.runcomfy.com/models/feature/lip-sync?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`/feature/character-swap`](https://www.runcomfy.com/models/feature/character-swap?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`/feature/upscale-video`](https://www.runcomfy.com/models/feature/upscale-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) capability tags
...
Full reference: [docs.runcomfy.com/cli/troubleshooting](https://docs.runcomfy.com/cli/troubleshooting?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy).
...
- **Scope of bash usage**: The skill never instructs the agent to run anything other than `runcomfy <subcommand>` — install lines are one-time operator setup.

## See also

- [runcomfy.com video models](https://www.runcomfy.com/models?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) — every t2v / i2v / extend endpoint with its API tab
- [`kling`](https://www.runcomfy.com/models/collections/kling?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`seedance`](https://www.runcomfy.com/models/collections/seedance?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`veo-3`](https://www.runcomfy.com/models/collections/veo-3?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`hailuo`](https://www.runcomfy.com/models/collections/hailuo?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`wan-models`](https://www.runcomfy.com/models/collections/wan-models?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`dreamina`](https://www.runcomfy.com/models/collections/dreamina?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) — RunComfy video brand collections
- [`/feature/lip-sync`](https://www.runcomfy.com/models/feature/lip-sync?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`/feature/character-swap`](https://www.runcomfy.com/models/feature/character-swap?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) · [`/feature/upscale-video`](https://www.runcomfy.com/models/feature/upscale-video?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) — capability tags
- [docs.runcomfy.com/cli](https://docs.runcomfy.com/cli/introduction?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-video-generation-runcomfy) — CLI install, authentication, troubleshooting
