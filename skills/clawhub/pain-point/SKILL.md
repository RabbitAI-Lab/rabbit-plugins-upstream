---
name: amazon-pain-point-miner
display_name: 亚马逊用户痛点挖掘 · 评论需求洞察
description: >
  亚马逊用户痛点挖掘 Skill：从评论中提炼买家真正的痛点与未被满足的需求，
  按提及频次与情绪强度排序，区分靠文案就能解释掉的误解与必须改产品的硬伤，
  每条痛点附原评论佐证。Use when the user asks about pain points, unmet needs,
  customer frustrations, product gaps, 痛点分析、痛点挖掘、用户需求、需求洞察、
  未满足需求、抱怨归类。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: pain-point
displayName: 亚马逊用户痛点挖掘 · 评论需求洞察
version: 1.4.7
summary: 提炼痛点与未满足需求，附原评论佐证
license: MIT
---
