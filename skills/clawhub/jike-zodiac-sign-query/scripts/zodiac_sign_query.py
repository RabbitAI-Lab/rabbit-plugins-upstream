...
3. 调用即刻数据开放接口 `/v1/zodiac_sign` 查询数据。
...
API_PATH = "/v1/zodiac_sign"
APPKEY_ENV_NAMES = ("JIKE_ZODIAC_SIGN_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
FIELDS = [('name', '星座'), ('features', '特征'), ('ruling_house', '守护宫'), ('negative_and_positive', '阴阳性'), ('biggest_feature', '最大特征'), ('supervisor_star', '守护星'), ('clr', '幸运色'), ('jewelry', '珠宝'), ('lucky_num', '幸运数字'), ('metal', '金属'), ('constellation_gregorian_dt_rng', '日期区间'), ('attributes', '属性'), ('overall_evaluation', '整体评价'), ('girl_characteristics', '女生特点'), ('boy_characteristics', '男生特点')]
OPTIONAL_PARAMS = [('name', '星座名称，例如 双鱼座')]
REQUIRED_PARAMS = []
DATE_PARAMS = []
TITLE = "星座查询 - 即刻数据"
FAIL_TITLE = "星座查询失败"
