...
const manifest = {
  ...
  "displayName": "Xiaohongshu Creator Marketplace (Pugongying) Creator Feature Tags",
  "openapi": "3.1.0",
  "platformKey": "xiaohongshu-pgy",
  "primaryTag": "Xiaohongshu Creator Marketplace (Pugongying)",
  "skillName": "justoneapi_xiaohongshu_pgy_api_solar_kol_data_v2_kol_feature_tags",
  "slug": "justoneapi-xiaohongshu-pgy-api-solar-kol-data-v2-kol-feature-tags",
  ...
  "endpointPath": "api/solar/kol/dataV2/kolFeatureTags",
  "skillType": "interface"
};
