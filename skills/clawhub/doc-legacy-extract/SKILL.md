---
name: doc-legacy-extract
displayName: doc-legacy-extract
slug: doc-legacy-extract
author: 诺声(Logos)@SynomosAI
copyright: SynomosAI
version: 1.0.0
license: MIT
description: 提取老版 Word .doc（OLE 复合文档）正文文本的可靠方法
tags:
- 诺声
- AI技能
- SynomosAI
...
- linux
read_when:
- 需要读取 .doc（非 .docx）老格式文档全文
- NMPA/政府网站法规附件是 .doc 且现有工具打不开
- 需要把中文法规正文按「第X条」结构化切分
languages:
- zh-CN
- en
- ja
...
- ar
updated: 2026-08-28
fingerprint: FP-MX-030B5834370F
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-030B5834370F
