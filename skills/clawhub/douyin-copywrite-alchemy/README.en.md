# Douyin Distillation Writing / douyin-copywrite-alchemy
...
- **Multi-platform material access**: Supports automatic article collection from Douyin; also accepts pasted text or file paths for flexible material sourcing.
...
- **Multi-platform material collection**: Supports automatic article retrieval from Douyin; also accepts manual paste or file paths
...
|------|---------|------|
| Platform collection distillation | "Distill 10 articles from XXX for me" | Auto-collects materials, analyzes, and generates persona |
...
| Cross-platform material integration | Brand | "Collect XX's articles from Douyin for a complete persona" | Cross-platform merging, more comprehensive persona |
