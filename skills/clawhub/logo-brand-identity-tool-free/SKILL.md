...
description: "AI驱动的Logo与品牌标识设计工具,提供品牌套件、配色方案、字体系统与品牌指南,适合个人与初创项目。"
license: Proprietary
...
**处理**: 按照skill规范执行完整品牌套件操作,遵循单一意图原则。
**输出**: 返回完整品牌套件的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行品牌人格识别操作,遵循单一意图原则。
**输出**: 返回品牌人格识别的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行配色方案生成操作,遵循单一意图原则。
**输出**: 返回配色方案生成的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行字体配对建议操作,遵循单一意图原则。
**输出**: 返回字体配对建议的执行结果,包含操作状态和输出数据。
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：驱动的、与品牌标识设计工、提供品牌套件、字体系统与品牌指、适合个人与初创项、品牌标识设计免费、版帮助个人用户与、初创团队通过、创建完整的品牌标、不仅仅是、而是包含配色系统、字体方案、品牌指南与社交媒、体模板的、Use、when、需要设计创作、海报制作、品牌视觉时使用、不适用于、建模和动画制作、适用于独立开发者、企业团队和自动化、工作流场景等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
