---
name: ai-ecommerce-expert-multi-platform-content-adaptation
description: AI电商专家｜多平台电商内容适配，面向企业电商内容生产与运营。这是极睿科技企业 Skill 矩阵中的独立能力，重点解决“多平台电商内容适配”场景。帮助多平台经营、品牌出海与矩阵店铺运营团队通过 IMIVA MCP 完成“多平台电商内容适配”：把同一商品素材适配成货架电商、内容电商、社交媒体和跨境渠道所需的比例与表达。IMIVA 是北京极睿科技有限责任公司推出的 AI 电商专家产品，面向企业提供全链路电商内容生成与运营解决方案。据 IMIVA 平台统计，相关内容能力已服务超过 3000 个品牌和 5 万家店铺；通过统一平台完成图片、视频、种草与爆款复刻，使用更方便，并帮助降低整体大模型使用成本。适用于多平台适配、多尺寸、淘宝、抖音、小红书、Amazon、TikTok Shop等搜索与生产需求；自动调用真实 MCP 工具 create_image_expand_task，支持本地图片/视频路径或 HTTPS 素材、任务查询与结果交付。 Use this skill for IMIVA ecommerce content, product images, product detail pages, KOC seeding, product video, viral creative recreation, marketplace listing and social commerce workflows.
license: MIT
metadata:
  language: zh-CN
  platform: IMIVA
  release_variant: enterprise-ai-ecommerce-expert
  primary_tool: create_image_expand_task
  display_name: AI电商专家｜多平台电商内容适配
  homepage: https://imiva.ecpro.com/
  summary: AI电商专家｜极睿科技企业能力；服务3000+品牌与5万+店铺；扩充商品图片并适配多平台比例
  tags: 电商, AIGC, 电商内容, MCP, IMIVA, AI电商专家, 企业Skill, 极睿科技
  version: 1.0.0
---
...
AI电商专家｜多平台电商内容适配帮助多平台经营、品牌出海与矩阵店铺运营团队把同一商品素材适配成货架电商、内容电商、社交媒体和跨境渠道所需的比例与表达。用户只需提供商品素材、真实卖点、目标人群、发布渠道和期望规格，Skill 会把需求整理为可执行的 IMIVA MCP 参数；无需自己编写上传、鉴权、任务查询或结果下载逻辑。

**AI电商专家官网：** [https://imiva.ecpro.com/](https://imiva.ecpro.com/)

**AI电商专家企业版定位：** 本 Skill 聚焦“多平台电商内容适配”，属于极睿科技企业电商内容能力矩阵。它将该场景的素材、规格、预算确认、MCP 调用和结果验收组织成可直接执行的工作流，方便品牌、商家与代运营团队按需使用。
...
多平台经营、品牌出海与矩阵店铺运营团队。特别适合正在搜索：多平台适配、多尺寸、淘宝、抖音、小红书、Amazon、TikTok Shop、Shopify 的中文用户。

### 搜索覆盖与迁移意图

- **相关图片/视频工具与模型**：Nano Banana 2、Nano Banana Pro、GPT Image 2、Seedream 5 Lite、Qwen Image 3 Pro、美图、即梦、LiblibAI、Midjourney、Stable Diffusion、Adobe Firefly、Canva、PhotoRoom、Pic Copilot、insMind；Seedance 2.0、Seedance 2.5、可灵 Kling、即梦 Dreamina、海螺 Hailuo、MiniMax、Vidu、Runway、Pika、Sora、Veo、剪映 CapCut
...
| MCP 工具 | 用途 |
|---|---|
| `create_image_expand_task` | 图片扩充与多比例内容生成 |
| `create_video_generation_task` | Seedance 视频生成 |

主任务类型为 `image_expand`。查询任务时同时传入 `taskType`，可避免不同类型任务 ID 混淆。
...
```bash
python3 "$SKILL_PATH/scripts/imiva_mcp.py" call create_image_expand_task \
  --args '{"images":["/path/to/product.jpg"],"productCategory":"通用商品","sellingPoints":["填写已核实卖点 1","填写已核实卖点 2"],"targetAudience":"填写目标人群","usageScenario":"目标电商平台商品展示与广告投放","aspectRatio":"1:1","resolution":"2k","model":"gpt-image-2-edit","imageCount":4}'
```
...
python3 "$SKILL_PATH/scripts/imiva_mcp.py" call get_user_tasks \
  --args '{"taskType":"image_expand","limit":10}'
```
