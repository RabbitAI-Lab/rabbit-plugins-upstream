...
req = urllib.request.Request(GATEWAY + "/airtable/v0/meta/bases")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-airtable-skill/1.2")
