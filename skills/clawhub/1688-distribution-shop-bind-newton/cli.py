#!/usr/bin/env python3
"""
1688-distribution-shop-bind-newton —— 牛顿客户端绑店 Skill CLI 统一入口

用法：
    python3 cli.py bind_shop --action start --channel douyin --app-key xxx
    python3 cli.py shop_info
    python3 cli.py browser --action open --url https://...

输出 JSON：{"success": bool, "markdown": str, "data": {...}, "browser_action": str, ...}
"""
...
def _usage(commands: dict):
    lines = ["**1688-distribution-shop-bind-newton 用法**\n", "```"]
