...
description: "Collect TikTok comments from a known TikTok content URL. Do not use for video download, profile collection, or general TikTok discovery."
---
...
```bash
python3 scripts/build-dataify-request.py --help
```
