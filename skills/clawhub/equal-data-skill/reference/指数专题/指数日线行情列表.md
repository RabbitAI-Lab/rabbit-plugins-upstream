...
指数日线行情列表:查询指定指数的日线行情数据，支持按指数代码、名称和日期范围筛选，返回每日开盘价、收盘价、最高价、最低价、成交量。适用于指数短期走势分析
...
| `indexCodeArray` | `str` | 否 | - | 指数代码,多个用逗号隔开 示例:000001 |
| `indexNameArray` | `str` | 否 | - | 指数名称,多个用逗号隔开-建议用指数代码去查 示例:上证指数 |
