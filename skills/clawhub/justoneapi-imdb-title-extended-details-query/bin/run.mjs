...
const manifest = {
  ...
  "displayName": "IMDb Extended Details",
  "openapi": "3.1.0",
  "platformKey": "imdb",
  "primaryTag": "IMDb",
  "skillName": "justoneapi_imdb_title_extended_details_query",
  "slug": "justoneapi-imdb-title-extended-details-query",
  ...
  "endpointPath": "title-extended-details-query",
  "skillType": "interface"
};
