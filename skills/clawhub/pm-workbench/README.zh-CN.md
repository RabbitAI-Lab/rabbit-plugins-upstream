...
![通用 AI 与 pm-workbench 对比图](assets/readme/zh-CN/generic-ai-vs-pm-workbench.png)

![pm-workbench benchmark 快照](assets/readme/zh-CN/benchmark-snapshot.png)
...
![pm-workbench 工作流地图](assets/readme/zh-CN/workflow-map.png)
