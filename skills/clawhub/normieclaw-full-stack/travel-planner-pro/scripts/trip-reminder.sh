...
# Resolve workspace root by looking for AGENTS.md or SOUL.md marker files.
...
resolve_workspace_root() {
    ...
    echo "ERROR: Cannot find workspace root (no AGENTS.md or SOUL.md found)." >&2
    return 1
}

WORKSPACE_ROOT="$(resolve_workspace_root)"
TRAVEL_DIR="$WORKSPACE_ROOT/travel"
TRIPS_DIR="$TRAVEL_DIR/trips"
CONFIG_FILE="$WORKSPACE_ROOT/config/travel-config.json"
