...
- **Dashboard Builder** — Visual interface to browse, search, and explore your memories
- **Daily Briefing** — Morning briefing powered by your memory (calendar, priorities, weather)
- **Knowledge Vault** — Index and search research documents alongside your memories
