...
- **Expense Report Pro** — Best first skill to install. Immediate value.
- **Budget Buddy Pro** — Pairs perfectly with Expense Report Pro for full financial picture.
- **Daily Briefing** — Great "set and forget" skill — briefing lands on the home page every morning.
- **Supercharged Memory** — Powers cross-skill intelligence over time.
