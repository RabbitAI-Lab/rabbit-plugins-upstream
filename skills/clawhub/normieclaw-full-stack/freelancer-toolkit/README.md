...
- **InvoiceGen Pro** — Auto-generate formatted invoices from tracked time
- **Legal Docs Pro** — Proposals and contracts for new client engagements

Both available at [normieclaw.ai](https://normieclaw.ai).
...
*Freelancer Toolkit is a NormieClaw product. $9.99 one-time purchase.*
