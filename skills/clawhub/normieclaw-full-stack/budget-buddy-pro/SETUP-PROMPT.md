...
# 1. Find and copy the skill files to the workspace
find . -path "*/skills/budget-buddy-pro/SKILL.md" -exec cp {} skills/budget-buddy-pro/SKILL.md \;
find . -path "*/skills/budget-buddy-pro/config/budget-config.json" -exec cp {} skills/budget-buddy-pro/config/budget-config.json \;
find . -path "*/skills/budget-buddy-pro/scripts/generate-budget-report.sh" -exec cp {} skills/budget-buddy-pro/scripts/generate-budget-report.sh \;
find . -path "*/skills/budget-buddy-pro/scripts/parse-statement.py" -exec cp {} skills/budget-buddy-pro/scripts/parse-statement.py \;
find . -path "*/skills/budget-buddy-pro/examples/budget-setup-example.md" -exec cp {} skills/budget-buddy-pro/examples/budget-setup-example.md \;
find . -path "*/skills/budget-buddy-pro/examples/monthly-review-example.md" -exec cp {} skills/budget-buddy-pro/examples/monthly-review-example.md \;
find . -path "*/skills/budget-buddy-pro/examples/savings-goal-example.md" -exec cp {} skills/budget-buddy-pro/examples/savings-goal-example.md \;
find . -path "*/skills/budget-buddy-pro/dashboard-kit/DASHBOARD-SPEC.md" -exec cp {} skills/budget-buddy-pro/dashboard-kit/DASHBOARD-SPEC.md \;
