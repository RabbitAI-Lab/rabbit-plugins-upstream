# `EXTEND.md` Schema (`avatar-image-generator`)

Configuration file paths, in priority order:

- `<project>/.image-skills/avatar-image-generator/EXTEND.md`
- `~/.image-skills/avatar-image-generator/EXTEND.md`

Optional model registry paths:

- `<project>/.image-skills/avatar-image-generator/MODELS.json`
- `~/.image-skills/avatar-image-generator/MODELS.json`
