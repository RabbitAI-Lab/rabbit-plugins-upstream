...
description: "Search live Google Hotels stays by location, dates and occupancy, returned in one unified schema alongside every other booking platform. Use when a user wants to find Google Hotels listings. Powered by the StayingAPI REST API / MCP server."
version: "1.0.0"
license: MIT-0
author: StayingAPI
...
tags: ["google-hotels", "google-hotels-api", "search", "vacation-rental", "travel", "accommodation"]
metadata: {"openclaw":{"emoji":"🔍","requires":{"env":["STAYINGAPI_KEY"]},"primaryEnv":"STAYINGAPI_KEY","homepage":"https://stayingapi.com"},"hermes":{"tags":["google-hotels","google-hotels-api","search","vacation-rental","travel","accommodation"],"category":"integrations"}}
---

# Google Hotels search

Search live Google Hotels stays via [StayingAPI](https://stayingapi.com) — one call, the same unified schema you use for Airbnb, Booking.com, Vrbo and Google Hotels.
