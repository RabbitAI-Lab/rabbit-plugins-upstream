...
| **FY2026 Revenue** | ~$2.92B (FY2026/1/31) | Not separately disclosed (part of Alibaba Cloud) | Part of Microsoft 365 ecosystem |
| **Customer Scale** | 18,950+ customers (FY2024/1/31; Okta no longer discloses exact customer counts from FY2025 onward) | Broad domestic enterprise customer coverage | World's largest enterprise directory (Microsoft 365 commercial paid seats: 400M+ monthly active users, 2026-Q1) |
| **Core Strengths** | Mature ecosystem, 7,000+ integrated apps; first GAAP-profitable year (FY2026) | Domestic compliance + moderate pricing + Alibaba Cloud ecosystem | Seamless integration with Office/Azure; passkey profiles & synced passkeys GA (2026-Q1) |
...
**Data Source**: Okta FY2026 Annual Report (as of 2026/1/31, revenue $2.919B, YoY growth 12%); Okta FY2024 Annual Report (as of 2024/1/31, 18,950+ customers, of which 4,485 customers with ACV > $100K — last fiscal year Okta disclosed customer counts); Microsoft Entra ID: March 2026 blog updates including passkey GA and enhanced identity protection; Alibaba Cloud IDaaS is the domestic market share-leading cloud-native identity management platform (industry common knowledge). Data refreshed 2026-07.
...
### Case C01 — Enterprise Permission Management Platform PRD
- **Okta Customer & Revenue Data**: Okta FY2024 Annual Report (as of 2024/1/31, 18,950+ customers, 4,485 customers with ACV > $100K — last fiscal year Okta disclosed customer counts); Okta FY2025 Annual Report (as of 2025/1/31, revenue $2.61B, YoY growth 15.3%); Okta FY2026 Annual Report (as of 2026/1/31, revenue $2.919B, YoY growth 12%). Source: Okta Investor Relations page (https://www.okta.com/press-room/) and SEC Filings. Data refreshed 2026-07.
