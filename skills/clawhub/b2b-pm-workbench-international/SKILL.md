...
# B2B PM Super Workbench V1.2.0-intl / B2B PM Super Workbench
...
> Covering 12 stages, 50+ frameworks, 30+ deliverables, 10 role hats.
...
### Chinese Enterprise PM Capability Model Comparison (Tencent/Alibaba/ByteDance) [China Subsidiary / Global Expansion Perspective]
...
| Key points to PPT | `ppt-generator` skill → Auto layout |
...
| Create PPT | `ppt-generator` | `ppt-generator` / `ppt-master` |
...
| Metric | Data | Source |
|------|------|------|
| Tiered pricing adoption rate | 67% | Paddle (formerly Profitwell, 2024 baseline, corrected 2026-07) |
| Pure usage-based adoption rate | 18% | Paddle (formerly Profitwell, 2024 baseline, corrected 2026-07) |
| Hybrid pricing with usage elements | 38% | Paddle (formerly Profitwell, 2024 baseline, corrected 2026-07) |
...
### PLG China Market Adaptation Analysis [China Subsidiary / Global Expansion Perspective]
...
## 2026 China SaaS Four Major Trends [China Subsidiary / Global Expansion Perspective]

> This section reflects trends specific to the China domestic market. For global B2B PMs working with China subsidiaries or planning APAC expansion, these trends provide critical context for localization strategy and competitive landscape.
...
|------|------|----------|
| V1.2.0-intl | 2026-07-07 | Routine iterative upgrade: Added AI frontier paradigms (GraphRAG/Agentic RAG, MCP as Agent tool-access standard, Computer Use for API-less legacy systems, reasoning model routing with three-tier recommendation (Lightweight GPT-4o-mini/Claude Haiku/Gemini Flash / Mid-Tier GPT-4.1/Claude Sonnet 4 / Heavy Reasoning o1/o3/Claude Opus 4.5/DeepSeek-R1), Chinese open-source models & Xinchuang LLM adaptation (China Subsidiary/Global Expansion Perspective), updated Embedding recommendations bge-m3/Voyage/Jina); Added AI-Assisted Development Coding Agent section (Cursor/Copilot/Coding Agent collaboration modes); Refreshed IDaaS competitive case data to FY2026 (Okta $2.92B, Entra ID passkey GA); Updated salary benchmarks to 2025–2026 data with collection timestamp; Added Figma independence note (PLG table); Annotated China-specific content as "China Subsidiary/Global Expansion Perspective"; Fixed stale references (Profitwell→Paddle, context window 128K→200K–1M); Unified stage count to 12 stages |
...
| V2.0 | 2026-06-02 | Initial version (note: this historical entry's title was mislabeled V2.0; unified to the 1.x series in 2026-07, initial baseline recorded as V1.0; current version V1.2.0-intl), covering 12 stages + 50+ methodologies + 30+ deliverables + 12 diagram types |
...
| *> Note: Figma remains independent; Adobe acquisition abandoned as of Dec 2023 (corrected 2026-07).* ||||||||
...
> **Sources**: Glassdoor, Levels.fyi, LinkedIn Salary Insights (2025–2026 data, collected 2026-07). Total compensation (including equity, bonus) can be 20-50% higher, especially in the US and at public/late-stage private companies.
...
- 2025 prediction: 40%+ of new B2B SaaS startups will be AI-native (2025 prediction, under observation as of 2026-07)
- 2026 observation: AI-native B2B continues as a dominant startup theme with sustained VC and enterprise investment; precise adoption metrics pending updated industry benchmarks (observation added 2026-07)
```
...
- Hybrid models (base + usage) growing fastest — 38% adoption (Paddle, formerly Profitwell, 2024 baseline, corrected 2026-07)
