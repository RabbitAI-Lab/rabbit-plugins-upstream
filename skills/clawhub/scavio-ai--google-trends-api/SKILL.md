...
metadata:
  openclaw:
    ...
    throttle: 1
    emoji: "\U0001F4C8"
    homepage: https://scavio.dev/docs/google-trends?utm_source=clawhub&utm_medium=skill&utm_campaign=google-trends-api
---
...
Get a free API key at [scavio.dev](https://scavio.dev/?utm_source=clawhub&utm_medium=skill&utm_campaign=google-trends-api) (50 free credits to get started, no card required):
...
# Your key from https://scavio.dev/?utm_source=clawhub&utm_medium=skill&utm_campaign=google-trends-api. Load it from your environment or secret
...
- `429` means rate or usage limit exceeded. Wait before retrying. See https://scavio.dev/docs/rate-limits?utm_source=clawhub&utm_medium=skill&utm_campaign=google-trends-api.
