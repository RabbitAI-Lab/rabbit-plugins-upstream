# `EXTEND.md` Schema (`children-book-image-generator`)

Configuration file paths, in priority order:

- `<project>/.image-skills/children-book-image-generator/EXTEND.md`
- `~/.image-skills/children-book-image-generator/EXTEND.md`

Optional model registry paths:

- `<project>/.image-skills/children-book-image-generator/MODELS.json`
- `~/.image-skills/children-book-image-generator/MODELS.json`
