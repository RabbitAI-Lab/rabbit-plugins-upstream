...
metadata:
  openclaw:
    homepage: description: "Use when activating the adaptive agent OS: open-minded skill use, data-first behavior, stepwise reasoning, self-correction, anti-repetition, and agentic task execution.
...
# aurum-brain — X∞ Compliance Layer
