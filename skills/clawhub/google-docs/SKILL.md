...
req = urllib.request.Request(GATEWAY + "/google-docs/v1/documents/{documentId}")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-google-docs-skill/1.2")
