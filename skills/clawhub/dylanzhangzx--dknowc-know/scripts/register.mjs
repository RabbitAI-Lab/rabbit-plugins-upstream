#!/usr/bin/env node
// 国内 MaaS headless 注册助手（供 ClawHub 版深知晓调用；纯 node，内置 fetch，无三方依赖）。
//   node register.mjs scan-reuse
//   node register.mjs reuse-key --from <候选目录名或 slug>
//   node register.mjs [--base URL] send     --phone <p>
//   node register.mjs [--base URL] register --phone <p> --vcode <c> [--type 11] [--organ ..] [--name ..] [--channel ..] [--password ..] [--new-key] [--config ../config.ini]
...
const DEFAULT_SEARCH_ENDPOINT = "https://open.dknowc.cn/dependable/search";
