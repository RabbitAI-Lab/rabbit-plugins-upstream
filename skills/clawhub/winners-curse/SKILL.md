...
2. Check fit — is the value *shared and uncertain* (common-value), or does it just differ by taste (private-value)? If purely private with no rivals, redirect to batna-zopa.
