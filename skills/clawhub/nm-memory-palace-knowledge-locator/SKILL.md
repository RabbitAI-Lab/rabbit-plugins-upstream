...
description: Searches and navigates stored knowledge in memory palaces
version: 1.9.8
triggers:
  - retrieval
  - search
  ...
  - spatial-memory
  - pr-review
  - looking for previously stored information or cross-referencing concepts across palaces
