...
description: Defines the contract for deferred-item capture across plugins
version: 1.9.8
triggers:
  - building or validating a plugin's deferred-capture wrapper or adding source labels
