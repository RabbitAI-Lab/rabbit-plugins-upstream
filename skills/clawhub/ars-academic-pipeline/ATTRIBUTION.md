...
This skill (academic-pipeline) is an **adaptation** of the [Academic Research Skills (ARS) suite](https://github.com/Imbad0202/academic-research-skills).
...
- **Preserved:** All knowledge files (agent definitions, references, templates, shared cross-skill documents) are preserved **verbatim** from the original
...
- `SKILL.md` — Contains attribution metadata and modification notice in frontmatter
