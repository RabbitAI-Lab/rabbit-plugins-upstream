...
DEFAULT_URL = "https://www.facebook.com/MayeMusk"
...
def ensure_python_version():
    if sys.version_info < MIN_PYTHON:
        print(
            "Python {}.{} or newer is required. Run this script with a Python 3 interpreter, for example: python3 scripts/submit_dataify_facebook_profile_by_url.py --url \"{}\"".format(
                MIN_PYTHON[0],
                MIN_PYTHON[1],
                DEFAULT_URL,
            ),
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Submit a Dataify Facebook Profile by URL Builder task.")
    parser.add_argument("--url", action="append", help="Facebook personal profile URL. Repeat for multiple URLs.")
