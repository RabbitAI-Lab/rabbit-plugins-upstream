...
- [API Key 配置](https://ai-skills.open-idea.net/skill-docs/shift-scheduler/API-KEY.md)
- [Operations 契约](https://ai-skills.open-idea.net/skill-docs/shift-scheduler/OPERATIONS.md)
