                    ...
                    [
                        {
                            ...
                            "required": true,
                            "description": "AI Skills 平台智能排班 API 密钥。",
                        },
                        {
...
2. 登录后进入 [产品管理](https://ai-skills.open-idea.net/dashboard/products) 开通本 Skill，再到 [API 密钥管理](https://ai-skills.open-idea.net/dashboard/keys) 创建密钥。
...
- [API 密钥配置](https://ai-skills.open-idea.net/skill-docs/shift-scheduler/API-KEY.md)
- [操作契约](https://ai-skills.open-idea.net/skill-docs/shift-scheduler/OPERATIONS.md)
- [HTTP 请求与任务轮询](https://ai-skills.open-idea.net/skill-docs/shift-scheduler/HTTP-REQUESTS.md)
- [行为与错误规则](https://ai-skills.open-idea.net/skill-docs/shift-scheduler/BEHAVIOR-RULES.md)
