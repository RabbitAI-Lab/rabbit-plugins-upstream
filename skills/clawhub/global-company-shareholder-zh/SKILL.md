...
```bash
python scripts/error_report.py --params '{"requestPath":"/agent/search/depth_company/company/shareholder/list","requestId":"f47ac10b58cc4372a5670e02b2c3d479","context":"股东列表查询失败，服务端异常"}'
```
