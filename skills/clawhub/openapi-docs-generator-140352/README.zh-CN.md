...
- github-issues：[Restoring full type for query/path/header params](https://github.com/kubb-labs/plugins/issues/632)
- github-issues：[[CAL-3718] Improvement in webhooks documentation](https://github.com/ellarock-software/cal.diy/issues/165)
