...
- github-issues：[Split `v3/performance/expid` into multiple performance endpoints](https://github.com/BSC-ES/autosubmit-api/issues/321)
...
- github-issues：[fix(tasks): sessionPrefix collides across every macOS project](https://github.com/mherod/swiz/issues/824)
- github-issues：[Auth forms: CSRF protection, duplicate submission prevention, and user enumeration mitigation](https://github.com/Stellar-Deejah/HerLedger/issues/30)
