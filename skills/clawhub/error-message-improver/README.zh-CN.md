...
- github-issues：[Strange "Can't convert to string" error when using `$record \| math sum` or `$record \| math avg` or `$record \| math stddev`](https://github.com/nushell/nushell/issues/18749)
- github-issues：[Improve error messages for Trusted Publishing](https://github.com/pypa/twine/issues/1355)
- github-issues：[🎥 Improve Device Permission UX for Live Meeting Room (Camera & Microphone Access)](https://github.com/imuniqueshiv/MeetOnMemory/issues/809)
- github-issues：[fix(chapters): suppress error logging when chapter data is absent](https://github.com/laxamentumtech/audnexus/issues/883)
...
- hacker-news-search：[Fil-C: Garbage In, Memory Safety Out [video]](https://news.ycombinator.com/item?id=49045494)
