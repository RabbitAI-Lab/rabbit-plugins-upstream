...
- github-issues：[regex format implementation?](https://github.com/sourcemeta/jsonschema/issues/842)
- github-issues：[pod: mint_token sends the pod's .local_secret over TCP loopback — route it over the pod's unix socket](https://github.com/kirodotdev/KiroCrew/issues/8552)
...
- github-issues：[Suggestion: Replace latex with typst](https://github.com/Open-Science-Ledger/how-to-train-your-slop-cannon/issues/1)
- hacker-news-search：[Zig: Pointer Stability for ArrayLists](https://news.ycombinator.com/item?id=49502293)
- hacker-news-search：[Arbitrary code execution in QubesOS via copy-to-VM error reporting backchannel](https://news.ycombinator.com/item?id=49501950)
