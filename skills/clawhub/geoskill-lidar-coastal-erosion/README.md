# LiDAR Coastal Erosion Analysis (geoskill-lidar-coastal-erosion)

> Compute coastal erosion and accretion volumes from two-epoch LiDAR point cloud / DSM differencing, extract the shoreline, and quantify retreat rates using the EPR (End Point Rate) method
...
python geoskill-lidar-coastal-erosion.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
