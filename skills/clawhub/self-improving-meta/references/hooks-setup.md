...
- **UserPromptSubmit** (recommended): Reminder after matching prompts to evaluate meta learnings
...
Propose recurring patterns as reviewed diffs; apply to prompt files only after explicit approval.
```
...
2. **Narrow the matcher further**. Current domain matcher examples: infrastructure-related prompts:
