...
- `THREADLY_BASE_URL` (optional) — defaults to `https://growthos-production-d600.up.railway.app`
...
```bash
BASE="${THREADLY_BASE_URL:-https://growthos-production-d600.up.railway.app}"
