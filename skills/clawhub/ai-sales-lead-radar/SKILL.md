---
name: ai-sales-lead-radar
description: AI销售线索雷达。当政企销售/BD/渠道人员想找销售线索、开发客户时，必须使用此SKILL：销售线索挖掘、潜在客户发现、拟建项目（提前6-18个月布局）、采购意向（发标前1-3个月对接）、临期续约（替换现供应商）、线索按金额与紧急度排序、每日商机晨报订阅。给一个行业/产品/地区即输出按价值排序的线索清单。即使用户没有提到「线索」，只要涉及找客户、开发市场、挖商机、谁会买我们产品等需求，都应使用本SKILL。
metadata: { "openclaw": {"requires": {"env":["ZLBX_API_KEY"]},"primaryEnv": "ZLBX_API_KEY"}}
---

# AI 销售线索雷达 · 政企销售的找客户引擎

AI 驱动的政企**销售线索**引擎：拟建项目、采购意向、临期续约三路并扫，把「谁可能要买你的东西」按价值排好序，每条线索附下一步动作，支持固化成每日晨报。

## 常见使用场景

- 「我们卖视频会议设备，帮我找找华东的销售线索」
- 「帮我把这套商机扫描固化成每天早上的晨报」
- 「这条线索的采购单位过去买过什么？帮我跟踪进展」
