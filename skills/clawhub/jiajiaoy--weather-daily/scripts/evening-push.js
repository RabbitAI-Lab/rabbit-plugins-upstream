 ...
 *
 * Usage:
 *   node evening-push.js <userId> [--city <city>] [--units metric|imperial] [--lang zh|en]
 */
...
if (!args[0]) {
  console.error('Usage: node evening-push.js <userId> [--city <city>] [--units metric|imperial] [--lang zh|en]');
  process.exit(1);
}
