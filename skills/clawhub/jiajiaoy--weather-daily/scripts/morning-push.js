 ...
 *
 * Usage:
 *   node morning-push.js <userId> [--city <city>] [--units metric|imperial] [--lang zh|en]
 */
...
if (!args[0]) {
  console.error('Usage: node morning-push.js <userId> [--city <city>] [--units metric|imperial] [--lang zh|en]');
  process.exit(1);
}
