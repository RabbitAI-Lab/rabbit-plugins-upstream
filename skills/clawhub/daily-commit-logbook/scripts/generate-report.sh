#!/bin/bash
# Daily commit report generator for logbook.
# Loads local config, then delegates diff-aware analysis to generate-report.js.
...
exec node "$SCRIPT_DIR/generate-report.js" "$@"
