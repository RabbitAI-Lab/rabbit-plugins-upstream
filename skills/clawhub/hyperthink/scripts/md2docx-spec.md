...
compatible with the hyperthink pipeline output format.
...
The hyperthink pipeline produces output using these elements — support all of them:
...
| Confidence tag | 🟢 🟡 🔴 inline | Preserved as-is (unicode renders in Word) |
...
- Unicode emoji (🟢 🟡 🔴) pass through as-is — python-docx handles unicode correctly
...
- [ ] Unicode emoji preserved (🟢 🟡 🔴 confidence tags)
