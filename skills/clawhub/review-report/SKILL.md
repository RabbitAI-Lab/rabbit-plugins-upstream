---
name: amazon-review-report
display_name: 亚马逊评论分析报告 · 一键生成VOC
description: >
  亚马逊评论分析报告 Skill：一条指令走完采集到出报告的全流程，
  生成 VOC、深度洞察、趋势、变体、竞品对比等类型的结构化报告并自动归档，
  随时可回看历史报告或导出分享。Use when the user asks to generate an Amazon review
  report, VOC report, analysis deliverable, 评论报告、分析报告、VOC 报告、洞察报告、
  报告生成、一键分析。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: review-report
displayName: 亚马逊评论分析报告 · 一键生成VOC
version: 1.4.7
summary: 一条指令走完采集、分析、归档全流程
license: MIT
---
