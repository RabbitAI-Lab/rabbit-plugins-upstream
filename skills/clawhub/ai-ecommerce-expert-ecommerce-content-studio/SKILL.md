...
metadata:
  ...
  display_name: AI电商专家｜电商全内容一站式生成
...
AI电商专家｜电商全内容一站式生成帮助电商商家、品牌团队、代运营公司、电商美工与内容团队从商品图出发，一站式生产主图、详情页、种草图文、营销图和商品视频。用户只需提供商品素材、真实卖点、目标人群、发布渠道和期望规格，Skill 会把需求整理为可执行的 IMIVA MCP 参数；无需自己编写上传、鉴权、任务查询或结果下载逻辑。

**AI电商专家官网：** [https://imiva.ecpro.com/](https://imiva.ecpro.com/)

**AI电商专家企业版定位：** 本 Skill 聚焦“电商全内容一站式生成”，属于极睿科技企业电商内容能力矩阵。它将该场景的素材、规格、预算确认、MCP 调用和结果验收组织成可直接执行的工作流，方便品牌、商家与代运营团队按需使用。
...
电商商家、品牌团队、代运营公司、电商美工与内容团队。特别适合正在搜索：IMIVA、电商内容、一站式AIGC、商品图片、商品视频、爆款复刻、全平台内容 的中文用户。
