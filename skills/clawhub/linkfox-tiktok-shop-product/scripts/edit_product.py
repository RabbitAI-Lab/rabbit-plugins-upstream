#!/usr/bin/env python3
"""TikTok Shop ERP — edit_product
Full edit PUT

Usage:
  python edit_product.py '<JSON>'
"""
...
def main() -> None:
    ...
    print(json.dumps(run_product_api("edit_product", params, "edit_product.py"), indent=2, ensure_ascii=False))
