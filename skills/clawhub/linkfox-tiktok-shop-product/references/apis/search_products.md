...
> 官方文档：https://partner.tiktokshop.com/docv2/page/search-products-202502

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `search_products` |
| 脚本 | `scripts/search_products.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202502/products/search` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"search_products","openId":"...","shop_cipher":"GCP_..."}'
```
