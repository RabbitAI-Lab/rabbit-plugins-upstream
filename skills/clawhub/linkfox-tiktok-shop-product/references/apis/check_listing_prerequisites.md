...
> 官方文档：https://partner.tiktokshop.com/docv2/page/check-listing-prerequisites-202312

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `check_listing_prerequisites` |
| 脚本 | `scripts/check_listing_prerequisites.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202312/prerequisites` |
| method | `GET` |
