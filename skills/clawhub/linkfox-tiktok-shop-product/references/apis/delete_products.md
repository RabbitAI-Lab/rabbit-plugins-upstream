...
> 官方文档：https://partner.tiktokshop.com/docv2/page/delete-products-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `delete_products` |
| 脚本 | `scripts/delete_products.py` |
...
```bash
python scripts/product_api.py '{"api":"delete_products","openId":"...","shop_cipher":"GCP_..."}'
```
