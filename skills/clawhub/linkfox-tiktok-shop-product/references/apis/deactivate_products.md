...
> 官方文档：https://partner.tiktokshop.com/docv2/page/deactivate-products-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `deactivate_products` |
| 脚本 | `scripts/deactivate_products.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/products/deactivate` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"deactivate_products","openId":"...","shop_cipher":"GCP_..."}'
```
