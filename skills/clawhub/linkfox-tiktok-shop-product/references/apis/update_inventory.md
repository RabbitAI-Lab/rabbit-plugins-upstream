...
> 官方文档：https://partner.tiktokshop.com/docv2/page/update-inventory-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `update_inventory` |
| 脚本 | `scripts/update_inventory.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/products/{product_id}/inventory/update` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"update_inventory","openId":"...","shop_cipher":"GCP_..."}'
```
