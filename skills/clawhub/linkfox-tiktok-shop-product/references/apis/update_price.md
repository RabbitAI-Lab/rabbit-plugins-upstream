...
> 官方文档：https://partner.tiktokshop.com/docv2/page/update-price-202309
...
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/products/{product_id}/prices/update` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"update_price","openId":"...","shop_cipher":"GCP_..."}'
```
