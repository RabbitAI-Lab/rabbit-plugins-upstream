...
> 官方文档：https://partner.tiktokshop.com/docv2/page/activate-product-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `activate_product` |
| 脚本 | `scripts/activate_product.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/products/activate` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"activate_product","openId":"...","shop_cipher":"GCP_..."}'
```
