...
> 官方文档：https://partner.tiktokshop.com/docv2/page/check-product-listing-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `check_product_listing` |
| 脚本 | `scripts/check_product_listing.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/products/listing_check` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"check_product_listing","openId":"...","shop_cipher":"GCP_..."}'
```
...
* Format: Text without spaces |
   ...
   ^^currency |string |Y |USD |The currency.Possible values based on the region:
* BRL: Brazil
* CZK: Czech Republic
