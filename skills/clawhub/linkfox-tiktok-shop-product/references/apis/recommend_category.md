...
> 官方文档：https://partner.tiktokshop.com/docv2/page/recommend-category-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `recommend_category` |
| 脚本 | `scripts/recommend_category.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/categories/recommend` |
| method | `POST` |
...
```bash
python scripts/product_api.py '{"api":"recommend_category","openId":"...","shop_cipher":"GCP_..."}'
```
