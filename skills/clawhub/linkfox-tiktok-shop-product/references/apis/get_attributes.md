...
> 官方文档：https://partner.tiktokshop.com/docv2/page/get-attributes-202309

## LinkFox 转发映射（本 skill）

| 项 | 值 |
|----|----|
| 具名 api | `get_attributes` |
| 脚本 | `scripts/get_attributes.py` |
| 网关 | `POST /tiktokShop/developerProxy` |
| appType | **`erp`（固定）** |
| 上游 path | `product/202309/categories/{category_id}/attributes` |
| method | `GET` |
...
```bash
python scripts/product_api.py '{"api":"get_attributes","openId":"...","shop_cipher":"GCP_..."}'
```
