...
python3 skills/dog-slide/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
python3 skills/dog-slide/scripts/visual_review.py <project_path>
```
...
- Path to the rubric: `skills/dog-slide/references/visual-review.md`
