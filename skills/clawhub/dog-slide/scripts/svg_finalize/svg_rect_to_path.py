#!/usr/bin/env python3
"""
Dog Slide - SVG Rounded Rectangle to Path Tool
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description='Dog Slide - SVG Rounded Rectangle to Path Tool',
...
'''
    ...
    if not quiet:
        print("Dog Slide - SVG Rounded Rectangle to Path Tool")
        print("=" * 50)
