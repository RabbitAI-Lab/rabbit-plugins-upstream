#!/usr/bin/env python3
"""
Dog Slide - Examples Index Generator
...
def generate_examples_index(examples_dir: str = 'examples') -> str:
    ...
    content = []
    content.append("# Dog Slide Example Projects Index\n")
    content.append("> This file is auto-generated by `skills/dog-slide/scripts/generate_examples_index.py`\n")
    ...
    content.append("---\n")
    content.append(
        f"*Auto-generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} by Dog Slide*")
...
def main() -> None:
    ...
    print("=" * 80)
    print("Dog Slide - Examples Index Generator")
    print("=" * 80 + "\n")
