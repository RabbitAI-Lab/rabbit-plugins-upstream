...
```bash
ls skills/dog-slide/templates/icons/chunk-filled/ | grep home
ls skills/dog-slide/templates/icons/tabler-filled/ | grep home
ls skills/dog-slide/templates/icons/tabler-outline/ | grep chart
ls skills/dog-slide/templates/icons/phosphor-duotone/ | grep house
ls skills/dog-slide/templates/icons/simple-icons/ | grep github
```
