...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一张高完成度商业图片，用于替代 通义万相 工作流，主体准确，构图清晰，细节真实", "keywords": "万相图片、Wan、阿里云、通义万相图片、通义万相替代、平替、API、国内可用、图片生成、图片编辑", "model": "public_model_nano_banana_pro", "name": "wanxiang-image-generation-editing-alternative", "rule": "optional", "search": "寻找 通义万相 替代、同类、平替、价格与国内 API 入口", "title": "通义万相 图片生成替代｜AI 图片生成与编辑"}')
