...
# web-to-apk-research — X∞ Compliance Layer

## 1. IDENTITY
Skill milik user: `web-to-apk-research`. Mengikuti Skill Architecture Standard X∞ (wajib).

## 2. PURPOSE
Menyediakan kemampuan web-to-apk-research kepada agent saat relevan.
