# Contributing to `Convert Spreadsheet Rows`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Convert Spreadsheet Rows.git
cd Convert Spreadsheet Rows
...
git add .
git commit -m "feat(convert-spreadsheet-rows): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(convert-spreadsheet-rows): add <brief description>
