---
name: continuous-test-review-loop
displayName: continuous-test-review-loop
slug: continuous-test-review-loop
author: 诺衡(Krites)@SynomosAI
copyright: SynomosAI
version: 1.0.0
license: MIT
description: 把「不断测试 → 复盘 → 改进 → 复测」做成常态化机制，用于回答「方案上线后怎么持续验证」「怎么让团队养成复盘节奏」这类问题
tags:
- 诺衡
- AI技能
- SynomosAI
...
display_name: 实测-复盘-改进循环
summary: 把「不断测试→复盘→改进→复测」做成常态化机制：固定测试清单、复盘模板、改进闭环、每轮报告入方案池。触发词：测试、复盘、改进、打磨、实际运行测试、验证方案。
agent_created: true
category: 方法论
platforms:
- windows
...
- linux
updated: 2026-08-28
fingerprint: FP-MX-0CEAD3790D40
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-0CEAD3790D40
