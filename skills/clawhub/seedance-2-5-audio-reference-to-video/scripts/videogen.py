...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedance 2.5 完成高质量参考音频生视频，动作连续，镜头稳定", "fixed_mode": "r2v", "keywords": "Seedance2.5、Seedance 2.5、字节 Seedance、豆包 Seedance、即梦视频、参考音频生视频、音频参考生视频、音乐生成视频、声音驱动视频、audio to video、AI视频、视频生成", "models": {"r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-2-5-audio-reference-to-video", "rule": "audio", "search": "固定调用 Seedance 2.5 的参考音频生视频裸接口能力", "title": "Seedance 2.5 参考音频生视频"}')
