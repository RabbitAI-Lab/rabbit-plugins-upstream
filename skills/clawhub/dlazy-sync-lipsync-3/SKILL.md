...
Execute `dlazy sync-lipsync-3` to get the result.
...
Options:
  ...
  --sync_mode [sync_mode]              Sync mode [default: cut_off] (choices: "cut_off", "loop", "bounce", "silence", "remap")
...
```bash
dlazy sync-lipsync-3 --prompt 'prompt content'
```
