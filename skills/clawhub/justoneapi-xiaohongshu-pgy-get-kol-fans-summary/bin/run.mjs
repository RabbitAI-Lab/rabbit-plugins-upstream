...
const manifest = {
  ...
  "displayName": "Xiaohongshu Creator Marketplace (Pugongying) Follower Summary",
  "openapi": "3.1.0",
  "platformKey": "xiaohongshu-pgy",
  "primaryTag": "Xiaohongshu Creator Marketplace (Pugongying)",
  "skillName": "justoneapi_xiaohongshu_pgy_get_kol_fans_summary",
  "slug": "justoneapi-xiaohongshu-pgy-get-kol-fans-summary",
  ...
  "endpointPath": "get-kol-fans-summary",
  "skillType": "interface"
};
