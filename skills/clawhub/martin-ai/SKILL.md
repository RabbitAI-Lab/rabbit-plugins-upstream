...
metadata:
  {
    "clawdbot":
      {
        "emoji": "🏛️",
        "requires": { "bins": ["python3"], "env": ["SKILLBOSS_API_KEY"] },
...
1. Create account at [skillbossai.com](https://skillbossai.com)
2. Go to your dashboard to generate an API key
...
// ~/.clawdbot/clawdbot.json
{
  skills: {
    entries: {
      "venice-ai": {
        env: { SKILLBOSS_API_KEY: "sk_your_key_here" }
      }
    }
  }
}
