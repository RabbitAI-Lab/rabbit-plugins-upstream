...
- github-issues: [Define FX settlement fee currency and signed cash-leg economics](https://github.com/sgajbi/lotus-core/issues/754)
- github-issues: [Tenant pause/resume (scale-to-zero) + accurate cloud cost model](https://github.com/vitalharmony/harmonic-forge/issues/62)
- github-issues: [Wait for analytics source readiness before latency measurement](https://github.com/sgajbi/lotus-core/issues/785)
- github-issues: [Make repo-native Python validation worktree-isolated](https://github.com/sgajbi/lotus-core/issues/763)
- github-issues: [chunker ignores chunk_token_num: soft cap routinely overshoots by one unit (and can blow past 100x)](https://github.com/infiniflow/ragflow/issues/17202)
