...
description: 酒店降价监控与多平台比价助手，同时搜索多个旅游平台实时价格帮你比价省钱，支持按酒店名称精确比价、按城市搜索酒店列表、创建降价监控任务，多旅游平台数据直连。暑期订酒店省钱，价格监控与实时比价
version: 1.1.1
...
# 酒店价格监控与比价 — 多平台实时比价，降价了第一时间告诉你

> 搜一家酒店，多个旅游平台价格一目了然；已订酒店帮盯降价，买贵了第一时间知道。

🔥 **核心亮点：**
- **多平台比价** — 同时查询多个旅游平台实时价格，最低价一目了然
- **降价监控** — 已订酒店帮盯价格变化，降了第一时间通知
- **精确匹配** — 按酒店名+城市精确定位，跨平台名称差异自动匹配
- **取消政策** — 各平台取消政策一目了然，判断值不值得继续盯
- **智能推荐** — 不只列价格，还给倾向性建议和性价比分析

## 快速入门

**3个开场白示例，复制即用：**

1. "我订了上海外滩华尔道夫，帮我看看现在有没有降价"
2. "帮我比一下三亚亚特兰蒂斯各平台的价格"
3. "后天去上海住哪里性价比高"

## 核心能力

1. **多平台比价**：同时查询多个旅游平台实时价格，按最低价排序
2. **精确酒店匹配**：按酒店名+城市精确定位，跨平台名称差异自动匹配
3. **降价监控**：输出结构化监控请求，由宿主Agent承接定时复查和通知
4. **免费取消政策**：查询各平台取消政策，判断是否值得继续盯
5. **智能推荐**：不只列价格，还给倾向性建议和性价比分析
6. **城市搜索**：按城市+日期搜索酒店列表，快速筛选候选
...
- **酒店比价** — 飞猪+途牛+同程+美团+RG 5平台酒店一站式比价
