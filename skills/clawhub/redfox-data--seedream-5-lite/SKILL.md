...
前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册账号获取自己的 API Token，三种配置方式任选其一：
...
A：前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册获取自己的 API Token。
