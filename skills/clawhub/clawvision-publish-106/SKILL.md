---
name: "clawvision"
description: "ClawVision 1.0.6 — improve ClawHub security review transparency by rewriting description and removing unused skill_workshop permission."
metadata:
  version: 1.0.6
  author: Maximius
...
- **ClawVision 1.0.6** — current stable version: permission transparency + CSS variable fix + Summary Design Specification + 5 aesthetic presets for HTML/PPTX.
