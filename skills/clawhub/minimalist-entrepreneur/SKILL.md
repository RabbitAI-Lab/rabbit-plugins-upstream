...
A complete business-building skill pack based on **[The Minimalist Entrepreneur](https://www.minimalistentrepreneur.com/)** by Sahil Lavingia (founder of Gumroad).
...
Skills authored by [Sahil Lavingia](https://sahillavingia.com/) based on his book. Originally published as [Claude Code plugins](https://github.com/slavingia/skills). Ported to OpenClaw by [zooshots7](https://clawhub.com/zooshots7).
