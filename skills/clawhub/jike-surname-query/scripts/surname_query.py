...
3. 调用即刻数据开放接口 `/v1/surname/query` 查询数据。
...
API_PATH = "/v1/surname/query"
APPKEY_ENV_NAMES = ("JIKE_SURNAME_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
FIELDS = [('name', '姓氏'), ('from', '起源'), ('celebrity', '名人'), ('aresdistribute', '迁徙分布')]
OPTIONAL_PARAMS = []
REQUIRED_PARAMS = [('name', '姓氏，例如 赵')]
DATE_PARAMS = []
TITLE = "百家姓查询 - 即刻数据"
FAIL_TITLE = "百家姓查询失败"
