...
if ({solve_for_power}) {{
  ...
  cat(t("header.mixed_model_power"), "\n")
  cat(t("label.effect"), "{ename}", "=", {eff}, "\n")
  cat(t("label.n_subjects"), {nobs}, "\n")
