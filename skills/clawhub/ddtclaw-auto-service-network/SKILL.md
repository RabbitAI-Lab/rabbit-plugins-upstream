---
name: auto-service-network
slug: ddtclaw-auto-service-network
displayName: 店店通·汽车后市场门店网络分析
version: 1.0.0
summary: 面向润滑油、轮胎、汽服连锁的市场与销售团队，快速洞察门店网络、区域覆盖、单店位置画像与拜访机会。
description: 用已发布的汽车后市场门店快照，快速分析品牌网络、服务类型、区域覆盖、周边画像、竞对与候选点。适合市场、渠道、销售和拓展团队获取可执行的攻店与选址线索。
tags: [汽车后市场, 汽服, 润滑油, 轮胎, 门店网络, 选址]
homepage: https://gotoshop-ai.com/ddtclaw/
---

# 汽车后市场门店网络（auto-service-network）
