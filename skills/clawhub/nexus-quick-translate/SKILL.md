...
description: "Fast lightweight translation for short texts"
version: 2.1.0
capabilities:
...
> NEXUS Agent-as-a-Service on Cardano + Stellar + XRPL | Price: $0.03/request | Accepts: ADA, DJED, iUSD, USDCx, USDM (Cardano) + USDC, XLM (Stellar) + XRP, RLUSD (XRPL)
