---
name: download-dem
description: 'Select, discover, download, resume, tile, mosaic, crop, and validate'
---
...
python scripts\dem_download.py plan --admin "北京市" --admin-level province --admin-expand-km 5 --dataset cop-dem-glo-90
