...
- Participants and their order of appearance
- Messages with numbering and type (sync/async/return)
- Conditions (alt/opt/loop) if they exist

## Checklist
- Sequential IDs with no gaps
- Lifelines use dashed style
- Activation boxes aligned to their messages
- Correct arrow styles for call vs return
...
## Layout rules
- Participants flow left to right
- Messages flow top to bottom
- Alt/Loop frames span the full width of the messages they contain

## Common errors
- Lifelines missing dashed style
- Activation boxes out of alignment with messages
- Return arrows not dashed

## When to ask
- Message type not specified (sync vs async)
