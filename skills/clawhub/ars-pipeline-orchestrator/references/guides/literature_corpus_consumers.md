...
**Authoritative spec**: [对应设计文档（移植版未附带）](对应设计文档（移植版未附带）)

## What this document covers

This is the contract every literature-reading consumer agent must follow. The v3.6.4 input port (`references/shared/contracts/passport/literature_corpus_entry.schema.json`) defines what enters a Material Passport; this document defines how Phase 1 agents read it.
