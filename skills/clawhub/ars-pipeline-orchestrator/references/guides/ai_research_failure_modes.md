...
**Status**: v3.2
**Parent skill**: `ars-pipeline-orchestrator`
...
This also extends the existing 5-type citation hallucination taxonomy (in `ars-academic-reviewer` references) into a broader 7-type AI research hallucination taxonomy. Citation hallucinations become mode 2 below.
...
- ARS `ars-academic-reviewer/references/` — existing 5-type citation hallucination taxonomy (Mode 2).
- ARS `ars-pipeline-orchestrator/references/guides/claim_verification_protocol.md` — existing integrity verification that this checklist extends.
- ARS `ars-pipeline-orchestrator/references/guides/integrity_review_protocol.md` — existing integrity review protocol that Stage 2.5 follows.
