...
```
Entering Stage 3 (REVIEW) -- using ars-academic-reviewer quick mode
...
Loading ars-academic-reviewer SKILL.md (full mode)...
Passing Revised Draft + Response to Reviewers + Editorial Decision Letter ( Judge Record input)...
