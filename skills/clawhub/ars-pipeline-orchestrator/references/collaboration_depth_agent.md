...
rubric_ref: references/shared/collaboration_depth_rubric.md
...
# references/shared/collaboration_depth_rubric.md (agent behaviour vs rubric content).
version: "1.0.0"
---
...
The canonical rubric lives at `references/shared/collaboration_depth_rubric.md`. Read it before every scoring session — do not paraphrase or cache it. The rubric defines:
...
The canonical rules live in `references/shared/collaboration_depth_rubric.md` §"Anti-sycophancy discipline for consumer agents". Follow them as written; do not paraphrase. One agent-specific addition:
...
Advisory only — your pipeline continues regardless. Full rubric: references/shared/collaboration_depth_rubric.md
━━━
```
...
---
Rubric: references/shared/collaboration_depth_rubric.md (version 1.0)
...
- **This is not** a reviewer. `ars-academic-reviewer` skill evaluates paper quality. You evaluate collaboration mode.
