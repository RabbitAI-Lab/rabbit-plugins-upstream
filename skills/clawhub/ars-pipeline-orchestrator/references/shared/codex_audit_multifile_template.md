...
**Audience:** ARS pipeline orchestrator (ars-pipeline-orchestrator, ars-deep-research, ars-academic-paper) producing codex audit prompts for Phase 2 / Phase 3 deliverables. Human authors running ad-hoc cross-model review on a deliverable bundle.
...
- ars-deep-research/references/synthesis_agent.md (the agent prompt — for understanding patterns, not for audit)
...
- `references/shared/irb_terminology_glossary.md` — referenced by dimension §3.5.
- `references/shared/psychometric_terminology_glossary.md` — referenced by dimension §3.5.
- `references/shared/protected_hedging_phrases.md` — referenced by Section 4(f) report_compiler bundle check (sub-checks ii + iii).
- `references/shared/word_count_conventions.md` — referenced by Section 4(f) report_compiler bundle check (sub-check i).
