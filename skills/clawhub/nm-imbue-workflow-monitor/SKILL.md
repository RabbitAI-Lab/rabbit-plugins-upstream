...
description: Detects workflow failures and inefficient patterns then files GitHub issues
version: 1.9.8
triggers:
  - workflow
  - monitoring
  ...
  - efficiency
  - automation
  - a workflow step repeatedly fails or produces inconsistent output
