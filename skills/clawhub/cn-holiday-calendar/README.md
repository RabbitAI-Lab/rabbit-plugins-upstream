...
This skill answers whether a date is a workday in China using official gov.cn holiday notices and `lunar-python` calendar data.
...
- Includes lunar date summaries by default and, for single-date queries, returns the date, lunar date, weekday, holiday status, holiday name if applicable, and solar term if present
