...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedance 2.5 完成高质量首尾帧生视频，动作连续，镜头稳定", "fixed_mode": "i2v", "keywords": "Seedance2.5、Seedance 2.5、字节 Seedance、豆包 Seedance、即梦视频、首尾帧生视频、首尾帧视频、首帧尾帧、两张图生成视频、转场视频、AI视频、视频生成", "models": {"i2v": "public_model_seedance_2_5_i2v"}, "name": "seedance-2-5-first-last-frame-to-video", "rule": "first_last", "search": "固定调用 Seedance 2.5 的首尾帧生视频裸接口能力", "title": "Seedance 2.5 首尾帧生视频"}')
