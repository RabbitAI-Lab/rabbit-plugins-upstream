...
Enable the webhook step only after confirming the target xCloud site, staging vs production, and backup status. Keep `XCLOUD_DEPLOY_WEBHOOK` as a GitHub secret; never print or commit it.
