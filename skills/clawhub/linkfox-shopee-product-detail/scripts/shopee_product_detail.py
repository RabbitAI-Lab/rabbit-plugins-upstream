#!/usr/bin/env python3
"""
Shopee Product Detail Lookup - LinkFox Skill
调用 /shopee/product/detail 接口。

Usage:
  python shopee_product_detail.py '<JSON parameters>'           # 自动：小结果全量；大结果写文件+摘要
  python shopee_product_detail.py '<JSON parameters>' --inline  # 强制全量打印到 stdout
...
API_PATH = "/shopee/product/detail"
SLUG = "linkfox-shopee-product-detail"
