...
text={
	...
	'自定义股票池':"自定义股票池设置",
	"股票池设置":"持有限制10的股票池设置",
	"股票池":["511090.SH", "159937.SZ", "510300.SH", "510050.SH", "159680.SZ", 
			"159915.SZ", "159351.SZ", "159536.SZ", "159581.SZ", 
			"512800.SH", "513100.SH"],
	"股票池名称":["30年国债ETF", "黄金ETF", "沪深300ETF", "上证50ETF", 
				"中证1000ETF", "创业板ETF", "A500ETF", "中证2000ETF", 
				"红利ETF", "银行ETF", "纳斯达克ETF"]
}
class A():
	pass
