...
def init(c):
	...
	#开始时间
	c.start='20240501 00:00:00'
	#结束时间
	c.end='20500101 00:00:00'
	#测试资金
	c.capital=300000
	c.stock_list=["511090.SH", "159937.SZ", "513100.SH", "516160.SH", "515790.SH",
		"159869.SZ", "512480.SH", "515880.SH", "512690.SH", "512010.SH",
		"510880.SH", "512880.SH", "512800.SH", "159655.SZ", "511380.SH", 
		"512679.SH", "513220.SH", "513090.SH"]
	c.name_list=["30年国债ETF", "黄金ETF", "纳斯达克ETF", "新能源ETF", "光伏ETF", 
		"游戏ETF", "半导体ETF", "通信ETF", "白酒ETF", "医药ETF", "红利ETF", 
		"证券ETF", "银行ETF", "标普ETF", "可转债ETF", "军工ETF", 
		"互联网ETF", "香港证券ETF"]
	#持有限制
	c.hold_limit=10
	#买入比率
