...
def init(c):
	...
	#开始时间
	c.start='20250101 00:00:00'
	#结束时间
	c.end='20500101 00:00:00'
	#测试资金
	c.capital=300000
	c.stock_list=["511090.SH", "159937.SZ", "510300.SH", "510050.SH", 
			"159680.SZ", "159915.SZ", "159351.SZ",
			"159536.SZ", "159581.SZ", "512800.SH", "513100.SH"]
	c.name_list=["30年国债ETF", "黄金ETF", "沪深300ETF", "上证50ETF", 
			"中证1000ETF", "创业板ETF", "A500ETF", "中证2000ETF", "红利ETF", 
			"银行ETF", "纳斯达克ETF"]
	#持有限制
	c.hold_limit=10
	#买入比率
