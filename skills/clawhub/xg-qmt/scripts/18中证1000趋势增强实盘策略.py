...
text={
	...
	'策略名称':'西蒙斯中证1000趋势增强实盘策略5',
	"是否测试模型设置":"是否测试模型设置,实盘改成否",
	"是否测试模型":"否",
	"账户":"7705",
	"账户类型":"STOCK",
	
	"小市值路径":'C:/Users/lxg123456/Desktop/ZZ1000.blk',
...
def init(c):
	...
	#c.run_time("run_trader_check_fun","60nSecond","2024-07-25 13:20:00")
	#账户个股止盈止损，安成本价计算
