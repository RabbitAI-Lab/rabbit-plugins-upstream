...
|------|------|------|------|
| Wave 1: Technology Enablement | 2023-2026 | LLM / Copilot / Automation | Efficiency ↑15-40%, cost reduction |
| Wave 2: Process Reinvention | 2025-2028 | AI Agents / Multimodal / Domain Models | AI-native products & services, new business models |
| Wave 3: Business Model Innovation | 2027-2030+ | AGI Precursors / Human-AI Collaboration / Institutional Change | Industry boundary reshaping, new markets |

> Note: Time windows and GenAI data metrics use SKILL.md main text "McKinsey AI Value Creation: Three Waves" as the **single source of truth** (aligned 2026-07; old 2022-2024 / 2024-2027 framing is historical, no longer used).

### GenAI Implementation Gap
**Full funnel**: 88% of enterprises use AI → 46% deploy GenAI at scale → only 9% achieve significant business value. Gap of 37pp. (Aligned with SKILL.md; McKinsey 2025-2026, as of full-year 2025)
...
| "Bigger models are better" | Current model-tiered routing practice (updated 2026-07): lightweight models (GPT-4o-mini / Claude Haiku / Gemini Flash) for simple tasks, large models (GPT-4.1 / Claude Sonnet / Gemini 2.5 Pro) for complex reasoning | Tiered strategy: route by task complexity to balance cost & quality; legacy GPT-3.5/GPT-4 comparison is obsolete |
