...
req = urllib.request.Request(GATEWAY + "/signnow/user")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-signnow-skill/1.2")
