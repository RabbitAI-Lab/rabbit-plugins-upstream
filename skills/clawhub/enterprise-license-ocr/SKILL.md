---
name: enterprise_license_ocr
description: 支持企业许可证的票据识别。
version: 1.0.0
author: SCNet
license: MIT
tags:
...
---
# Sugon-Scnet 企业许可证 OCR 技能

本技能封装了企业许可证识别的 OCR 服务，通过单一接口即可调用 7种识别能力，高效提取票据内容。

---

## 功能特性

- **企业许可证识别**：支持识别企业经营许可证、食品生产许可证、卫生许可证、金融许可证、金融机构代码证、支付业务许可证、开户许可证的票据信息。
...
| 参数名 | 类型 | 必填 | 描述                                      |
|--------|------|------|-----------------------------------------|
| ocrType | string | 是 | 识别类型枚举。必须为以下之一：<br>• ENTERPRISE_OPERATING_LICENSE（企业经营许可证）<br>• ENTERPRISE_PRODUCTION_LICENSE（食品生产许可证）<br>• ENTERPRISE_HYGIENE_LICENSE（卫生许可证）<br>• ENTERPRISE_FINANCIAL_LICENSE（金融许可证）<br>• ENTERPRISE_FINANCIAL_LICENSE（金融机构代码证）<br>• ENTERPRISE_PAYMENT_LICENSE（支付业务许可证）<br>• ENTERPRISE_ACCOUNTING_LICENSE（开户许可证） |
| filePath | string | 是 | 待识别图片的本地绝对路径。支持 jpg、png、pdf 等常见格式。      |

### 命令行调用示例

```bash
   python .claude/skills/enterprise_license_ocr/scripts/main.py ENTERPRISE_OPERATING_LICENSE /path/to/test.jpg
```
...
- “帮我识别这张图像中的企业经营许可证票据信息，图片在 /Users/name/Downloads/test.jpg”
- “帮我识别这张图像中的食品生产许可证票据信息，图片在 /Users/name/Downloads/test.jpg”
- “帮我识别这张图像中的卫生许可证票据信息，图片在 /Users/name/Downloads/test.jpg”
- “帮我识别这张图像中的金融许可证票据信息，图片在 /Users/name/Downloads/test.jpg”
- “帮我识别这张图像中的金融机构代码证票据信息，图片在 /Users/name/Downloads/test.jpg”
- “帮我识别这张图像中的支付业务许可证票据信息，图片在 /Users/name/Downloads/test.jpg”
- “帮我识别这张图像中的开户许可证票据信息，图片在 /Users/name/Downloads/test.jpg”
