...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: FOOD_BUSINESS_LICENSE, FOOD_PRODUCTION_LICENSE, HYGIENE_LICENSE,FINANCIAL_LICENSE,FINANCIAL_INSTITUTION_CODE_CERT,PAYMENT_BUSINESS_LICENSE,ACCOUNT_OPENING_LICENSE")
        sys.exit(1)
