...
description: "Concise description of the coding pattern, bug fix, or idiom this skill addresses. Require narrow, testable trigger conditions plus explicit exclusions (never empty or catch-all matchers)."
---
...
---
name: skill-name-here
description: "What coding pattern this addresses and when to apply it. Require narrow, testable trigger conditions plus explicit exclusions (never empty or catch-all matchers)."
---
