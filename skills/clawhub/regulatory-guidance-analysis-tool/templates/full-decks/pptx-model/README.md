...
白底 + 红琥珀警示色 + 条纹危险边 + 大红 strike 和 pill。灵感来自 AI 测试与安全场景的 `.focus` 黑底白字块、hero quote box 和高对比 black-on-white 气质 —— 但把语气推到「警示 / 风控 / 事故报告」层级。
...
**Source inspiration:** AI 测试与安全场景 html 原型.

**Path:** `templates/full-decks/pptx-model/index.html`
