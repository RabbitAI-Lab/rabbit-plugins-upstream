...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "高点击封面，单一视觉焦点，强对比构图，标题区域清晰，缩略图尺寸下仍可快速识别", "keywords": "爆款封面、高点击封面、短视频封面、文章封面、视觉钩子、封面设计、封面改图", "model": "public_model_nano_banana_pro", "name": "viral-cover-image-generation-editing", "product_promise": "输入主题、平台、受众和标题，生成多种封面方向并按点击吸引力、可读性和品牌一致性检查", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "爆款封面图片生成与编辑", "trend_inspired": true}')
