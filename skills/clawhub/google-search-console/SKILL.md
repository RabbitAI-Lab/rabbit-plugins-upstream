...
req = urllib.request.Request(GATEWAY + "/google-search-console/webmasters/v3/sites")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-google-search-console-skill/1.2")
