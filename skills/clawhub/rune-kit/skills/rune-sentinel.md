...
- Signal: `quarantine.notice.emitted` (from `rune-quarantine.md`) — escalate when the same untrusted MCP namespace is quarantined ≥5× in a session (suggests prompt-injection attempt)
