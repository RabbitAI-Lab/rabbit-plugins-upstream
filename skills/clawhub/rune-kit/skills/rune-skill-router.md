...
| "Did it fully implement?" / "does code match spec?" / check completeness | `rune-converge.md` | L3 — needs requirements.md |
...
| `rune-converge.md` | cook | Spec↔code gap scan (Phase 6.5) |
