...
def main():
    if len(sys.argv) < 2:
        ...
        print("用法: python query_region_dimension.py <trackType>")
        print("\n参数说明:")
        print("  trackType: 平台类型 (MOBILE/OTT/PC)")
        print("\n示例:")
        print("  python query_region_dimension.py MOBILE")
        sys.exit(1)
    ...
    # 调用API（使用GET方法）
    call_api("/audience/rule/region", request_body, method="GET")
