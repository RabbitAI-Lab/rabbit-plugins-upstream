...
var require_types = __commonJS({
  "dist/types.js"(exports2) {
    ...
    exports2.CREDENTIAL_APPLY_URL = "https://qzm.550wai.cn";
  ...
  "dist/credential-manager.js"(exports2) {
    ...
    var CredentialManager = class {
      constructor(storagePath) {
        this.storagePath = storagePath ?? path2.resolve(__dirname, "../.credentials.json");
      }
      get() {
        ...
        try {
          const content = fs2.readFileSync(this.storagePath, "utf-8");
      ...
      set(credential) {
        ...
        fs2.mkdirSync(path2.dirname(this.storagePath), { recursive: true });
        fs2.writeFileSync(this.storagePath, JSON.stringify(stored, null, 2), { encoding: "utf-8", mode: 384 });
        fs2.chmodSync(this.storagePath, 384);
      }
      isConfigured() {
      ...
      getGuideMessage() {
        return {
          ...
          message: `\u51ED\u8BC1\u672A\u914D\u7F6E\u3002\u8BF7\u5148\u83B7\u53D6 userNo \u548C apiKey\uFF0C\u7533\u8BF7\u5730\u5740: ${types_1.CREDENTIAL_APPLY_URL}\u3002\u83B7\u53D6\u540E\u8BF7\u8C03\u7528 configureCredentials action \u5B8C\u6210\u914D\u7F6E\u3002`
        };
      }
    };
      ...
      return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
        ...
        if (socketPath) {
          ...
          if (allowedSocketPaths != null) {
            ...
            const resolvedSocket = path2.resolve(socketPath);
  ...
  "dist/validator.js"(exports2) {
    ...
    function validateResolution(width, height) {
      if (Math.max(width, height) > 1920 || Math.min(width, height) > 1080) {
        return validationError(`\u89C6\u9891\u5206\u8FA8\u7387\u8D85\u9650\uFF0C\u8981\u6C42\u6700\u5927\u8FB9\u4E0D\u8D85\u8FC7 1920 \u4E14\u6700\u5C0F\u8FB9\u4E0D\u8D85\u8FC7 1080\uFF08\u5F53\u524D ${width}\xD7${height}\uFF09`);
      }
      return null;
    }
    ...
    function validate(action, params) {
      switch (action) {
        ...
        case "taskDetail":
          return validateTaskId(params.taskId);
        case "taskList":
          return null;
        case "queryCredits":
          return null;
        case "removeVideoWatermark":
          return validateUrl(params.videoUrl);
        ...
        default:
          return validationError(`\u4E0D\u652F\u6301\u7684 action: ${action}`);
      }
    }
  }
});
...
var require_error_handler = __commonJS({
  "dist/error-handler.js"(exports2) {
    ...
    function createTimeoutErrorResponse(timeoutMs) {
      return createErrorResponse(types_1.ErrorCode.SERVER_ERROR, `\u7F51\u7EDC\u8D85\u65F6: \u8BF7\u6C42\u5728 ${timeoutMs / 1e3} \u79D2\u5185\u672A\u6536\u5230\u54CD\u5E94\u3002\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5\u540E\u91CD\u8BD5`);
    }
  }
});
...
var require_workflow_engine = __commonJS({
  "dist/workflow-engine.js"(exports2) {
    ...
    async function executeWorkflow(params, client) {
      ...
      return { code: types_1.ErrorCode.SERVER_ERROR, message: `\u8F6E\u8BE2\u8D85\u65F6\uFF1A\u4EFB\u52A1\u5728 ${types_1.MAX_POLL_COUNT * types_1.POLL_INTERVAL / 1e3 / 60} \u5206\u949F\u5185\u672A\u5B8C\u6210\u5904\u7406\u3002\u60A8\u53EF\u4EE5\u7A0D\u540E\u4F7F\u7528 taskDetail \u67E5\u8BE2\u4EFB\u52A1 ${taskId} \u7684\u6700\u7EC8\u72B6\u6001`, taskId, timedOut: true };
    }
  }
});
...
function attachLocalFile(request) {
  const params = { ...request.params || {} };
  const filePath = typeof params.filePath === "string" ? params.filePath : typeof params.file === "string" ? params.file : null;
  if (!filePath)
