...
req = urllib.request.Request(GATEWAY + "/supabase/rest/v1/")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-supabase-skill/1.2")
