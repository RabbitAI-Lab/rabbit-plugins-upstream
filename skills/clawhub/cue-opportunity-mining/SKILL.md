...
description: >
  用 Cue 跑「商机挖掘」场景的深度研究：扫描大额资金流动与资本动作的前置信号，锁定募资户、派息户与代发源头。覆盖高管股权激励解禁日历、区域优质企业名录、对公揽储商机线索、对公拜访简报、项目线索穿透与 BD 策略、对公客户动态雷达、产业链上下游拓客、分红商机查询等核心搭子，产出可派单的商机清单与对公营销底稿。
...
## 当前可用搭子（仅供理解；运行时以 live 为准）
  - 高管股权激励解禁日历：跟着解禁日历做业务。提前预测哪些上市公司高管即将获得股票解禁，为理财师提供精准的资金周转介入时机，抢占流动性窗口。
  ...
  - 项目线索穿透与BD策略：穿透项目线索表象，还原商业实质与交易结构，锁定实质运营主体并深挖股权与资本动态，识别知识产权、跨境合规及国资合作等法律痛
  - 对公客户动态雷达：扫一遍存量对公客户名单，捕捉中标、扩产、融资、被执行与舆情等公开动态，挑出今天有变化的、值得优先跟进。
  - 产业链上下游拓客：从一家核心企业出发，顺着客户、供应商与招投标关系，挖出上下游可拓展名单，给出每家切入点和可能的金融需求。
