---
name: google-hotels-availability
description: "Check day-by-day Google Hotels availability (the booking calendar) for a known listing over a date window. Use when a user asks whether a listing on Google Hotels is open on specific dates. Powered by StayingAPI."
version: "1.0.0"
license: MIT-0
author: StayingAPI
...
tags: ["google-hotels", "google-hotels-api", "availability", "calendar", "travel", "accommodation"]
metadata: {"openclaw":{"emoji":"📅","requires":{"env":["STAYINGAPI_KEY"]},"primaryEnv":"STAYINGAPI_KEY","homepage":"https://stayingapi.com"},"hermes":{"tags":["google-hotels","google-hotels-api","availability","calendar","travel","accommodation"],"category":"integrations"}}
---

# Google Hotels availability

Check day-by-day availability for a known Google Hotels listing — the booking calendar over any date window.
...
- "Is this Google Hotels listing free the first week of August?"
- "Show the calendar for this Google Hotels place"
