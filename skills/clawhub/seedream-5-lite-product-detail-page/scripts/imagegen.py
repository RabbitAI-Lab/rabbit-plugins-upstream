...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度商品详情页，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、商品详情页、电商详情页、详情页视觉、卖点图、产品长图、商品介绍图、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-product-detail-page", "rule": "optional", "search": "固定调用 Seedream 5.0 Lite 的商品详情页裸接口能力", "title": "Seedream 5.0 Lite 商品详情页"}')
