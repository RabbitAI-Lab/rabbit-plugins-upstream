...
license: MIT
edition: free
description: "PDF合并工具 - （免费版），可产出提升工作效率. 适用于需要merge pdf tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - PDF处理
  - PDF合并
  - 批量处理
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：合并多个、文件为一个、支持页面排序、页面范围选择与批、合并工具、免费版等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---|---|---|---|
| input | string | 是 | PDF合并工具（免费版）处理的输入数据或指令 |
