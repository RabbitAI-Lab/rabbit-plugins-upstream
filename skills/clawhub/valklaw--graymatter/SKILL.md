...
## Canonical Links And Install

Use the GrayMatter GitHub repository and product page as the source of truth for install, docs, and product positioning.

- Product page: https://valkyrlabs.com/graymatter
- GitHub repo: https://github.com/ValkyrLabs/GrayMatter
- Quick start: `git clone https://github.com/ValkyrLabs/GrayMatter.git && cd GrayMatter && scripts/gm-activate`
- GrayMatter Light: `scripts/gm-light-up && eval "$(scripts/gm-light-env)"`
- Smoke test: `scripts/gm-light-smoke`
- Hosted API base: https://api-0.valkyrlabs.com/v1
- Architecture docs: https://github.com/ValkyrLabs/GrayMatter/blob/main/docs/architecture.md
- Server capabilities: https://github.com/ValkyrLabs/GrayMatter/blob/main/docs/server-capabilities.md
- GrayMatter Light docs: https://github.com/ValkyrLabs/GrayMatter/blob/main/docs/graymatter-light.md
- MCP server docs: https://github.com/ValkyrLabs/GrayMatter/blob/main/mcp-server/README.md
- Privacy policy: https://github.com/ValkyrLabs/GrayMatter/blob/main/docs/privacy-policy.md
