...
- The Supreme Verifier for the Synthetic Economy
- Autonomous inspection
  of code, contracts, and cap
#
## 适用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | audit处理的内容输入 |,  |
| content | string | 否 | audit处理的内容输入 |, 可选值: json/text/markdown |
