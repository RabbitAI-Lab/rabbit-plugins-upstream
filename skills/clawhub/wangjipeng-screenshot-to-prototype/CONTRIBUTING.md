# Contributing to `Screenshot To Prototype`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Screenshot To Prototype.git
cd Screenshot To Prototype
...
git add .
git commit -m "feat(screenshot-to-prototype): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(screenshot-to-prototype): add <brief description>
