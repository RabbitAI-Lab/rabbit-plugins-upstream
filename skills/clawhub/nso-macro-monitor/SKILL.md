...
- Requires web access to the canonical NSO release page and linked report pages or PDFs.
- Prefer canonical NSO URLs over reposted summaries.
- If report text or PDF extraction is unavailable, continue with accessible NSO metadata, set confidence to `Low` or `Medium` based on missing indicator blocks, and list the missing items.
...
- "Summarize the latest NSO macro release for Vietnam equities."
