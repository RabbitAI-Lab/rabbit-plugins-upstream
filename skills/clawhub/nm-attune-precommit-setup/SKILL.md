...
description: Configures pre-commit hooks for linting, type checking, formatting, and testing
version: 1.9.8
triggers:
  - pre-commit
  - quality-gates
  ...
  - type-checking
  - testing
  - setting up a new project or adding quality gates to an existing one
