...
display_name: 亚马逊评论采集 · 批量抓取导出
description: >
  亚马逊评论采集 Skill：按 ASIN 与站点批量采集评论并入库，支持按页数控制量级、
  查看采集进度、按星级与时间筛选浏览及导出，覆盖美国、英国、德国、日本、加拿大、
  法国、西班牙、意大利八个站点。采集前先报价，确认后才扣积点。
  Use when the user asks to scrape or export Amazon reviews, fetch review data,
  评论采集、评论抓取、评论爬取、评论导出、评论数据、批量下载评论。
  Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: review-scraper
displayName: 亚马逊评论采集 · 批量抓取导出
version: 1.4.7
summary: 八大站点评论批量采集、筛选与导出
license: MIT
---
