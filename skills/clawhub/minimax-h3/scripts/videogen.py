...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "电影感城市夜景，镜头缓慢推进，灯光倒映在湿润路面", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、文生视频、图生视频、参考生视频、AI视频、视频生成、广告、TVC、带货、种草、短剧、漫剧", "models": {"i2v": "public_model_minimax_h3_i2v", "r2v": "public_model_minimax_h3_r2v", "t2v": "public_model_minimax_h3_t2v"}, "name": "minimax-h3", "rule": "optional", "search": "覆盖 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频 的裸接口与全部公开模式", "title": "MiniMax H3 视频生成"}')
