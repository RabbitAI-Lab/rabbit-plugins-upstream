...
3. 调用即刻数据开放接口 `/v1/zodiac_pairing` 查询数据。
...
API_PATH = "/v1/zodiac_pairing"
APPKEY_ENV_NAMES = ("JIKE_ZODIAC_PAIRING_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
FIELDS = [('boy_zodiac', '男生星座'), ('girl_zodiac', '女生星座'), ('pairing_idx', '配对指数'), ('paired_proportions', '配对比例'), ('compassion_idx', '同情指数'), ('longevity_idx', '天长地久指数'), ('results_rvw', '结果评述'), ('love_advc', '恋爱建议'), ('precautions', '注意事项')]
OPTIONAL_PARAMS = []
REQUIRED_PARAMS = [('boy_zodiac', '男生星座，例如 双鱼座'), ('girl_zodiac', '女生星座，例如 天蝎座')]
DATE_PARAMS = []
TITLE = "星座配对 - 即刻数据"
FAIL_TITLE = "星座配对查询失败"
