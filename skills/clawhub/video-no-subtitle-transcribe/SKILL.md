...
# Video No-Subtitle Transcribe (whisper fallback)
...
3. After transcription, read the output transcript → understand content by timeline → structured summary for the user
