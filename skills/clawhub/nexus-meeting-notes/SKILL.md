...
Use when you need to convert meeting transcripts into structured notes.
...
curl -X POST https://ai-service-hub-15.emergent.host/api/original-services/meeting-notes \
  ...
  -d '{
  "input": "Example input for Meeting Notes Generator"
}'
```

**Endpoint:** `https://ai-service-hub-15.emergent.host/api/original-services/meeting-notes`
**Method:** POST
**Headers:**
...
|-----|--------|-----------|
| `https://ai-service-hub-15.emergent.host/api/original-services/meeting-notes` | POST | Input parameters as JSON body |
