...
Use `label_summary.csv`, `figure_inventory.csv`, and `source-corpus-notes.md` before routing a new target. The labels are multi-label, so a single paper or diagram may count under multiple classes.
