...
def get_zodiac_sign(month: int, day: int) -> dict | None:
    """根据月日返回星座信息
...
def format_zodiac_output(month: int, day: int, zodiac_info: dict) -> str:
    """格式化星座输出
    ...
    for date_str in test_cases:
        ...
        if month and day:
            ...
            if zodiac:
                ...
                print(format_zodiac_output(month, day, zodiac))
                print("-" * 50)
            else:
