#!/usr/bin/env python3
"""
1688-ai-message-push —— 1688 AI 消息推送 CLI 统一入口

Usage:
    python3 cli.py <command> [options]

Commands（更多参数见项目根目录 SKILL.md）:
    wx_push       发送微信通知       python3 cli.py wx_push --text "通知内容"
    app_push      发送APP系统通知    python3 cli.py app_push --title "通知标题" --text "通知内容"
