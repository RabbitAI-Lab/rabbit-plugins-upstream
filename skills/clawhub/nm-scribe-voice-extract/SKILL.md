---
name: voice-extract
description: Extracts a user's writing voice from text samples via SICO comparative analysis
version: 1.9.8
triggers:
  - voice
  - extraction
...
metadata: {"openclaw": {"homepage": "https://github.com/athola/claude-night-market/tree/master/plugins/scribe", "emoji": "\u270d\ufe0f", "requires": {"config": ["night-market.scribe:style-learner", "night-market.scribe:slop-detector"]}}}
