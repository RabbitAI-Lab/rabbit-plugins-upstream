...
# AI Instagram Post Generator Generator Skills from craftsman-agent
...
This is a demo to generate an 2 pages Instagram Ready Social Media Posts using just simple text and reference images prompts. The AI instagram posts asset size ratio/width/height can be customized.
The final generated assets (contents, images, captains, backgrounds) are editable, and the generated final posts can be exported and published to instagram instantly.
