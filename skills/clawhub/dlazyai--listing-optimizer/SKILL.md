...
| 合规校验 | 每张自动过 [platform-compliance](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/platform-compliance/skill.md)，避免因驳回污染数据 |
| 复盘模板 | 产出可填数据的对照表 |
...
- **赢的那版存进 [brand-kit](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/brand-kit/skill.md)**，让它成为之后的默认，实验成果才会沉淀。
