...
description: >
  ...
  TikTok 投流、多语言本地化。从 gingiris-aso-growth 提炼。
when_to_use: |
  Use this skill when you need to: optimize App Store / Google Play metadata, research ASO
  keywords, execute app cold-start from 0 to 10K downloads, build TikTok creator matrix for
  mobile UA, or run multi-language localization for app store listings.
  Trigger phrases: "ASO" | "App Store ranking" | "app cold start" | "UGC creator matrix" |
  "应用商店优化" | "App冷启动" | "关键词排名" | "Google Play优化"
metadata:
