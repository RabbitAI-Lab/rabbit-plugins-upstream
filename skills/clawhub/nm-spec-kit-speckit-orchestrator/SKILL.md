...
description: Orchestrates Spec Driven Development by coordinating spec, plan, and task skills
version: 1.9.8
triggers:
  - speckit
  - workflow
  ...
  - planning
  - specification
  - running the full speckit workflow from spec to implementation
