...
"""
丽思卡尔顿酒店技能 - ClawHub版
3个工具：search_ritz_carlton_hotels / get_ritz_carlton_hotel_info / search_ritz_carlton_packages
...
def main():
    ...
    if tool == "search":
        print(search_ritz_carlton_hotels(**args))
    elif tool == "detail":
        print(get_ritz_carlton_hotel_info(**args))
    elif tool == "packages":
        print(search_ritz_carlton_packages(**args))
    else:
