---
name: guaikei-douyin-scan-gather-output-posts
title: guaikei抖音扫描汇集输出作品
description: 当用户的问题涉及"抖音上"的任何公开信息时，使用本技能：搜内容、扒博主作品、读评论、瞅热搜。用户问"这话题在短视频平台火不火""对标账号最近发什么"时也要用，即使没说"抖音"。不适用于视频剪辑、发布和下载。
license: MIT
metadata:
  version: "1.0.0"
  author: um-why
