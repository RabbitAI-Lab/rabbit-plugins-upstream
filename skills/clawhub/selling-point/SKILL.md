---
name: amazon-selling-point
display_name: 亚马逊卖点提炼 · 购买动因挖掘
description: >
  亚马逊卖点提炼 Skill：从好评里反推买家到底为什么下单——哪个功能被反复提、
  哪句描述打动了人、跟替代品比赢在哪，按说服力排序输出卖点清单，
  可直接用于主图文案与五点描述。Use when the user asks about selling points,
  purchase drivers, unique selling proposition, why customers buy, 卖点提炼、
  购买动因、下单理由、核心卖点、种草点、主推卖点。
  Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: selling-point
displayName: 亚马逊卖点提炼 · 购买动因挖掘
version: 1.4.7
summary: 从好评反推下单理由，按说服力排卖点
license: MIT
---
