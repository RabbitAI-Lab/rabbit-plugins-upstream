...
- **UserPromptSubmit**: Reminder after matching prompts to evaluate legal findings
...
2. **Narrow the matcher further**. Current domain matcher examples: legal-related prompts:
