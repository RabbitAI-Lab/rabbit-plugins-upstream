...
NOTICE_DATABASES = {
    ...
    "fidic-silver": {
        "name": "FIDIC Silver Book 2017 (Conditions of Contract for EPC/Turnkey Projects)",
        "notices": [
            {"clause": "1.9", "event": "Notify Employer of errors in Employer's Requirements", "period": "As soon as discovered", "recipient": "Employer", "consequence": "Contractor bears risk if should have discovered", "category": "Design"},
            {"clause": "4.12", "event": "Notify Employer of Unforeseeable physical conditions", "period": "As soon as practicable", "recipient": "Employer", "consequence": "May lose entitlement to Cost/EOT", "category": "Claims"},
            {"clause": "5.2", "event": "Submit design documents to Employer for review", "period": "Per programme / Contract Data", "recipient": "Employer / Employer's Representative", "consequence": "Delay to programme; Contractor bears risk", "category": "Design"},
            {"clause": "8.3", "event": "Programme submission", "period": "28 days from Commencement Date", "recipient": "Employer", "consequence": "Payment may be withheld", "category": "Programme"},
            {"clause": "13.2", "event": "Notice that instruction constitutes a Variation", "period": "As soon as practicable / before executing", "recipient": "Employer", "consequence": "May lose entitlement to additional Cost/Time", "category": "Variations"},
            {"clause": "14.3", "event": "Payment Statement (per Schedule of Payments / milestones)", "period": "Per Contract Data", "recipient": "Employer", "consequence": "Late payment", "category": "Payment"},
            {"clause": "16.1", "event": "Notice of suspension by Contractor (non-payment)", "period": "21 days notice", "recipient": "Employer", "consequence": "Contractor may suspend work", "category": "Payment"},
            {"clause": "20.2.1", "event": "Notice of Claim (Contractor)", "period": "28 days from awareness", "recipient": "Employer", "consequence": "TIME-BARRED — claim lost", "category": "Claims"},
            {"clause": "20.2.4", "event": "Fully detailed claim submission", "period": "84 days from Notice of Claim", "recipient": "Employer", "consequence": "Claim may be reduced", "category": "Claims"},
            {"clause": "20.1", "event": "Notice of Claim (Employer)", "period": "28 days from awareness", "recipient": "Contractor", "consequence": "TIME-BARRED — claim lost", "category": "Claims"},
            {"clause": "21.4", "event": "Referral to DAAB", "period": "28 days after Employer's determination", "recipient": "DAAB", "consequence": "Lose right to refer", "category": "Disputes"},
            {"clause": "21.4.4", "event": "NOD (Notice of Dissatisfaction)", "period": "28 days after DAAB decision", "recipient": "Other Party", "consequence": "Decision becomes FINAL & BINDING", "category": "Disputes"},
        ]
    },
    "psscoc": {
...
def generate_calendar(form, fmt, output=None, commencement=None, completion=None):
    ...
    if fmt == "csv":
        ...
        lines = []
        lines.append(VISIBLE_DISCLAIMER)
        lines.append(HTML_DISCLAIMER)
