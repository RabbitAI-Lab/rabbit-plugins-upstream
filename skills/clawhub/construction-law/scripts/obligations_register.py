...
CSV_DISCLAIMER = ["# DISCLAIMER: This is a workflow aid not legal advice. Verify edition amendments and governing law before use."]
...
OBLIGATIONS = {
    ...
    "fidic-yellow": {
        "name": "FIDIC Yellow Book 2017 (Plant & Design-Build)",
        "contractor": [
            {"clause": "1.3", "obligation": "Submit Contractor's Documents per Schedule", "timing": "Per Contract Data", "priority": "High", "category": "Administration"},
            {"clause": "1.6", "obligation": "Execute Contract Agreement", "timing": "35 days from Letter of Acceptance", "priority": "High", "category": "Administration"},
            {"clause": "2.2", "obligation": "Comply with permits, licences, approvals", "timing": "As required", "priority": "High", "category": "Compliance"},
            {"clause": "4.1", "obligation": "Design, execute and complete Works fit for purpose specified in Employer's Requirements", "timing": "Per programme", "priority": "Critical", "category": "Design"},
            {"clause": "4.2", "obligation": "Provide Performance Security", "timing": "Within 28 days of Letter of Acceptance", "priority": "Critical", "category": "Financial"},
            {"clause": "4.4", "obligation": "Appoint Contractor's Representative", "timing": "Before Commencement", "priority": "High", "category": "Administration"},
            {"clause": "4.8", "obligation": "Health & Safety obligations", "timing": "Ongoing", "priority": "Critical", "category": "Safety"},
            {"clause": "4.10", "obligation": "Use Site data; verify and interpret", "timing": "Pre-design / ongoing", "priority": "Medium", "category": "Records"},
            {"clause": "4.12", "obligation": "Notify Engineer of unforeseeable physical conditions", "timing": "As soon as practicable", "priority": "Critical", "category": "Claims"},
            {"clause": "4.18", "obligation": "Environmental protection measures", "timing": "Ongoing", "priority": "High", "category": "Compliance"},
            {"clause": "5.1", "obligation": "Carry out Contractor's design; design responsibility for Works", "timing": "Pre-construction / ongoing", "priority": "Critical", "category": "Design"},
            {"clause": "5.2", "obligation": "Submit Contractor's Documents to Engineer for review", "timing": "Per Contract Data review periods", "priority": "Critical", "category": "Design"},
            {"clause": "5.3", "obligation": "Provide Contractor's undertaking that design complies with Employer's Requirements and applicable laws", "timing": "With Tender / on demand", "priority": "High", "category": "Design"},
            {"clause": "5.4", "obligation": "Comply with technical standards and regulations", "timing": "Ongoing", "priority": "High", "category": "Compliance"},
            {"clause": "5.6", "obligation": "Provide as-built records and operation/maintenance manuals", "timing": "Before Tests on Completion", "priority": "High", "category": "Records"},
            {"clause": "5.8", "obligation": "Rectify design errors at Contractor's cost", "timing": "Upon discovery", "priority": "Critical", "category": "Design"},
            {"clause": "6.1", "obligation": "Employ suitable staff and labour", "timing": "Ongoing", "priority": "High", "category": "Resources"},
            {"clause": "7.1", "obligation": "Execute works with proper workmanship; Plant fit for purpose", "timing": "Ongoing", "priority": "Critical", "category": "Works"},
            {"clause": "8.1", "obligation": "Commence Works", "timing": "Per Notice of Commencement", "priority": "Critical", "category": "Programme"},
            {"clause": "8.3", "obligation": "Submit programme; resubmit revisions when accuracy lost", "timing": "28 days from Commencement; updates as required", "priority": "High", "category": "Programme"},
            {"clause": "8.7", "obligation": "Proceed with due expedition and without delay", "timing": "Ongoing", "priority": "Critical", "category": "Programme"},
            {"clause": "9.1", "obligation": "Carry out Tests on Completion (functional/performance tests)", "timing": "Before Taking Over", "priority": "High", "category": "Testing"},
            {"clause": "10.1", "obligation": "Apply for Taking Over Certificate", "timing": "On completion + passing tests", "priority": "High", "category": "Completion"},
            {"clause": "11.1", "obligation": "Rectify defects during DNP", "timing": "Within DNP", "priority": "High", "category": "Defects"},
            {"clause": "12.1", "obligation": "Carry out Tests after Completion (production/output verification)", "timing": "Per Contract Data", "priority": "Critical", "category": "Testing"},
            {"clause": "14.3", "obligation": "Submit monthly Statements / Interim Payment applications", "timing": "Monthly", "priority": "High", "category": "Payment"},
            {"clause": "14.11", "obligation": "Submit Final Statement", "timing": "56 days from Performance Certificate", "priority": "High", "category": "Payment"},
            {"clause": "17.1", "obligation": "Indemnify Employer (third party claims)", "timing": "Ongoing", "priority": "High", "category": "Insurance"},
            {"clause": "17.4", "obligation": "Liability for Contractor's design (subject to Cl. 1.15 cap)", "timing": "Ongoing", "priority": "Critical", "category": "Design"},
            {"clause": "18.1", "obligation": "Insure Works (CAR/EAR) and design (PI insurance per Contract Data)", "timing": "Before Commencement", "priority": "Critical", "category": "Insurance"},
            {"clause": "20.2.1", "obligation": "Give Notice of Claim within 28 days", "timing": "28 days from awareness", "priority": "Critical", "category": "Claims"},
            {"clause": "20.2.3", "obligation": "Maintain contemporary records for claims", "timing": "Ongoing during claim event", "priority": "High", "category": "Records"},
            {"clause": "20.2.4", "obligation": "Submit fully detailed claim", "timing": "84 days from Notice of Claim", "priority": "Critical", "category": "Claims"},
        ],
        "employer": [
            {"clause": "1.6", "obligation": "Execute Contract Agreement", "timing": "35 days from Letter of Acceptance", "priority": "High", "category": "Administration"},
            {"clause": "1.9", "obligation": "Confirm any errors in Employer's Requirements promptly", "timing": "On notice from Contractor", "priority": "Critical", "category": "Design"},
            {"clause": "2.1", "obligation": "Give right of access to and possession of Site", "timing": "Per Contract Data", "priority": "Critical", "category": "Access"},
            {"clause": "2.4", "obligation": "Provide financial evidence/arrangements", "timing": "On request", "priority": "High", "category": "Financial"},
            {"clause": "2.5", "obligation": "Provide assistance with permits/licences from authorities", "timing": "As required", "priority": "High", "category": "Compliance"},
            {"clause": "3.1", "obligation": "Appoint Engineer", "timing": "Before Commencement", "priority": "Critical", "category": "Administration"},
            {"clause": "5.2", "obligation": "Engineer to review Contractor's Documents within Review Period", "timing": "Per Contract Data", "priority": "High", "category": "Design"},
            {"clause": "14.6", "obligation": "Engineer to issue IPC", "timing": "28 days from Statement", "priority": "Critical", "category": "Payment"},
            {"clause": "14.7", "obligation": "Pay amount certified in IPC", "timing": "56 days from Statement", "priority": "Critical", "category": "Payment"},
            {"clause": "14.9", "obligation": "Pay Advance Payment", "timing": "Per Contract Data", "priority": "High", "category": "Payment"},
            {"clause": "14.13", "obligation": "Issue Final Payment Certificate", "timing": "28 days from Final Statement", "priority": "High", "category": "Payment"},
            {"clause": "20.1", "obligation": "Give Notice of Employer's Claim within 28 days", "timing": "28 days from awareness", "priority": "Critical", "category": "Claims"},
        ]
    },
    "fidic-silver": {
        "name": "FIDIC Silver Book 2017 (EPC/Turnkey)",
        "contractor": [
            {"clause": "1.3", "obligation": "Submit Contractor's Documents per Schedule", "timing": "Per Contract Data", "priority": "High", "category": "Administration"},
            {"clause": "1.6", "obligation": "Execute Contract Agreement", "timing": "35 days from Letter of Acceptance", "priority": "High", "category": "Administration"},
            {"clause": "2.2", "obligation": "Comply with permits, licences, approvals", "timing": "As required", "priority": "High", "category": "Compliance"},
            {"clause": "4.1", "obligation": "Design, execute and complete Works to satisfy Employer's Requirements and fitness for purpose", "timing": "Per programme", "priority": "Critical", "category": "Design"},
            {"clause": "4.2", "obligation": "Provide Performance Security", "timing": "Within 28 days of Letter of Acceptance", "priority": "Critical", "category": "Financial"},
            {"clause": "4.4", "obligation": "Appoint Contractor's Representative", "timing": "Before Commencement", "priority": "High", "category": "Administration"},
            {"clause": "4.8", "obligation": "Health & Safety obligations", "timing": "Ongoing", "priority": "Critical", "category": "Safety"},
            {"clause": "4.10", "obligation": "Use and verify Site data; Contractor to satisfy itself of correctness and sufficiency", "timing": "Pre-tender / ongoing", "priority": "Critical", "category": "Records"},
            {"clause": "4.12", "obligation": "Notify Employer of Unforeseeable physical conditions (higher threshold than Red/Yellow)", "timing": "As soon as practicable", "priority": "Critical", "category": "Claims"},
            {"clause": "4.18", "obligation": "Environmental protection measures", "timing": "Ongoing", "priority": "High", "category": "Compliance"},
            {"clause": "5.1", "obligation": "Carry out and be responsible for design of Works — fitness for purpose standard", "timing": "Pre-construction / ongoing", "priority": "Critical", "category": "Design"},
            {"clause": "5.2", "obligation": "Submit Contractor's Documents to Employer for review", "timing": "Per Contract Data review periods", "priority": "Critical", "category": "Design"},
            {"clause": "5.3", "obligation": "Undertaking that design complies with Employer's Requirements and applicable laws", "timing": "With Tender / on demand", "priority": "High", "category": "Design"},
            {"clause": "5.4", "obligation": "Comply with technical standards and regulations", "timing": "Ongoing", "priority": "High", "category": "Compliance"},
            {"clause": "5.6", "obligation": "Provide as-built records and O&M manuals", "timing": "Before Tests on Completion", "priority": "High", "category": "Records"},
            {"clause": "5.8", "obligation": "Rectify design errors at Contractor's cost", "timing": "Upon discovery", "priority": "Critical", "category": "Design"},
            {"clause": "6.1", "obligation": "Employ suitable staff and labour", "timing": "Ongoing", "priority": "High", "category": "Resources"},
            {"clause": "7.1", "obligation": "Execute works with proper workmanship; Plant and Works fit for purpose", "timing": "Ongoing", "priority": "Critical", "category": "Works"},
            {"clause": "8.1", "obligation": "Commence Works", "timing": "Per Notice of Commencement", "priority": "Critical", "category": "Programme"},
            {"clause": "8.3", "obligation": "Submit programme; resubmit when accuracy lost", "timing": "28 days from Commencement; updates as required", "priority": "High", "category": "Programme"},
            {"clause": "8.7", "obligation": "Proceed with due expedition and without delay", "timing": "Ongoing", "priority": "Critical", "category": "Programme"},
            {"clause": "9.1", "obligation": "Carry out Tests on Completion", "timing": "Before Taking Over", "priority": "High", "category": "Testing"},
            {"clause": "10.1", "obligation": "Apply for Taking Over Certificate", "timing": "On completion + passing tests", "priority": "High", "category": "Completion"},
            {"clause": "11.1", "obligation": "Rectify defects during DNP", "timing": "Within DNP", "priority": "High", "category": "Defects"},
            {"clause": "12.1", "obligation": "Carry out Tests after Completion (performance/output verification)", "timing": "Per Contract Data", "priority": "Critical", "category": "Testing"},
            {"clause": "14.3", "obligation": "Submit Statements per Schedule of Payments / milestones", "timing": "Per Contract Data", "priority": "High", "category": "Payment"},
            {"clause": "14.11", "obligation": "Submit Final Statement", "timing": "56 days from Performance Certificate", "priority": "High", "category": "Payment"},
            {"clause": "17.1", "obligation": "Indemnify Employer (third party claims)", "timing": "Ongoing", "priority": "High", "category": "Insurance"},
            {"clause": "17.4", "obligation": "Liability for Contractor's design — fitness for purpose (subject to Cl. 1.15 cap)", "timing": "Ongoing", "priority": "Critical", "category": "Design"},
            {"clause": "18.1", "obligation": "Insure Works (CAR/EAR) and design (PI insurance per Contract Data)", "timing": "Before Commencement", "priority": "Critical", "category": "Insurance"},
            {"clause": "20.2.1", "obligation": "Give Notice of Claim within 28 days", "timing": "28 days from awareness", "priority": "Critical", "category": "Claims"},
            {"clause": "20.2.3", "obligation": "Maintain contemporary records for claims", "timing": "Ongoing during claim event", "priority": "High", "category": "Records"},
            {"clause": "20.2.4", "obligation": "Submit fully detailed claim", "timing": "84 days from Notice of Claim", "priority": "Critical", "category": "Claims"},
        ...
        "employer": [
            {"clause": "1.6", "obligation": "Execute Contract Agreement", "timing": "35 days from Letter of Acceptance", "priority": "High", "category": "Administration"},
            {"clause": "1.9", "obligation": "Provide Employer's Requirements (complete and accurate)", "timing": "Before Commencement", "priority": "Critical", "category": "Design"},
            {"clause": "2.1", "obligation": "Give right of access to and possession of Site", "timing": "Per Contract Data", "priority": "Critical", "category": "Access"},
            {"clause": "2.4", "obligation": "Provide financial evidence/arrangements", "timing": "On request", "priority": "High", "category": "Financial"},
            {"clause": "2.5", "obligation": "Provide assistance with permits/licences from authorities", "timing": "As required", "priority": "High", "category": "Compliance"},
            {"clause": "5.2", "obligation": "Review Contractor's Documents within Review Period (note: no Engineer — Employer reviews directly or via Employer's Representative)", "timing": "Per Contract Data", "priority": "High", "category": "Design"},
            {"clause": "14.6", "obligation": "Issue Payment Certificate (Employer issues directly — no Engineer)", "timing": "28 days from Statement", "priority": "Critical", "category": "Payment"},
            {"clause": "14.7", "obligation": "Pay amount certified", "timing": "56 days from Statement", "priority": "Critical", "category": "Payment"},
            {"clause": "14.9", "obligation": "Pay Advance Payment", "timing": "Per Contract Data", "priority": "High", "category": "Payment"},
            {"clause": "14.13", "obligation": "Issue Final Payment Certificate", "timing": "28 days from Final Statement", "priority": "High", "category": "Payment"},
            {"clause": "20.1", "obligation": "Give Notice of Employer's Claim within 28 days", "timing": "28 days from awareness", "priority": "Critical", "category": "Claims"},
        ]
...
def generate_register(form, party, fmt, output=None):
    ...
    if fmt == "md":
        lines = [VISIBLE_DISCLAIMER, HTML_DISCLAIMER, f"# Obligations Register — {db['name']}", "",
        ...
        writer.writerow(CSV_DISCLAIMER)
