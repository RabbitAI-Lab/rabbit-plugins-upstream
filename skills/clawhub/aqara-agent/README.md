...
1. **Open the normative spec:** [`SKILL.md`](SKILL.md) (CLI rules, method list, session order, intent table, error handling).
...
| **Ambience / mood (`ambience_create`)** | [`references/ambience.md`](references/ambience.md) (workflow, LightingEffectAgent, **save scene payload**, fast path for presets) |
...
**Note:** Persisted **lighting ambience** scene saves are specified in [`references/ambience.md#save-scene-payload`](references/ambience.md#save-scene-payload) and tied to create-scene APIs per [`SKILL.md`](SKILL.md) intent routing; follow `SKILL.md` for when **not** to use `scene-workflow/create.md`.
