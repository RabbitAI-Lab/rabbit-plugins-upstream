---
name: retail-network
slug: ddtclaw-retail-network
displayName: 店店通·零售连锁门店网络分析
version: 1.0.0
summary: 面向零售连锁的市场、拓展与渠道团队，快速看清门店规模、业态结构、区域覆盖、竞争与候选点机会。
description: 用已发布的零售品牌门店快照，快速分析门店网络、业态分类、区域覆盖、周边画像、品牌对比与坐标选址。适合便利店、超市、药店、化妆品等零售连锁团队做市场与拓展判断。
tags: [零售, 连锁, 门店网络, 业态分析, 渠道拓展, 选址]
homepage: https://gotoshop-ai.com/ddtclaw/
---

# 零售行业门店网络（retail-network）
