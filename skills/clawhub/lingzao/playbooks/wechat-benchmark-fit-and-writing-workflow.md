...
Open the liked links only after confirming paid scope and current credit cost.
...
seed URL and within the confirmed credit scope.
...
- stop at the confirmed credit ceiling
