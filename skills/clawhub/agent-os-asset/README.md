...
`agent-os-asset` is a privacy-safe toolkit for turning mixed historical files and code repositories into reviewable Agent Assets and final retrieval indexes. / `agent-os-asset` 是一个隐私安全工具包，用于把混合历史文件与代码仓库转换为可 review 的 Agent Assets 和最终检索索引。
