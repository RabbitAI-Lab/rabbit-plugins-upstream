---
name: agent-os-asset
description: "Design and execute privacy-safe historical-file modernization as a vendor-neutral Agent Skills suite / 以供应商中立的 Agent Skills 套件设计并执行隐私安全的历史文件现代化，覆盖 source、semantic entry、manifest、review、lifecycle decisions 与 final retrieval indexing。"
license: Apache-2.0
metadata:
  version: "0.1.0"
---

# Agent OS Asset v0.1.0 / Agent OS 资产 v0.1.0
...
Agent Asset v0.1.0 has four layers. / Agent Asset v0.1.0 包含四层。
