...
环境变量：
  ...
  TENCENTCLOUD_COS_BUCKET       - COS Bucket 名称（必需）
...
# 老片修复（OldFilm）— 源画质特别差/损失严重，综合增强+人脸增强+去划痕
# 小脸优化-真人（RealSmallFace）— 远景小脸优化，适用真人场景
# 小脸优化-漫剧（AnimeSmallFace）— 远景小脸优化，适用漫剧场景
#
# 模板号  场景             分辨率  说明
...
# 327021  OldFilm          720P    老片/低清场景-大模型修复-综合增强+人脸增强+去划痕
# 327022  OldFilm          1080P   老片/低清场景-大模型修复-综合增强+人脸增强+去划痕
# 327023  OldFilm          2K      老片/低清场景-大模型修复-综合增强+人脸增强+去划痕
# 327024  OldFilm          4K      老片/低清场景-大模型修复-综合增强+人脸增强+去划痕
# 327025  RealSmallFace    720P    真人场景-大模型增强-小脸优化-720P
# 327026  RealSmallFace    1080P   真人场景-大模型增强-小脸优化-1080P
# 327027  RealSmallFace    2K      真人场景-大模型增强-小脸优化-2K
# 327028  RealSmallFace    4K      真人场景-大模型增强-小脸优化-4K
# 327029  AnimeSmallFace   720P    漫剧场景-大模型增强-小脸优化-720P
# 327030  AnimeSmallFace   1080P   漫剧场景-大模型增强-小脸优化-1080P
# 327031  AnimeSmallFace   2K      漫剧场景-大模型增强-小脸优化-2K
# 327032  AnimeSmallFace   4K      漫剧场景-大模型增强-小脸优化-4K
...
DIFFUSION_TEMPLATES = {
    ...
    "face-2k": 327019,
    "face-4k": 327020,
    # 老片/低清修复（OldFilm）— 源画质特别差，综合增强+人脸增强+去划痕
    "old-720p": 327021,
    "old-1080p": 327022,
    "old-2k": 327023,
    "old-4k": 327024,
...
DIFFUSION_TEMPLATE_DESC = {
    ...
    327021: "老片/低清修复-720P（源画质特别差，综合增强+人脸增强+去划痕）",
    327022: "老片/低清修复-1080P（源画质特别差，综合增强+人脸增强+去划痕）",
    327023: "老片/低清修复-2K（源画质特别差，综合增强+人脸增强+去划痕）",
    327024: "老片/低清修复-4K（源画质特别差，综合增强+人脸增强+去划痕）",
    327025: "真人场景-小脸优化-720P（远景小脸优化，适用真人场景）",
    327026: "真人场景-小脸优化-1080P（远景小脸优化，适用真人场景）",
    327027: "真人场景-小脸优化-2K（远景小脸优化，适用真人场景）",
    327028: "真人场景-小脸优化-4K（远景小脸优化，适用真人场景）",
    327029: "漫剧场景-小脸优化-720P（远景小脸优化，适用漫剧场景）",
    327030: "漫剧场景-小脸优化-1080P（远景小脸优化，适用漫剧场景）",
    327031: "漫剧场景-小脸优化-2K（远景小脸优化，适用漫剧场景）",
    327032: "漫剧场景-小脸优化-4K（远景小脸优化，适用漫剧场景）",
}
...
def build_transcode_task(args):
    ...
    策略：
    - 如果用户指定了 --template（大模型增强专用模板 327001~327032）→ 直接使用该模板
...
环境变量：
  ...
  TENCENTCLOUD_COS_REGION       COS Bucket 区域（必需）
    ...
    diffusion_template_group = parser.add_argument_group(
        "大模型增强专用模板（327001~327032，直接指定模板号，优先级最高）"
    )
    diffusion_template_group.add_argument(
        "--template", type=int, metavar="TEMPLATE_ID",
        help=(
            "直接指定大模型增强专用模板 ID（327001~327032），优先级高于 --preset 和其他增强参数。\n"
            ...
            "老片/低清修复（OldFilm，综合增强+人脸增强+去划痕）：327021(720P) 327022(1080P) 327023(2K) 327024(4K)\n"
            "真人小脸优化（RealSmallFace，远景小脸优化）：327025(720P) 327026(1080P) 327027(2K) 327028(4K)\n"
            "漫剧小脸优化（AnimeSmallFace，远景小脸优化）：327029(720P) 327030(1080P) 327031(2K) 327032(4K)"
        )
    )
