# Contributing to `Api Spec To Mock Server`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Api Spec To Mock Server.git
cd Api Spec To Mock Server
...
git add .
git commit -m "feat(api-spec-to-mock-server): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(api-spec-to-mock-server): add <brief description>
