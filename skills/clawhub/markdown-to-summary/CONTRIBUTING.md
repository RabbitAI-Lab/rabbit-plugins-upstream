# Contributing to `Markdown To Summary`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Markdown To Summary.git
cd Markdown To Summary
...
git add .
git commit -m "feat(markdown-to-summary): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(markdown-to-summary): add <brief description>
