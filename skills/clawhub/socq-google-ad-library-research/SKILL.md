---
name: socq-google-ad-library-research
description: Research public Google Ad Library content, accounts, keywords, and performance data with SocQ. Use when an agent needs Google Ad Library-specific discovery, collection, endpoint selection, credit estimates, asynchronous task execution, pagination, or raw exports through the SocQ CLI, MCP, or REST API.
metadata:
  openclaw:
...
# SocQ Google Ad Library Research

## SocQ Links

- Website: <https://socq.ai/>
- Platform page: <https://socq.ai/platforms>
- API documentation: <https://docs.socq.ai/api-manual/google-ad-library>
...
Use this Skill to select and run SocQ endpoints for public Google Ad Library research. SocQ requests are asynchronous and credit-metered.

## Use When

- The user asks to discover, collect, compare, or analyze public Google Ad Library data.
- The workflow needs Google Ad Library-specific endpoint selection, input validation, pagination, or raw exports.
...
1. Prefer an already configured SocQ MCP server at `https://api.socq.ai/mcp?platforms=google-ad-library`; use the typed tool listed in [platform.md](references/platform.md), or compact `socq_execute` when needed.
