---
name: error-patterns
description: Provides error classification, recovery, and graceful-degradation patterns
version: 1.9.8
triggers:
  - errors
  - error-handling
  ...
  - resilience
  - debugging
  - implementing error handling or debugging resilience failures in any skill
