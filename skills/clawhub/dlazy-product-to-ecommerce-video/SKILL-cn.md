---
name: dlazy-product-to-ecommerce-video
version: 1.3.4
description: "商品转视频、带货视频、电商广告、Amazon 链接转视频、TikTok Shop 视频、跨境带货——把产品规格书、说明书、目录,或 Amazon / Shopify / eBay / Temu 商品链接做成以转化为目标的带货短视频,支持多语言配音与可选数字人主播。用于商品广告与跨境带货视频。"
...
商品转视频、带货视频、电商广告、Amazon 链接转视频、TikTok Shop 视频、跨境带货——把产品规格书、说明书、目录,或 Amazon / Shopify / eBay / Temu 商品链接做成以转化为目标的带货短视频,支持多语言配音与可选数字人主播。用于商品广告与跨境带货视频。
...
此技能与 dlazy 沙箱 agent 对话，**已固定到 `product-to-ecommerce-video` 模板** —— 一个以项目为单位、可端到端运行该模板的助手，支持多轮对话。
...
> **智能体关键指令**:
>
> 1. 新任务运行 `dlazy chat --skill product-to-ecommerce-video --prompt "..."`。
