...
Options:
  ...
  --generation_mode [generation_mode]  Generation Mode（frames=Frames; components=Components; extend=Extend Video） [default: frames] (choices: "frames", "components", "extend")
  ...
  --video [video]                      Video (URL) [video: url or local path] [only when generation_mode="extend"]
  --size [size]                        Size [default: 16:9] (choices: "16:9", "9:16") [only when generation_mode!="extend"]
  --resolution [resolution]            Resolution [default: 720P] (choices: "720P", "1080P", "4K") [only when generation_mode!="extend"]
  --duration [duration]                Duration (s) (4/6/8 in frames mode; fixed 8 in components mode; fixed 7 in extend mode) Options depend on "generation_mode". when generation_mode="": 4 (4s), 6 (6s), 8 (8s); when generation_mode="generation_mode=components": 8 (8s); when generation_mode="generation_mode=extend": 7 (+7s) [default: 8] (choices: "4", "6", "8", "7")
