...
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy veo-3.1 -h 查看帮助信息。"}}
---
...
Options:
  --prompt [prompt]                    提示词
  --generation_mode [generation_mode]  生成模式（frames=首尾帧; components=参考图; extend=视频延展） [default: frames] (choices: "frames", "components", "extend")
  ...
  --video [video]                      视频链接 [video: url or local path] [only when generation_mode="extend"]
  --size [size]                        尺寸 [default: 16:9] (choices: "16:9", "9:16") [only when generation_mode!="extend"]
  --resolution [resolution]            分辨率 [default: 720P] (choices: "720P", "1080P", "4K") [only when generation_mode!="extend"]
  --duration [duration]                时长（秒） (4/6/8 in frames mode; fixed 8 in components mode; fixed 7 in extend mode) Options depend on "generation_mode". when generation_mode="": 4 (4s), 6 (6s), 8 (8s); when generation_mode="generation_mode=components": 8 (8s); when generation_mode="generation_mode=extend": 7 (+7s) [default: 8] (choices: "4", "6", "8", "7")
...
# 复杂调用：
dlazy veo-3.1 --prompt '提示词内容' --image 'https://files.dlazy.com/image.png'
```
