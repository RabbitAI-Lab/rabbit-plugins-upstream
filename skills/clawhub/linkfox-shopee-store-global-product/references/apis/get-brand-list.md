...
| Method / path | GET `api/v2/global_product/get_brand_list` |
| 官方文档 | [get_brand_list](https://open.shopee.com/documents/v2/v2.global_product.get_brand_list?module=90&type=1) |
...
# 通用入口
python scripts/global_product_api.py '{"api": "get_brand_list", "shopId": "67890", "offset": "<offset>", "page_size": 20, "category_id": 123}'
```
