...
def main() -> None:
    ...
    print(json.dumps(run_global_product_api("get_global_item_list", params, "get_global_item_list.py"), indent=2, ensure_ascii=False))
