...
def main():
    if len(sys.argv) < 3:
        print("用法: python cli.py <file_path> <chart_type> [--title 标题] [--x-axis 列名] [--y-axis 列1 列2] [--transform-code 代码] [--output-dir 目录] [--skiprows N] [--header-row N] [--sheet <name|index>] [--lang zh|en]")
        sys.exit(1)
