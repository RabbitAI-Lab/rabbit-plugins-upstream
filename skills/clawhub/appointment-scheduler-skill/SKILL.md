...
Polly Appointment Scheduler is your personal booking agent. Whether it's a dental cleaning, a haircut, a car inspection, a visa interview, or a business meeting — Polly finds the right number, calls the provider, negotiates available time slots based on your preferences, and confirms the appointment.
Many service providers still only accept phone bookings. Polly bridges that gap.

---

## When to Use

- The user needs to schedule an appointment with any service provider
- The user says things like "book me an appointment with…", "schedule a visit to…", "I need to see a doctor on…"
- The user wants to arrange interviews, consultations, or in-person meetings by phone
- The provider doesn't offer online scheduling
