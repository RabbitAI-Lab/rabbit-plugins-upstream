---
name: patentfig-ai-patent-drawing
...
license: MIT
metadata:
  slug: patentfig-ai-patent-drawing
  displayName: PatentFig AI Patent Drawing
  version: 1.0.0
  summary: Generate patent line art, numbered figures, and filing-ready vector or raster outputs with PatentFig AI.
  tags:
    - patent-drawing
    - patent-figure
    - line-art
    - vectorization
  author: TopLocalAI, LLC
  homepage: https://patentfig.ai
  repository: https://github.com/TopLocalAI/patentfig-skill
...
- Before any credit-consuming call, state the operation and its credit cost,
  then get the user's confirmation immediately before execution.
