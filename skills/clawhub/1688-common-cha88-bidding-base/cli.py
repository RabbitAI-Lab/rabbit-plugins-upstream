#!/usr/bin/env python3
"""
cha88-bidding-search —— 88查招投标搜索工具 CLI 统一入口

用法：
    python3 cli.py bidding_search --keyword "关键词" --pageNo "1" --pageSize "10"

Usage:
    python3 cli.py <command> [options]

Commands（更多参数见项目根目录 SKILL.md）:
    bidding_search  招投标搜索    python3 cli.py bidding_search --keyword "智慧城市" --pageNo "1" --pageSize "10"
