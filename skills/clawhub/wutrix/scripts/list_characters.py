...
"""List wutrix characters.

Usage:
    list_characters.py
    list_characters.py --universe awakening_uni
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="List wutrix characters")
    ...
    url = base_url.rstrip("/") + "/api/characters"
    if args.universe:
