...
```bash
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub"
```
...
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --start-date "2026-04-15 00:00:00" --end-date "2026-04-16 00:00:00"
```
...
```bash
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --platforms "wb,dy,bz"
```
...
```bash
# 关键词筛选
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --keywords "体育,足球"

# 关键词泛化扩展
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --keywords "体育" --expand-keywords
```
...
```bash
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --platforms wb --output markdown
```
...
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --start-date "2026-04-15 00:00:00" --end-date "2026-04-16 00:00:00"  # 昨日
python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --start-date "2026-04-16 00:00:00" --end-date "2026-04-17 00:00:00"  # 今日实时
```
...
| 场景 | 命令 |
|------|------|
| 最新热榜 | `python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub"` |
| 今日热榜 | `python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --start-date "T 00:00:00" --end-date "T HH:00:00"` |
| 昨日热榜 | `python scripts/fetch_hotspot.py --source "全平台热点事件-ClawHub" --start-date "T-1 00:00:00" --end-date "T 00:00:00"` |
