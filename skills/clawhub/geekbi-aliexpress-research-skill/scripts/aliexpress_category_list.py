...
ENDPOINT = "/api/v1/aliexpress/category/ai-list"
...
def validate_response(payload):
    data = validate_envelope(payload, "AliExpress 类目列表查询失败")
...
def main():
    parser = argparse.ArgumentParser(description="查询 AliExpress 子类目")
