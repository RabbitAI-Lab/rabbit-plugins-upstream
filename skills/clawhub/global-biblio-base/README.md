# SmartLib 学术文献检索 Skill v3.10.1

用自然语言查论文、找文献、下载全文 —— 覆盖 8000 万篇中文期刊 + 12.28 亿条全球文献。**全自动**：首次使用自动注册开通（免费 100 次/月），配额自动消耗，用尽引导支付宝扫码支付。
...
配额耗尽后回复「充值」，展示数字选套餐卡片（①-④），回复数字即可获取带套餐信息的支付宝付款码。
...
**配额耗尽 → 对话支付：** 在对话中说「充值」→ 展示 ①-④ 数字套餐卡片 → 回复数字选择 → 直接出带订单信息的支付宝付款码 → 扫码支付 → 即时恢复。

---

## 常见问题

**Q: 免费吗？** 首次使用自动注册，免费 100 次/月。超出后付费，¥9.90 体验卡（1000 次）起。

**Q: 英文文献能下全文吗？** 可以。十一级多渠道下载策略，Gold/Hybrid/Green OA 成功率 >85%。付费墙内（Closed）论文无法获取。

**Q: 配额耗尽后怎么办？** 在对话中说「充值」，展示数字选套餐卡片，回复数字直接获取支付宝付款码，扫码后即时恢复。
