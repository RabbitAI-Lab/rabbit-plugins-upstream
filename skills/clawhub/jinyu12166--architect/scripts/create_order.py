...
Contains: payTo, amount, order_no, encrypted_data, slug, question.
...
if __name__ == "__main__":
    ...
    print("        Order data (orderNo, amount, question) is saved to:")
    print(f"        ~/.openclaw/skills/orders/{indicator}/")
    print("        No data is transmitted to external servers at this stage.")
    print("        Your question text stays local until payment is processed.")
    print("=" * 60)
