...
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.0.9","installAlternative":"npx @dlazy/cli@1.0.9","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy wan2.6-r2v-flash -h 查看帮助信息。"}}
---
...
Options:
  --prompt [prompt]                    提示词
  --generation_mode [generation_mode]  生成模式 [default: components] (choices: "components")
  --images [images...]                 参考图 [image: url or local path] (max 10)
  --size [size]                        尺寸 [default: 720*1280] (choices: "1280*720", "720*1280", "960*960", "1088*832", "832*1088", "1920*1080", "1080*1920", "1440*1440", "1632*1248", "1248*1632")
  --duration [duration]                时长（秒） [default: 5] (choices: "2", "3", "4", "5", "6", "7", "8", "9", "10")
  --shotType [shotType]                镜头类型 [default: single] (choices: "single", "multi")
...
# 复杂调用：
dlazy wan2.6-r2v-flash --prompt '提示词内容' --image 'https://files.dlazy.com/image.png'
```
