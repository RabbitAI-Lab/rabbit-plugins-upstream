...
3. 调用即刻数据开放接口 `/v1/birthday/pwd` 查询数据。
...
API_PATH = "/v1/birthday/pwd"
APPKEY_ENV_NAMES = ("JIKE_BIRTHDAY_PWD_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
FIELDS = [('birthday', '生日'), ('lucky', '幸运'), ('healthy', '健康'), ('suggest', '建议'), ('celebrity', '名人'), ('tarot', '塔罗'), ('aphorism', '箴言'), ('advantage', '优点'), ('disadvantage', '缺点')]
OPTIONAL_PARAMS = [('birthday', '生日，格式 MM-DD，例如 01-06')]
REQUIRED_PARAMS = []
