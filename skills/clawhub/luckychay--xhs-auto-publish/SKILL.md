...
2. **封面生成**：使用ImageMagick生成浅色背景深色字体封面，**必须使用 Noto-Sans-CJK-SC-Bold 中文字体**（-font Noto-Sans-CJK-SC-Bold），禁止用 Helvetica/Arial 等西文字体
...
- v1.1.0 (2026-06-21): 改为默认生成1个标题直接发布，无需逐项确认；修复封面字体（指定Noto Sans CJK SC Bold中文字体）