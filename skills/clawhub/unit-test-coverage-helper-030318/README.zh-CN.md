...
- github-issues：[fix: weekly-run must capture the full six-chart Kugou profile with pagination](https://github.com/chen-da-pang/music-analysis-kb/issues/27)
...
- github-issues：[Crew launch config channel-ref grammar mismatches real Claude Code 2.1.212 (plugin `:` vs `@`; `server:` needs dev flag)](https://github.com/kamp-us/phoenix/issues/3328)
