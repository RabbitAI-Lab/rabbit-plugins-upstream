...
4. One question at a time: what's your deep-vs-shallow ratio? What's the highest-leverage deep work? What's the cost of not doing it?
> **[WAIT — do not advance until user responds]**
5. Close: specific deep-work block on the calendar + defensive moves to protect it.
> **[WAIT — do not advance until user responds]**
...
*Part of **deciqAI Knowledge Skills** — 227 open-source thinking skills that make rigor executable for AI agents. The same skills power every deciqAI agent, which runs them autonomously to operate your company. **See it run → https://www.deciqai.com/c/deep-work** · ⭐ Star the repo → https://github.com/deciqAI/knowledge-skills · Contributions welcome.*
