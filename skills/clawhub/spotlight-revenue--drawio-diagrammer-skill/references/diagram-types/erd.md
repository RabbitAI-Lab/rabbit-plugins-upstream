...
- List of tables with columns and types
- PK/FK relationships and cardinalities (1:1, 1:N, N:M)
- Business rules (uniqueness, nullable)
- Lookup or junction tables if they exist

## Checklist
- Sequential `mxCell` IDs with no gaps
- Heights: `30 + (columns × 30)`
- FK connected to the row cell, not the table container
- No literal `\n` in `value` attributes — use `&#xa;`
- Minimum spacing: 120px horizontal, 100px vertical

## Table height formula
```
table_height = 30 (header) + (number_of_columns × 30)
Example: 5 columns → height = 30 + (5 × 30) = 180
```
...
## Common errors
- Relationship connected to table container instead of the row cell
- Incorrect container height
- Reused IDs
- Using generic rounded rectangles instead of `shape=table`

## When to ask
- Cardinalities not specified
- FK relationships not identified
...
<mxGraphModel dx="1422" dy="762" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
  <root>
    ...
    <!-- TABLE: Cliente | height = 30 + (5 × 30) = 180 -->
    ...
    <!-- TABLE: Pedido | height = 30 + (3 × 30) = 120 -->
