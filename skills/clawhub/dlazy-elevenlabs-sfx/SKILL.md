...
Execute `dlazy elevenlabs-sfx` to get the result.
...
Options:
  ...
  --duration [duration]                Duration (s) [default: 5]
  --prompt_influence [prompt_influence]Prompt Influence [default: 0.3]
...
```bash
dlazy elevenlabs-sfx --prompt 'prompt content'
```
