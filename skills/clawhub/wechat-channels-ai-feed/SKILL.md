...
前往 [redfox.hk/api-keys](https://www.redfox.hk/settings/api-keys?source=clawhub) 注册获取个人 API Key。
...
**Q：没有 API Key 怎么办？**
A：前往 [redfox.hk](https://www.redfox.hk/settings/api-keys?source=clawhub) 注册获取，然后执行 `export REDFOX_API_KEY=ak_你的密钥`。
