...
metadata:
  openclaw:
    homepage: description: Web search via 9Router /v1/search using Tavily / Exa / Brave / Serper / SearXNG / Google PSE / Linkup / SearchAPI / You.com / Perplexity. Use when the user wants to search the web, look up information, find articles, check news, or query a search engine.
    version: homepage: https://github.com/decolua/9router
---
