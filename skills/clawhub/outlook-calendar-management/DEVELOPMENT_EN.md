...
references/             # User documentation
  commands.md           # Full command reference (English: commands_EN.md)
  recurring-events.md   # Recurring events deep-dive (English: recurring-events_EN.md)
  configuration.md      # Connection configuration (English: configuration_EN.md)
  troubleshooting.md    # Troubleshooting (English: troubleshooting_EN.md)
  azure-app-setup.md    # Bring-your-own Azure app registration (English: azure-app-setup_EN.md)
```
