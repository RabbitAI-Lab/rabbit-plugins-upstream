...
它不只总结内容，还会整理老师解决问题的方法，设计循序练习，针对你的尝试给反馈，并检查你能不能在真实场景中独立使用。
...
| 6. 开始第一课 | 告诉新 Skill 你的目标、基础、可投入时间和想解决的真实问题 | 先做简短摸底，再给一个与你当前水平匹配的任务，等你尝试后才反馈 |
...
<img src="./docs/img/lineage-real-workflow-demo-zh.gif" alt="Lineage 使用虚构合同审查课程演示从材料整理、方法提炼、第一次尝试、针对性反馈、修订到迁移检验的完整学习过程" width="100%">
...
> 用刚刚生成的课程 Skill 开始带我学习。先问清楚我的目标、基础、每周可投入时间和一个真实应用场景；然后做一次简短摸底，只给我当前最合适的一项练习。等我提交第一次尝试后，再按明确标准反馈并让我修订。
...
<img src="./docs/img/lineage-system-architecture.svg" alt="从课程来源到个人能力的四个层次" width="100%">
...
<img src="./docs/img/apprenticeship-lifecycle.svg" alt="从开始学习到独立应用的完整过程" width="100%">
