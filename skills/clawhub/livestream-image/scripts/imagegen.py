...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量直播带货图片，主体准确，商业信息清晰", "keywords": "直播带货图片、直播间背景、带货图、直播贴片、直播商品图、直播视觉、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "livestream-image", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "直播带货图片"}')
