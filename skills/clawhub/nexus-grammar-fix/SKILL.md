...
description: "Fix grammar, spelling, and improve writing"
version: 2.1.0
capabilities:
...
> NEXUS Agent-as-a-Service on Cardano + Stellar + XRPL | Price: $0.02/request | Accepts: ADA, DJED, iUSD, USDCx, USDM (Cardano) + USDC, XLM (Stellar) + XRP, RLUSD (XRPL)

## When to use

Use when you need to fix grammar, spelling, and improve writing.
...
curl -X POST https://ai-service-hub-15.emergent.host/api/original-services/grammar-fix \
  ...
  -d '{
  "input": "Example input for Grammar Fixer"
}'
```
