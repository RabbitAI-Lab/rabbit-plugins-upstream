...
def main():
    ...
    parser.add_argument("--kilohertz", help="Shared kilohertz value. Default: 48000.")
    parser.add_argument("--kilohertz-direction", help="Shared kilohertz direction. Default: <=.")
    ...
    parser.add_argument("--is-subtitles", help="Shared is_subtitles value. Default: false.")
