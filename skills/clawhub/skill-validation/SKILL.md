...
description: "changelog: "v2.0.0: Align with current ClawHub spec — trigger-style descriptions, single-line metadata JSON, folder=slug rule, progressive disclosure budget, install specs. v1.0.0: Initial checklist"
metadata:
  openclaw:
    homepage: description: Validate a skill folder against ClawHub publishing standards. Use when creating a new skill, editing an existing SKILL.md, reviewing someone else's skill, or before publishing/deploying to ClawHub.
...
## 2. PURPOSE
changelog: "v2.0.0: Align with current ClawHub spec — trigger-style descriptions, single-line metadata JSON, folder=slug rule, progressive disclosure budget, install specs. v1.0.0: Initial checklist
