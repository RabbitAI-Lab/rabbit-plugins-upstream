---
name: amazon-competitor-listing-gap
description: >
...
slug: competitor-listing-gap
displayName: Amazon 竞品 Listing 差距
version: 1.4.7
summary: 对照竞品商品页字段识别 Listing 表达差距
license: MIT
---
...
- 本入口只执行 `page_compare/listing_gap`，输出模板固定为 `ops_page_compare`。
