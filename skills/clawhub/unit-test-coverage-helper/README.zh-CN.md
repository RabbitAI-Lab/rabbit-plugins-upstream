...
- github-issues：[Evaluator provenance: supplied by the environment, never self-reported](https://github.com/rzhu3/psi-mini/issues/33)
- github-issues：[[Bug] Prometheus metrics format bug](https://github.com/apache/hugegraph/issues/3142)
- github-issues：[ci(parser): restore parser-stack gate and formatter baseline](https://github.com/EffortlessMetrics/perl-lsp-swarm/issues/6491)
...
- github-issues：[First-class OpenCode Go and Zen LLM providers](https://github.com/svarm-dev/svarm/issues/118)
- hacker-news-search：[What's the best programming language for coding agents?](https://news.ycombinator.com/item?id=49252952)
