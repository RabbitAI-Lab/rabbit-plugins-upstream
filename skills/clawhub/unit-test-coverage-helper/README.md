...
- github-issues: [[SIA][W02] Establish collector, clock, metric and capability architecture](https://github.com/davecrawley/sia/issues/14)
- github-issues: [[Relationships][Friend][FFR-06] Prove real Mac↔Windows Friend walk on current exact source](https://github.com/vgong24/VexLife/issues/379)
- github-issues: [MASTER: Web Pilot capability-gap and production-readiness program](https://github.com/ORCHORDS/OrchordsBrowserPilot/issues/9)
- github-issues: [P0: Harden Streamable HTTP against DNS rebinding, hostile origins, request abuse, and unsafe exposure](https://github.com/ORCHORDS/OrchordsBrowserPilot/issues/43)
- hacker-news-ask-hn: [User-guide-driven development with coding agents](https://news.ycombinator.com/item?id=49579372)
- github-issues: [Add agy (Antigravity CLI) as a third TuvalAiAgent backend, Pi-shaped and kernel-tool-free](https://github.com/kamp-us/phoenix/issues/8162)
