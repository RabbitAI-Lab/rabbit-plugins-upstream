...
- github-issues: [goobers doctor --k8s: add the six checks a real multi-node deployment needed and every existing gate missed (pin agreement, image contract, runner capacity vs allocatable, apiserver ipBlock drift, per-container pod health, OTLP signal set)](https://github.com/Agent-Clubhouse/Goobers/issues/4290)
- github-issues: [Pre-Build Diff-Size and Iteration-Velocity Anomaly Warning in Pipeline Vitals](https://github.com/sethdford/shipwright/issues/3313)
- github-issues: [Pre-Build Static Lint Gate for Bash 3.2 Compatibility Violations](https://github.com/sethdford/shipwright/issues/3239)
- github-issues: [Adaptive Build-Loop Iteration Budget Based on Historical Issue Complexity](https://github.com/sethdford/shipwright/issues/3347)
- github-issues: [Split sw-daemon.sh into scripts/lib/daemon-*.sh Modules Beyond Existing Extraction](https://github.com/sethdford/shipwright/issues/3346)
- github-issues: [Distinguish transient/infra errors from code errors in build-loop failure classification](https://github.com/sethdford/shipwright/issues/3458)
- hacker-news-search: [We had a unit test once which only failed on Sundays (2015)](https://qntm.org/unit)
...
- segmentfault-search: [Writing Great Unit Tests: Best and Worst Practices](https://segmentfault.com/a/1190000009709754)
