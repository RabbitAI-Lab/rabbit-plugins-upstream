...
/**
 * 获取候选布局列表
 * 用法: node getCandidateLayout.js --token <token> --designId <designId>
 */
...
const options = {
    ...
    port: 443,
    path: `/oauth2/openapi/ai-design-skill/layout/candidateList?access_token=${encodeURIComponent(token)}&obsDesignId=${designId}`,
    method: 'GET'
};
