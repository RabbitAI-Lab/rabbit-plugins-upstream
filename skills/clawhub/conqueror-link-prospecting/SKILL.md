---
name: conqueror-link-prospecting
description: "Find link prospects from SERPs and competitor backlinks, discover public contact paths, and draft personalized outreach. Use when promoting a page, study, or tool. Requires a connected Conqueror MCP server."
---
...
Find realistic pages, sites, and authors that might reference the user's page, product, study, guide, or tool. Use Conqueror for prospect discovery, then use available web/search/browser tools for contact discovery.
...
After Conqueror identifies good prospects, use available non-Conqueror browsing or search tools for public contact discovery. Depending on the client, this may be web search, page fetches, browser automation, or a search API.
...
- Do not say Conqueror found contact details unless a Conqueror tool returned them. Attribute contact discovery to the web/search/browser source used.
