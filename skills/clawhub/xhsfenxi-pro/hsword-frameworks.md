...
| 博主 | 外壳 | 真正内核 | 深层价值观 |
|------|------|---------|-----------|
| A 荒诞美学代表（A型）| 旅行vlogger / 文艺青年 | "荒诞滤镜下的生活哲学家" | 用奇怪但有质感的视角，记录在世界上存在过的痕迹 |
| B 共鸣命名代表（B型）| 旅行/成长博主 | "把私人经历转为普世命题的命名者" | 让年轻人获得"原来不止我这样"的理解 |
| C 现实策略代表（C型）| 大厂博主/成长博主 | "普通女孩现实破局教练型博主" | 普通女性如何在不体面的现实里最大化利用手上的牌 |
| B 治愈系代表（B+A）| 留学vlogger | "把说不清楚的感受用诗意语言说清楚的命名者" | 鼓励女性关注自己内心，认可流动与不确定性 |
