# 🏛️ 智慧招采通 Smart Procurement Navigator v2.1.0

[![Version](https://img.shields.io/badge/version-2.1.0-blue)](https://github.com/yinjianheng/smart-procurement-navigator)
...
```bash
# 安装到 Claude / WorkBuddy / OpenClaw / Code X / Cursor
