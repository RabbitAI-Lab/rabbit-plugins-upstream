...
description: >
  ...
  More: deciqai.com/c/business-model-canvas
---
...
**Compose:** first-principles to clarify genuine dependencies · occams-razor to compare models · inversion to find the block whose failure kills the model · second-order-thinking to trace block cascades.
...
2. Check fit against When to Use / When NOT to use. If no customer named, redirect to first-principles.
...
*Part of **deciqAI Knowledge Skills** — 227 open-source thinking skills that make rigor executable for AI agents. The same skills power every deciqAI agent, which runs them autonomously to operate your company. **See it run → https://www.deciqai.com/c/business-model-canvas** · ⭐ Star the repo → https://github.com/deciqAI/knowledge-skills · Contributions welcome.*
