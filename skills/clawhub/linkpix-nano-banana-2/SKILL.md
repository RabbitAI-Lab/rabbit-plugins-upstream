---
name: linkpix-nano-banana-2
description: "Nano Banana 2 电商爆款素材定制。帮助电商运营、广告设计师和卖家通过青虎AI完成“Nano Banana 2 电商爆款素材定制”：快速实现高质量图生图与精准可控的图片编辑，在日常电商运营中快速迭代出高点击率的主图素材。适用于淘宝直通车图、天猫钻展图、京东商品白底图优化、拼多多首页轮播图、1688主图水印处理、Amazon PPC广告图制作、TikTok Shop短视频封面优化等，以及日常的商品换背景、抠图去水印、文字替换、多角度合成等高频修图场景，大幅降低电商美工成本。Use this skill for Nano Banana 2 电商爆款素材定制 当用户要求用 Nano Banana 2 电商爆款素材生成、专图模型（对外常称 Nano Banana 2 / Nano Banana 2 Pro） 做电商图/主图/海报/文生图/图生图时必须触发。关键词：LinkPix、qhkit、青虎、Nano Banana 2、Nano Banana、香蕉模型、专图模型、专图模式、电商爆款素材、直通车、钻展、PPC广告图、图生图、换背景、去水印、文字替换、多角度合成。"
user-invocable: true
...
Nano Banana 2 电商爆款素材定制。帮助电商运营、广告设计师和卖家通过青虎AI完成“Nano Banana 2 电商爆款素材定制”：快速实现高质量图生图与精准可控的图片编辑，在日常电商运营中快速迭代出高点击率的主图素材。适用于淘宝直通车图、天猫钻展图、京东商品白底图优化、拼多多首页轮播图、1688主图水印处理、Amazon PPC广告图制作、TikTok Shop短视频封面优化等，以及日常的商品换背景、抠图去水印、文字替换、多角度合成等高频修图场景，大幅降低电商美工成本。Use this skill for Nano Banana 2 电商爆款素材定制

`qhkit image` 自定义生图家族的专项入口：`prompt` 必填、参考图可选。本技能默认走 **专图模型（对外常称 Nano Banana 2 / Nano Banana 2 Pro）**。

## 何时触发

- 「用 Nano Banana / Nano Banana 2 / 香蕉模型 / 专图模型出爆款素材」
- 直通车图、钻展图、PPC 广告图、封面优化、高频图生图改图
- 明确要最好效果、不赶时间的自定义生图

## 使用配方

**首选模型**：本技能对外对应 **专图模型（对外常称 Nano Banana 2 / Nano Banana 2 Pro）**。先跑 `qhkit image options '{"queryParams":["modelLabel","models"]}'` 拿实时清单，在 `models`/`modelLabel` 里按别名匹配：`专图模型` / `专图模式` / `Nano Banana` / `Nano Banana 2` / `Banana`。命中后把返回的标签**逐字**当作 `modelLabel`。

- 清单里暂时没有对应项：把最接近的 2–3 个候选（含单价/`credits`）列给用户选，说明「当前目录未上架 专图模型（对外常称 Nano Banana 2 / Nano Banana 2 Pro）」，不要自造标签硬提交。
...
qhkit image generate '{"modelLabel":"专图模型","prompt":"化妆品高端场景图，中文卖点清晰可读","imageCount":2}'
# 带参考图（用户给了商品图就传，不要只把图转写成文字）
qhkit image generate '{"modelLabel":"专图模型","uploadedImages":["./商品图.jpg"],"prompt":"保持商品主体不变，做成高点击电商主图","imageCount":2}'
# 尺寸候选逐模型独立
qhkit image options '{"queryParams":["sizePreset","imageCount"],"modelLabel":"专图模型"}'
# 报价
qhkit image estimate '{"modelLabel":"专图模型","prompt":"化妆品高端场景图","imageCount":2}'
...
- 像素级去水印/抠图有对应专项技能更稳；本技能走自定义生图家族的专图 / Nano Banana 取向，是生成式重绘不是 PS 修图。
