...
#### Create a Chunked Upload for a New Version
...
req = urllib.request.Request(GATEWAY + "/box/2.0/users/me")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-box-skill/1.2")
