...
summary: "基础区块链安全API，地址声誉检查和积分蜜罐检测。面向AI代理的区块链安全API免费版。提供地址声誉检查、积分蜜罐检测和免费额度查询等基础功能， 支持Ethereum和Base链。适用于基础"
summary_zh: "基础区块链安全API，地址声誉检查和积分蜜罐检测。面向AI代理的区块链安全API免费版。提供地址声誉检查、积分蜜罐检测和免费额度查询等基础功能， 支持Ethereum和Base链。适用于基础"
license: "MIT"
description: |- 功能涵盖:。Use when 需要安全检测、合规审计、质量检查、加密防护时使用。不适用于安全评估未授权目标。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。提供结构化输出和错误处理机制。支持多场景应用和灵活配置。具备完整的输入输出规范。 功能涵盖: aegis。
  面向AI代理的区块链安全API免费版。提供地址声誉检查、积分蜜罐检测和免费额度查询等基础功能，
...
## 典型场景
- **日常开发**: 区块链安全基础版可快速集成到现有开发流程中,提升工作效率
