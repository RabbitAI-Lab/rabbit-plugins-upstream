...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：Figma、导出图层、查看评论的免费体、适合个人设计稿查、设计助手、是一款面向设计师、与开发协作的、文件交互工具、REST、API、实现文件结构读取、图层导出与评论查、看等核心能力、文件的页面、图层层级结构、按需导出指定图层、查看文件最近评论、支持协作沟通追踪、提供安全可靠的、Token、管理方式等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
...
```json
{
  "success": true,
  "data": {
    "result": "Figma设计助手(免费版)处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "figma tw designer"
    }
  },
