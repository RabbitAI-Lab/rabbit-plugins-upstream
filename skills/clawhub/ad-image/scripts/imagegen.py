...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量广告图片，主体准确，商业信息清晰", "keywords": "广告图片、广告图、广告KV、信息流广告、商业广告、品牌广告视觉、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "ad-image", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "广告图片"}')
