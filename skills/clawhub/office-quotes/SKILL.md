...
metadata: {"clawdbot":{"requires":{"bins":["office-quotes"]},"install":[{"id":"node","kind":"node","package":"@gumadeiras/office-quotes","bins":["office-quotes"],"label":"Install office-quotes (npm)"}]}}
---
