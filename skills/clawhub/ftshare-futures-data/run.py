#!/usr/bin/env python3
"""
FTShare-futures-data 统一调度入口（期货数据）。

用法：
    python run.py <subskill名> [handler参数...]

示例：
    python run.py futures-lists --trade-date 20260331
    python run.py futures-base-data --trade-date 20260331 --symbol A2605.DCE
    python run.py futures-kline --symbol A2605.DCE --interval 30min --limit 50
"""
import os
import runpy
import sys
