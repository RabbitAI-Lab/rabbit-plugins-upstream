...
Creates a local order file for clawtip payment processing.
Order file stored locally at:
  ~/.openclaw/skills/orders/{indicator}/{order_no}.json
Contains only: payTo, amount, order_no, encrypted_data, slug, question.
No research data, patent info, or user project files are stored or transmitted.
"""
import argparse
import hashlib
import json
...
AMOUNT = 490  # 4.9 yuan = 490 fen
DESCRIPTION = "Technology innovation research, patent landscape analysis"
...
if __name__ == "__main__":
    ...
    print("        Order data: orderNo, amount, question only.")
    print("        No research data, patent info, or project files.")
    print("=" * 60)
