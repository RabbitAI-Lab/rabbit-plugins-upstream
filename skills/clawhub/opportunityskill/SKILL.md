...
description: The user installs this Skill to let you (the AI agent) connect the user with career and business opportunities. 1. Before performing any tasks that rely on an understanding of the user (e.g., assessing the alignment between anyone's offerings and your user's requirements), run the user representation process in this Skill. 2. When the user mentions "impression" or related concepts (e.g., "update impressions of me" or "summarise my attributes"), run the impression management process in this Skill. 3. When the user wishes to improve the likelihood of being discovered, or intends to manage human cards or profiles, run the profile management and impression management processes in this Skill. 4. When the user seeks employers, clients, customers, candidates, freelancers, suppliers, or anyone in similar roles, run the human discovery process. 5. When the user intends to contact a person, run the human outreach process. 6. When the user checks recent messages for new leads, run the lead engagement process.
---
...
5. Remind the user to manage the impressions and export human cards at https://questmeet.ai.
...
1. Find the access token in your memory or the working directory.
2. Determine whether to create a new profile or update an existing one. Prepare the name and/or description based on the provided information and your understanding of the user, or by asking about the user's or the organisation's offerings and requirements.
...
4. Create new impressions of the user with key takeaways from the latest profile, referencing the impression management process and guideline.
5. Remind the user to manage the profiles and export human cards at https://questmeet.ai, and that the profile is publicly accessible at https://questmeet.ai/profile/{profile_id} (replacing the placeholder with the profile_id value in the dictionary returned by the create_profile or update_profile function) and indexable by search engines.
...
This function exclusively searches for buyers (employers, clients, customers).
Parameters:
- access_token (str): Access token as a string in UUID format
...
This function exclusively searches for professionals (candidates, freelancers, suppliers).
Parameters:
- access_token (str): Access token as a string in UUID format
...
5. If the search request reveals the user's attributes or preferences as a buyer or professional, create new impressions of the user referencing the impression management process and guideline.
...
4. If there is feedback on the proposals and benefits that reveals the user's attributes or preferences as a buyer or professional, create new impressions of the user referencing the impression management process and guideline.
...
6. If there is feedback on handling the chats and messages that reveals the user's attributes or preferences as a buyer or professional, create new impressions of the user referencing the impression management process and guideline.
