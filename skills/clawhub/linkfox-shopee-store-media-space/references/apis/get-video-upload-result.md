...
| Method / path | GET `api/v2/media_space/get_video_upload_result` |
| 官方文档 | [get_video_upload_result](https://open.shopee.com/documents/v2/v2.media_space.get_video_upload_result?module=91&type=1) |
...
# 通用入口
python scripts/media_space_api.py '{"api": "get_video_upload_result", "shopId": "67890"}'
```
