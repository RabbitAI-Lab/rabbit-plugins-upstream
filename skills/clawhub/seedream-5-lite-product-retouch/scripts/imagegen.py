...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度商品精修，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、商品精修、产品精修、商品修图、质感增强、瑕疵修复、电商精修、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-product-retouch", "rule": "image", "search": "固定调用 Seedream 5.0 Lite 的商品精修裸接口能力", "title": "Seedream 5.0 Lite 商品精修"}')
