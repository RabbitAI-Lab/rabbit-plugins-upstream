...
description: >-
  跨境电商 SEO 关键词研究 — 亚马逊 A9/Backend、Shopify 站内+Meta、TikTok 搜索+
话题标签，经 Yufluent 云端 Harness 输出结构化投放建议。Cross-border ecommerce
keyword research & SEO placement reports for Amazon (A9/backend), Shopify
(on-page+meta) & TikTok Shop (search+hashtags). Use for 关键词研究、SEO、A9、
search terms、长尾词、Backend Keywords、Meta title、TikTok 话题标签.
version: 1.1.2
author: 元畅 · Yufluent
metadata:
  category: ecommerce
  tags: [seo, keywords, amazon, a9, shopify, tiktok, listing, yufluent, b2b]
  billing: yufluent
...
|------|----------------------|----------------|
| **Amazon** | A9：相关性 + 转化 + 文案完整度；标题权重高 | 标题 / 五点 / Backend 分栏 + `avoid` |
...
```text
1) yufluentcn-seo-pro  →  JSON 关键词报告（本技能）
2) 人工删改 / 对照广告&搜索词报告（可选）
3) yufluentcn-ecommerce-listing  →  将高优先级词写入标题/五点/描述
...
| 字段 | 策略要点 |
|------|----------|
| **标题** | 核心高优先级词靠前；不堆砌重复词；遵守类目字数 |
| **五点** | 每点 1–2 个长尾；覆盖场景/人群/差异化 |
| **描述** | 补充同义词与场景叙事；避免与五点完全重复 |
...
5. **下一步**：_offer `yufluentcn-ecommerce-listing`，把 `primary_keywords` 中高优先级词写入 `--keywords`。  
...
- "关键词研究" / "SEO 优化"  
- "Amazon A9" / "Backend Search Terms"  
- "Shopify meta title"  
- "TikTok 话题标签"  
- "长尾词扩展"  
- "标题埋词怎么布局"
