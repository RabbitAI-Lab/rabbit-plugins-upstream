...
---
# Sugon-Scnet 营业执照 OCR 技能

本技能封装了 Sugon-Scnet 营业执照 OCR 服务，通过单一接口即可调用 1 种识别能力，高效提取文字及票据信息。

> ## 🚨 重要隐私与安全警告（使用前必读）
>
> **1. 数据外传性质**  
> 本技能会将您提供的营业执照图片，**通过网络传输至第三方服务商（`api.scnet.cn`）** 进行 OCR 处理。图片数据**会离开您的本地设备**，并非在本地离线处理。
>
> **2. 数据的敏感性**  
> 营业执照包含以下高度敏感的商业信息：
> - **企业身份**：统一社会信用代码、企业名称、法定代表人、住所（注册地址）。
> - **财务与运营**：注册资本、成立日期、经营范围、营业期限。
> - **登记信息**：登记机关、发证日期。
...
>
> **4. 法律合规与授权**  
> 使用本技能处理非本企业或未经授权的营业执照时，您必须**确保已获得该企业信息主体的明确授权**。未经授权处理他人商业信息可能违反《个人信息保护法》及《反不正当竞争法》等相关法律法规。
>
> **5. 用户知情同意**  
...
| 参数名 | 类型 | 必填 | 描述 |
|--------|------|------|------|
| ocrType | string | 是 | 识别类型枚举。必须为以下之一：<br>• BUSINESS_LICENSE（营业执照） |
...
- “帮我提取这个营业执照的法定代表人和注册资本，路径是 /Users/name/Downloads/license.png”
