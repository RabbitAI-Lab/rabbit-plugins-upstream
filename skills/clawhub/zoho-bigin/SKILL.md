...
req = urllib.request.Request(GATEWAY + "/zoho-bigin/bigin/v2/settings/modules")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-zoho-bigin-skill/1.2")
