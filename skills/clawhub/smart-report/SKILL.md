---
name: smart-report
description: "Data-to-report skill. Turns data files (CSV/Excel/JSON) into single-file interactive HTML reports with ECharts visualizations, narrative analysis and full numeric traceability (fact ledger). Use when the user asks to write a report, weekly/monthly report, analysis document, review, or presentation material from data files."
license: MIT
