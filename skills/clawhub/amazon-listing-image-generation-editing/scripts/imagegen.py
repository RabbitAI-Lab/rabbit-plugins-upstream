...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "Amazon Listing图片，准确还原商品，分别表现白底主图、功能信息、使用场景、尺寸和对比卖点", "keywords": "Amazon Listing Images、亚马逊主图、Amazon A+、PDP、信息图、场景图、Amazon卖家", "model": "public_model_nano_banana_pro", "name": "amazon-listing-image-generation-editing", "product_promise": "面向 Amazon 卖家生成 Listing 和 A+ 视觉素材，支持多语言市场与不同站点版本", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "Amazon Listing 图片生成与编辑", "trend_inspired": true}')
