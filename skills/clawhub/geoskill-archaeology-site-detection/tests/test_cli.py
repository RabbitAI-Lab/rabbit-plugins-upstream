"""CLI tests for archaeology-site-detection."""
import os
import subprocess
import sys
...
class TestCLIBasics:
    def test_help(self):
        ...
        for flag in ("--bbox", "--synthetic", "--fusion"):
    ...
    def test_bad_fusion_exit_2(self):
        r = run_cli(["--bbox", "116", "39", "117", "40", "--synthetic", "--fusion", "nope"])
