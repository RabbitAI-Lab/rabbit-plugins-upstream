...
from aliexpress_search_common import DEFAULT_BASE_URL, build_url, parse_int, validate_object_response
from geekbi_auth import ActionRequired, authenticated_json_request


ENDPOINT = "/api/v1/aliexpress/mall/ai-info"
...
def main():
    parser = argparse.ArgumentParser(description="查询 AliExpress 店铺详情")
    parser.add_argument("--mall-id", required=True, help="AliExpress 店铺或卖家 ID")
    ...
    try:
        ...
        payload = validate_object_response(payload, "mall", "AliExpress 店铺查询失败")
