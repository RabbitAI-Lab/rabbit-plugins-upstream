...
4. Save and write SEO Plans only to disk in the folder SEO_PLANS/<new-seo-plan-id>.md after explicit "yes" from user.
...
### Generating a Plan
```text
seoplan "Vintage analog cameras Germany" --lang de --brand brand-example
...
# → Creates in the folder SEO_PLANS/ a new file `vintage-analog-cameras-de.md`
# → Adds a new row to at the end of this file to the index of `## Registry Table for new SEO Plans`
```
...
## Registry Table for new SEO Plans

Never completly overwrite this SEO_PLANS/_index.md. You only add new SEO Plans in the following table.
