# SEOwlsClaw — Command Reference (v0.9.2)
...
- Page-type-specific rule values (`SEO_RULES/<type>.md`), scored via `SEO_CHECKS/page-type-specific-checks.md`
...
| `--primary-kw` | Optional | Override auto-detected primary keyword | `--primary-kw "leica m6 buy online"` |
...
| `fr` | French | `LOCALE/fr.md` | ✅ Available |
| `es` | Spanish | `LOCALE/es.md` | ✅ Available |
| `pt` | Portuguese | `LOCALE/pt.md` | ✅ Available |
...
*Adds: checks command description points at SEO_RULES/<type>.md instead of do-and-don-lists.md*
