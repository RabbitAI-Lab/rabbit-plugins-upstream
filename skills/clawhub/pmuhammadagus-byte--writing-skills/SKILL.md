---
name: writing-skills
description: "Gunakan saat ingin membuat/memperbaiki skill (process documentation) dengan pendekatan Test-Driven Development: tulis skenario pressure, lihat agen gagal tanpa skill, tulis skill, verifikasi agen patuh. Aktif saat user minta "buat skill", "skill creation TDD", atau "authoring skill"."
metadata:
  openclaw:
    version: 1.0.0
---
...
# writing-skills — X∞ Compliance Layer

## 1. IDENTITY
Skill milik user: `writing-skills`. Mengikuti Skill Architecture Standard X∞ (wajib).

## 2. PURPOSE
Pembuatan skill adalah TDD yang diterapkan ke dokumentasi proses: tulis test case (pressure scenario dengan subagent), lihat gagal (RED), tulis skill (doc), lihat lewat (GREEN), lalu refactor (tutup celah).
...
changelog: Enhanced with ClawHub metadata
