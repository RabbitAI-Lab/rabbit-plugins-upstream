# Sediment Transport Modeling (geoskill-sediment-transport-modeling)

> RUSLE soil erosion model + sediment delivery ratio (SDR) to estimate watershed sediment yield and identify key sediment source areas.
...
python geoskill-sediment-transport-modeling.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
