---
name: "douyin-copy-extract-v2"
description: "粘贴抖音公开可访问的视频链接、分享文案或 aweme_id，一键提取视频标题/基础信息、原视频简介、口播逐字稿、可复制文案和精简版；适合内容创作、自媒体运营、短视频脚本整理、抖音文案提取、抖音视频转文字、抖音口播转文字、口播文案整理和逐字稿复盘。已有 job_id 时继续查询任务状态。来自 SocialDataX 社媒数据助手。"
source_client: "socialdatax-skills"
source_platform: "clawhub"
source_skill: "douyin-copy-extract-v2"
...
- 你通常会得到：视频标题/基础信息、原视频简介、口播逐字稿、可复制文案和精简版；适合自媒体运营、短视频脚本整理和口播文案整理；未完成时先继续查询任务状态。
...
npx -y socialdatax-skills@latest douyin transcript \
  ...
  --source-skill douyin-copy-extract-v2

npx -y socialdatax-skills@latest douyin transcript \
  --aweme-id "<aweme_id>" --pretty --source-client socialdatax-skills \
  --source-platform clawhub --source-skill douyin-copy-extract-v2
...
- 可选：`--source-client socialdatax-skills --source-platform clawhub --source-skill douyin-copy-extract-v2`：这是当前 Agent Skill 的来源标记；按本 Skill 示例执行时保持这些值不变。

常见说法：内容创作、自媒体运营、短视频脚本整理、抖音文案一键提取、抖音视频文案提取、抖音视频转文字、抖音口播转文字、口播文案整理和抖音逐字稿，均按当前抖音文案提取 / 转写流程处理。
...
优先输出适合内容创作和自媒体运营继续整理的抖音文案提取结果：视频标题/基础信息、原视频简介、口播逐字稿、可复制文案和精简版；未完成时继续查询任务状态。
