 ...
 *   - 防御性编程：防止无限循环和正则回溯
 */
const { claimExtractor } = require('../reasoning/claim-extractor');
...
// 兼容 heartflow.js 的 new ConfidenceAnnotator() 调用模式
class ConfidenceAnnotator {
  constructor() { return confidenceAnnotator; }
}

module.exports = { confidenceAnnotator, ConfidenceAnnotator };
