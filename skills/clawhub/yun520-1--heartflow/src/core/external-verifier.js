...
let claimExtractor;
try { claimExtractor = require('../reasoning/claim-extractor').claimExtractor; } catch (e) { claimExtractor = null; }
...
const externalVerifier = {
  ...
  async verify(claim) {
    ...
    // [PROD] 生产环境移除 console.error: this.saveCacheAsync().catch(e => console.error("[ExternalVerifier] Cache save failed:", e.message));
    return result;
  },
