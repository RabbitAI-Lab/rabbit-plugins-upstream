...
| `TUSHARE_GATEWAY` | `https://tushare.citydata.club/` | 自定义后端地址 (主) |
| `TUSHARE_GATEWAY_BACKUP2` | `http://124.223.112.152:6331/` | 备用 gateway 2 (BACKUP1/BACKUP3 已下线: gw04 退役 / gw03 改官网节点) |
