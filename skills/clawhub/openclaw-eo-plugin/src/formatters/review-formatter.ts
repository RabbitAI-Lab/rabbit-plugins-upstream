...
export function formatReviewOutput(path: string, depth: string, results: ExpertResult[], summary: any): string {
  const lines: string[] = []
...
export function formatReviewFallback(path: string, depth: string): string {
