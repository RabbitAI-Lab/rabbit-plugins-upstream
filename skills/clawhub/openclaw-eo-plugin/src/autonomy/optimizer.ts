...
interface OptimizationRule {
  name: string
  condition: (stats: ReturnType<typeof effectTracker.stats>) => boolean
  action: () => string[]
  apply: () => void
}
...
export class SelfOptimizer {
  private lastOpt = 0
  private cooldown = 3600000 // 1 hour
   ...
   */
  private optimizeParams(stats: ReturnType<typeof effectTracker.stats>): string[] {
   ...
   */
  private applyStrategy(strategy: Strategy): void {
