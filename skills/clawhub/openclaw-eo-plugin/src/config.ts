...
// Architecture styles
export const ARCH_STYLES = ['layered', 'microservices', 'serverless', 'event-driven'] as const

// Languages
export const LANGUAGES = ['typescript', 'python', 'java', 'go', 'rust'] as const

// Clouds
export const CLOUDS = ['aws', 'gcp', 'azure', 'multi-cloud'] as const

// Review depths
export const REVIEW_DEPTHS = ['quick', 'standard', 'deep'] as const

// Checkpoint types
export const VERIFY_TYPES = ['code', 'architecture', 'test', 'security', 'performance'] as const
