...
// Tool handlers
import { handleCollab, handleListExperts, handlePlan, handleArchitect, handleVerify, handleCodeReview, handleDream, handleSelfLearn, handleRAGQuery, handleMemoryStats, handleEvolve, handleRAGIndex, handleRAGAccess, handlePatternLearn, } from './tools/index.js';
// Hooks
import { createSessionStartHook, createSessionEndHook, createProactiveMonitorHook, configureProactiveMonitor, createDreamTriggerHook, createRuleEnforcementHook, createNewConversationHook, initContextWorkflowHooks, onMessageHook, afterToolCallHook, afterOutcomeHook, } from './hooks/index.js';
...
import { effectTracker, patchManager } from './autonomy/index.js';
// Auto-init
...
const plugin = {
    ...
    register(api) {
        ...
        api.registerHook('on_message', async (event) => {
