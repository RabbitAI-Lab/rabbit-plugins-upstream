 ...
 * Range: 0-100
 */
export function linearScore(result, expectation, baseScore = 100) {
    if (expectation === 0)
        return 0;
 ...
 */
export function binaryScore(success, baseScore = 100) {
 ...
 */
export function timeScore(actualMs, expectedMs, baseScore = 100) {
    if (actualMs === 0)
        return 0;
 ...
 */
export function qualityScore(errors, total, baseScore = 100) {
    if (total === 0)
        return baseScore;
...
export class EffectScoreCalculator {
     ...
     */
    static calculate(decision, outcome) {
     ...
     */
    static calculateConfidence(decision, outcome) {
        let factors = 0;
        let totalFactors = 0;
        totalFactors++;
...
export class AutoScorer {
     ...
     */
    static fromImplicitFeedback(decision, context) {
        let score = 75;
        let success = true;
     ...
     */
    static fromOutcomeType(outcome) {
...
//# sourceMappingURL=effect-scorer.js.map