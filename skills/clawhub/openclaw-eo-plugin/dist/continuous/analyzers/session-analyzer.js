...
export class SessionAnalyzer {
     ...
     */
    classifyWorkflow(input) {
        const lowerMessage = input.lastMessage.toLowerCase();
        if (lowerMessage.includes('plan') || lowerMessage.includes('wbs'))
            return 'planning';
