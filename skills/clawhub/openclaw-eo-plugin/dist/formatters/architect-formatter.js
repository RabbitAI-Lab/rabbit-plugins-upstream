...
export function formatArchitectOutput(task, style, language, results, summary) {
    const lines = [];
...
export function formatArchitectFallback(task, style, language) {
...
//# sourceMappingURL=architect-formatter.js.map