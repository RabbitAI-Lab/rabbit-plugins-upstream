...
## 当前可用搭子（仅供理解；运行时以 live 为准）
  ...
  - 法律实务问题研判：把一个具体实务法律问题，研判成可回查的法条与类案底稿：现行有效法条依据、类案裁判规则、实务操作要点与风险点，逐条标官方出
  - 监管处罚雷达：最近哪些上市公司被证监会立案、处罚或市场禁入？给定一类监管动作，跨全市场扫出近期命中公司，按事由分类给出名称、时间与涉及
  - 诉讼文书起草：把案件事实、当事人立场和上传的对方材料，起草成规范的诉讼文书草稿（答辩状 / 质证意见 / 律师函等），逐点附法条与类案
