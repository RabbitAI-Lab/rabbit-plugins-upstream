...
req = urllib.request.Request(GATEWAY + "/quickbooks/v3/company/:realmId/companyinfo/:realmId")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-quickbooks-skill/1.2")
