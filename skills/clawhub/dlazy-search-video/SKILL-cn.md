...
version: 1.3.6
description: "视频搜索工具：调用 Pixabay 视频 API，根据关键字返回视频 URL 与元数据，适合检索免费视频素材。"
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy search_video -h 查看帮助信息。"}}
---
...
Options:
  --query [query]                      搜索关键字
  --videoType [videoType]              视频类型 [default: all] (choices: "all", "film", "animation")
  --category [category]                分类 (choices: "backgrounds", "fashion", "nature", "science", "education", "feelings", "health", "people", "religion", "places", "animals", "industry", "computer", "food", "sports", "transportation", "travel", "buildings", "business", "music")
  --minDuration [minDuration]          最小时长（秒）
  --maxDuration [maxDuration]          最大时长（秒）
  --page [page]                        页码 [default: 1]
  --perPage [perPage]                  每页数量 [default: 10]
...
```bash
dlazy search_video --prompt '提示词内容'
```
