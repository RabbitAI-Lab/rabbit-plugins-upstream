---
name: levea_ai_video_editor
description: Agentic AI video editor: send a prompt, the autonomous editor plans, uses internal tools, exports, and returns the result.
version: 1.0.2
metadata:
  openclaw:
    requires:
