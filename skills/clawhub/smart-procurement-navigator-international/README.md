# 🏛️ Smart Procurement Navigator v2.1.0-intl

[![Version](https://img.shields.io/badge/version-2.1.0--intl-blue)](https://github.com/yinjianheng/smart-procurement-navigator-international)
...
```bash
# Install for Claude / WorkBuddy / OpenClaw / Code X / Cursor
