---
name: guaikei-douyin-public-content-to-dataset-export
title: guaikei抖音公开数据采集
description: 当用户要查抖音公开数据时使用本技能：搜视频、抓博主作品、读评论、看实时热榜。做选题、找对标、看口碑、追热点即使用户没提"抖音"也适用。不用于发布/剪辑/下载视频或其他平台。
license: MIT
metadata:
  version: "1.0.0"
  author: um-why
