...
name: dlazy-kimi-k3
version: 1.2.3
description: "月之暗面深度思考模型，支持文本、图像与视频理解。适合需要长链推理的复杂分析、代码与写作任务。"
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy kimi-k3 -h 查看帮助信息。"}}
---
...
月之暗面深度思考模型，支持文本、图像与视频理解。适合需要长链推理的复杂分析、代码与写作任务。
...
Options:
  ...
  --videos [videos...]                 参考视频 [video: url or local path] (max 8)
