...
const SKILL_ID = '0080b9ad-50b3-4ec6-aab4-8479515b8e61'; // Polymarket监控 // 需要在SkillPay后台创建

/**
 * 扣费 - 每次调用扣费 0.002 USDT
 */
async function chargeUser(userId, amount = 0.002) {
  // 开发模式：不强制扣费
