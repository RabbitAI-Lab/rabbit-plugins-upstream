...
### v1.0.21 (2026-07-30)
- **关键词降权修复**：11个宽泛词降权到 auxiliary（项目、行业、市场、供给、需求、出口、进口、贸易、宏观、调控、财经），单独命中不足以放行，修复"足球项目"误命中
- **新增体育/文娱排除规则**：菁英赛、精英赛、公开赛、邀请赛、总决赛、冠军赛、马拉松、青少年足球、校园足球、中小学生运动会、演唱会、音乐节、文艺汇演等30+模式
- **新增 IPO/打新过滤**：弃购、中签、申购代码、发行价、上市首日、破发等
- **新增公安特警比武竞赛过滤**：特警挑战赛、狙击项目、比武竞赛等
- **MAX_OUTPUT_COUNT**：50→60
