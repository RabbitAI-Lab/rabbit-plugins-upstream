...
The collector runs `data-updates` when available and includes only a compact freshness summary. Treat it as a stale-data diagnostic, not as sleep/calendar facts.
