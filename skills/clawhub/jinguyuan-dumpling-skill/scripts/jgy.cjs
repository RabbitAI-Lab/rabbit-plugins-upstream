...
var require_passport = __commonJS({
  "scripts/passport.js"(exports2, module2) {
    ...
    function writeJsonPrivate(file, value) {
      ...
      try {
        fs.writeFileSync(tempFile, JSON.stringify(value, null, 2), { encoding: "utf8", mode: 384 });
        if (process.platform !== "win32") {
          try {
    ...
    function createPassport({
      ...
      const sessionFile = sessionPath(cacheDir, CLIENT_ID);
      ...
      function saveSession(session) {
        ensureStorage();
        writeJsonPrivate(sessionFile, session);
      }
      ...
      return {
        ...
        async pollAuth({ timeoutSeconds = 30, intervalSeconds = 2 } = {}) {
          ...
          for (; ; ) {
            ...
            if (authStatus === 3) {
              clearSession();
              throw passportError("PASSPORT_RISK_DENIED", "Passport authorization was denied by risk control");
            }
            if (authStatus === 5) {
              clearSession();
...
var require_queue = __commonJS({
  "scripts/queue.js"(exports2, module2) {
    ...
    function defaultDependencies(overrides) {
      ...
      return {
        passport: overrides.passport || createPassport({ homeDir }),
