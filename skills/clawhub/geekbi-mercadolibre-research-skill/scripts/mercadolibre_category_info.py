#!/usr/bin/env python3
"""查询 Mercado Libre 当前 ES 商品样本中的类目父链。"""
...
ENDPOINT = "/api/v1/mercadolibre/category/ai-info"
...
def validate_response(payload):
    data = validate_envelope(payload, "Mercado Libre 类目路径查询失败")
...
def main():
    parser = argparse.ArgumentParser(description="查询 Mercado Libre 类目路径")
