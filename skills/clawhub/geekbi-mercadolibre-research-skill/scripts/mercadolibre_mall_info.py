...
ENDPOINT = "/api/v1/mercadolibre/mall/ai-info"
...
def main():
    parser = argparse.ArgumentParser(description="查询 Mercado Libre 店铺详情")
    parser.add_argument("--mall-id", required=True, help="Mercado Libre 店铺或卖家 ID")
    ...
    try:
        ...
        payload = validate_object_response(payload, "mall", "Mercado Libre 店铺详情查询失败")
