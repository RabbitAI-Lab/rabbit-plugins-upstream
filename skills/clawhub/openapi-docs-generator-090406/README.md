...
- github-issues: [[RFC][Refactor]: Entrypoints & api_server Refactor Roadmap](https://github.com/vllm-project/vllm-omni/issues/5227)
- github-issues: [Expose provider usage, finish reason, and latency in job results](https://github.com/parsehawk/parsehawk/issues/136)
