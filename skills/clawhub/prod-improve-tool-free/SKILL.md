...
summary: "追踪、分类与分析工作活动,生成日报与周报,帮助提升效率与保持平衡。核心能力: 效率管理领域的专业化 AI 辅助工具,提供核心基础功能支持."
license: Proprietary
edition: free
...
**处理**: 解析实时活动追踪与时间戳记录的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回实时活动追踪与时间戳记录的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 自动分类活动(工作/学习/健康
自动分类活动(工作/学习/健康/生活/休息)

**处理**: 解析自动分类活动(工作/学习/健康的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回自动分类活动(工作/学习/健康的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 每日/每周时间分布分析
每日/每周时间分布分析

**处理**: 解析每日/每周时间分布分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回每日/每周时间分布分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 专注时间 vs 碎片时间分析
专注时间 vs 碎片时间分析

**处理**: 解析专注时间 vs 碎片时间分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回专注时间 vs 碎片时间分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 日报自动生成与导出
日报自动生成与导出

**处理**: 解析日报自动生成与导出的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回日报自动生成与导出的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：分类与分析工作活、生成日报与周报、帮助提升效率与保、持平衡、效率管理领域的专、辅助工具、提供核心基础功能等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
| input | string | 是 | 效率追踪器基础版处理的输入数据或指令 |
