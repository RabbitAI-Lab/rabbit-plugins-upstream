# Contributing to `Diagram To Code`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Diagram To Code.git
cd Diagram To Code
...
git add .
git commit -m "feat(diagram-to-code): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(diagram-to-code): add <brief description>
