...
license: Proprietary
edition: free
description: Word文档工具 - （免费版），可生成提升工作效率
...
Word文档工具是针对文档处理领域的专业化AI辅助工具。免费版面向个人用户，提供核心功能与基础用法，适合快速上手和日常使用.
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：支持格式化、目录生成与批量操、文档工具、免费版等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---|---|---|---|
| input | string | 是 | Word文档工具（免费版）处理的输入数据或指令 |
...
def create_docx(title, content):
    ...
    return "output.docx"
# ...
path = create_docx("报告标题", "第一段内容\n第二段内容\n第三段内容")
print(f"Word已创建: {path}")
```
