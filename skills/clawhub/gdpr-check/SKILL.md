...
2. If the user wants a scored report, prompt them to get a free Key on the account page (https://compliancehub.cn/account.html?skill=gdpr-check), then run the full 检查.
