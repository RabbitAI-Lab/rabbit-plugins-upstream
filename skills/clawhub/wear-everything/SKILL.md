...
和 [flat-lay](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/flat-lay/skill.md) 的区别：flat-lay 处理「穿在身上的衣服」，本技能处理「戴在身上的东西」——商品只占画面的一小块区域，因此**选区（商品出现在参考图的哪个位置）**是成败关键。
...
**不做**：不改商品外形、颜色、五金、logo 与镜片色；不处理服装（用 [flat-lay](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/flat-lay/skill.md)）；不用于伪造他人肖像代言。
...
| 输入：商品图 | 输入：参考图 |
| --- | --- |
| <img src="https://raw.githubusercontent.com/dlazyai/ecommerce-skills/main/docs/wear-everything/product-sunglasses.jpg" width="280"> | <img src="https://raw.githubusercontent.com/dlazyai/ecommerce-skills/main/docs/wear-everything/model-reference.jpg" width="280"> |
...
<img src="https://raw.githubusercontent.com/dlazyai/ecommerce-skills/main/docs/wear-everything/example-output.jpg" width="320">
