...
使用方法：
python fetch_articles.py --type "科技数码" --source "公众号文章原创之王-ClawHub" --start_date "2026-05-03" --end_date "2026-05-04"
python fetch_articles.py --type "总排名" --source "公众号文章原创之王-ClawHub"  # 自动判断时间
...
def main():
    ...
    parser.add_argument("--source", default="公众号文章原创之王-ClawHub", help="数据源")
