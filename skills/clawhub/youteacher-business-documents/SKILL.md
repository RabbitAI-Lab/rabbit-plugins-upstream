...
- [API Key 配置](https://github.com/YouTeacher/ai-skills-platform/blob/main/openclaw/business-documents/references/API-KEY.md)：安装、配置或更换 Key 时阅读。
- [Operations 契约](https://github.com/YouTeacher/ai-skills-platform/blob/main/openclaw/business-documents/references/OPERATIONS.md)：创建请求或确认字段、金额和结果格式时阅读。
- [HTTP 请求与任务轮询](https://github.com/YouTeacher/ai-skills-platform/blob/main/openclaw/business-documents/references/HTTP-REQUESTS.md)：调用 API、处理幂等或轮询任务时阅读。
- [行为与错误规则](https://github.com/YouTeacher/ai-skills-platform/blob/main/openclaw/business-documents/references/BEHAVIOR-RULES.md)：处理缺失事实、版本冲突、失败和安全边界时阅读。
