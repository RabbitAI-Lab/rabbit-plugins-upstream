---
name: linkpix-video-ad-assets
description: 根据商品信息快速生成广告视频素材，适用于信息流广告、品牌推广及社交媒体营销，支持多条量产。当用户要求做信息流视频、广告视频素材、投放视频、社媒视频素材时必须触发。关键词：LinkPix、qhkit、视频广告、信息流视频、投放视频、广告素材、社媒视频、素材量产、巨量千川、Facebook广告、TikTok广告。
user-invocable: true
homepage: https://www.npmjs.com/package/@iqinghu/qhkit
metadata: {"openclaw":{"emoji":"📹","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# AI电商视频广告素材生成器 | LinkPix

投放导向的视频量产：信息流用 `全能电商2.0`/`电商热卖引擎`（省、快），品牌向用 `品牌质感大片`/`可灵3.0 Omni`，`count` 一次多条——模型清单实时、`modelLabel` 必填无默认，下面的模型名只是示例，先 `options` 查当前清单再定。

## 何时触发

- 「出几条信息流广告视频」「给投放准备视频素材」
- 需要按平台批量产出多版本视频时。
...
- 画幅按投放位选：信息流/短视频 `竖屏 9:16`，横版广告位 `横屏 16:9`；海外投放加 `languageLabel`（如 `英语`），共 17 种（简体中文/繁体中文/英语/西班牙语/法语/德语/日语/韩语/越南语/葡萄牙语/意大利语/阿拉伯语/俄语/泰语/马来语/印尼语/菲律宾语）。
...
- 图文广告素材走「AI电商图文广告素材生成器 | LinkPix」；单条精品带货视频走「AI电商带货视频生成器 | LinkPix」。
