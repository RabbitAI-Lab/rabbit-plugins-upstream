...
class VisitManager:
    ...
    def generate_weekly_plan(self, start_date=None):
        ...
        # 保存计划
        plan_path = f"/Users/mac/.qclaw/skills/visit-management/plans/周走访计划_{start_date.strftime('%Y%m%d')}.json"
    ...
    def generate_daily_reminders(self):
        ...
        # 保存提醒
        reminder_path = f"/Users/mac/.qclaw/skills/visit-management/reminders/提醒_{today.strftime('%Y%m%d')}.json"
    ...
    def run_daily_task(self):
        ...
        # 保存日报
        report_path = f"/Users/mac/.qclaw/skills/visit-management/reports/日报_{datetime.now().strftime('%Y%m%d')}.json"
