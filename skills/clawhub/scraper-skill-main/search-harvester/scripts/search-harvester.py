#!/usr/bin/env python3
"""
Search harvester (ScrapeBox-style) — rotate Tor exit nodes, query engines,
harvest candidate URLs, dedupe, score, export markdown.

Usage:
  python3 search-harvester.py "submit your company" "add your company" --niche "directory"
  python3 search-harvester.py --queries-file queries.txt --engine ddg --max-rotations 4
...
def main():
    ap = argparse.ArgumentParser(description="Tor-rotating search harvester")
