...
- github-issues: [Fully adopt Dioxus: remove HTMX, Alpine, Bootstrap, and highlight.js; TipTap and Swagger UI stay self-hosted](https://github.com/neon-law-foundation/navigator/issues/641)
- github-issues: [[BIP-110] Verify lighter node sync with limited data](https://github.com/Conxian/conxian-nexus/issues/163)
...
- github-issues: [Implement Spring Boot backend foundation](https://github.com/fatiimaazzam1/smartwallet/issues/6)
