...
- github-issues：[fix: 修复缺失 Issue 需求的同步收敛](https://github.com/fitlab-ai/agent-infra/issues/683)
- hacker-news-search：[Preventing LLM unit test spam](https://blog.larah.me/test-slop/)
- github-issues：[🐞 [BUG] Guard against duplicate sub-issue creation: enumerate parent epic children before fan-out](https://github.com/kburson/ai-task-manager/issues/921)
