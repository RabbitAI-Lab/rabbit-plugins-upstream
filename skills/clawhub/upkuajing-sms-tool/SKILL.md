...
```bash
python scripts/error_report.py --params '{"requestPath":"/agent/sms/send","requestId":"f47ac10b58cc4372a5670e02b2c3d479","context":"SMS send failed with a server error"}'
```
