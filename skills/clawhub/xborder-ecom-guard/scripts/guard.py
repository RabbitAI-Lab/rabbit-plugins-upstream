#!/usr/bin/env python3
"""跨境电商合规护栏检测内核 (xborder-ecom-guard)。

实时护栏：在面向美国 / 欧盟市场的跨境电商商品详情、广告文案、直播话术、
店铺介绍、客服话术发布前，检测其中与跨境合规相关的危险表述
（虚假评论刷单 / 原产地误导 / CE 标识虚假宣称 / 关税申报违规表述 /
安全合规宣称需核实 / 跨境广告极限词与疗效宣称），按风险分级输出命中与
整改建议，供 Agent 主动调用。
