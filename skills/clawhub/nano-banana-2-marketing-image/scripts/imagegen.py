...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Nano Banana 2 制作高完成度营销图片，主体准确，构图清晰", "keywords": "Nano Banana 2、NanoBanana2、Nano Banana、香蕉2、Gemini 图片、营销图片、营销视觉、活动KV、推广图片、促销图、Campaign视觉、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "nano-banana-2-marketing-image", "rule": "optional", "search": "固定调用 Nano Banana 2 的营销图片裸接口能力", "title": "Nano Banana 2 营销图片"}')
