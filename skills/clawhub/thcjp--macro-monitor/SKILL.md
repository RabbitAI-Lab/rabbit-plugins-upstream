...
name: macro-monitor
version: "1.0.2"
displayName: Macro Monitor
summary: 每日宏观数据监控和推送。自动浏览免费数据源（Trading Economics、FRED、国家统计局、央行官网、财联社等），整理整合过去24小时发布的宏观数据和政策信息，并推送给用户。通过
  cr...
license: MIT
description: |-
  每日宏观数据监控和推送。自动浏览免费数据源（Trading Economics、FRED、国家统计局、央行官网、财联社等），整理整合过去24小时发布的宏观数据和政策信息，并推送给用户。通过
  cr...
  ...
  触发关键词: trading, 自动浏览免费, monitor, 数据源, 每日宏观数据, 国家统计局, 监控和推送, fred
tags:
- Automation
tools:
- read
...
```text
browser action=start profile=skill-platform
```
