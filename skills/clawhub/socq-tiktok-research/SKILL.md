---
name: socq-tiktok-research
description: Research public TikTok content, accounts, keywords, and performance data with SocQ. Use when an agent needs TikTok-specific discovery, collection, endpoint selection, credit estimates, asynchronous task execution, pagination, or raw exports through the SocQ CLI, MCP, or REST API.
metadata:
  openclaw:
...
# SocQ TikTok Research

## SocQ Links

- Website: <https://socq.ai/>
- Platform page: <https://socq.ai/apis/tiktok>
- API documentation: <https://docs.socq.ai/api-manual/tiktok>
...
Use this Skill to select and run SocQ endpoints for public TikTok research. SocQ requests are asynchronous and credit-metered.

## Use When

- The user asks to discover, collect, compare, or analyze public TikTok data.
- The workflow needs TikTok-specific endpoint selection, input validation, pagination, or raw exports.
...
1. Prefer an already configured SocQ MCP server at `https://api.socq.ai/mcp?platforms=tiktok`; use the typed tool listed in [platform.md](references/platform.md), or compact `socq_execute` when needed.
