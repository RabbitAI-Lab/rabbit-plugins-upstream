...
- **Paths updated:** Point to `~/.openclaw/workspace/code/mb-core/` instead of Windsurf paths
...
- **Scan locations:**
  ...
  - `~/.openclaw/workspace/code/mb-core/` (mb-core repo for reference)

### Step 1: Read Memory Bank Update Protocol
- **First Action:** Read the memory bank update protocol from `~/.openclaw/workspace/code/mb-core/integrated-rules-v6.12.md` (Sections 1.5, 1.6, and 6.5)
...
- **Template Compliance:** All file updates MUST follow the exact formats given in `~/.openclaw/workspace/code/mb-core/memory-bank/templates/` folder
- **Available Templates:** 
