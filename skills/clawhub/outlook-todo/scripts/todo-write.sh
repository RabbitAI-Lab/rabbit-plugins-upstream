...
Options:
  ...
  --yes                Skip the "type YES" confirmation for delete
  -h, --help           Show this help

Safety:
  - update/create default to dry-run (prints JSON payload, no network call)
  - delete always shows the task first and asks for confirmation
  - pass --apply to execute; delete also accepts --yes to skip prompt
