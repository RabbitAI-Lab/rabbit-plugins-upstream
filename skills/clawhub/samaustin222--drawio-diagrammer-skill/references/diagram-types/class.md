...
- Inheritance, implementation, associations, and multiplicities

## Checklist
- Sequential IDs with no gaps
- Three compartments visible (name, attributes, methods)
...
- Associations are lateral
- Maintain row alignment across the diagram

## Common errors
- Missing divider line between attributes and methods
- Using `\n` instead of `&#xa;` for multiline text
- Connecting relationships to text cells instead of container cells

## When to ask
- Multiplicities not specified
- Types or visibility prefixes missing
