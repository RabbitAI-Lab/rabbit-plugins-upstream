# SAR Flood Mapping (geoskill-sar-flood-mapping)

> Flood extent mapping based on the SAR low-backscatter characteristic: Otsu thresholding to segment low-σ⁰ water + morphological denoising + optional DEM slope exclusion, then vectorization to GeoJSON. SAR flood extent mapping via Otsu thresholding of low backscatter, morphological cleanup and vectorization. Outputs a flood binary GeoTIFF + area statistics JSON + extent GeoJSON.
...
python geoskill-sar-flood-mapping.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
