---
name: tibetan-ai
description: Use when 用户提到藏语、藏文、汉藏翻译、中文翻译成藏语、藏语翻译成中文、藏语问答写作或 DOCX/PDF 文字层翻译；需要 TIBETAN_AI_SKILL_API_KEY。
metadata: {"packageVersion":"1.0.0","openclaw":{"emoji":"☸️","homepage":"https://ai-skills.open-idea.net","primaryEnv":"TIBETAN_AI_SKILL_API_KEY","requires":{"env":["TIBETAN_AI_SKILL_API_KEY"]}}}
---
