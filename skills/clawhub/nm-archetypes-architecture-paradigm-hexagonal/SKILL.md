...
description: Applies hexagonal architecture isolating domain from infrastructure
version: 1.9.8
triggers:
  - architecture
  - hexagonal
  ...
  - testability
  - designing systems where testability and port/adapter separation are priorities
