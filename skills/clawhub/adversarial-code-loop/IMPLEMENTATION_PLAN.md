...
- The legacy predecessor entry point was removed before release
...
**Deliverable:** v4 directory structure and proof that it works
...
- Notes stating that the legacy predecessor entry point was removed before release
...
```bash
# Once everything is green, adversarial_loop.py remains the only entry point.
```
...
|---|-------|-----------|-------|
| 0 | v4 preparation | scripts/ | Importable structure |
...
| 7 | Finalize v4 | scripts/adversarial_loop.py | All green |
