...
python3 ~/.hermes/skills/adversarial-code-loop/scripts/adversarial_loop.py \
  ...
  --dev-cmd "python3 ~/.hermes/skills/autonomous-ai-agents/hermes-agent/scripts/claude-tmux.py --model fable" \
...
**antigravity-usage** a son propre flux OAuth (client ID distinct).
