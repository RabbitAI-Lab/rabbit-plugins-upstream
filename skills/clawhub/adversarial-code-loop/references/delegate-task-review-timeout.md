...
python3 adversarial_review.py --project-dir /path/to/target \
  --a-cmd "python3 /path/to/claude-tmux.py --model best --timeout 900 --hard-timeout 1800" \
  --b-cmd "codex exec -C /path/to/target" \
  --synth-cmd "python3 /path/to/claude-tmux.py --model best --timeout 900 --hard-timeout 1800" \
