...
```bash
# Instead of:
--review-cmd "python3 /path/to/claude-tmux.py --model fable --timeout 1800 --hard-timeout 2400 --cwd /path"

# Use:
--review-cmd "python3 /path/to/claude-tmux.py --model sonnet --timeout 600 --hard-timeout 1200 --cwd /path"
```
