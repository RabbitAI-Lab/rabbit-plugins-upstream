...
req = urllib.request.Request(GATEWAY + "/slack/api/auth.test")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-slack-skill/1.2")
