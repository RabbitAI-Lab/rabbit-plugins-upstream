---
name: meta-fintech-engineer
version: 1.0.0
description: |
  由 model-distillation 从教师技能 fintech-engineer 蒸馏并增强的超越型元技能，
  在教师能力之上叠加自验证、自我反思、super-agent 编排与持续自进化闭环，逐步超越教师。
agent_created: true
visibility: public
---
# meta-fintech-engineer（蒸馏超越型元技能）

> 由 `model-distillation` 从教师技能 **fintech-engineer** 蒸馏并增强生成。
> 生成时间：2026-07-23 00:32:58 ｜ 蒸馏机制：跨模型蒸馏（见 meta-evolver 北极星策略）
...
## 教师 vs 学生 对比
| 维度 | 教师(fintech-engineer) | 学生(meta-fintech-engineer) |
| --- | --- | --- |
| 能力来源 | 原始 SKILL.md（721 字符） | 蒸馏提取 + 元进化增强 |
...
## 使用
直接调用本技能完成「fintech-engineer」领域的任务；本技能在教师能力之上叠加自验证与反思，输出更可靠、可追溯。
