---
name: defi-stop-loss
description: Decentralized stop-loss orders for DeFi. Gasless, oracle-protected, 8 EVM chains supported.
---

# Spot Advanced Swap Orders

Set decentralized stop-loss orders on any supported DEX — gasless, non-custodial, and oracle-protected across 8 EVM chains.
