...
dest="$repo_root/plugins/humanize-text-skill/skills/humanize-text-skill/SKILL.md"
...
plugin_version="$(
  python3 - "$repo_root/plugins/humanize-text-skill/.claude-plugin/plugin.json" <<'PY'
import json
import sys
