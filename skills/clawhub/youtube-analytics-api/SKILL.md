...
req = urllib.request.Request(GATEWAY + "/youtube-analytics/v2/groups?mine=true")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-youtube-analytics-skill/1.2")
