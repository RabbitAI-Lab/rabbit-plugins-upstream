...
| 资源类型 | 路径 | 用途 | 何时读取 |
|---|---|---|---|
| 🐍 必要脚本 | [`scripts/smyx_child_drowsiness_fatigue_detection_analysis.py`](scripts/smyx_child_drowsiness_fatigue_detection_analysis.py) | 调用 API、执行分析或查询历史报告 | 执行分析或查询时使用 |
