...
def main():
    parser = argparse.ArgumentParser(description="宠物跑步机运动强度与心率关联分析工具")
    parser.add_argument("--input", help="本地宠物跑步机运动视频文件路径")
    parser.add_argument("--url", help="网络宠物跑步机运动视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示跑步机运动强度分析历史报告清单")
