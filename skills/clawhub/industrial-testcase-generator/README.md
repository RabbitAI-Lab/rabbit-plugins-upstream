...
面向**工业控制/智能制造**领域的 Agent Skill：从需求文档/描述输出**标准化、可追溯、可直接导入用例管理平台**的 Excel 测试用例。
...
- **标准合规门禁（V1.1.0）**：国标/行标/企标三级体系，**试验项级覆盖率 100% 硬性验收线**（GB/T 17626 系列、GB/T 2423 系列、IEC 61508/62061、IEC 62443、GB/T 30976、GB 5226.1）
...
- 编号规则 `TC-{模块前缀}-NNN`（12 个工业模块前缀，如 ALM/COMM/HMI/SCADA）
