#!/usr/bin/env python3
"""soft-ip-full-lifecycle-delivery-pro - Order Creation Script (Phase 1)

Creates local order file for clawtip payment processing.
The AI model generates copyright documents in conversation after payment.
...
AMOUNT = 690  # 6.9 yuan = 690 fen
DESCRIPTION = "Software copyright registration full lifecycle delivery"
