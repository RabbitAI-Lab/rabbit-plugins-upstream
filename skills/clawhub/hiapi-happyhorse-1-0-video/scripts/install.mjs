#!/usr/bin/env node
// HiAPI HappyHorse 1.0 Video Skill installer.
// Run with: npx github:HiAPIAI/hiapi-happyhorse-1-0-video-skill -y
...
const SKILL_FOLDER = 'hiapi-happyhorse-1-0-video';
const REPO_URL = 'https://github.com/HiAPIAI/hiapi-happyhorse-1-0-video-skill.git';
const DISPLAY_NAME = 'HiAPI HappyHorse 1.0 Video Skill';
const MODEL_PAGE = 'https://www.hiapi.ai/en/models/happyhorse-1-0';
