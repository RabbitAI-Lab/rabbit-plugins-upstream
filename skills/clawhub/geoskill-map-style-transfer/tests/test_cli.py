"""CLI argument parsing tests for map-style-transfer."""
import subprocess
import sys
import os
...
class TestCLIBasics:
    ...
    def test_bad_style_exit_2(self):
        r = run_cli(["--bbox", "116", "39", "117", "40", "--synthetic", "--style", "bad"])
