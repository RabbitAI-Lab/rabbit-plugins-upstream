...
注册获取 Key：[redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub)
...
前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册获取个人 API Token：
...
**Q：额度用完怎么办？**
A：前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册获取 Token。
