...
def main() -> None:
    ...
    print(json.dumps(run_bundle_deal_api("update_bundle_deal", params, "update_bundle_deal.py"), indent=2, ensure_ascii=False))
