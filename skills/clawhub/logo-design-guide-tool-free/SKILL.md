...
description: "AI Logo设计原则与图像生成优选实践指南,涵盖Logo类型、提示词技巧、可扩展性规则,适合个人学习使用。"
license: Proprietary
...
**处理**: 按照skill规范执行AI生成的关键局限操作,遵循单一意图原则。
**输出**: 返回AI生成的关键局限的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行提示词编写技巧操作,遵循单一意图原则。
**输出**: 返回提示词编写技巧的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行可扩展性规则操作,遵循单一意图原则。
**输出**: 返回可扩展性规则的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行配色指南操作,遵循单一意图原则。
**输出**: 返回配色指南的执行结果,包含操作状态和输出数据。
