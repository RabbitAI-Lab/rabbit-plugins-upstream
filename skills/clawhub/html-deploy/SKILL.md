---
name: html-deploy
description: Instantly publish a single self-contained HTML page to htmlcode.fun. Use for the fastest path from generated HTML to a live URL, including landing pages, demos, QR share pages, reports, and AI-generated single-file frontends. Supports stable short codes, versioned updates, reading deployed source, editing only unlocked versions, and user-driven version preservation by manual likes. Live guide: https://www.htmlcode.fun/s/htmlcode-fun-guide
---
