---
name: video-extend
displayName: "⏭️ Video Extend — Pro Pack on RunComfy"
description: >
...
**Veo 3-1 Fast Extend** — [`google-deepmind/veo-3-1/fast/extend-video`](https://www.runcomfy.com/models/google-deepmind/veo-3-1/fast/extend-video?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend)
...
**Catalog**: [Veo 3-1 extend](https://www.runcomfy.com/models/google-deepmind/veo-3-1/extend-video?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) · [Veo 3-1 fast extend](https://www.runcomfy.com/models/google-deepmind/veo-3-1/fast/extend-video?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) · [`veo-3` collection](https://www.runcomfy.com/models/collections/veo-3?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend)
...
- [Veo 3-1 collection](https://www.runcomfy.com/models/collections/veo-3?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) — all Veo endpoints (t2v, i2v, extend, fast variants)
- [All video models](https://www.runcomfy.com/models?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) — every video endpoint with its API schema tab
...
Full reference: [docs.runcomfy.com/cli/troubleshooting](https://docs.runcomfy.com/cli/troubleshooting?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend).
...
- [Veo 3-1 collection](https://www.runcomfy.com/models/collections/veo-3?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) — all Veo endpoints (t2v, i2v, extend, fast variants)
- [All video models](https://www.runcomfy.com/models?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) — every video endpoint with its API schema tab
- [docs.runcomfy.com/cli](https://docs.runcomfy.com/cli/introduction?utm_source=clawhub&utm_medium=skill&utm_campaign=video-extend) — CLI install, authentication, troubleshooting
