---
name: conqueror-competitive-landscape
description: "Map who wins an SEO market: recurring domains, winning content themes, keyword coverage, backlink strength, and the openings. Use for a market-level view before picking targets. Requires a connected Conqueror MCP server."
---
...
Use this when the user wants a market-level view across several competitors. For a deep dive on one domain, use `conqueror-competitor-analysis`.
...
- Recommended next workflows: `conqueror-competitor-analysis`, `conqueror-keyword-clustering`, or a content brief

## Guardrails

- Distinguish SEO competitors from business competitors.
- Do not overstate exact traffic when Conqueror returns estimates.
