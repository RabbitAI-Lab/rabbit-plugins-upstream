...
metadata:
  openclaw:
    emoji: "🤝"
    env:
      - name: CLIENT_FLOW_BASE_PATH
        description: "Local base path for client project folders. Default: ~/Clients"
      - name: CLIENT_FLOW_USE_GMAIL
        description: "Set to 1 to send welcome emails via Gmail MCP. Default: 0 (draft only)"
      - name: CLIENT_FLOW_USE_GOOGLE_CALENDAR
        description: "Set to 1 to create Google Calendar events. Default: 0 (draft only)"
      - name: CLIENT_FLOW_TASK_TOOL
        description: "Preferred task tool: todoist, clickup, linear, asana, or none. Default: none"
---
