        ...
        if method == "server/discover":
            return {
                ...
                "result": _modern_ok({
                    ...
                    "capabilities": {"tools": {}},
                    "instructions": "元呈 MCP（基于 MCP 最新协议 2026-07-28，向后兼容 2025-11-25 及更早握手）：把任意 AI 输出（JSON/Markdown/纯文本）统一为可复制 Markdown/纯文本的呈现工具 present_result/present_forms/present_templates；按需本机 SVG，数据不出本机。",
                }, (3600000, "public")),
            }
