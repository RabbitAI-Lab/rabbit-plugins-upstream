...
- clawhub-popular-skill: [Popular Clawhub skill demand: Gog has 186,097 downloads](https://clawhub.ai/skills/gog)
- clawhub-popular-skill: [Popular Clawhub skill demand: Skill Vetter has 258,186 downloads](https://clawhub.ai/skills/skill-vetter)
- clawhub-popular-skill: [Popular Clawhub skill demand: Github has 190,310 downloads](https://clawhub.ai/skills/github)
- v2ex-hot: [GPT-5.5 真能让人用得舒心吗？怎么在我这跟弱智一样](https://www.v2ex.com/t/1220572)
- clawhub-popular-skill: [Popular Clawhub skill demand: Weather has 160,917 downloads](https://clawhub.ai/skills/weather)
- hacker-news-ask-hn: [Ask HN: How are you enabling your employees to do AI dev in the cloud?](https://news.ycombinator.com/item?id=48543969)
- hacker-news-ask-hn: [Ask HN: Why are Spec-kit specs like that](https://news.ycombinator.com/item?id=48539057)
- hacker-news-ask-hn: [Ask HN: Active GitHub accounts (probably) delivering malware, now what?](https://news.ycombinator.com/item?id=48548530)
- github-issues: [Implement resource resolvers (image search, icon matching, real-data charts)](https://github.com/wcyapplemist/opencode-config-template-chenyu/issues/30)
- github-issues: [Header and window controls scroll with page content on step 2 when using small window sizes](https://github.com/unicef/adt-studio/issues/511)
- github-issues: [🦞 OpenClaw Ecosystem Digest 2026-06-16](https://github.com/QYQAQ/agents-radar/issues/372)
- github-issues: [Add repo skill for standardized GitHub issue creation](https://github.com/repoprompt/repoprompt-ce/issues/232)
