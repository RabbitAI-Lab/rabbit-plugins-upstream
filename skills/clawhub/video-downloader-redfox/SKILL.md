...
通过 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) API 解析并下载主流短视频平台的无水印视频/图文。
...
可访问 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册获取个人 API Key：
...
**Q：如何获取自己的 API Key？**
A：前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 注册即可获取 Token。
...
本工具基于 [redfox.hk](https://redfox.hk/settings/api-keys?source=clawhub) 的 `parseWork/parse` 接口构建。前往官网查看更多 API 能力和使用文档。
