# Spectral Unmixing (geoskill-spectral-unmixing)

> Linear spectral unmixing (LSMM); constrained least squares to derive endmember abundances; outputs abundance maps and endmember spectra
...
python geoskill-spectral-unmixing.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
