...
req = urllib.request.Request(GATEWAY + "/google-play/androidpublisher/v3/applications/{packageName}/inappproducts")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-google-play-skill/1.2")
