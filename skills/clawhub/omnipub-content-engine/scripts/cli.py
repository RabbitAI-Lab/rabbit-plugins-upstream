...
try:
    ...
    from wechat_publish import create_draft
...
def main():
    ...
    p.add_argument("--output", default="./toutiao-prep")
    p.add_argument("--title", help="Article title (for publish)")
    p.add_argument("--inject", help="Inject script path")
    p.add_argument("--images", help="Images JSON path")
