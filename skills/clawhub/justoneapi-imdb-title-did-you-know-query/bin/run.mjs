...
const manifest = {
  ...
  "displayName": "IMDb 'Did You Know' Insights",
  "openapi": "3.1.0",
  "platformKey": "imdb",
  "primaryTag": "IMDb",
  "skillName": "justoneapi_imdb_title_did_you_know_query",
  "slug": "justoneapi-imdb-title-did-you-know-query",
  ...
  "endpointPath": "title-did-you-know-query",
  "skillType": "interface"
};
