...
总图不嵌整图 base64、不用 clipPath。

  python tools/shared/structure_lineart_compose.py --case-dir outputs/case
  python tools/shared/structure_lineart_compose.py --case-dir outputs/case --check
  python tools/shared/structure_lineart_compose.py --case-dir outputs/case --prepare-jobs
"""
...
def _image_href(href: str, *, x: float | None = None, y: float | None = None, width: float, height: float) -> str:
    pos = ""
    ...
    return (
        ...
        f'preserveAspectRatio="none" href="{escaped}" xlink:href="{escaped}"/>'
    )
