...
用法：
  ...
  python tools/crawl/cnipa_epub_search.py --type design --class 26-05
...
def _usage() -> None:
    print(
        "usage: python tools/crawl/cnipa_epub_search.py [--type invention|utility_model|design|all] [--class CODE] [term ...]",
        file=sys.stderr,
    )
    print(
    ...
    print(
        "class-only: python tools/crawl/cnipa_epub_search.py --type design --class 26-05",
        file=sys.stderr,
    )
