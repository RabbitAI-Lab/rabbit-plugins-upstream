...
- **请求地址**：`${LINKFOX_TOOL_GATEWAY}/echotik/listVideoRank`
...
```json
{
  "skillName": "linkfox-echotik-list-video-rank",
  "sentiment": "POSITIVE",
  "category": "OTHER",
...
**Field rules:**
- `skillName`: Use this skill's `name` from the YAML frontmatter (`linkfox-echotik-list-video-rank`)
