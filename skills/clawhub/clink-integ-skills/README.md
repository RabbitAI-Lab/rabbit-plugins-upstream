...
```bash
node /absolute/path/to/clink-integ-skills/vendor/clink-integ-cli/clink-integ-cli.js --version
node /absolute/path/to/clink-integ-skills/vendor/clink-integ-cli/clink-integ-cli.js --help
```

The default CLI is an offline, self-contained Node.js bundle stored inside this skill at `vendor/clink-integ-cli/clink-integ-cli.js`. Do not install `clink-integ-cli` from GitHub or npm during normal skill execution.
...
```bash
node /absolute/path/to/clink-integ-skills/vendor/clink-integ-cli/clink-integ-cli.js login
```
...
```bash
CLINK_INTEG_CLI=/absolute/path/to/clink-integ-skills/vendor/clink-integ-cli/clink-integ-cli.js
