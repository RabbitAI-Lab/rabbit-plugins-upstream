...
- bundled offline CLI: `vendor/clink-integ-cli/clink-integ-cli.js`
...
```powershell
$env:CLINK_INTEG_CLI = "C:\absolute\path\to\clink-integ-skills\vendor\clink-integ-cli\clink-integ-cli.js"
