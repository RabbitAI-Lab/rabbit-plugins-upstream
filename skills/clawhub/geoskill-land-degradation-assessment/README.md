# Land Degradation Assessment (geoskill-land-degradation-assessment)

> SDG 15.3.1 three-indicator land degradation assessment: productivity trend, LULC change, and soil organic carbon, integrated into degrading/stable/improving classes
...
python geoskill-land-degradation-assessment.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
