---
name: dlazy-seedream-5.0
version: 1.2.3
description: "豆包图像创作模型完整版，支持 2K/3K/4K 高分辨率出图与参考图重绘，适合主视觉、海报以及需要放大印刷的场景。"
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy seedream-5.0 -h 查看帮助信息。"}}
---
...
豆包图像创作模型完整版，支持 2K/3K/4K 高分辨率出图与参考图重绘，适合主视觉、海报以及需要放大印刷的场景。
...
Options:
  ...
  --resolution [resolution]            分辨率 [default: 2k] (choices: "2k", "3k", "4k")
...
```bash
dlazy seedream-5.0 --prompt '提示词内容'
```
