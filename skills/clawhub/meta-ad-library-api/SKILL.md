...
metadata:
  openclaw:
    ...
    throttle: 1
    emoji: "\U0001F3AF"
    homepage: https://scavio.dev/docs/meta-ads-search?utm_source=clawhub&utm_medium=skill&utm_campaign=meta-ad-library-api
---
...
Get a free API key at [scavio.dev](https://scavio.dev/?utm_source=clawhub&utm_medium=skill&utm_campaign=meta-ad-library-api) (50 free credits to get started, no card required):
...
# Your key from https://scavio.dev/?utm_source=clawhub&utm_medium=skill&utm_campaign=meta-ad-library-api. Load it from your environment or secret
...
- `429` means rate or usage limit exceeded. Wait before retrying. See https://scavio.dev/docs/rate-limits?utm_source=clawhub&utm_medium=skill&utm_campaign=meta-ad-library-api.
