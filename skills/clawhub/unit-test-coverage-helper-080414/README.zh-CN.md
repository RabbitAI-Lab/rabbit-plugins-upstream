...
- github-issues：[Autonomous Platform Code Quality Agent with Self-Refactoring & Tech Debt Prioritization](https://github.com/sethdford/shipwright/issues/785)
- github-issues：[Pipeline Stage Result Cache & Smart Reuse System](https://github.com/sethdford/shipwright/issues/787)
- github-issues：[[Epic] Dynamic Workflows for Codex — Claude-Code-parity workflow runtime](https://github.com/kedarkolluri/codex/issues/1)
- github-issues：[[R1-upstream-rebase-architecture] Keep the fork easy to rebase and decompose upstream](https://github.com/kedarkolluri/codex/issues/56)
- github-issues：[[P0-context-bounds] Bound workflow model-visible inputs and remove raw-source execution](https://github.com/kedarkolluri/codex/issues/59)
- github-issues：[Add the qualified production local model backend](https://github.com/PSyron/polis/issues/43)
