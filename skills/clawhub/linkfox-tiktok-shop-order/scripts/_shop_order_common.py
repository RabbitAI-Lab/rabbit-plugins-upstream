"""Shared helpers for linkfox-tiktok-shop-order (ERP developerProxy, token backendized)."""
...
# ERP order skill path whitelist (relative paths, no host prefix)
ALLOWED_PATH_PREFIXES = ("order", "authorization")


def ensure_auth_skill_available(caller: str = "shop-order script") -> None:
