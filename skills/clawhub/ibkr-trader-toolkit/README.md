...
> ## ⚠️ This skill was renamed
>
> **The package `ibkr-trader-toolkit` is deprecated.** All future releases ship
> as **[`ibkr-options-assistant`](https://github.com/AlexLiu0130/ibkr-options-assistant)** —
> same code, same scripts, same behavior. The new name better reflects
> positioning (an options-analysis assistant for Claude, not a trading bot).
>
...
> ```
> On ClawHub, search for **`ibkr-options-assistant`**.
