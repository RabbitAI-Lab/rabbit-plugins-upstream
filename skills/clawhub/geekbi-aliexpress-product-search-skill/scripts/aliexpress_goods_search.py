...
ENDPOINT = "/api/v1/aliexpress/goods/ai-search"
...
def main():
    parser = argparse.ArgumentParser(description="查询 AliExpress 商品并输出 JSON")
