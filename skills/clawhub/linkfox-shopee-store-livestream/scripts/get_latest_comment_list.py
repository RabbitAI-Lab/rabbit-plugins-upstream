...
def main() -> None:
    ...
    print(json.dumps(run_livestream_api("get_latest_comment_list", params, "get_latest_comment_list.py"), indent=2, ensure_ascii=False))
