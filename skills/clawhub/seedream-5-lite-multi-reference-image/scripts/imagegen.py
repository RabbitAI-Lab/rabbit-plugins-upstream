...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度多参考图生成，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、多参考图生成、多图融合、多参考图、多图合成、角色风格参考、素材合成、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-multi-reference-image", "rule": "multi", "search": "固定调用 Seedream 5.0 Lite 的多参考图生成裸接口能力", "title": "Seedream 5.0 Lite 多参考图生成"}')
