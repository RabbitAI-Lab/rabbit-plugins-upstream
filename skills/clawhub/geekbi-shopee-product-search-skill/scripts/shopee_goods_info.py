...
ENDPOINT = "/api/v1/shopee/goods/ai-info"
...
def validate_response(payload):
    result = validate_object_response(payload, "goods", "Shopee 商品详情查询失败")
...
def main():
    parser = argparse.ArgumentParser(description="查询 Shopee 商品详情与历史")
    parser.add_argument("--goods-id", required=True, help="Shopee 商品 ID")
