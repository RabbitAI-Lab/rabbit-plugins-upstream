"""Shared helpers for linkfox-tiktok-shop-return-refund (ERP developerProxy, token backendized)."""
...
# ERP return_refund skill path whitelist
ALLOWED_PATH_PREFIXES = ("return_refund", "authorization")


def ensure_auth_skill_available(caller: str = "shop-return_refund script") -> None:
