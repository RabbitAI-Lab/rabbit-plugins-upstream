#!/usr/bin/env python3
# 财税合规助手 - 离线参考工具（Offline Reference Tool）· 国企经责审计涉税版
# Version: v2.0.0 | Updated: 2026-07-25
#
...
OFFLINE_RISK_KEYWORDS = {
    ...
    "SOE Audit Risk": ["账外账", "小金库", "国有资本收益截留", "专项资金挤占挪用", "关联转移国有资产"],
...
def main():
    import sys
    print('=' * 60)
    print('Tax Compliance Assistant - Offline Reference Tool v2.0.0 (SOE Audit)')
    print('=' * 60)
    if len(sys.argv) > 1:
        arg = sys.argv[1]
        if arg == '--ref':
