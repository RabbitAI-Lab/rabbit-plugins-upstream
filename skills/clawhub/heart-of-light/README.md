...
**Categories:** knowledge, productivity, communication  
**Public tags:** #knowledge, #ethics, #honesty, #agent-governance, #communication

## ✨ Functionalities

MAX EDITION ethical operating system: Seven Lights + Lamp of ehsan + a calibrated honesty engine (certainty 0-1), self-verification suite, per-task playbooks, an anti-pattern gallery, and an anti-tyranny Sunlight Doctrine. Opt-in via HEART_OF_LIGHT_MODE=ON.
...
Read the ethical framework first and explicitly opt in with the documented mode toggle before applying its decision and honesty playbooks.
...
• Opt-in mode (HEART_OF_LIGHT_MODE=ON)
• Toggle helper heart_toggle.sh
...
- Behavior only activates when explicitly enabled.
...
**Artifact SHA-256 (TREE-SHA256-v1):** `a8bf4c7eb8b211e86870b79d470a53053710abd95ab24ea280f1f51ffffa259b`
