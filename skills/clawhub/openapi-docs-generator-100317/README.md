...
- github-issues: [Investigate and evolve a capability-driven XBuilder Admin Console](https://github.com/goplus/builder/issues/3361)
...
- github-issues: [Documentation: Get all movie translations](https://github.com/trakt/trakt-api/issues/869)
