...
req = urllib.request.Request(GATEWAY + "/one-note/v1.0/me/onenote/notebooks")
req.add_header("Authorization", "Bearer " + os.environ["MATON_API_KEY"])
req.add_header("User-Agent", "maton-one-note-skill/1.2")
