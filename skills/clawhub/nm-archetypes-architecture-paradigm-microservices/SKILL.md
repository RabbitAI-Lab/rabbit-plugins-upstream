...
description: Applies microservices for independent deployment and per-service scaling
version: 1.9.8
triggers:
  - architecture
  - microservices
  ...
  - team-autonomy
  - scalability
  - teams need autonomous release cycles with distinct capability scaling needs
