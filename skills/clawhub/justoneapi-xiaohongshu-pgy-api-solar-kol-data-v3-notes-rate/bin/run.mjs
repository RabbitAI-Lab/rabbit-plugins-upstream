...
const manifest = {
  ...
  "displayName": "Xiaohongshu Creator Marketplace (Pugongying) Note Performance Metrics",
  "openapi": "3.1.0",
  "platformKey": "xiaohongshu-pgy",
  "primaryTag": "Xiaohongshu Creator Marketplace (Pugongying)",
  "skillName": "justoneapi_xiaohongshu_pgy_api_solar_kol_data_v3_notes_rate",
  "slug": "justoneapi-xiaohongshu-pgy-api-solar-kol-data-v3-notes-rate",
  ...
  "endpointPath": "api/solar/kol/dataV3/notesRate",
  "skillType": "interface"
};
