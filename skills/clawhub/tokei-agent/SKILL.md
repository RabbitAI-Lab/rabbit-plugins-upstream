...
7. **Monitor** — stats, leaderboard, signups
...
// list reads (pages:list, leaderboard, entries:list, surveys:list,
//             templates:list, webhooks:list)
{ "success": true, "data": [ … ],
...
# Other
tokei-agent mcp                       # MCP stdio server (all 17 commands as tools)
