---
name: amazon-review-keywords
display_name: 亚马逊评论关键词提取 · 高频词云
description: >
  亚马逊评论关键词提取 Skill：统计评论中的高频词与共现词，分出买家夸的词和骂的词。
  这些是买家自己的语言，可直接用于 Listing 埋词与广告词筛选。
  口径是评论文本词频，不是搜索排名或流量数据。Use when the user asks about review keywords,
  word frequency, customer wording, 评论关键词、高频词、词云、买家用语、埋词参考、
  关键词提取。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: review-keywords
displayName: 亚马逊评论关键词提取 · 高频词云
version: 1.4.7
summary: 评论高频词与共现词，好评差评分开统计
license: MIT
---
