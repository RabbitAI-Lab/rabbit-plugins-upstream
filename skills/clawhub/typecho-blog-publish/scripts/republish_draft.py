...
def republish_draft(post_id):
    ...
    try:
        ...
        print(f"🔗 新文章链接：{blog_url}/archives/{new_post_id}.html")
        return True
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法：python3 republish_draft.py <文章 ID>")
        print("示例：python3 republish_draft.py 916")
        sys.exit(1)
    
    try:
        post_id = int(sys.argv[1])
        success = republish_draft(post_id)
