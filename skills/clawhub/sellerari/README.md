...
客户端未选中时，在问题前加“使用 $amazon-review-intelligence-extractor”。
...
作为安装目录名。当前包的 name 是 amazon-review-intelligence-extractor，WorkBuddy 用户级目录为
~/.workbuddy/skills/amazon-review-intelligence-extractor/。版本压缩包的外层目录名不是固定 Skill 名。
更新已有同名安装时保留本地配置。
