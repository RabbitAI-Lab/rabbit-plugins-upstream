...
**MIT License (local Skill) — open source.** Cloud TemplateSpec remains the author's proprietary asset. See LICENSE. Free for personal use; commercial redistribution or re-listing on paid marketplaces requires the author's written permission. See [LICENSE](LICENSE) (Chinese text prevails).
