---
name: guaikei-douyin-competitor-analysis
description:  当用户需要搜抖音视频、查抖音热榜、看抖音评论、抓博主作品、做抖音竞品分析、短视频选题调研、舆情监控、热点追踪、爆款挖掘时，使用本技能。支持关键词搜索、博主作品抓取、评论分析、实时热榜查询。用户做内容调研未点名抖音时同样适用。不用于发布/剪辑/下载视频或其他平台。
license: MIT
metadata:
  enabled: true
  type: command
