...
企查查中转站通过 zqcc 将企查查企业数据能力统一中转为一个 MCP 地址和一套 Chat API，可发布到 ClawHub 并安装到 OpenClaw。用户只需一个企查查中转站 AppKey，即可调用 6 类、共 185 项企业数据工具。

English documentation: [README.md](README.md)

## 功能与能力

企查查中转站对外提供一个 MCP 地址，统一代理 6 类、共 185 个企查查企业数据工具：
...
企查查中转站注册地址和用户控制台：<https://zqcc.mkstone.club>
...
ClawHub 上的公开展示名为“企查查中转站”，安装 slug 保持为 `zqcc`。Skill 使用 MIT-0 许可；企查查中转站服务、企查查数据、账户和积分消耗仍分别受对应服务条款约束。
