...
和 [main-image-video](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/main-image-video/skill.md) 的分工：那个是主图位的 3 秒单镜，
...
| 真人口播 | 用 [ugc-testimonial](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/ugc-testimonial/skill.md) |
