...
try:
    ...
    # BUG FIXED (v1.4.0): see tests/test_smoke.py - SkipTest at import produced a
    # traceback plus exit 0, indistinguishable from a pass.
    print(f"SKIP test_advanced.py - REQUIRED dependency missing: {exc}")
