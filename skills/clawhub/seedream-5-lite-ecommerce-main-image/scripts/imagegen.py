...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度电商主图，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、电商主图、商品主图、电商首图、白底图、SKU主图、平台主图、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-ecommerce-main-image", "rule": "optional", "search": "固定调用 Seedream 5.0 Lite 的电商主图裸接口能力", "title": "Seedream 5.0 Lite 电商主图"}')
