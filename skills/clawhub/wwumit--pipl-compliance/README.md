# PIPL Compliance v1.2.2

**中国个人信息保护法（PIPL）合规检查、风险评估和文档生成工具**

🎉 **v1.2.2 重要更新**：全新统一化CLI接口，支持JSON/Markdown/HTML/CSV多格式报告输出。
...
```
pipl-compliance-1.2.2/
├── SKILL.md                    # 主文档
├── README.md                   # 本文件
├── package.json                # 元数据 (v1.2.2)
├── CHANGELOG.md                # 更新日志
...
**PIPL Compliance v1.2.2 - Wei Wu (wwumit)**
