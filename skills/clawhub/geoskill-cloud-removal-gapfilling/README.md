# Cloud Removal and Gap Filling (geoskill-cloud-removal-gapfilling)

> Multi-temporal median/percentile compositing for cloud removal, producing cloud-free composite imagery and cloud coverage statistics
...
python geoskill-cloud-removal-gapfilling.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
