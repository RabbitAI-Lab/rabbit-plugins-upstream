# 🔒 Vibe Codebase Audit - English Usage Guide

## 📋 Overview

**Vibe Codebase Audit** is a comprehensive security auditing tool designed for AI-generated codebases, featuring agent-native integration, multi-provider support, and dependency security scanning.

> 🎉 **NEW in v2.0**: Agent-native audit (no API key needed), multi-provider support, dependency scanning, and configuration audit
...
```python
# No API key needed! Use current agent's LLM directly
...
|-------|-------------|-------|----------|
| **OpenCode** | Native skill | Auto-discovered | Seamless workflow |
