# Contributing to `User Provides Programming`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/User Provides Programming.git
cd User Provides Programming
...
git add .
git commit -m "feat(error-to-fix): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(error-to-fix): add <brief description>
