#!/usr/bin/env python3
"""ai-content-creator-assistant - Order Creation Script (Phase 1)

Creates local order file for clawtip payment processing.
The AI model generates content in conversation after payment.
...
Clawtip payment metadata only. No created content, source materials, or platform credentials.
"""
import argparse
import hashlib
import json
...
DESCRIPTION = "Multi-platform content creation and distribution assistant"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Create order for ai-content-creator-assistant"
    )
    ...
    print("        Fields: orderNo, amount, question, slug, payTo,")
    print("        encrypted_data, description, resource_url.")
    print("        No created content, source materials, or platform")
    print("        credentials (cookies, API keys) are stored.")
    print("=" * 60)
    ...
    summary = {"order_no": order_data["order_no"], "amount": order_data["amount"],
