...
PROXY_URL = os.environ.get("PROXY_URL", "https://1439498936-2v8x8x9kyb.ap-guangzhou.tencentscf.com")
TOOL_NAME = "get_trending_items"
CHANNEL_NAME = "实时热销"
TIMEOUT_SHORT = 15
TIMEOUT_LONG = 90
...
def tool_get_trending_items(params):
    """查询京东实时热销商品"""
...
TOOLS = {
    "get_trending_items": tool_get_trending_items,
}
