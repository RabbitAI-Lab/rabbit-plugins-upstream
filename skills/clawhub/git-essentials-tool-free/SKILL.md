...
description: "提供Git版本控制核心命令,涵盖初始化、提交、分支、远程同步与历史管理,适合开发者入门。"
license: Proprietary
...
**处理**: 按照skill规范执行初始设置操作,遵循单一意图原则。
**输出**: 返回初始设置的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行基本工作流操作,遵循单一意图原则。
**输出**: 返回基本工作流的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行分支与合并操作,遵循单一意图原则。
**输出**: 返回分支与合并的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行远程操作操作,遵循单一意图原则。
**输出**: 返回远程操作的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行历史与日志操作,遵循单一意图原则。
**输出**: 返回历史与日志的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行撤销与恢复操作,遵循单一意图原则。
**输出**: 返回撤销与恢复的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行暂存(stash)操作,遵循单一意图原则。
**输出**: 返回暂存(stash)的执行结果,包含操作状态和输出数据。
