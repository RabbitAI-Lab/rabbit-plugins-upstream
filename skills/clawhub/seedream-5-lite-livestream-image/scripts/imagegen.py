...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度直播带货图片，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、直播带货图片、直播间背景、带货图、直播贴片、直播商品图、直播视觉、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-livestream-image", "rule": "optional", "search": "固定调用 Seedream 5.0 Lite 的直播带货图片裸接口能力", "title": "Seedream 5.0 Lite 直播带货图片"}')
