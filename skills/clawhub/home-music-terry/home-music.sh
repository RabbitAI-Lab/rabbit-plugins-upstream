...
PLAYLIST_READING="spotify:playlist:37i9dQZF1DWZqd5JICZI0u"  # Ambient Reading
...
# Reading scene: Ambient background for reading
# - Living Room + Bedroom at 20% volume
# - Ambient reading playlist for focus without distraction
scene_reading() {
    echo "📖 Starting Reading scene..."
    
    # Set Airfoil source to Spotify
    airfoil_set_source_spotify
    
    # Connect Living Room and Bedroom at 20%
    airfoil_connect "Living Room"
    airfoil_connect "Bedroom"
    sleep 0.5
    airfoil_volume "Living Room" 0.2
    airfoil_volume "Bedroom" 0.2
    
    # Start playlist
    "$SPOTIFY_CMD" play "$PLAYLIST_READING"
    "$SPOTIFY_CMD" volume 100
    
    echo "✅ Reading: Living Room + Bedroom @ 20%, Ambient Reading"
}
...
Scenes:
  ...
  reading    Ambient Reading on Living Room + Bedroom (20% volume)
