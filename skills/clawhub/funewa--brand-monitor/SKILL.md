---
name: amazon-brand-monitor
display_name: 亚马逊品牌口碑监控 · 评论舆情追踪
description: >
  亚马逊品牌口碑监控 Skill：把自家多个 ASIN 订阅起来持续采集评论，
  跟踪评分与差评主题的变化，发现集中爆发的负面反馈，也可同时盯住竞品品牌做横向对照。
  Use when the user asks about brand reputation monitoring, review alerts,
  ongoing review tracking, 品牌口碑、口碑监控、舆情监控、差评预警、评论追踪、
  品牌评价。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: brand-monitor
displayName: 亚马逊品牌口碑监控 · 评论舆情追踪
version: 1.4.3
summary: 多 ASIN 持续追踪，差评集中爆发即预警
license: MIT
---
