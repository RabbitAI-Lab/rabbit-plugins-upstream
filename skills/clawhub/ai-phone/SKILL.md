...
Polly AI Phone turns your phone number into an AI-powered communication hub. It goes beyond a simple dialer — Polly screens incoming calls in real time, provides caller intent analysis before you pick up, transcribes voicemails into text, logs all call activity, and gives you smart summaries of every interaction.
Think of it as an AI layer on top of your phone that makes every call smarter, safer, and more efficient.

---

## When to Use

- The user wants AI-enhanced phone features (smart screening, transcription, call summaries)
- The user says things like "screen my calls", "who's calling me?", "transcribe my voicemails", "give me a call summary"
- The user wants a centralized dashboard to manage all phone activity
- The user needs call analytics, history, or recordings
