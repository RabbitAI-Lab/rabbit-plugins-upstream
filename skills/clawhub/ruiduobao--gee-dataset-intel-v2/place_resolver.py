...
PRESETS: Dict[str, Dict] = {
    "city-uhi": {
        # Urban Heat Island — small city bbox, 8-day product, default to 30 days
        "product": "MOD11A2",
        "bbox": (115.7, 39.4, 116.8, 40.3),  # Beijing
    ...
    "city-uhi-daily": {
        ...
        "layers": "LST_Day_1km,LST_Night_1km,QC_Day,QC_Night",
        "description": "城市热岛：逐日 Terra 1km LST",
    },
    "china-lst": {
        "product": "MOD11A2",
        "bbox": (73.0, 18.0, 135.0, 54.0),
        "layers": "LST_Day_1km,QC_Day",
        "description": "中国 8 天合成 Terra LST",
    },
    "global-lst-daily": {
        "product": "MOD11A1",
        "bbox": (-180.0, -90.0, 180.0, 90.0),
        "layers": "LST_Day_1km",
        "description": "全球逐日 Terra LST（通常会被 CMR 分页）",
    },
}
