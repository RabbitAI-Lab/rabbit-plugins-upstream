...
description: >
  Use this skill when a manager needs to draft an annual or mid-year performance
  review for a direct report. Guides structured evidence gathering and
  competency assessment, then produces a complete, bias-checked review document
  covering goals, accomplishments, development areas, and next-period objectives
  ready for manager refinement and HR submission.
---
...
6. Any of the following (ask as a single grouped question so the manager can answer what applies):
...
2–4 sentences: What did the employee accomplish this period? What is the overall performance signal? This sets the tone for the rest of the review.

**Section 2 — Goals and Achievements**
For each goal or OKR:
- State the goal
...
If the manager provided a competency framework, assess each competency with a rating and a 1–2 sentence justification grounded in a specific example from the review period.
...
Draft 2–4 specific, measurable goals for the next review period based on the employee's role and the development areas identified. Use this format for each:
