...
```bash
maton api '/v1/courses/{courseId}' -X DELETE
```
...
```bash
maton api '/v1/courses/{courseId}/courseWork/{courseWorkId}' -X DELETE
```
...
```bash
maton api '/v1/courses/{courseId}/teachers/{userId}' -X DELETE
```
...
```bash
maton api '/v1/courses/{courseId}/students/{userId}' -X DELETE
```
...
```bash
maton api '/v1/courses/{courseId}/announcements/{announcementId}' -X DELETE
```
...
```bash
maton api '/v1/courses/{courseId}/topics/{topicId}' -X DELETE
```
...
```bash
maton api '/v1/invitations/{invitationId}' -X DELETE
```
