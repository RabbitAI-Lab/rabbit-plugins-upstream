...
description: Designs memory palace structures with spatial layouts and domain organization
version: 1.9.8
triggers:
  - memory
  - organization
  ...
  - architecture
  - mnemonic
  - creating a new palace or planning knowledge architecture by hand
