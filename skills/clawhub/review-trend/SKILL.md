---
name: amazon-review-trend
display_name: 亚马逊评论趋势监控 · 口碑变化预警
description: >
  亚马逊评论趋势监控 Skill：按时间轴追踪评论量、评分与情绪的变化，
  识别口碑拐点并定位拐点前后新增的抱怨主题，及早发现批次质量问题或竞品冲击。
  Use when the user asks about review trends over time, rating decline,
  reputation tracking, 评论趋势、口碑变化、评分走势、舆情监控、差评突增、
  趋势分析。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: review-trend
displayName: 亚马逊评论趋势监控 · 口碑变化预警
version: 1.4.7
summary: 口碑拐点预警：评论量、评分与情绪走势
license: MIT
---
