#!/usr/bin/env python3
"""Dependency Check - linkfox-tiktok-shop-fulfillment -> linkfox-tiktok-shop-auth."""
...
def main() -> None:
    ...
    payload = {
        ...
        "reason": "linkfox-tiktok-shop-fulfillment 依赖 linkfox-tiktok-shop-auth，未找到其 SKILL.md。",
