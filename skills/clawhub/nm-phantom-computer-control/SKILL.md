...
description: Automates desktop GUI workflows via computer use API with screenshot capture
version: 1.9.8
triggers:
  - scripting GUI interactions or recording browser sessions for tutorials
