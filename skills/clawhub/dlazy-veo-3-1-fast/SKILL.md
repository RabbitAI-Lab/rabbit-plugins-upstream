...
Options:
  ...
  --generation_mode [generation_mode]  Generation Mode（frames=Frames; extend=Extend Video） [default: frames] (choices: "frames", "extend")
  ...
  --duration [duration]                Duration (s) (4/6/8 in frames mode; fixed 7 in extend mode) Options depend on "generation_mode". when generation_mode="": 4 (4s), 6 (6s), 8 (8s); when generation_mode="generation_mode=extend": 7 (+7s) [default: 8] (choices: "4", "6", "8", "7")
