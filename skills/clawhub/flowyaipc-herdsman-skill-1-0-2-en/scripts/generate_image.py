...
def auto_output_path(index: int) -> str:
    ...
    return os.path.join(default_output_dir(), f"img_{timestamp}_{index + 1}.png")


def main() -> None:
    parser = argparse.ArgumentParser(description="Herdsman Text-to-Image")
