# Image Quality Assessment (geoskill-image-quality-assessment)

> Assess radiometric (SNR, striping, dead lines) and geometric (cloud, sharpness) quality of multispectral imagery; outputs a scored JSON and HTML report.
...
python geoskill-image-quality-assessment.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
