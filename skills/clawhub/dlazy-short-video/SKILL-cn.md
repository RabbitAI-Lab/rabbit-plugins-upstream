---
name: dlazy-short-video
version: 1.2.6
description: "竖屏短视频、抖音视频、TikTok 视频、小红书视频、YouTube Shorts、Reels、口播视频、9:16 视频——钩子前置的单线分镜、逐镜首帧与图生视频、TTS 配音,最后由 Remotion 拼接并烧录字幕。交付 15-25 秒的竖屏成片 mp4,不是脚本。适合社交平台短片;以转化为目标的带货广告请用 product-to-ecommerce-video。"
metadata: {"clawdbot":{"emoji":"📱","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli@1.2.3","installAlternative":"npx @dlazy/cli@1.2.3","homepage":"https://github.com/dlazyai/cli","source":"https://github.com/dlazyai/cli","author":"dlazyai","license":"see-repo","npm":"https://www.npmjs.com/package/@dlazy/cli","configLocation":"~/.dlazy/config.json","apiEndpoints":["api.dlazy.com","files.dlazy.com"]},"openclaw":{"systemPrompt":"当调用此技能时，新任务运行 'dlazy chat --skill short-video --prompt ...'，继续已有项目用 'dlazy chat --project <id> --prompt ...'（用 'dlazy projects list' 查 id）；不要同时传 --skill 和 --project。"}}
---
...
竖屏短视频、抖音视频、TikTok 视频、小红书视频、YouTube Shorts、Reels、口播视频、9:16 视频——钩子前置的单线分镜、逐镜首帧与图生视频、TTS 配音,最后由 Remotion 拼接并烧录字幕。交付 15-25 秒的竖屏成片 mp4,不是脚本。适合社交平台短片;以转化为目标的带货广告请用 product-to-ecommerce-video。
...
此技能与 dlazy 沙箱 agent 对话，**已固定到 `short-video` 模板** —— 一个以项目为单位、可端到端运行该模板的助手，支持多轮对话。
...
```bash
# 用该模板新建项目
dlazy chat --skill short-video --prompt "..."
...
> **智能体关键指令**:
>
> 1. 新任务运行 `dlazy chat --skill short-video --prompt "..."`。
