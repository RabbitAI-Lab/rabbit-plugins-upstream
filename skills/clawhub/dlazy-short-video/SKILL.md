...
This skill talks to the dlazy sandbox agent, **pinned to the `short-video` template** — a project-scoped assistant that runs the template end-to-end across multiple turns.
...
1. For a new task, run `dlazy chat --skill short-video --prompt "..."`.
