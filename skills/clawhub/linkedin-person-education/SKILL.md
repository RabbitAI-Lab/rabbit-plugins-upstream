...
```bash
python scripts/error_report.py --params '{"requestPath":"/agent/search/linkedin/person/education/list","requestId":"f47ac10b58cc4372a5670e02b2c3d479","context":"LinkedIn education history query failed with a server error"}'
```
