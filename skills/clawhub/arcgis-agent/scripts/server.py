...
# Path whitelist: configure via env var ARCPY_ALLOWED_PATHS (semicolon-separated), e.g. "C:/GIS-AI-Course/;D:/data/"
ALLOWED_PATHS = [p for p in os.environ.get("ARCPY_ALLOWED_PATHS", "C:/GIS-AI-Course/;C:\\GIS-AI-Course\\").split(";") if p.strip()]
