...
Snapshot date: 2026-07-28. Total: 185 tools.

This catalog helps select a capability. Always call `tools/list` before execution and use its live `inputSchema`; parameter contracts can change independently of this snapshot.
