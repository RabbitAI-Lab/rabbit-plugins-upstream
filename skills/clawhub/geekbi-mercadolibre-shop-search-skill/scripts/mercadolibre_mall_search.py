...
ENDPOINT = "/api/v1/mercadolibre/mall/ai-search"
BASE_PARAMS = {"keyword", "siteId", "page", "size", "sort", "order"}
NUMERIC_RANGE_PARAMS = {"goodsNum", "followerNum", "mallSold", "mallStar"}
INTEGER_RANGE_PARAMS = {"goodsNum", "followerNum", "mallSold"}
...
SORT_FIELDS = {"updateTime", "goodsNum", "followerNum", "mallSold", "mallStar", "mallOpenTime"}
...
def main():
    parser = argparse.ArgumentParser(description="查询 Mercado Libre 店铺并输出 JSON")
    ...
    try:
        ...
        payload = validate_search_response(payload, "Mercado Libre 店铺查询失败")
