---
name: compdf-compress-pdf
description: Compress PDF files with ComPDF while balancing file size and readable visual quality. Use for PDF optimization, resolution control, compression strategies, and removal of non-essential document content.
---
...
ComPDF Compress PDF helps teams shrink PDF file sizes for faster transfer, easier storage, and smoother downstream workflows. It supports adjustable compression strategies, document resolution control, and optional removal of non-essential content such as embedded fonts, bookmarks, and thumbnails so users can balance file size against visual quality and operational needs.
...
| --- | --- |
| Compress PDF | `compress-guides` |
| Compression flags | `optimization-flags` |

## Scope

Use compression endpoints only. Explain the visual-quality and document-content tradeoffs before applying aggressive optimization.
