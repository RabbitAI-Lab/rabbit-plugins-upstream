    ...
    console.log(JSON.stringify({
      tools: [
        ...
        },
        {
          ...
          description: 'Generate images using MiniMax image-01 model via Token Plan API. Input a text prompt and receive image URLs. Supported: realistic photos, illustrations, anime, concept art, etc.',
          inputSchema: {
            type: 'object',
            properties: {
              prompt: {
                type: 'string',
                description: 'Image generation prompt - describe what you want to see. Be specific about style, content, and quality.'
              }
            },
            required: ['prompt']
          }
