...
- github-issues：[fix(template): reject Python keywords as package names](https://github.com/Alex-Kopylov/ai-ready-modern-python-template/issues/30)
- hacker-news-search：[Preventing LLM unit test spam](https://blog.larah.me/test-slop/)
- hacker-news-ask-hn：[I got tired of every .NET HTML-to-PDF library so I built a free one from scratch](https://news.ycombinator.com/item?id=48853670)
...
- hacker-news-search：[After 7 years in production, Scarf has reluctantly moved away from Haskell](https://news.ycombinator.com/item?id=48869310)
