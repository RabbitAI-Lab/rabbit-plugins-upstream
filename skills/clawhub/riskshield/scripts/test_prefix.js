/**
 * RiskShield Auto Approve - Test with prefix search
 */

const { chromium } = require('playwright');

const CASE_FULL = '2604131000000597537';
const SEARCH_PREFIX = '26041310000005';  // As shown in user's screenshot
...
(async () => {
    log(`Testing prefix search: "${SEARCH_PREFIX}" for case ${CASE_FULL}`);
