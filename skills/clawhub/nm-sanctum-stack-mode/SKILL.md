...
triggers:
  ...
  - fix-pr
  - iteration
  - a command supports --stack flag for multi-PR iteration
metadata: {"openclaw": {"homepage": "https://github.com/athola/claude-night-market/tree/master/plugins/sanctum", "emoji": "\u2699\ufe0f", "requires": {"config": ["night-market.sanctum:stack-create", "night-market.sanctum:stack-push", "night-market.sanctum:stack-rebase", "night-market.leyline:git-platform"]}}}
