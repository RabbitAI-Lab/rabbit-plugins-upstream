...
> **Always confirm before restoring**: "About to restore from `<backup-name>`, which will overwrite files in your home directory. Proceed?"

### Agent Only Restore

```bash
# Remove agent first
gateway agents delete <agent-name>
