...
function backup() {
  ...
  const files = [
    '.openclaw/agents',
    '.openclaw/workspace-ghada/skills',
    '.openclaw/workspace-ghada/.openclaw-cron.json',
    '.openclaw/workspace-ghada/MEMORY.md',
    '.openclaw/workspace-ghada/memory',
...
function gitSync() {
  try {
    const workspace = path.join(OPTIN_DIR, 'workspace-ghada');
