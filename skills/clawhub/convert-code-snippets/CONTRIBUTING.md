# Contributing to `Convert Code Snippets`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Convert Code Snippets.git
cd Convert Code Snippets
...
git add .
git commit -m "feat(convert-code-snippets): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(convert-code-snippets): add <brief description>
