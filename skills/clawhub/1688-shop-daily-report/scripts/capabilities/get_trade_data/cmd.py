...
from capabilities.get_trade_data.service import get_trade_data

COMMAND_NAME = "get_trade_data"
COMMAND_DESC = "获取指定日期的交易数据（GMV、订单量、客单价、转化率、询盘数）"
...
def main():
    ...
    try:
        result = get_trade_data(args.query_date, login_id=login_id)
        print_output(True, "交易数据查询成功", {"data": result})
