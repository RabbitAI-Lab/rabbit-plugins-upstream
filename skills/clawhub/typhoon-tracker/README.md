...
skill 的预测规律来自三个层次、共 **8 个台风经验**：

| 层次 | 台风 | 沉淀方式 | 贡献的经验 |
| --- | --- | --- | --- |
| **全周期案例**（独立案例文件） | 巴威（2609）/ 白海豚（2613）/ 浪卡（2617） | `references/` 独立案例文件 + 预测 vs 实际复盘表 | 登陆时间收敛、铁路停运三层模型、残涡追踪协议、远距离水汽副作用 |
