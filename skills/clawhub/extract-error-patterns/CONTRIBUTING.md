# Contributing to `Extract Error Patterns`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Extract Error Patterns.git
cd Extract Error Patterns
...
git add .
git commit -m "feat(extract-error-patterns): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(extract-error-patterns): add <brief description>
