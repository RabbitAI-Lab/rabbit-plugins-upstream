...
from capabilities.get_industry_benchmark.service import get_industry_benchmark

COMMAND_NAME = "alibaba.1688.get.industry.benchmark"
COMMAND_DESC = "行业大盘对比数据查询"


def main():
    parser = argparse.ArgumentParser(description="行业大盘对比数据查询")
    ...
    try:
        ...
        result = get_industry_benchmark(args.query_date, login_id=login_id)
