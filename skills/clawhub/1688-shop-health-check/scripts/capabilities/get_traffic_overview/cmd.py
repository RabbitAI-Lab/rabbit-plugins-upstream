...
from capabilities.get_traffic_overview.service import get_traffic_overview

COMMAND_NAME = "alibaba.1688.get.traffic.overview"
COMMAND_DESC = "获取全店流量概览数据"


def main():
    parser = argparse.ArgumentParser(description="获取全店流量概览数据")
    ...
    try:
        ...
        result = get_traffic_overview(args.query_date, login_id=login_id)
