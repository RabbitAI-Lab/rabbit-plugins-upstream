...
from capabilities.get_ad_channel_detail.service import get_ad_channel_detail

COMMAND_NAME = "alibaba.1688.get.ad.channel.detail"
COMMAND_DESC = "广告渠道深度下钻"


def main():
    parser = argparse.ArgumentParser(description="广告渠道深度下钻")
    ...
    try:
        ...
        result = get_ad_channel_detail(args.query_date, login_id=login_id)
