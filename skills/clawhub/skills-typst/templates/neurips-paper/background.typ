...
Extended Neural GPU @kaiser2016can, ByteNet @kalchbrenner2017neural and ConvS2S
@gehring2017convolutional, all of which use convolutional neural networks as basic
...
positions, linearly for ConvS2S and logarithmically for ByteNet. This makes it
more difficult to learn dependencies between distant positions
@hochreiter2001gradient. In the Transformer this is reduced to a constant number
of operations, albeit at the cost of reduced effective resolution due to averaging
attention-weighted positions, an effect we counteract with Multi-Head Attention as
described in @sec-attention.
...
task-independent sentence representations @cheng2016long @parikh2016decomposable
@paulus2017deep @lin2017structured.
...
question answering and language modeling tasks @sukhbaatar2015end.
...
advantages over models such as @kaiser2016neural @kalchbrenner2017neural and
