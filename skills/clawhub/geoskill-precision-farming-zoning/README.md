# Precision Agriculture Management Zoning (geoskill-precision-farming-zoning)

> Standardizes multi-source layers, clusters them with K-means into management zones with per-zone advice.
...
python geoskill-precision-farming-zoning.py --bbox 116 39 117 40 --synthetic --output-dir ./out
```
...
---
name: geoskill-precision-farming-zoning
description: '多源数据标准化后用 K-means 聚类生成管理分区并给出每区建议。Standardizes multi-source layers, clusters them with K-means into management zones with per-zone advice.'
---
