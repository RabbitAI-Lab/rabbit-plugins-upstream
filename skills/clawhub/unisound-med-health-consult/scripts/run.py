#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""健康咨询与导诊 — 独立 skill，可单独拷贝发布；不依赖其他 skill 或 _shared。"""
...
TASKS: Dict[str, Dict[str, str]] = {'hc': {'title': '健康咨询与体检解读问答', 'hint': '解答健康生活方式、体检指标含义等咨询，语气清晰、避免过度诊断。'}, 'hg': {'title': '智能导诊与挂号科室推荐', 'hint': '依据主诉与对话信息归纳线索，推荐更合适的就诊科室方向。'}}
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="健康咨询与导诊：由调用方传入题目与 --task，直连内部医疗大模型。")
