---
name: amazon-new-product-validation
display_name: 亚马逊新品验证 · 上架前需求测算
description: >
  亚马逊新品验证 Skill：上架前先用在售同类产品的评论验证需求——买家现在抱怨什么、
  愿意为什么多付钱、哪些卖点已经烂大街，据此决定做不做、怎么做差异化，
  把试错成本从备货阶段前移到调研阶段。Use when the user asks about validating a new
  product idea, pre-launch research, 新品验证、新品调研、上架前调研、需求测算、
  产品立项、开发验证。Requires an ARI API key (ari_live_*).
author: ARI (funewa)
agent_created: true
slug: new-product
displayName: 亚马逊新品验证 · 上架前需求测算
version: 1.4.7
summary: 上架前用同类评论验证需求与差异化
license: MIT
---
