...
const manifest = {
  ...
  "displayName": "IMDb Redux Overview",
  "openapi": "3.1.0",
  "platformKey": "imdb",
  "primaryTag": "IMDb",
  "skillName": "justoneapi_imdb_title_redux_overview_query",
  "slug": "justoneapi-imdb-title-redux-overview-query",
  ...
  "endpointPath": "title-redux-overview-query",
  "skillType": "interface"
};
