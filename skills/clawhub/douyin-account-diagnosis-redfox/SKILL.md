...
>
> 如需使用自己的额度，可前往 [红狐hub](https://redfox.hk/settings/api-keys?source=clawhub) 获取 API KEY，并通过以下任一方式配置：
>
...
**Q：提示积分不足怎么办？**
A：前往 [红狐hub](https://redfox.hk/settings/api-keys?source=clawhub) 充值后重试即可。
