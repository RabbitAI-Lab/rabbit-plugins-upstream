...
All notable changes to RealBrowser QA by Ceki will be documented here.

## v0.1.0 — 2026-07-22

QA-focused fork for Cursor directory. Key differences from realbrowser-skill:

- Human Behavior Playbook reframed as Realistic User Simulation for QA Testing
- Removed Registration Template (Reddit/GitHub/IMAP account creation scripts)
- Repositioned for QA testing, security auditing, and vulnerability discovery
- Clean metadata for Cursor MCP directory submission
