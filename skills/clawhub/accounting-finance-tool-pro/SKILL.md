...
license: "Proprietary"
edition: "pro"
description: |- 功能涵盖: accounting(会计)。
...
**处理**: 解析一、估值建模（14个技能）的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回一、估值建模（14个技能）的响应数据,包含状态码、结果和日志.
### 二、财务分析（26个技能）
...
**处理**: 解析二、财务分析（26个技能）的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回二、财务分析（26个技能）的响应数据,包含状态码、结果和日志.
### 三、风险评估（18个技能）
...
**处理**: 解析三、风险评估（18个技能）的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回三、风险评估（18个技能）的响应数据,包含状态码、结果和日志.
