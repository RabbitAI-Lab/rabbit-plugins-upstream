"""CLI argument parsing tests for map-symbology-optimizer."""
import subprocess
import sys
import os
...
class TestCLIBasics:
    ...
    def test_bad_palette_exit_2(self):
        r = run_cli(["--bbox", "116", "39", "117", "40", "--synthetic", "--palette", "bad"])
