#!/usr/bin/env python3
"""Run the Website Phone Number Finder Apify actor from an agent-friendly CLI."""
...
DEFAULT_ACTOR_ID = "HE8ML7ZqmGI6OtyFU"
DEFAULT_TIMEOUT_SEC = 1800

VALID_RESULT_MODE = {"phonesOnly", "contactsOnly", "allWebsites"}
UNSUPPORTED_FIELDS = {
    "searchStringsArray",
    "locationQuery",
    "placeIds",
...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if forbidden:
        raise SkillError(
            "This actor scans submitted website domains and URLs for phone numbers, not Google Maps searches or reviews. "
    ...
    result_mode = str(payload.get("resultMode", "phonesOnly"))
...
def build_quick_domains_payload(args: argparse.Namespace) -> dict[str, Any]:
    payload: dict[str, Any] = {
        ...
        "extractEmails": args.extract_emails,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    quick.add_argument("--result-mode", choices=sorted(VALID_RESULT_MODE), default="phonesOnly")
    ...
    quick.add_argument("--extract-emails", action="store_true")
