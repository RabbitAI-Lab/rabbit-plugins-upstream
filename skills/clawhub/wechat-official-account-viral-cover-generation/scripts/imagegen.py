...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "公众号文章爆款封面，围绕主题形成清晰隐喻，主体强识别，标题留白适合微信信息流", "keywords": "公众号爆款封面、微信封面、文章首图、公众号头图、高点击封面、封面生图", "model": "public_model_nano_banana_pro", "name": "wechat-official-account-viral-cover-generation", "product_promise": "围绕文章主题、赛道和读者情绪生成公众号封面方案，交付可继续改字和换风格的图片", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "公众号爆款封面生成与编辑", "trend_inspired": true}')
