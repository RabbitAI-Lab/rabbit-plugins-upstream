...
- The user needs a new phone number for any purpose
- The user says things like "give me a second number", "I need a work number", "I want a private number for…", "get me a phone number"
- The user wants to list a number on a website, business card, or form without exposing their personal number
- An AI agent needs its own phone identity to make or receive calls
