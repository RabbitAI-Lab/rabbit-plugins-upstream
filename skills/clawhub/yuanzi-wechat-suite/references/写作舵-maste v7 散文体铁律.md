...
description: "元子公众号图文系列之『写作舵』。公众号图文大师 v7：老板定稿。三问 + 检索 + 六步 + 三查。散文体铁律：入戏不套话，长句不堆砌，具体不抽象。事实可考据、谁在说话、入戏不套话、行文节奏 4 铁律。"
tags: [yuanzi, gzh, articles, wechat, master, suite:yuanzi-wechat-series]
version: 1.0.0
metadata:
