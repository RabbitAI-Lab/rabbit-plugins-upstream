...
| 输入：待检图 |
| --- |
| <img src="https://raw.githubusercontent.com/dlazyai/ecommerce-skills/main/docs/detect-task/candidate.jpg" width="280"> |
| `candidate.jpg` — 由 [flat-lay](https://github.com/dlazyai/ecommerce-skills/blob/main/skills/flat-lay/skill.md) 生成的军绿毛衣模特上身图，1024×1536 |
...
**输出**：完整报告见 [`docs/detect-task/example-report.md`](https://github.com/dlazyai/ecommerce-skills/blob/main/docs/detect-task/example-report.md)，3 credits。摘要：
