 ...
 * @param {object} sdk
 * @param {object} [opts]
 * @param {number} [opts.maxWaitMs]   Overall cap (default 5000).
...
async function waitForStableBalance(sdk, { maxWaitMs = 5000, intervalMs = 1000 } = {}) {
  ...
  // Timed out — return the last read, flagged as not confirmed-stable.
  return { balanceSats: cur, stable: cur === prev };
}
