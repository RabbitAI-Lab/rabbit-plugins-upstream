"""CLI argument parsing tests for biodiversity-mapping."""
import subprocess
import sys
import os
...
class TestCLIMethods:
    def test_all_methods_accepted(self):
        for method in M.METHODS:
            r = run_cli([
                "--bbox", "116", "39", "117", "40",
                "--synthetic", "--method", method, "--quiet",
                "--output-dir", f"./_test_method_{method}",
            ])
            assert r.returncode == 0, f"method {method} failed: {r.stderr}"
