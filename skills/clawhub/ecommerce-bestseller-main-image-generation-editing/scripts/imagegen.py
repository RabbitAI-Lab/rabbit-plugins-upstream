...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "电商高点击主图，商品结构准确，主体占比明确，单一卖点视觉化，预留价格和活动信息安全区", "keywords": "电商爆款主图、商品主图、高点击主图、测图、CTR、SKU主图、白底图、场景主图", "model": "public_model_nano_banana_pro", "name": "ecommerce-bestseller-main-image-generation-editing", "product_promise": "输入商品图、平台和卖点，生成白底、场景、卖点和促销方向，适合主图测款与批量 SKU", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "电商爆款主图生成与编辑", "trend_inspired": true}')
