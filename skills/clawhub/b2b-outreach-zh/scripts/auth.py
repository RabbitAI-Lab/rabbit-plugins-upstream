...
顺带修复 email-tool / sms-tool 原SKILL.md声称 --price_info 但 auth.py 未实现的现存 bug。
"""
import argparse
import json
import os
...
ORIGINAL_SKILL_NAMES = [
    # 营销触达 (8 scripts across 3 skills)
    "upkuajing-email-tool", "upkuajing-sms-tool", "upkuajing-map-merchants-search",
    # 联系方式校验 (3 scripts across 3 skills)
    "phone-validity-check", "email-validity-check", "domain-validity-check",
]
