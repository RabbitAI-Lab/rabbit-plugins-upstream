...
def get_task_record_list(
    ...
    # 发起请求
    response = make_request('/agent/sms/task/record/list', params, api_key=api_key)
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        choices=[0, 1, 2, 3],
        help='发送状态（0-待发送 1-发送中 2-成功 3-失败）'
    )
    parser.add_argument(
        '--page_no',
        type=int,
