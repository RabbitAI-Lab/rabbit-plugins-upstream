...
3. 分别调用 `/v1/xiehouyu/query` 和 `/v1/xiehouyu/random` 接口。
...
API_PATH_MAP = {"query": "/v1/xiehouyu/query", "random": "/v1/xiehouyu/random"}
APPKEY_ENV_NAMES = ("JIKE_XIEHOUYU_QUERY_KEY", "JIKE_APPKEY")
REGISTER_URL = "https://www.jikeapi.cn/"
TITLE = "歇后语查询 - 即刻数据"
FAIL_TITLE = "歇后语查询失败"
ROW_FIELDS = [('riddle', '歇后语'), ('answer', '答案')]
