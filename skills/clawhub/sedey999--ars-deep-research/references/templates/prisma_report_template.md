...
Template for writing a systematic review report following PRISMA 2020 (Page et al., 2021). All 27 PRISMA items are mapped to their corresponding sections. Use alongside `references/guides/systematic_review_toolkit.md` for detailed guidance.
