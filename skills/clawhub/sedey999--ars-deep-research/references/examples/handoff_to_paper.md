# Handoff Example: ars-deep-research → ars-academic-paper

This example demonstrates how ars-deep-research full mode, after completing research, hands off to ars-academic-paper to begin paper writing.

---

## Scenario Setup

The user has completed ars-deep-research full mode on the topic "AI-Assisted Quality Assurance in Higher Education: A Comparative Analysis of Implementation Strategies in East Asian Universities." Below is a summary of the research outputs.

---

## ars-deep-research Output Summary
...
After completing ars-deep-research, the user inputs:
...
## ars-academic-paper intake_agent Auto-Detection
...
Recommended ars-academic-paper mode: full (with accelerated pipeline)
...
| ars-academic-paper Step | Normal Workflow | After Handoff | Reason |
|---------------------|---------|-----------|------|
...
## Post-Handoff ars-academic-paper Actual Workflow

```
=== ars-academic-paper: Accelerated Pipeline ===

Step 1: STRUCTURAL MAPPING
  [outline_agent]
  - Input: RQ Brief + Methodology Blueprint + Synthesis Report
  - Output: Complete paper outline, each section tagged with corresponding ars-deep-research materials
  - Output example:
...
Step 3: DISCUSSION + BOOKENDS
  [discussion_writer_agent] → Discussion
    ...
    - Integrates ars-deep-research Knowledge Gaps as Future Research
...
**ars-academic-paper's Opening Message**:

> I've read your complete outputs from the ars-deep-research stage, including:
...
1. **Not copy-paste**: ars-academic-paper does not directly copy ars-deep-research outputs, but transforms them into the tone and format of an academic paper
2. **May discover new issues**: During the writing process, ars-academic-paper agents may discover points missed by ars-deep-research and will proactively supplement them
...
4. **Review recommendation auto-connects**: After paper completion, the user can continue with `ars-academic-reviewer` for formal review
