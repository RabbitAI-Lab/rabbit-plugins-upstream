...
3. **Fill in the 21-item checklist**: Use the `references/templates/preregistration_template.md` template
...
## Completed-artifact handoff boundary
...
自动校验脚本（移植版未附带，以文字规则为准） with an explicit RFC3339
...
through ars-academic-paper and every pipeline handoff. Later explicit user supply
...
Missing, blank, generic, incomplete, or inaccessible scope means not checked.
 ...
 does not judge whether preregistration was required, timely, authentic,
