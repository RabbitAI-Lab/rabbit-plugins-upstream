...
ars-deep-research provides 8 modes suited to different research stages and needs. This guide helps users select the most appropriate mode.
...
socratic → ars-academic-paper    Write paper directly after Socratic completion
...
systematic-review → ars-academic-paper  Write up systematic review as a paper
```

### ars-deep-research to ars-academic-paper Mode Mapping

| ars-deep-research Mode | Output | Maps to ars-academic-paper Mode | Description |
|-------------------|------|--------------------------|------|
...
### ars-deep-research vs ars-academic-reviewer Mode Mapping

| ars-deep-research `review` mode | ars-academic-reviewer |
|------------------------------|------------------------|
...
```
Step 1: ars-deep-research (socratic/full)
          ↓ Research Plan / Full Report
Step 2: ars-academic-paper (plan/full)
          ↓ Paper draft
Step 3: ars-academic-reviewer (full/guided)
          ↓ Review comments
Step 4: ars-academic-paper (revision)
          ↓ Revised paper
...
### Transition: systematic-review → ars-academic-paper
