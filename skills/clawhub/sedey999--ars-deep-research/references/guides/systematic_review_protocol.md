...
See `references/risk_of_bias_agent.md` and `references/meta_analysis_agent.md` for detailed agent definitions.
See `references/guides/systematic_review_toolkit.md` for the Cochrane/PRISMA/GRADE reference guide.
...
=== Phase 1: SCOPING (Generates Protocol, not just RQ) ===
     ...
     |   - Protocol follows PRISMA-P 2015 (references/templates/prisma_protocol_template.md)
...
=== Phase 4: COMPOSITION ===
     ...
     +-> [report_compiler_agent] -> PRISMA 2020 Report
         - Uses references/templates/prisma_report_template.md
