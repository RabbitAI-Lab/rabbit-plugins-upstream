...
Reporting Standard: PRISMA 2020 (see references/guides/equator_reporting_guidelines.md)
```
...
Reporting Standards: QUAL strand → COREQ; QUAN strand → STROBE/CONSORT (see references/guides/equator_reporting_guidelines.md)
```
...
Reporting Standard: COREQ for interviews/focus groups (see references/guides/equator_reporting_guidelines.md)
```
