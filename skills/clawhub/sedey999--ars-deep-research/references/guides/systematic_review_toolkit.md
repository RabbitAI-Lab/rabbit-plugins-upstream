...
See `references/templates/prisma_protocol_template.md` for the complete protocol template.
...
│   └── Use PRISMA-P template → references/templates/prisma_protocol_template.md
│
...
│
└── 8. Report
    └── PRISMA 2020 checklist → references/templates/prisma_report_template.md
```
