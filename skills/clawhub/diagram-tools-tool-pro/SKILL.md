...
version: 1.0.0
displayName: 图表工具专业版
summary: "企业级图表工坊,支持自定义主题、批量渲染、SVG/PDF 导出与图表版本管理。核心能力: 可视化工具领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 可视化工具领域的专业化 AI 辅助工具,提供企业级高级功能支持。Use when 需要数据分析、报表生成、统计洞察、数据可视化时使用。不适用于实时流数据处理。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。提供结构化输出和错误处理机制。 功能涵盖: diagram。"
...
本工具是 **可视化工具** 领域的 **PRO 版本** AI Skill,专为企业级场景与专业用户设计。通过自然语言指令驱动 AI Agent 执行任务,提供高级功能、批量操作与团队协同.
...
**处理**: 解析自定义品牌主题与企业视觉规范适的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回自定义品牌主题与企业视觉规范适的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 批量图表渲染与高清输出(SVG
批量图表渲染与高清输出(SVG/PDF/PNG)

**处理**: 解析批量图表渲染与高清输出(SVG的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回批量图表渲染与高清输出(SVG的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 图表版本管理与变更对比
图表版本管理与变更对比

**处理**: 解析图表版本管理与变更对比的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回图表版本管理与变更对比的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与文档系统集成的图表嵌入
与文档系统集成的图表嵌入

**处理**: 解析与文档系统集成的图表嵌入的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回与文档系统集成的图表嵌入的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 图表模板库与团队共享
图表模板库与团队共享

**处理**: 解析图表模板库与团队共享的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回图表模板库与团队共享的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级图表工坊、支持自定义主题、批量渲染、导出与图表版本管、核心能力、可视化工具领域的、专业化、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 图表工具专业版处理的输入数据或指令 |
...
- **自动化执行**: 企业级图表工坊,支持自定义主题、批量渲染、SVG/PDF 导出与图表版本管理。核心能力: 可视化工具领域的专业化 AI 
