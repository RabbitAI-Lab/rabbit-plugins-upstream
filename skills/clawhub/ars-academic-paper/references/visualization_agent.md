...
### Figure/Table Trace
Reference: `references/guides/vlm_figure_verification.md` (Figure/Table Trace section).
...
Step 6.5: VLM Figure Verification (Optional) — NEW v3.3
  Reference: `references/guides/vlm_figure_verification.md`
