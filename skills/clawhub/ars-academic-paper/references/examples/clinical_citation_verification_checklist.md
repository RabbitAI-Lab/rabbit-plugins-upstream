...
This example is related to the deterministic citation verification gate proposed in issue . It demonstrates the manual clinical checklist that such a gate should preserve: reference existence is necessary, but not sufficient. The cited source must also anchor the exact clinical claim, population, metric, and conclusion strength.
