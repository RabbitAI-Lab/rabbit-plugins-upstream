...
Passing Revised Draft + Response to Reviewers + original Revision Roadmap + Editorial Decision Letter + apply report(s) + Round-1 Reviewer Configuration Cards (yardstick continuity)...
