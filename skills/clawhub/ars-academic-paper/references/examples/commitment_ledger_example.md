...
---
**See also:** `revision_recovery_example.md`, `references/shared/handoff_schemas.md` Schema 11, `ars-academic-reviewer/references/guides/re_review_mode_protocol.md` step 5.
