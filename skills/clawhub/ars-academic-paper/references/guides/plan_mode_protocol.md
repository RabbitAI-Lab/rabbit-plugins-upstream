...
=== Step 0: RESEARCH READINESS CHECK ===
     ...
     +-> [socratic_mentor_agent] -> Confirm what materials the user already has
         ...
         -> If research foundation is lacking, recommend running ars-deep-research (socratic mode) first
     |
...
=== Step 2.5: CONTRIBUTION SHARPENING ===
     ...
     +-> [socratic_mentor_agent] -> Ask the user to articulate the contribution their
         ...
         (single-sourced in ars-deep-research/references/socratic_mentor_agent.md Layer 5 —
         NOT this skill's references/socratic_mentor_agent.md, which has no Layer 5;
...
-> Or use ars-academic-reviewer to review the Chapter Plan
```
