# Contributing to `Convert Screenshot Any`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/Convert Screenshot Any.git
cd Convert Screenshot Any
...
git add .
git commit -m "feat(convert-screenshot-any): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(convert-screenshot-any): add <brief description>
