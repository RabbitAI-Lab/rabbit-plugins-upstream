...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度角色一致性图片，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、角色一致性图片、人物一致性、角色一致、IP形象、同一人物、多场景角色、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-character-consistency", "rule": "image", "search": "固定调用 Seedream 5.0 Lite 的角色一致性图片裸接口能力", "title": "Seedream 5.0 Lite 角色一致性图片"}')
