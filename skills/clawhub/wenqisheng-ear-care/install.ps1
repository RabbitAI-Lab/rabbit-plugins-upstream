# ============================================================
# 闻其声耳轻松可视采耳 Skill · Windows 一键安装
# ============================================================
# 用法：
#   powershell -c "irm https://raw.githubusercontent.com/Liubuq-sys/wenqisheng-ear-care-skill/main/install.ps1 | iex"
# ============================================================

$Repo = "https://github.com/Liubuq-sys/wenqisheng-ear-care-skill.git"
$SkillName = "wenqisheng-ear-care"
...
Write-Host "=== 闻其声耳轻松可视采耳 Skill · 安装 ===" -ForegroundColor Green
...
if (Test-Path "$SkillPath\.git") {
    ...
    $TmpDir = Join-Path $env:TEMP "wenqisheng-skill-$([System.Guid]::NewGuid())"
...
# 配置计划任务（每天 3:07）
$TaskName = "WenqishengSkillUpdate"
$Existing = Get-ScheduledTask -TaskName $TaskName -ErrorAction SilentlyContinue
if (-not $Existing) {
    $Action = New-ScheduledTaskAction -Execute "bash" -Argument "scripts/auto_update.sh" -WorkingDirectory $SkillPath
...
Write-Host "已就绪！现在对 AI 说「闻其声耳轻松」即可触发。" -ForegroundColor Green
